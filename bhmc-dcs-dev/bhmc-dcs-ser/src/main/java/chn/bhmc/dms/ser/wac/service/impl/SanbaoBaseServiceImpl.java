...
public class SanbaoBaseServiceImpl extends HService implements SanbaoBaseService{
    ...
    */
    public void multiSabaoBases(SanbaoBaseSaveVO saveVO) throws Exception {
        ...
        spSerSanbaoBaseInfoHead();
        
        //DCS-DMS EAI InterFace Header Info
        Map<String, Object> message = new HashMap<String, Object>();
        serviceCommonService.executeEaiCall("ALL","SER043",message,"Y");
    ...
    public void insertSabaoBaseItemsGrps(SanbaoBaseSaveVO saveVO)throws Exception{
        ...
        //I/F 
        spSerSanbaoBaseInfoPart();
        
        //DCS-DMS EAI InterFace Header Info
        Map<String, Object> message = new HashMap<String, Object>();
        serviceCommonService.executeEaiCall("ALL","SER044",message,"Y");
    ...
    public void spSerSanbaoBaseInfoHead()throws Exception{
        sanbaoBaseDAO.spSerSanbaoBaseInfoHead();
    }
    ...
    public void spSerSanbaoBaseInfoPart()throws Exception{
        sanbaoBaseDAO.spSerSanbaoBaseInfoPart();
    }
