...
public class FreeServicePartVO extends BaseVO {
     ...
     * 딜러고품반납송장번호
     **/
    private String dlrOldItemRtnInvcNo;

    /**
     * 공금상면비부품송장번호
     **/
    private String spyrFreeItemRtnInvcNo;
    ...
    /**
     * @return the dlrOldItemRtnInvcNo
     */
    public String getDlrOldItemRtnInvcNo() {
        return dlrOldItemRtnInvcNo;
    }

    /**
     * @param dlrOldItemRtnInvcNo the dlrOldItemRtnInvcNo to set
     */
    public void setDlrOldItemRtnInvcNo(String dlrOldItemRtnInvcNo) {
        this.dlrOldItemRtnInvcNo = dlrOldItemRtnInvcNo;
    }

    /**
     * @return the spyrFreeItemRtnInvcNo
     */
    public String getSpyrFreeItemRtnInvcNo() {
        return spyrFreeItemRtnInvcNo;
    }

    /**
     * @param spyrFreeItemRtnInvcNo the spyrFreeItemRtnInvcNo to set
     */
    public void setSpyrFreeItemRtnInvcNo(String spyrFreeItemRtnInvcNo) {
        this.spyrFreeItemRtnInvcNo = spyrFreeItemRtnInvcNo;
    }
	...
	public String getFreeItemStatNm() {
		return freeItemStatNm;
	}
	public void setFreeItemStatNm(String freeItemStatNm) {
		this.freeItemStatNm = freeItemStatNm;
	}
}
