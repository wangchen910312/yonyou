...
public class WorkGroupManageController extends HController {
    ...
    public @ResponseBody boolean multiWorkGroupManages(@Validated @RequestBody BaseSaveVO<WorkGroupMasterVO> saveVO, BindingResult bindingResult) throws Exception {
    ...
    public @ResponseBody boolean multiWorkGroupDetails(@Validated @RequestBody BaseSaveVO<WorkGroupDetailVO> saveVO) throws Exception {
