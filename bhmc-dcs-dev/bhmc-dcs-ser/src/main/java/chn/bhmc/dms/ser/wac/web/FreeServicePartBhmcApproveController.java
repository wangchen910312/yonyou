 ...
 */
@Controller
public class FreeServicePartBhmcApproveController extends HController{
    ...
    * @throws Exception
    */
   @RequestMapping(value="/ser/wac/freeServicePart/selectFreeServicePartBhmcApproveMain.do", method = RequestMethod.GET)
   public String selectFreeServicePartReqeustMain(Model model)throws Exception{
       ...
       model.addAttribute("preFixId", "BHMC");

       return "/ser/wac/freeServicePart/selectFreeServicePartBhmcApproveMain";
   ...
   * @throws Exception
   */
  @RequestMapping(value="/ser/wac/freeServicePart/selectFreeServicePartsBhmc.do", method = RequestMethod.POST)
  @ResponseBody
   ...
   * @throws Exception
   */
  @RequestMapping(value="/ser/wac/freeServicePart/selectFreeServicePartBhmcByKey.do", method = RequestMethod.POST)
  @ResponseBody
   ...
   * @throws Exception
   */
  @RequestMapping(value="/ser/wac/freeServicePart/multiFreeServicePartBhmc.do", method = RequestMethod.POST)
  @ResponseBody
  public String multiFreeServicePart(@RequestBody @Validated FreeServicePartVO freeServicePartVO)throws Exception{

      String docNo =  freeServicePartService.multiFreeServicePart(freeServicePartVO);
