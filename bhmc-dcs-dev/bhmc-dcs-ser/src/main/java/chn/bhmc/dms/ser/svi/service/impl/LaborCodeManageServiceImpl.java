...
public class LaborCodeManageServiceImpl extends HService implements LaborCodeManageService, JxlsSupport{
    ...
    */
    ...
    public void insertCheckLaborMaster(LaborCodeMasterVO laborVO) throws Exception {
        ...
        laborVO.setDlrCd(LoginUtil.getDlrCd());
        laborVO.setRegUsrId(LoginUtil.getUserId());


        int resultCnt = selectLaborMasterByConditionCnt(laborVO);

      //TODO [권기현] processException 메세지 적용 필요
        if(resultCnt > 0){
    ...
    public void insertLaborMaster(LaborCodeMasterVO laborVO) throws Exception {
        ...
        laborCodeManageDAO.insertLaborMaster(laborVO);
    ...
    public void updateLaborMaster(LaborCodeMasterVO laborVO) throws Exception {
        ...
        laborCodeManageDAO.updateLaborMaster(laborVO);
