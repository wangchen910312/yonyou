...
public interface DcMasterDAO {
     ...
     * @return 등록된 목록수
     */
    public int insertDcMaster (DcMasterVO dcMasterVO);
     ...
     * @return 수정된 목록수
     */
    public int updateDcMaster(DcMasterVO dcMasterVO);
     ...
     * @return 삭제된 목록수
     */
    public int deleteDcMaster(DcMasterVO dcMasterVO);
     ...
     * @return 조회 목록
     */
    public List<DcMasterVO> selectDcMasterByCondition(DcMasterSearchVO searchVO);
     ...
     * @return
     */
    public int selectDcMasterByConditionCnt(DcMasterSearchVO searchVO);
