 ...
 * </pre>
 *
 * @ClassName   : SanbaoTechApproveDAO.java
 ...
 * </pre>
 */
@Mapper("sanbaoTechApproveDAO")
public interface SanbaoTechApproveDAO {
    ...
    * @throws Exception
    */
    public int updateSanbaoTechApprove(SanbaoTechVO sanbaoTechVO)throws Exception;
