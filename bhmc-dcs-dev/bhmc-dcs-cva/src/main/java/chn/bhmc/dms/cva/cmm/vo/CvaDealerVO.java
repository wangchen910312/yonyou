...
//    @ValidField(field = "leadTimeCd", mesgKey = "global.lbl.leadTimeCd")
    ...
    @ValidField(field = "onDutyYn", mesgKey = "global.lbl.onDutyYn"),
    ...
    @ValidField(field = "scAssignAutoYn", mesgKey = "global.lbl.scAssignAutoYn"),
    @ValidField(field = "autoTrsfConf", mesgKey = "global.lbl.autoTrsfConf")
})
public class CvaDealerVO extends BaseVO {
    ...
    /**
     * @return the scAssignAutoYn
     */
    public String getScAssignAutoYn() {
        return scAssignAutoYn;
    }

    /**
     * @param scAssignAutoYn the scAssignAutoYn to set
     */
    public void setScAssignAutoYn(String scAssignAutoYn) {
        this.scAssignAutoYn = scAssignAutoYn;
    }
