 ...
 * </pre>
 *
 * @ClassName   : CommonCodeTextIfBatchJobBean.java
 * @Description : 공통코드 텍스트 전송 배치
...
public class CommonCodeTextIfBatchJobBean extends BaseJobBean{
	@Autowired
	EaiClient eaiClient;
    ...
    protected void executeJob(JobExecutionContext context) throws JobExecutionException {
        ...
        try{
            ...
            commonCodeIfBatchService.insertCommonCodeTextIf();
