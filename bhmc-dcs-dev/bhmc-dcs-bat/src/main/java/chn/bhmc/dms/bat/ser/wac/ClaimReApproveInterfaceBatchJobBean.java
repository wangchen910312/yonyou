...
public class ClaimReApproveInterfaceBatchJobBean extends BaseJobBean{
    ...
    protected void executeJob(JobExecutionContext context) throws JobExecutionException {
        ...
        String dlrCd = context.getJobDetail().getJobDataMap().getString("dlrCd");

        try{
            //ClaimApproveService claimApproveService = getBean(ClaimApproveService.class);
            claimApproveService.insertReClaimApprove(day, dlrCd);
        }catch(Exception e){
