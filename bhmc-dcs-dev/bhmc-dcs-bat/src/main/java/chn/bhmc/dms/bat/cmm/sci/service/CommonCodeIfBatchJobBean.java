 ...
 * </pre>
 *
 * @ClassName   : CommonCodeIfBatchJobBean.java
 * @Description : 공통코드 전송 배치
...
public class CommonCodeIfBatchJobBean extends BaseJobBean{
    ...
    protected void executeJob(JobExecutionContext context) throws JobExecutionException {
        ...
        try{
            ...
            commonCodeIfBatchService.insertCommonCodeIf(day);
