...
public class PurcOrdSearchVO extends SearchVO {
     ...
     * 1职员 2科长 3其他
     */
    private String sUsrTp;
    
    /**
     * 登录人id
     */
    private String sCurrentUsrId;
    
    private String sReplyStatus;//订单申诉回复进度状态( 0一级处理中 1二级处理中2三级处理中 3已处理)
    private String sBmpAccount;//通过bmp账号限制查询到的店代码
    ...
    private String sPage;//页面标识
    private String sQuestionNo;//申诉编号
    
    private String sBmpCd;
    private String sHistoryFlg;
    /**
     * @return the sDlrCd
     */
	...
	public String getsUsrTp() {
		return sUsrTp;
	}

	public void setsUsrTp(String sUsrTp) {
		this.sUsrTp = sUsrTp;
	}

	public String getsCurrentUsrId() {
		return sCurrentUsrId;
	}

	public void setsCurrentUsrId(String sCurrentUsrId) {
		this.sCurrentUsrId = sCurrentUsrId;
	}

	public String getsReplyStatus() {
		return sReplyStatus;
	}

	public void setsReplyStatus(String sReplyStatus) {
		this.sReplyStatus = sReplyStatus;
	}
	...
	public String getsQuestionNo() {
		return sQuestionNo;
	}
	

	public String getsBmpAccount() {
		return sBmpAccount;
	}

	public void setsBmpAccount(String sBmpAccount) {
		this.sBmpAccount = sBmpAccount;
	}

	public void setsQuestionNo(String sQuestionNo) {
		this.sQuestionNo = sQuestionNo;
	}

	public String getsBmpCd() {
		return sBmpCd;
	}

	public void setsBmpCd(String sBmpCd) {
		this.sBmpCd = sBmpCd;
	}

	public String getsHistoryFlg() {
		return sHistoryFlg;
	}

	public void setsHistoryFlg(String sHistoryFlg) {
		this.sHistoryFlg = sHistoryFlg;
	}
