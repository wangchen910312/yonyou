...
public class PurcOrdVO extends BaseVO{
    ...
    private static final long serialVersionUID = -6071720494896446459L;
        ...
        /**
         * @param purcOrdStatNm the purcOrdStatNm to set
         */
        public void setPurcOrdStatNm(String purcOrdStatNm) {
            this.purcOrdStatNm = purcOrdStatNm;
        }

        /**
         * @return the purcOrdStatNm
         */
        public String getPurcOrdStatNm() {
            return purcOrdStatNm;
        }
