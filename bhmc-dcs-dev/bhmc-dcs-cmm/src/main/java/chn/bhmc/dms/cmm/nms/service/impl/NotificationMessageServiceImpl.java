...
public class NotificationMessageServiceImpl extends HService implements NotificationMessageService {
    ...
    public void sendNotificationMessage(String sysCd, String alrtPolicyGrpId, String dlrCd, NotificationMessageContext context) throws Exception {
        ...
        sendNotificationMessage(sysCd, alrtPolicyGrpId, dlrCd, context, null);
        /*
        ...
        //수신대상자 조회
        List<NotificationTargetUserVO> targetUsers = notificationTargetService.selectNotificationTargetAllUsers(sysCd, notificationPolicyVO.getAlrtPolicyGrpId(), notificationPolicyVO.getAlrtPolicyId());
    ...
    public void sendNotificationMessage(String sysCd, String alrtPolicyGrpId, String dlrCd, NotificationMessageContext context, List<NotificationTargetUserVO> targetUsers) throws Exception {
        ...
        if(targetUsers == null){
            targetUsers = notificationTargetService.selectNotificationTargetAllUsers(sysCd, notificationPolicyVO.getAlrtPolicyGrpId(), notificationPolicyVO.getAlrtPolicyId());
        }
