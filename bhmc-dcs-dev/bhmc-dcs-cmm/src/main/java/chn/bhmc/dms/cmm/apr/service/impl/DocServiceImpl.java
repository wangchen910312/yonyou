...
public class DocServiceImpl extends HService implements DocService {
    ...
    public int deleteDoc(DocVO docVO) throws Exception {
        docDAO.deleteDocLinesBySignDocId(docVO.getSignDocId());
    ...
    public int insertDocLine(DocLineVO docLineVO) throws Exception {
        DocLineVO obj = selectDocLineByKey(docLineVO.getSignDocId(), docLineVO.getSignDocLineNo());
     ...
     */
    @Override
    public int updateDocLine(DocLineVO docLineVO) throws Exception {
        return docDAO.updateDocLine(docLineVO);
    }
     ...
     */
    @Override
    public int deleteDocLine(DocLineVO docLineVO) throws Exception {
        return docDAO.deleteDocLine(docLineVO);
    }
     ...
     */
    @Override
    public void deleteAndInsertDocLines(String signDocId, List<DocLineVO> signLines) throws Exception {
        String userId = LoginUtil.getUserId();

        docDAO.deleteDocLinesBySignDocId(signDocId);
     ...
     */
    @Override
    public DocLineVO selectDocLineByKey(String signDocId, int signDocLineNo) throws Exception {
        return docDAO.selectDocLineByKey(signDocId, signDocLineNo);
    }
