...
public class IssueBoardController extends HController {
    ...
    public boolean updateIssueBoard(@Validated @RequestBody IssueBoardVO issueBoardVO, BindingResult bindingResult) throws Exception {
        ...
        //완료[03], BHIT확인[05], BHMC확인[09], 추후추진[06]
        //처리상태가 완료 상태 인 경우는 BHIT확인/BHMC확인/추후추진 상태로만 변경 가능하다.
        ...
        //BHIT확인[05], BHMC확인[09], 추후추진[06]
        //처리상태가 BHIT확인 상태 인 경우는 처리상태를 BHMC확인/추후추진  상태로 만 변경 할 수 있다.
        if((
        ...
        //BHMC확인[09]
        //처리상태가 BHMC확인 상태 인 경우는 처리상태를 변경 할 수 없다.
