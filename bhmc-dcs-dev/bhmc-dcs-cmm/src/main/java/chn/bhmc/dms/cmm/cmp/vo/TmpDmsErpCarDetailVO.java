...
public class TmpDmsErpCarDetailVO extends SearchVO implements Serializable{
	...
	public String getErpPltGiDt() {
		return erpPltGiDt;
	}
	public void setErpPltGiDt(String erpPltGiDt) {
