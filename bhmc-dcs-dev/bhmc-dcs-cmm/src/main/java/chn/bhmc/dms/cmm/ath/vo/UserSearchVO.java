...
public class UserSearchVO extends SearchVO {
    ...
    /**
     * @return the sDssUsrYn
     */
    public String getsDssUsrYn() {
        return sDssUsrYn;
    }

    /**
     * @param sDssUsrYn the sDssUsrYn to set
     */
    public void setsDssUsrYn(String sDssUsrYn) {
        this.sDssUsrYn = sDssUsrYn;
    }
