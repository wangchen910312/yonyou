...
public interface CommonCodeDAO {
     ...
     */
    public CommonCodeGroupTxtVO selectCommonCodeGroupTxtByKey(@Param("cmmGrpCd") String cmmGrpCd, @Param("langCd") String langCd);
     ...
     * @throws Exception
     */
    public CommonCodeGroupTxtVO selectCommonCodeTxtByKey(@Param("cmmGrpCd") String cmmGrpCd, @Param("cmmCd") String cmmCd, @Param("langCd") String langCd);
