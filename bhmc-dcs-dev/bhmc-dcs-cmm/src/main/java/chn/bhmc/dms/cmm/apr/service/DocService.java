...
public interface DocService {
	 ...
	 * @throws Exception
	 */
	int updateDocLine(DocLineVO docLineVO) throws Exception;
     ...
     * @throws Exception
     */
    int deleteDocLine(DocLineVO docLineVO) throws Exception;
     ...
     * @throws Exception
     */
    void deleteAndInsertDocLines(String signDocId, List<DocLineVO> signLines) throws Exception;
     ...
     * @throws Exception
     */
    DocLineVO selectDocLineByKey(String signDocId, int signDocLineNo) throws Exception;
