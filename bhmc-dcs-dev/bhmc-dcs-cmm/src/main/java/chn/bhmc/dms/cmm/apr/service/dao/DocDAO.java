...
public interface DocDAO {
     ...
     * @return
     */
    public int updateDocLine(DocLineVO docLineVO);
     ...
     * @return
     */
    public int deleteDocLine(DocLineVO docLineVO);
     ...
     * @return
     */
    public int deleteDocLinesBySignDocId(String signDocId);
     ...
     * @return
     */
    public DocLineVO selectDocLineByKey(@Param("signDocId") String signDocId, @Param("signDocLineNo") int signDocLineNo);

    /**
     * 조회 조건에 해당하는 결재라인 목록을 조회한다.
     * @param searchVO
     * @return
     */
