...
public class DealerSearchVO extends SearchVO {
    ...
    **/
	...
	/**
     * @return the sCsAreaCcbzId
     */
    public String getsCsAreaCcbzId() {
		return sCsAreaCcbzId;
	}
    /**
     * @param sCsAreaCcbzId the sCsAreaCcbzId to set
     */
	public void setsCsAreaCcbzId(String sCsAreaCcbzId) {
		this.sCsAreaCcbzId = sCsAreaCcbzId;
	}
     ...
     * @return the sOpenDt
     */
    public String getsOpenDt() {
        return sOpenDt;
    }

    /**
     * @param sOpenDt the sOpenDt to set
     */
    public void setsOpenDt(String sOpenDt) {
        this.sOpenDt = sOpenDt;
    }
}