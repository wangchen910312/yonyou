                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" id="targpath" name="targpath"/>
                            </td>
                        </tr>
                        <tr>
...
$(document).ready(function() {
    ...
    *************************************************************/
     ...
     * 팝업 옵션
     */
     var parentOptions = parent.searchSrcFilePopupWin.options.content.data;
...
//         $("#grid").data("kendoExtGrid").dataSource.read();
    ...
    function initTree() {
        ...
        var rootNode = viewHierarchyTree.findByText("file_deploy");
...
//                     params["sPrtyNm"] = 'DCS_FILE_DEPLOY_HOME_DIR';
    ...
    cmmPrtyDataSource.read().then(function() {
        ...
        var filtered = $.grep(view, function(v) {
           if(v.prtyNm == 'DCS_FILE_DEPLOY_HOME_DIR') {
               return v;
           }
        });
...
//             rootFilepath = "C:\\Servers\\nexus\\sonatype-work\\nexus\\storage\\bhmc-dcs-dplysvr-releases\\file_deploy";
            ...
            var rootNode = { filename:"DCS_FILE_DEPLOY_HOME_DIR", filetype:"D", filepath:rootFilepath, spriteCssClass:"folder" };
    ...
    function addFileUrl() {
        ...
        if(dms.string.isEmpty($("#targpath").val())) {
            return;
        }

        var param = {
            "fileurl":$("#fileurl").val(),
            "targpath":$("#targpath").val()
        }

        parentOptions.callbackFunc(param);
        parent.searchSrcFilePopupWin.close();
    }
