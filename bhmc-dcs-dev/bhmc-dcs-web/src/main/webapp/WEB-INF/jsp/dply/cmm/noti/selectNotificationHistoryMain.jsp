...
<section class="group">
    ...
    <div class="header_area">
        ...
        <h1 class="title_basic">통보이력조회</h1>
        <div class="btn_right">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input id="sEventDt" class="form_datepicker">
                    </td>
                    <th scope="row">Notification Type</th>
                    <td>
                        <input id="sNotiTp" type="text" class="form_comboBox">
                    </td>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <th scope="row">Event Date</th>
                    <td>
                        <input id="eventDt" data-json-obj="true" class="form_input">
                    </td>
                    <th scope="row">Notification Type</th>
                    <td>
                        <input id="notiTp" name="notiTp" data-json-obj="true" class="form_comboBox">
                    </td>
                    <th scope="row">Email Addr</th>
                    <td>
                ...
                <tr>
                    <th scope="row">Bundle Name</th>
                    <td colspan="3">
                        <input id="bundleNm" name="bundleNm" class="form_input" data-json-obj="true" >
                    </td>
                    <td colspan="4"></td>
                </tr>
                <tr>
                    ...
                    <td colspan="7">
                        <textarea id="notiMesgBodyCont" name="notiMesgBodyCont" rows="4" placeholder="" class="form_textarea" data-json-obj="true" ></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
...
//         ,multiSelectWithCheckbox:true
        ...
        ,editable:false
        ,columns:[
            {field:"eventDt", title:"Event Date", width:80, sortable:false
                ,attributes:{"class":"ac"}
