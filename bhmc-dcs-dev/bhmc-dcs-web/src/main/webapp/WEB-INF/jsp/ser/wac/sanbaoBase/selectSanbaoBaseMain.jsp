        ...
        <div id="kendoSanbaoBaseForm">
             <section class="group">
                <div class="header_area">
                    ...
                    <div class="btn_right">
					<dms:access viewId="VIEW-I-12464" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" id="btnSearch" class="btn_m btn_search"><spring:message code="global.btn.search" /></button>
					</dms:access>
					<dms:access viewId="VIEW-I-12463" hasPermission="${dms:getPermissionMask('READ')}">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
									...
									<dms:access viewId="VIEW-I-12453" hasPermission="${dms:getPermissionMask('READ')}">
                                ...
                                <td>
									...
									<dms:access viewId="VIEW-I-12452" hasPermission="${dms:getPermissionMask('READ')}">
									...
									<dms:access viewId="VIEW-I-12451" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    $("#gridPart").kendoExtGrid({
        ...
        ,columns:[
                   ...
                   ,{field:"tcavTermVal", title:"<spring:message code='ser.lbl.tcavTerm' />", width:50
                       ,attributes :{"class":"ar"}
                       ,editor:function(container, options){
                           $('<input name="tcavTerm" id="tcavTerm" maxLength=3 data-name="<spring:message code="ser.lbl.tcavTerm" />" data-bind="value:' + options.field + '"/>')
                           .appendTo(container)
                           .kendoExtNumericTextBox({
                               format:"n0"                // n0:###,###, n2:###,###.##
                              ,decimals:0               // 소숫점
