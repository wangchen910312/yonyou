    ...
    <div class="content">
        <section class="group">
            <div class="header_area">
                <h1 class="title_basic"><spring:message code="ser.title.freeItemApprove" /></h1><!-- 면비부품신청 -->
                <div class="btn_right">
				...
				<dms:access viewId="VIEW-I-12440" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    $(document).ready(function() {
        ...
        setKendoDate = function( dtValue){
       	...
       	$("#btnExcel").kendoButton({
	        click:function(e){
	            var templateFile = "FreeServicePartBhmc_Tpl.xlsx";
	            var fileName = "<spring:message code='ser.title.freeItemApprove' />.xlsx";
      ...
      //버튼설정
        ...
        $("#grid").kendoExtGrid({
            ...
            ,columns:[
                ...
                ,{field:"bhmcConfirmDt", title:"<spring:message code='ser.lbl.bhmcConfirmDt'/>", width:150
                    ,attributes :{"class":"ac"}
                    ,format:"{0:<dms:configValue code='dateFormat' />}"
                }
