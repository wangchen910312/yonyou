...
function subTotalStatusCall(){
    ...
    //var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerFixTimeReport.cpt' />"
    ...
    if("Y"===regManJud){
       ...
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerFixTimeRegManReport.cpt' />";
    }else{
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerFixTimeReport.cpt' />";
    }
