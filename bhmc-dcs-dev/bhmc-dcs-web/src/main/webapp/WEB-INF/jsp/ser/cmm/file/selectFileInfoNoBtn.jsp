...
$(document).ready(function(){
        ...
        ,columns:[
                   {field:"fileNm", title:"<spring:message code='global.lbl.fileNm' />"
                       ...
                       if(dms.string.isNotEmpty(dataItem.fileDocNo)){
                           objResult = "<span style='text-decoration:underline;cursor:pointer;' onClick='dms.fileManager.download(\""+dataItem.fileDocNo+"\",\""+dataItem.fileNo+"\")'>"+dataItem.fileNm+"</span>";
                       }
                       return objResult;
                    }
                   }
    ...
    $("#btnFileAdd").click(function(e){
        ...
        r.opt.maxFiles = 3 - $("#fileGrid").data("kendoExtGrid").dataSource._total;
    });
    ...
    r.on('fileAdded', function(file) {
        ...
        if( $("#fileGrid").data("kendoExtGrid").dataSource._total > 2 ){
            dms.notification.warning("<spring:message code='ser.info.fileUploadCntChk' arguments='3' />");
            return;
        }
