...
function subTotalStatusCall(){
    ...
    var sStartYyMmDd = $("#sStartYyMmDd").val();
    var sEndYyMmDd = $("#sEndYyMmDd").val();
    //var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerPreCheckReport.cpt' />";
   ...
   var param = "";
    if("Y"===regManJud){
       ...
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerPreCheckRegManReport.cpt' />";
    }else{
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerPreCheckReport.cpt' />";
    }
