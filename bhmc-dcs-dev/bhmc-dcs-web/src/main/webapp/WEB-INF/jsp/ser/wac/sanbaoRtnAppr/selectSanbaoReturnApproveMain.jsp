...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
		<dms:access viewId="VIEW-I-12481" hasPermission="${dms:getPermissionMask('READ')}">
...
<div class="clfix">
    <section class="left_areaStyle">
       ...
       <div>
        ...
        <div class="header_area">
            <div class="btn_left">
			<dms:access viewId="VIEW-I-12480" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <section class="right_areaStyle">
        <div class="table_form mt10">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><spring:message code='ser.lbl.acceptPlm' /></span></th><!-- 접수차량문제 -->
        ...
        <div class="table_form mt5">
            <table>
                ...
                <tbody>
                    <tr>
                        <th scope="row"><spring:message code='ser.lbl.dlrRespCont' /></span></th><!-- 딜러담당의견 -->
                        <td colspan="3" class="readonly_area">
        ...
        <div class="table_form mt5">
            <table>
                ...
                <tbody>
                    <tr>
                        <th scope="row"><spring:message code='ser.lbl.reqTp' /></span></th><!-- 요청구분유형 -->
                        <td class="readonly_area">
                            <input type="text" id="reqDstinTp" name="reqDstinTp" value="" readonly class="form_comboBox" />
                        </td>
                        <th scope="row"><spring:message code='ser.lbl.returnDstin' /></span></th><!-- 반품구분 -->
                        <td class="readonly_area">
        ...
        <div class="header_area">
            <div class="btn_left">
			<dms:access viewId="VIEW-I-12476" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnAppFormPrint" class="btn_s btn_s_min5"><spring:message code='ser.btn.appFormPrint'/></button><!-- 신청서 -->
			</dms:access>
			<dms:access viewId="VIEW-I-12475" hasPermission="${dms:getPermissionMask('READ')}">
...
returnTpList.push({cmmCdNm:"${obj.cmmCdNm}", cmmCd:"${obj.cmmCd}"});
</c:forEach>
 ...
 // 차량정보, 고객정보 셋팅
    ...
    $("#gridClaimInfo").kendoExtGrid({
        ...
        ,columns:[
                   ...
                   ,{field:"cauItemCd", title:"<spring:message code='ser.lbl.cauItemCd' />", width:80, sortable:false, attributes :{"class":"al"}}
                 ]
