...
function subTotalStatusCall(){
    ...
    //var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerFixReport.cpt' />"
    ...
    if("Y"===regManJud){
       ...
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerFixRegManReport.cpt' />";
    }else{
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerFixReport.cpt' />";
    }
