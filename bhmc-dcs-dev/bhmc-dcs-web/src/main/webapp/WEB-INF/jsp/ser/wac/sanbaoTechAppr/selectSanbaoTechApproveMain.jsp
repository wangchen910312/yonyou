    ...
    <div class="content">
        <section class="group">
            <div class="header_area">
                <div class="btn_right">
				<dms:access viewId="VIEW-I-12473" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <div class="header_area">
            <div class="btn_right">
			<dms:access viewId="VIEW-I-12472" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" class="btn_s btn_approve btn_s_min5" id="btnAccept" disabled><spring:message code="ser.btn.btnAccept" /></button>
			</dms:access>
			<dms:access viewId="VIEW-I-12471" hasPermission="${dms:getPermissionMask('READ')}">
			...
			<dms:access viewId="VIEW-I-12470" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" class="btn_s btn_return btn_s_min5" id="btnReturn" disabled><spring:message code="ser.btn.return" /></button> <!-- 반송 -->
			</dms:access>
			<dms:access viewId="VIEW-I-12469" hasPermission="${dms:getPermissionMask('READ')}">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <textarea rows="4" id="emgcReasonCont" name="emgcReasonCont" cols="" readonly class="form_textarea form_readonly"  style="height:78px"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><spring:message code="ser.lbl.dlrProcOpnCnt" /></th> <!-- 딜러처리 의견 및 방안 -->
                                <td>
                                    <textarea rows="4" cols="" id="dlrProcOpnCont" name="dlrProcOpnCont" readonly class="form_textarea form_readonly" style="height:78px"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><span class="bu_required"><spring:message code="ser.lbl.bhmcProcCont" /></span></th> <!-- BMP 처리의견 -->
                                <td>
                                    <textarea rows="4" cols="" id="bmpProcCont" name="bmpProcCont" maxLength="600" class="form_textarea" style="height:72px" data-json-obj="true"></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
/********************** 초기 데이터  설정 ***************************/
   ...
   function saveDataValidation(statCd){
       ...
       if( dms.string.isEmpty(  $("#vinNo").val() ) ) {
           ...
           msgText = "<spring:message code='ser.lbl.bhmcProcCont' var='bmpProcCont' />"+
