    ...
    <div class="content">
        <section class="group">
            <div class="header_area">
                <h1 class="title_basic"><spring:message code="ser.title.freeItemCmpnApprove" /></h1><!-- 면비부품신청 -->
                <div class="btn_right">
                <!-- 20200804 tjx 添加免费法人判定下载功能 -->
				...
				<dms:access viewId="VIEW-I-12445" hasPermission="${dms:getPermissionMask('READ')}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="readonly_area">
                                    <input type="text" required id="bhmcJudgProcCont" name="bhmcJudgProcCont" value="" readonly class="form_input"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <th scope="row"><span class="bu_required"><spring:message code='ser.lbl.supplyCd'/></span></th><!-- 공급상 -->
                                <td>
                                    <input required type="text" id="spyrNm" name="spyrNm" value="" class="form_input" data-name="<spring:message code="ser.lbl.supplyCd" />" data-json-obj="true"/>
                                </td>
                                <th scope="row"><spring:message code='ser.lbl.supplyProcCont' /></th><!-- 공급상처리의견 -->
                                <td colspan="3">
                                    <input type="text" id="spyrProcCont" name="spyrProcCont" value="" data-name="<spring:message code="ser.lbl.supplyProcCont" />" class="form_input" data-json-obj="true"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div>
                        <div class="table_form mt0">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><span class="bu_required"><spring:message code='ser.lbl.supplyItemSendDt' /></span></th><!-- 공급상면비부품발송일  -->
                                        <td>
                                            <input required type="text" id="spyrFreeItemSendDt" name="spyrFreeItemSendDt" value="" data-name="<spring:message code="ser.lbl.supplyItemSendDt" />" class="form_datepicker" data-json-obj="true"/>
                                        </td>
                                        <th scope="row"><span class="bu_required"><spring:message code='ser.lbl.supplyItemInvoiceNo' /></span></th><!-- 공급상면비부품송장번호 -->
                                        <td>
                                            <input required type="text" required id="spyrFreeItemRtnInvcNo" name="spyrFreeItemRtnInvcNo" value="" data-name="<spring:message code="ser.lbl.supplyItemInvoiceNo" />" class="form_input" data-json-obj="true"/>
                                        </td>
                                        <th scope="row"><span class="bu_required"><spring:message code='ser.lbl.freeItemExpNm' /></span></th><!-- 면비부품발송택배회사명 -->
                                        <td>
                                            <input required type="text" id="freeItemExpsCmpNm" name="freeItemExpsCmpNm" value="" class="form_input" data-name="<spring:message code="ser.lbl.freeItemExpNm" />"  data-json-obj="true"/>
                                        </td>
                                    </tr>
                                    <tr>
...
var selectedYn = false;
    ...
    $(document).ready(function() {
        ...
        //20200804 update by tjx excel下载
        setKendoDate = function( dtValue){
            return kendo.toString(kendo.parseDate(dtValue),"<dms:configValue code='dateFormat' />");
        };
       	$("#btnExcel").kendoButton({
	        click:function(e){
	            var templateFile = "FreeServicePartSpy_Tpl.xlsx";
	            var fileName = "<spring:message code='ser.title.freeItemCmpnApprove' />.xlsx";
	            dms.ajax.excelExport({        
	                "beanName"         		:"freeServicePartService"
	                ...
	                ,"sItemCd"         		:$("#sItemCd").val()
	                ,"sItemTp"         		:$("#sItemTp").val()
	                ,"sFreeItemStatCd"    	:$("#sFreeItemStatCd").val()
	                ,"sPreFixId"          	:$("#preFixId").val()                          
	            });
	        }
    	});
        ...
        sendRequestData = function(statCd){
            ...
            if(statCd == "ZA"){
                $("#spyrNm").attr("required","");
                $("#spyrFreeItemSendDt").attr("required","");
                $("#spyrFreeItemRtnInvcNo").attr("required","");
                $("#freeItemExpsCmpNm").attr("required","");
            }else{

                $("#spyrNm").removeAttr("required");
                $("#spyrFreeItemSendDt").removeAttr("required");
                $("#spyrFreeItemRtnInvcNo").removeAttr("required");
                $("#freeItemExpsCmpNm").removeAttr("required");
            ...
            if(validator.validate()){
                ...
                formSaveData.spyrFreeItemSendDt = $("#spyrFreeItemSendDt").data("kendoExtMaskedDatePicker").value();

                $.ajax({
                    url:"<c:url value='/ser/wac/freeServicePart/multiFreeServicePartSpy.do' />"
      ...
      //버튼설정
        ...
        searchFreeItemmData = function(params){
            ...
            $.ajax({
                url:"<c:url value='/ser/wac/freeServicePart/selectFreeServicePartSpyByKey.do' />"
        ...
        $("#grid").kendoExtGrid({
            gridId:"G-SER-0925-100501"
            ,dataSource:{
                transport:{
                       read :{
                           url:"<c:url value='/ser/wac/freeServicePart/selectFreeServicePartsSpy.do'/>"
                       }
            ...
            ,columns:[
                ...
                ,{field:"spyrJudgDt", title:"<spring:message code='ser.lbl.supplyConfirmDt'/>", width:150
                    ,attributes :{"class":"ac"}
                    ,format:"{0:<dms:configValue code='dateFormat' />}"
                }
