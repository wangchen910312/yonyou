...
function subTotalStatusCall(){
    ...
    //var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerRoReport.cpt' />"
    ...
    if("Y"===regManJud){
       ...
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerRoRegManReport.cpt' />";
    }else{
       subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerRoReport.cpt' />";
    }
