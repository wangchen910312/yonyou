        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" id="phenCd" name="phenCd" class="form_input" style="width:80px" />
                        <input type="text" id="phenNm" name="phenNm" class="form_input" style="width:50%;" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="ser.lbl.cause" /></th><!-- 현상 -->
                    <td>
                        <input type="text" id="cauCd" name="cauCd" class="form_input" style="width:80px" />
                        <input type="text" id="cauNm" name="cauNm" class="form_input" style="width:50%;" />
                    </td>
                </tr>
