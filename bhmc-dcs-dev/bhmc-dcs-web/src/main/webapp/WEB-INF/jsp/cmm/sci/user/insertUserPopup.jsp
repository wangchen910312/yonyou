        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input id="dlrCd" name="dlrCd" type="text" value="${dlrCd}" class="form_input form_disabled" readonly data-name="<spring:message code="global.lbl.dlrCd" />" />
                    </td>
                    <th scope="row"><span class="bu_required"><spring:message code="global.lbl.usrId" /></span></th>
                    <td>
                        <input id="usrId" name="usrId" type="text" class="form_input" required data-name="<spring:message code="global.lbl.usrId" />" />
                    </td>
                    <th scope="row"><span class="bu_required"><spring:message code="global.lbl.usrPw" /></span></th>
                    <td>
                        <input id="usrPw" name="usrPw" type="password" class="form_input" required data-name="<spring:message code="global.lbl.usrPw" />"  />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="global.lbl.dept" /></th>
                    <td>
                        <input id="deptCd" name="deptCd" type="text" class="form_comboBox" />
                    </td>
                    <th scope="row"><span class="bu_required"><spring:message code="global.lbl.usrNm" /></span></th>
                    <td>
                        <input id="usrNm" name="usrNm" type="text" class="form_input" required data-name="<spring:message code="global.lbl.usrNm" />"  />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.empNo" /></th>
                    <td>
                        <input id="empNo" name="empNo" type="text" class="form_input" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="global.lbl.pstn" /></th>
                    <td>
                        <input id="pstnCd" name="pstnCd" type="text" class="form_comboBox" />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.telNo" /></th>
                    <td>
                        <input id="telNo1" name="telNo1" type="tel" class="form_input" />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.cellphone" /></th>
                    <td>
                        <input id="hpNo" name="hpNo" type="tel" class="form_input" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="global.lbl.claimReqPermYn" /></th>
                    <td>
                        <input id="claimReqPermYn" name="claimReqPermYn" type="text" class="form_comboBox" />
                    </td>
                    ...
                    <td>
                        <input id="email" name="email" type="email" class="form_input" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="global.lbl.bizCd" /></th>
                    <td>
                        <input id="bizCd" name="bizCd" type="text" class="form_input" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input id="servYn" name="servYn" type="text" class="form_comboBox" />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.zipCd" /></th>
                    <td>
                        <input id="zipNo" name="zipNo" type="text" class="form_input" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input id="saleYn" name="saleYn" type="text" class="form_comboBox" />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.addr" />1</th>
                    <td colspan="3">
                        <input id="addr1" name="addr1" type="text" class="form_input" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="global.lbl.task" /></th>
                    <td>
                        <input id="tskCd" name="tskCd" type="text" class="form_comboBox" />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.addr" />2</th>
                    <td colspan="3">
                        <input id="addr2" name="addr2" type="text" class="form_input" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><spring:message code="global.lbl.tskDetl" /></th>
                    <td>
                        <input id="tskDetl" name="tskDetl" type="text" class="form_comboBox" />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.addr" />3</th>
                    <td colspan="3">
                        <input id="addr3" name="addr3" type="text" class="form_input" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><span class="bu_required"><spring:message code="global.lbl.langCd" /></span></th>
                    <td>
                        <input id="langCd" name="langCd" type="text" class="form_comboBox" required data-name="<spring:message code="global.lbl.langCd" />"  />
                    </td>
                    <th scope="row"><span class="bu_required"><spring:message code="global.lbl.enabledYn" /></span></th>
                    <td>
                        <input id="enabledYn" name="enabledYn" type="text" class="form_comboBox" required data-name="<spring:message code="global.lbl.enabledYn" />"  />
                    </td>
                    <td></td>
                    <td></td>
                </tr>
...
$(document).ready(function() {
     ...
     * 팝업 옵션
     */
     var popupWindow = parent.$("#insertUserPopupWin").data("kendoWindow");
     ...
     $("#btnSave").kendoButton({
         click:function(e){
             if (validator.validate()) {
                 ...
                 $.ajax({
                     url:"<c:url value='/cmm/sci/user/insertUser.do' />"
