...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        *************************************************************/
         ...
         * 팝업 옵션
         */
         var options = parent.securedResourcePopupWin.options.content.data;
            ...
            click:function(e){
                ...
                if(rows !== null)
                {
                    ...
                    if(options["closeAfterSelect"]!=false) {
                        parent.securedResourcePopupWin.close();
                    }
                }
            }
        });
        ...
        *************************************************************/
        ...
        $("#grid").kendoExtGrid({
            ...
            ,columns:[
                ...
                ,{field:"resourceId", title:"<spring:message code='cmm.lbl.resourceId' />", width:60, attributes:{"class":"ac"} }
                ,{field:"resourceNm", title:"<spring:message code='cmm.lbl.resourceNm' />", width:150, attributes:{"class":"ac"}}
                ,{field:"resourcePattern", title:"<spring:message code='cmm.lbl.resourcePattern' />", width:80,  attributes:{"class":"ac"}}
                ,{field:"resourceDetlCont", title:"<spring:message code='cmm.lbl.resourceDetlCont' />", width:150}
                ,{field:"resourceTp", title:"<spring:message code='cmm.lbl.resourceTp' />", width:80
                ...
                ,{field:"sortOrder", title:"<spring:message code='global.lbl.sortOrder' />", width:150}
                ,{title:""}
            ]
