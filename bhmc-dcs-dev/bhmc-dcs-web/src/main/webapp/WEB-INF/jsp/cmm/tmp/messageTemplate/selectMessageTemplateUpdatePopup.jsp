...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#mesgTmplTp").data("kendoExtDropDownList").enable(false);
        ...
        *************************************************************/
         ...
         */
         ...
         $("#mesgTmplTp").data("kendoExtDropDownList").value(options.mesgTmplTp);
         $("#mesgTmplNm").val(options.mesgTmplNm);
         $("#mesgTmplCont").val(options.mesgTmplCont);
         $("#defaultYn").prop("checked", options.defaultYn == "Y"? true:false);
         $("#useYn").prop("checked", options.useYn == "Y"? true:false);

         if(options.defaultYn == "Y"){
             $("#defaultYn").attr("disabled", true);
        ...
        *************************************************************/
        ...
        $("#btnSave").click(function(){
            ...
            if (validator.validate()) {
                $.ajax({
                    url:"<c:url value='/cmm/tmp/messageTemplate/updateMessageTemplate.do' />"
                    ,data:JSON.stringify({
                        "mesgTmplNo":options.mesgTmplNo
