...
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="cmm.title.deptViewMapping" /></h1>
        <div class="btn_right">
        	<dms:access viewId="VIEW-I-12218" hasPermission="${dms:getPermissionMask('READ')}">
            	<button type="button" class="btn_m btn_search" id="btnSearch"><spring:message code="global.btn.search" /><!-- 조회 --></button>
            </dms:access>
            <dms:access viewId="VIEW-I-12217" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div style="position:relative;float:left;width:550px;">
        ...
        <div class="table_grid mt10">
            <div id="deptGrid" class="resizable-container-custom"></div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $("#deptGrid").kendoExtGrid({
        ...
        ,change:function(e){
            ...
            //참조ID-부서코드
            refId = this.dataItem(this.select()).deptCd;
