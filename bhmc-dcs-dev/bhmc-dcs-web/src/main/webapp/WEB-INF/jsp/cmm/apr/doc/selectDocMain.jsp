...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-I-12246" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="header_area">
        <div class="btn_right">
        	<dms:access viewId="VIEW-I-12245" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_s" id="btnSave"><spring:message code='global.btn.save' /><!-- 저장 --></button>
            </dms:access>
            <dms:access viewId="VIEW-I-12243" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_s btn_add" id="btnAdd"><spring:message code='global.btn.rowAdd' /><!-- 행추가 --></button>
            </dms:access>
            <dms:access viewId="VIEW-I-12242" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_s btn_delete" id="btnDel"><spring:message code='global.btn.rowDel' /><!-- 행삭제 --></button>
            </dms:access>
            <dms:access viewId="VIEW-I-12244" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-I-12241" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_s btn_save" id="btnLineSave"><spring:message code='global.btn.save' /><!-- 저장 --></button>
            </dms:access>
            <dms:access viewId="VIEW-I-12240" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_s btn_add" id="btnLineAdd"><spring:message code='global.btn.rowAdd' /><!-- 행추가 --></button>
            </dms:access>
            <dms:access viewId="VIEW-I-12239" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_s btn_del" id="btnLineDel"><spring:message code='global.btn.rowDel' /><!-- 행삭제 --></button>
            </dms:access>
            <dms:access viewId="VIEW-I-12238" hasPermission="${dms:getPermissionMask('READ')}">
