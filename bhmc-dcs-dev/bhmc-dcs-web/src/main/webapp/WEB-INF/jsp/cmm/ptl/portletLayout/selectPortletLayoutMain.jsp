...
<section class="group">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
	        <dms:access viewId="VIEW-I-12263" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="header_area">
        <div class="btn_right">
        	<dms:access viewId="VIEW-I-12261" hasPermission="${dms:getPermissionMask('READ')}">
	            <button class="btn_s" id="btnSave"><spring:message code="global.btn.save" /></button>
	        </dms:access>
	        <dms:access viewId="VIEW-I-12262" hasPermission="${dms:getPermissionMask('READ')}">
	            <button class="btn_s" id="btnAdd"><spring:message code="global.btn.add" /></button>
	        </dms:access>
	        <dms:access viewId="VIEW-I-12260" hasPermission="${dms:getPermissionMask('READ')}">
	            <button class="btn_s" id="btnDel"><spring:message code="global.btn.del" /></button>
	        </dms:access>
	        <dms:access viewId="VIEW-I-12259" hasPermission="${dms:getPermissionMask('READ')}">
	            <button class="btn_s" id="btnCancel"><spring:message code="global.btn.cancel" /></button>
	        </dms:access>
	        <dms:access viewId="VIEW-I-12258" hasPermission="${dms:getPermissionMask('READ')}">
	            <button class="btn_s" id="btnDefaultPortletSetting"><spring:message code="global.btn.defaultPortletSetting" /></button>
	        </dms:access>
        </div>
    </div>
    <!-- 그리드 기능 버튼 종료 -->
