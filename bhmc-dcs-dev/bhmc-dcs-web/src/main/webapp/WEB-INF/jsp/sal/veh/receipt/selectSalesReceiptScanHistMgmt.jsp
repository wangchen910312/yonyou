...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{field:"receiptCustNm", title:"<spring:message code='sal.lbl.publsNm' />", width:250,attributes:{"class":"ac"}}        /* 영수증발행자 */
            ,{field:"custSaleDt", title:"<spring:message code='sal.lbl.retlDt' />", width:150,attributes:{"class":"ac"}}            /* 소매일자 */
            ,{field:"receiptIssDt", title:"<spring:message code='sal.lbl.ReceiptPubDt' />", width:150,attributes:{"class":"ac"}}    /* 발행일자 */
            ,{field:"receiptStat", title:"<spring:message code='sal.lbl.UnUploadCause' />", width:350,attributes:{"class":"ac"}}    /* 미업로드 원인 */
