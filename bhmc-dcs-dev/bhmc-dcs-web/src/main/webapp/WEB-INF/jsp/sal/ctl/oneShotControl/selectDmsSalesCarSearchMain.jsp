...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <button id="batchSearchDcsCar" class="btn_m">初始化差异数据</button>        <!-- 初始化差异数据 -->
...
$(document).ready(function() {
    ...
    $("#btnExcelExport").kendoButton({
        click:function(e) {
            dms.ajax.excelExport({
                ...
                ,"templateFile":"DmsSalesCarSearch_Tpl.xlsx"
                ,"fileName":"DmsSalesCarSearch_Tpl.xlsx"
                ,"downloadType":"selectDmsSalesCarSearchMain"
    ...
    collect = function(){
        ...
        var sModelCd = $("#sModelCd").val().replace(/-/gi, "");
       	...
       	saveUrl = "<c:url value='/sal/ctl/oneShotControl/callDmsSalesCarCheck.do' />";
  ...
  //승인 , 불승인
    batch = function(){
        ...
        if(sDlrCd!=null&&sDlrCd!=undefined&&sDlrCd!=""){
       	...
       	saveUrl = "<c:url value='/sal/ctl/oneShotControl/searchCarInfoErpToDmsByThread.do' />";
    ...
    inquiryLog = function(){
		...
		param = {checkMonth:sModelCd};
    	$.ajax({
            url:"<c:url value='/sal/ctl/oneShotControl/checkCarProcessShow.do' />",
            data:JSON.stringify(param),
            type:'POST',
            dataType:'json',
            contentType:'application/json',
            ...
            success:function(jqXHR, textStatus) {
            	if(textStatus=="success"){
            		...
            		if(checkObj.hasCheck == checkObj.allCheck){
            			console.log("停止循环==");
            			alert("执行完毕");
    ...
    $("#grid").kendoExtGrid({
        ...
        ,dataSource:{
            transport:{
                read:{
                    url:"<c:url value='/sal/ctl/oneShotControl/selectDmsCarDiff.do' />"
                },
       ...
       ,columns:[
           ...
           ,{field:"dmsTrans", title:"DMS在途", width:40, attributes:{"class":"ac"}}                                      
           ,{field:"dmsStock", title:"DMS在库", width:40, attributes:{"class":"ac"}}                                        
           ,{field:"dmsRetail", title:"DMS零售", width:40, attributes:{"class":"ac"}} 
           ,{field:"dmsStrategy", title:"DMS战略出库", width:40, attributes:{"class":"ac"}} 
