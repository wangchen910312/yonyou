...
<section class="group">
    ...
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.title.dealerRegistrationReceipt" /></h1><!-- 딜러 영수증 등록 -->
        <div class="btn_right">
        <dms:access viewId="VIEW-I-12394" hasPermission="${dms:getPermissionMask('READ')}">
            <button id="btnFileUpload" class="btn_m btn_fileUpload"><spring:message code="par.btn.fileUpload" /></button><!-- 파일 업로드 -->
        </dms:access>
        <dms:access viewId="VIEW-I-12393" hasPermission="${dms:getPermissionMask('READ')}">
            <button class="btn_m btn_search" id="btnSearch"><spring:message code="global.btn.search" /></button><!-- 조회 -->
        </dms:access>
        <dms:access viewId="VIEW-I-12392" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input id="sOfficeNm" type="text"  class="form_combo">
                    </td>
    ...
    <div class="header_area">
        <div class="right_area">
            <ul class="txt_input">
                <li>
                    <span class="span_bg"><spring:message code='global.lbl.ddlnDt' /></span>
                    <input id="ddlnDt" class="form_datepicker" style="width:120px">  <!-- 마감일자 -->
					<dms:access viewId="VIEW-I-12391" hasPermission="${dms:getPermissionMask('READ')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        //사무소
        $("#sOfficeNm").kendoExtDropDownList({
            dataTextField :"cmmCdNm"
           ,dataValueField:"cmmCd"
           ,optionLabel:" "   // 전체
        });
        ...
        //버튼 - 조회
         ...
         $("#btnDel").kendoButton({
             click:function(e) {
                 ...
                 if( !confirm("<spring:message code='global.lbl.del' var='delete' /><spring:message code='global.info.cnfrmMsg' arguments='${delete},' />")){ // 삭제 하시겠습니까?
                     return;
                 }

                 var saveData = { "deleteList":arrDel };

                 $.ajax({
                     url:"<c:url value='/sal/cer/dealerRegistrationReceipt/deleteDealerRegistrationReceipt.do' />",
         ...
         $("#btnSave").kendoButton({
             click:function(e) {
                 ...
                 var saveData = { "updateList":arrSave
                                 ,"ddlnDt":$("#ddlnDt").data('kendoExtMaskedDatePicker').value() };

                 $.ajax({
                     url:"<c:url value='/sal/cer/dealerRegistrationReceipt/updateDealerRegistrationReceipt.do' />",
                     data:JSON.stringify(saveData),
                     type:'POST',
                     dataType:'json',
                     contentType:'application/json',
        ...
        //그리드 설정
        $("#grid").kendoExtGrid({
            gridId:"G-SAL-0721-113305"
            ,dataSource:{
                 transport:{
                    read:{
                        url:"<c:url value='/sal/cer/dealerRegistrationReceipt/selectDealerRegistrationReceipt.do'/>"
                    }
                    ,parameterMap:function(options, operation) {
                        if (operation === "read") {
                            ...
                            params["sOfficeNm"] = $("#sOfficeNm").data('kendoExtDropDownList').text()
                ...
                ,schema:{
                    model:{
                        ...
                        ,fields:{
                            ...
                            ,uploadDt   :{type:"date", format:"{0:<dms:configValue code='dateFormat' />}"}
