...
<section class="group">
    <div id="tabstrip" class="tab_area tab_iframe">
        <ul>
            <li id="1st_tab" class="k-state-active">DMS车辆差异比对</li>
            <li id="2nd_tab">DMS车辆差异处理</li>
...
selectTab = function(tabId){
    ...
    if (tabId == "1st_tab") {
        if($("#iframeStatus01").attr("src") == ""){
            iframeUrl = "<c:url value='/sal/ctl/oneShotControl/selectDmsSalesCarSearchMain.do' />";
    	 ...
    	 if($("#iframeStatus02").attr("src") == ""){
             iframeUrl = "<c:url value='/sal/ctl/oneShotControl/selectDmsSalesCarManageMain.do' />";
