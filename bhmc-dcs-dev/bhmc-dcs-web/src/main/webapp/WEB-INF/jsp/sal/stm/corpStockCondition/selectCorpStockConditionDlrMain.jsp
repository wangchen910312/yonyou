...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
       ...
       ,columns:[
          ...
          ,{field:"extColorNm", title:"<spring:message code='global.lbl.extColor' />", width:100,  attributes:{"class":"al"}}    // 외색명
          ,{field:"extColorCd", title:"<spring:message code='global.lbl.extColor' />", hidden:true, width:100,  attributes:{"class":"al"}}    // 외색코드
          ,{field:"intColorNm", title:"<spring:message code='global.lbl.intColor' />", width:100,  attributes:{"class":"al"}}    // 내색명
          ,{field:"intColorCd", title:"<spring:message code='global.lbl.intColor' />", hidden:true, width:100,  attributes:{"class":"al"}}    // 내색코드
          ,{
              field:"totStockQty"
