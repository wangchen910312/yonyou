                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="form_float">
                                    ...
                                    <div class="form_right">
                                        <input id="drvCustCd_01" readonly class="form_input form_readonly">
                                    </div>
                                </div>
                            </td>
                            <th scope="row"><spring:message code='global.lbl.custTp' /></th>       <!-- 고객유형 -->
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="form_float">
                                    ...
                                    <div class="form_right">
                                        <input id="drvCustCd_02" readonly class="form_input form_readonly" />
                                    </div>
                                </div>
                            </td>
                            <th scope="row"><spring:message code='global.lbl.custTp' /></th>       <!-- 고객유형 -->
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input id="usrVinNo" name="usrVinNo" maxlength="17" class="form_input" data-json-obj="true" />
                            </td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="fincLoadRate" name="fincLoadRate" class="form_numeric ar" data-json-obj="true" />
                                </td>
...
<c:forEach var="obj" items="${fincItemDS}">
    if(fincItemObj.hasOwnProperty("${obj.fincCmpCd}")){
        fincItemObj["${obj.fincCmpCd}"].push({cmmCd:"${obj.fincItemCd}", cmmCdNm:"${obj.fincItemNm}", instIntrRate:"${obj.instIntrRate}", grteIncAmt:"${obj.grteIncAmt}", hdlgFeeAmt:"${obj.hdlgFeeAmt}"});
    }else{
   ...
   ************************/
   ...
   // 메인 그리드
    $("#contGrid").kendoExtGrid({
       ...
       ,columns :[
          ...
          ,{field:"telNo1", title:"<spring:message code='sal.lbl.custTelNo' />", attributes:{"class":"ac"}, width:100}                       //고객전화번호
   ...
   fn_contGridDBclick = function(selectedItem){
       if( selectedItem != null && selectedItem != 'undefined'){
           ...
           $("#usrSbstAmt").data("kendoExtNumericTextBox").value(selectedItem.usrSbstAmt);
   ...
   $("#goodsGrid").kendoExtGrid({
       ...
       ,edit :function(e){
           ...
           if(fieldName == "goodsNm"){
               ...
               if(dms.string.isEmpty(selectedItem.goodsCd)){
...
function save_Validate(){
    ...
    */
    ...
    // 중고차 치환
    if($("#uatcCarPurcYn").data("kendoExtDropDownList").value() == "Y"){
        if($("#usrVinNo").val() == ""){
