...
<section class="group">
    ...
    <div class="header_area">
        <h1 class="title_basic">配置信息</h1><!-- VehicleSpec - 옵션 -->
        <div class="btn_right">
		<dms:access viewId="VIEW-I-12019" hasPermission="${dms:getPermissionMask('READ')}">
...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            {field:"optionCd",    title:"<spring:message code='global.lbl.optionCode' />", width:50,  attributes:{"class":"ac"}} //옵션코드
            ,{field:"optionNm",   title:"<spring:message code='global.lbl.optionNm' />",   width:150, attributes:{"class":"al"}} //옵션명
            ,{field:"optionEnNm", title:"<spring:message code='global.lbl.optionEnNm' />", width:150, attributes:{"class":"al"}} //옵션영문명
            ...
            ,{field:"regDt",      title:"<spring:message code='global.lbl.regDt' />",      width:120, attributes:{"class":"ac"},format:"{0:<dms:configValue code='dateTimeFormat' />}"} //등록일
        ]
    });
