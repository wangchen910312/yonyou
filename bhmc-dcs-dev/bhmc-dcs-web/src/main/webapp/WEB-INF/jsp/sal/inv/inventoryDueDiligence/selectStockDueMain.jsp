...
$(document).ready(function() {
    ...
    $("#btnSearch").kendoButton({ // 조회
        ...
        click:function(e){
            subParam = {};
            subParam["sStockDt"] = $("#sStockDt").data("kendoExtMaskedDatePicker").value();
   ...
   $("#subGrid").kendoExtGrid({
       ...
       ,columns:[
           ...
           ,{field:"stockDt", hidden:true}     // 순번
           ,{field:"vinNo", title:"<spring:message code='sal.lbl.carVinNo' />", width:160, attributes:{"class":"ac"}}
           ,{field:"carlineNm", title:"<spring:message code='global.lbl.carLine' />", width:150, attributes:{"class":"al"}}    //차종명
           ,{field:"modelNm", title:"<spring:message code='global.lbl.model' />", width:150, attributes:{"class":"al"}}        //모델명
           ,{field:"ocnNm", title:"<spring:message code='global.lbl.ocn' />", width:150, attributes:{"class":"al"}}            //OCN명
           ,{field:"extColorNm", title:"<spring:message code='global.lbl.extColor' />", width:150, attributes:{"class":"al"}}  //외장색
           ,{field:"intColorNm", title:"<spring:message code='global.lbl.intColor' />", width:150, attributes:{"class":"al"}}  //내장색명
           ,{field:"carStatNm", title:"<spring:message code='sal.lbl.strgeCd' />", width:150, attributes:{"class":"al"}}    //창고
           ,{field:"locNm", title:"<spring:message code='sal.lbl.location' />", width:150, attributes:{"class":"al"}}        //위치
           ,{field:"manufactYyMmDt", title:"<spring:message code='sal.lbl.manufactYyMmDt' />", width:150, attributes:{"class":"ac"}}    //제작년월
...
function fn_fileButtonTmp(fileName, docNo, no, uid){
    ...
    if(dms.string.strNvl(fileName) == ""){
        ...
        buttonInfo = '<button type="button" class="btn_s" id="btnFileReDelete" onclick="fn_fileDelClick(\''+docNo+'\', \''+no+'\', \''+uid+'\')"><spring:message code="global.btn.fileDelete" /></button>';
    }
    return buttonInfo;
}
