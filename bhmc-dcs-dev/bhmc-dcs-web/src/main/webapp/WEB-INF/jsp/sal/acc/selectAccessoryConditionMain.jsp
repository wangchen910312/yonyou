...
$(document).ready(function() {
   ...
   $(document).on("click", ".linkGoodsNo", function(e){
       ...
       // tab window open
       window.parent._createOrReloadTabMenu("<spring:message code='sal.menu.accessorySale' />", "<c:url value='/sal/acc/accessoryMng/selectAccessoryMngMain.do' />?accessoryMngNo="+dataItem.goodsContractNo);
   });
