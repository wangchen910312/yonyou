...
$(document).ready(function() {
    ...
    //상세내용 - 시작일, 종료일
    $("#startDt").on('change', {from:$("#startDt"), to:$("#endDt")}, fnChkSearchDate);
    $("#endDt").on('change',   {from:$("#startDt"), to:$("#endDt")}, fnChkSearchDate);
    ...
    $("#btnSave").kendoButton({
        click:function(e) {
            ...
            alert(kendo.stringify(saveData2));
    ...
    $("#btnSearchR").kendoButton({
        click:function(e){
            ...
            $('#searchModelGrid').data('kendoExtGrid').dataSource.page(1);
        }
    });
    ...
    $("#searchModelGrid").kendoExtGrid({
        ...
        ,multiSelectWithCheckbox:true
        ,columns:[
                    {field:"modelCdNm", title:"<spring:message code='sal.lbl.searchModel' />",    width:100, attributes:{"class":"al"}} //조회모델명
                   ]
    });
    ...
    $("#targetModelGrid").kendoExtGrid({
        ...
        ,multiSelectWithCheckbox:true
        ,columns:[
                    {field:"modelCdNm", title:"<spring:message code='global.lbl.targetModel' />",    width:100, attributes:{"class":"al"}} //대상모델명
                   ]
    });
