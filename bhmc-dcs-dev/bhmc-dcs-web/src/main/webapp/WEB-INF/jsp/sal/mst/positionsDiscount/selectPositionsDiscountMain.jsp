...
<c:forEach var="obj" items="${carLineCdInfo}">
    carLineDSList.push({carlineNm:"${obj.carlineNm}", carlineCd:"${obj.carlineCd}"});
...
$(document).ready(function () {
    ...
    $("#sCarlineCd").kendoExtDropDownList({
       ...
       ,select:function(e){
           ...
           //var rData = [{"modelCd":"ALL", "modelNm":"ALL"}];

           var responseJson = dms.ajax.getJson({
               url:"<c:url value='/sal/mst/positionsDiscount/selectModel.do' />"
           ...
           if(responseJson.total > 0){
               responseJson.data = rData.concat(responseJson.data);
    ...
    $("#sModelCd").kendoExtDropDownList({
       ...
       ,select:function(e){
           ...
           var responseJson = dms.ajax.getJson({
               url:"<c:url value='/sal/mst/positionsDiscount/selectOcn.do' />"
