...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <button id="batchUpdateDcs" class="btn_m"><spring:message code='sal.btn.back' /></button>        <!-- 승인 -->
            <button id="updateDcsBySql"  class="btn_m btn_modify"><spring:message code='sal.btn.ExecuteSQL' /></button>         <!-- 거절 -->
...
$(document).ready(function() {
    ...
    confirm = function(appr){
        ...
        if(appr == 'BATCH'){
        	...
        	saveUrl = "<c:url value='/sal/ctl/oneShotControl/updateDcsOrderBySql.do' />";
        }
    ...
    $("#grid").kendoExtGrid({
        ...
        ,dataSource:{
            transport:{
                read:{
                    url:"<c:url value='/sal/ctl/oneShotControl/selectDcsSalesMonth.do' />"
                },
