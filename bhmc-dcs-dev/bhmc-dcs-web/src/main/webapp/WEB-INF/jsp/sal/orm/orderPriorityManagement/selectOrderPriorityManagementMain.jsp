        ...
        */
    	...
    	$("#grid").kendoExtGrid({
            ...
            ,columns:[
                ...
                ,{field:"ordTp", title:"<spring:message code='par.lbl.purcOrdTp' />"
                    ,width:80
                    ,headerAttributes:{style:"text-align:center;"}
                    ,template:"#if(ordTp != null){# [#=ordTp#]#= ordTpArr[ordTp].cmmCdNm # #}#"
                }  // 오더유형
                ...
                ,{field:"erpSendYn", title:"<spring:message code='sal.lbl.erpSendYn' />"
                    ,width:40
                    ,headerAttributes:{style:"text-align:center;"}
                    ,attributes:{ "style":"text-align:center"}
                }  // GASS (ERP전송여부)
