...
function goContractInfo(contractNo, type){
    ...
    switch(sType){
        ...
        case 50:
            ...
            window.parent._createOrReloadTabMenu("<spring:message code='sal.menu.custDeliveryMgmt' />", "<c:url value='/sal/dlv/vehicleDelivery/selectDeliveryMngMain.do'/>?contNo="+contractNo);
            break;
        default:
            break;
    }
