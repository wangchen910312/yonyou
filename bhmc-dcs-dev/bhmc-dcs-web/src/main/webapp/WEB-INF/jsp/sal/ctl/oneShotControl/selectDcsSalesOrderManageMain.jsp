...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <button id="batchUpdateDcsOrder" class="btn_m">批量修复订单差异</button>        <!-- 批量修复订单差异 -->
...
$(document).ready(function() {
    ...
    $("#btnExcelExport").kendoButton({
        click:function(e) {
            dms.ajax.excelExport({
                ...
                ,"templateFile":"DcsSalesOrderManage_Tpl.xlsx"
                ,"fileName":"DcsSalesOrderManage_Tpl.xlsx"
                ,"downloadType":'selectDcsSalesOrderManageMain'
    ...
    $("#batchUpdateDcsOrder").kendoButton({      // 승인
        enable:true,
        click:function(e){
            confirm('BATCH');
        }
    ...
    confirm = function(appr){
        ...
        var sModelCd = $("#sModelCd").val().replace(/-/gi, "")
       	...
       	$("#batchUpdateDcsOrder").data("kendoButton").enable(false);
       	saveUrl = "<c:url value='/sal/ctl/oneShotControl/updateOrderInfoErpToDcs.do' />";
                ...
                if(result){
                	...
                	$.ajax({
                        ...
                        success:function(jqXHR, textStatus) {
                        	dms.loading.hide();
                            $("#grid").data("kendoExtGrid").dataSource.read();
                            $("#batchUpdateDcsOrder").data("kendoButton").enable(true);
    ...
    $("#grid").kendoExtGrid({
        ...
        ,dataSource:{
            transport:{
                read:{
                    url:"<c:url value='/sal/ctl/oneShotControl/selectDcsErpOrdDetail.do' />"
                },
       ...
       ,columns:[
          ...
          ,{field:"prty", title:"DCS订单状态", width:80, attributes:{"class":"al"}} 
          ,{field:"orty", title:"DCS订单类型", width:40, attributes:{"class":"ac"}}
          ,{field:"aldy", title:"DCS考评日期", width:40, attributes:{"class":"ac"}}
          ,{field:"ordYymm", title:"DCS订单年月", width:40, attributes:{"class":"ac"}}
          ,{field:"ordWeek", title:"DCS订单周次", width:40, attributes:{"class":"ac"}}
          ...
          ,{field:"erpPrty", title:"ERP订单状态", width:80, attributes:{"class":"al"}} 
