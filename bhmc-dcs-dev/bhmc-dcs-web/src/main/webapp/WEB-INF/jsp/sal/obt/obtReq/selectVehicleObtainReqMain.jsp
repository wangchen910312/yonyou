...
<section class="group">
    ...
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.title.vehicleObtainReq" /></h1><!-- 차량조달신청관리 -->
        <div class="btn_right">
    ...
    $("#btnSave").kendoButton({
        click:function(e) {
            ...
            if ( dms.string.isEmpty($("#telNo").val())){
                dms.notification.warning("<spring:message code='global.lbl.telNumer' var='msg' /><spring:message code='global.info.required.field' arguments='${msg}' />");
                $("#telNo").focus();
                return false;
            }
    ...
    $("#btnDelete").kendoButton({
        click:function(e){
            ...
            if (confirm("<spring:message code='global.lbl.del' var='del' /><spring:message code='global.info.cnfrmMsg' arguments='${del},' />") == false ){    //삭제하시겠습니까?
                ...
                var data = {};
                data["obtNo"] = selectedItem.obtNo;                                              // VIN NO
