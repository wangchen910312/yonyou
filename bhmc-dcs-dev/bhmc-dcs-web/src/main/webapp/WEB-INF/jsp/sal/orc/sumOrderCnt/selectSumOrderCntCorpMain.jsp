...
<div id="resizableContainer">
    <section class="group">
        <div class="header_area">
            ...
            <div class="btn_right">
			<dms:access viewId="VIEW-I-12390" hasPermission="${dms:getPermissionMask('READ')}">
            ...
            <table>
                ...
                <colgroup>
                   <!--
                    ...
                    <col style="width:10%;">
                    -->
                    <!--CSR 88 订单类型条件目前不起作用，需要调整 贾明 2020-5-14 贾明  -->
                    <col style="width:8%;">
	                <col style="width:19%;">
	                <col style="width:8%;">
	                <col style="width:16%;">
                ...
                <tbody>
                    ...
                    <tr>
                       <!-- 주문상태  CSR 88  去掉订购状态的查询条件 贾明 2020-5-14 -->
                        <!--
                        <th scope="row"><spring:message code='global.lbl.ordStat' /></th> 
                        <td>
                        ...
                        <td>
                         ...
                         <!--CSR 88 订单类型条件目前不起作用，需要调整 贾明 2020-5-14 贾明 start  -->
                        <th scope="row"><spring:message code='sal.lbl.extIntColor' /></th>
                        <td>
                            <input id="sExtColorCd" class="form_comboBox" style="width:49%"/>
                            <input id="sIntColorCd" class="form_comboBox" style="width:49%"/>
                        </td>
                         <!--CSR 88 订单类型条件目前不起作用，需要调整 贾明 2020-5-14 贾明  end-->
                    </tr>
                    <!-- 외장색 -->  <!-- 내장색 -->
                    <!--
                    <tr>
                        
                        <th scope="row"><spring:message code='global.lbl.extColor' /></th>        
                        <td>
                            <input id="sExtColorCd" class="form_comboBox" />
                        </td>
                       
                        <th scope="row"><spring:message code='global.lbl.intColor' /></th>       
                        <td class="bor_none">
...
$(document).ready(function() {
    ...
    // 주문상태
    /** CSR 88  去掉订购状态的查询条件 贾明 2020-5-14
    ...
    $("#mainGrid").kendoExtGrid({
        ...
        ,dataSource:{
            ...
            ,schema:{
                model:{
                    ...
                    fields:{
                        ...
                        ,sumTotalQty:{type:"number"}     //최종확인수량
            ...
            ,aggregate:[
                         ...
                         ,{ field:"sumTotalQty", aggregate:"sum" }
       ...
       ,columns:[
          ...
          ,{field:"dlrCnclQty"      ,title:"<spring:message code='global.lbl.dlrCnclQty' />"    ,width:100  ,attributes:{"class":"ar"}, format:"{0:n0}"
           ...
           ,{field:"sumTotalQty"         ,title:"<spring:message code='sal.lbl.finalConfQty' />"       ,width:80  ,attributes:{"class":"ar"}, format:"{0:n0}"
               ,footerTemplate:"#=kendo.toString(sum)#"
               ,footerAttributes:{style:"text-align:right;"}
              }          //최종확인수량
