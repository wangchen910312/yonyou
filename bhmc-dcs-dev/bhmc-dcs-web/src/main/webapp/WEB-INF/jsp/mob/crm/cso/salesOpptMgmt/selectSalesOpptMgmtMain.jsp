                        ...
                        <tr>
                            ...
                            <td class="f_term">
                                <div class="f_item01 f_disabled">
                                    <input type="text" id="sStartRegDt" value="${sevenDtBf}" data-json-obj="true" readOnly />
                                    <span class="date" onclick="calpicker('sStartRegDt')"><spring:message code='global.lbl.date' /></span>
                                </div>
                                <span class="termtext"> ∼</span>
                                <div class="f_item01 f_disabled">
                                    <input type="text" id="sEndRegDt" value="${toDt}" data-json-obj="true" disabled />
                        ...
                        <table class="flist01">
                            ...
                            <tbody  >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="f_text">
                                            <input type="text" id="hpNo" name="hpNo" placeholder="" data-json-obj="true"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="f_item01">
                                            <input type="text" id="expcSaleDt" name="expcSaleDt" data-json-obj="true" readonly />
...
saleOpptStepCdList.push({cmmCd:"${obj.cmmCd}", cmmCdNm:"${obj.cmmCdNm}"});
...
trsfStatCdList.push({cmmCd:"${obj.cmmCd}", cmmCdNm:"${obj.cmmCdNm}"});
...
//조회조건 - 성공확률
 ...
 succPrbCdList.push({text:"${obj.cmmCdNm}", value:"${obj.cmmCd}"});
...
<c:forEach var="obj" items="${saleOpptSrcCdList}">
    saleOpptSrcCdList.push({text:"${obj.cmmCdNm}", value:"${obj.cmmCd}"});
...
function contentDetail(dataItem) {
    ...
    $.ajax({
            url:"<c:url value='/mob/crm/cso/salesOpptMgmt/selectSalesOpptMgmtByKey.do' />"
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            if( dms.string.isEmpty($("#remark").val()) ){
                // 판매기회 개술 / 을(를) 입력해주세요.
                dms.notification.warning("<spring:message code='crm.lbl.saleRemark' var='arguMsg' /><spring:message code='global.info.confirmMsgParam' arguments='${arguMsg}'/>");
                return;
            }
            ...
            if( dms.string.isEmpty($("#saleOpptStepCd").val()) ){
                // 판매기회단계 / 을(를) 선택해주세요.
                dms.notification.warning("<spring:message code='global.lbl.saleOpptStepCd' var='arguMsg' /><spring:message code='global.info.chkSelectItemMsg' arguments='${arguMsg}'/>");
                return;
            }
...
/*             // 관심차 필수 체크
            ...
            $(saveData.deleteList).each(function(index, item){

                saveData.deleteList[index].regDt = chgDateTimeStamp(saveData.deleteList[index].regDt);
            });

            //console.log("saveData:",saveData);

            $.ajax({
                url:"<c:url value='/mob/crm/cso/salesOpptMgmt/multiSalesOpptMgmts.do' />"
