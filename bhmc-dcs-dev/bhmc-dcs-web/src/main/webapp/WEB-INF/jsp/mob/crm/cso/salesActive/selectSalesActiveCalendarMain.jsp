                        ...
                        <table class="flist01">
                            ...
                            <tbody id="salesActiveMgmtForm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <div class="f_item01">
                                            <input type="text" id="planStartDt" name="planStartDt" value="" required readOnly data-json-obj="true"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <div class="f_item01">
                                            <input type="text" id="planEndDt" name="planEndDt" value="" readOnly required data-json-obj="true"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <div class="f_item01">
                                            <input type="text" id="activeStartDt" name="activeStartDt" value="" readOnly data-json-obj="true"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <div class="f_item01">
                                            <input type="text" id="activeEndDt" name="activeEndDt" value="" readOnly data-json-obj="true"/>
                        ...
                        <table class="flist01">
                            ...
                            <tbody id="visitCustomerMgmtForm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="f_text ">
                                            <input type="text"  id="visitCustomer_hpNo" name="hpNo"  data-json-obj="true" required maxlength="14" class="" placeholder="" />
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <div class="f_item01 ">
                                            <input type="text" id="visitCustomer_resvDt" name="resvDt" value="" required data-json-obj="true"/>
                                ...
                                <table class="flist01">
                                    ...
                                    <tbody id="testDriveAreaForm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="f_text">
                                                    <input type="text"  id="testDrive_hpNo" name="hpNo"  data-json-obj="true" required maxlength="14" class="" placeholder="" disabled/>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
