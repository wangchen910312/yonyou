...
<script type="text/x-kendo-template" id="list-template">
        <div class="dlistitem">
            ...
            <span class="clboth" style="width:35%">#:rpirStatChange(rpirTp) #</span>
            <span style="width:35%">#:trimNull(planHm) #</span>
            <span style="width:30%">#:trimNull(allocHm) #</span>

            <span class="clboth" style="width:35%">#:trimNull(bayNm) #</span>
            <span style="width:35%">#:trimNull(wkgrpNm) #</span>
            <span style="width:30%">#:trimNull(realTecNm) #</span>

            <span class="clboth" style="width:100%">#:chgDate2DateTimeStr(wrkEndDt) #</span>
        </div>
</script>
