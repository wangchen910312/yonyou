...
<div class="deleteitem">
    ...
    <span style="width:35%">#:memoTpChg(memoTp) #/#:shareYn #</span>
    <span style="width:30%">#:usrNm #</span>
    <span style="width:35%">#:chgDate2Str(regDt) #</span>
    <span class="clboth" style="width:100%">#:memoCont #</span>
    <span class="delete">
      ...
      ,model:{
          id:"rnum"
              ,fields:{
               ...
               , regDt:{type:"string", editable:false}         // 등록일
               , custNo:{type:"string", editable:false}
               , dlrCd:{type:"string", editable:false}
               , updtDt:{type:"string", editable:false}         // 수정일
