...
<dms:configValue code='dateTimeFormat' var="_dateTimeFormat" />
    <section id="content">
        <div class="content_title conttitlePrev">
            <h2 id="content_title_h2"><spring:message code="global.lbl.custSearchCondition" />(<spring:message code="global.title.custSearch" />)<!-- 고개검색조건 (고객조회) --></h2>
        </div>
        <!-- 탭메뉴 -->
        <div class="tabarea">
            <ul class="tab_search">
            ...
            <section id="content_pop_list" style="display:none;">
                ...
                <div class="listarea">
                    <div class="dlistitem listhead">
                        <span style="width:40%"><spring:message code='global.lbl.custNm' />(<spring:message code="global.lbl.custTp" />)</span>
                        <span style="width:60%"><spring:message code='global.lbl.custNo' /></span>
                        ...
                        <colgroup>
                         ...
                         <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="f_text"><div class="f_text"><input type="text" id="hpNo" class="form_input" /></div>
                                    </td>
                                </tr>
                                <tr>
...
function setSearchBox(){
    ...
    //setMainListHeight();
    //setPopUpListHeight();
    setPopUpListObjHeight("content_pop_list");
}
//차량정보조회
function setSearchBox2(){
    ...
    setPopUpListObjHeight("content_pop_list2");
}
// 그리드에서 목록 선택시 선택값 세팅
var setDataItem; //고객
var setDataItem2; //정보
$(document).ready(function() {
    ...
    $("#docu_prev").bind("click", function()
    {
        ...
        if ($("#content_pop_list2").css("display") == "block") { goMain(); }
    ...
    $("#custSearchTab").bind("click", function()
    {
        ...
        $("#content_title_h2").text('<spring:message code="global.lbl.custSearchCondition" />(<spring:message code="global.title.custSearch" />)');<!-- 고개검색조건 (고객조회) -->
    ...
    $("#carInfoSearchTab").bind("click", function()
    {
        ...
        $("#content_title_h2").text('<spring:message code="global.lbl.custSearchCondition" />(<spring:message code="ser.title.carInfo" />)');<!-- 고개검색조건 (차량정보) -->
