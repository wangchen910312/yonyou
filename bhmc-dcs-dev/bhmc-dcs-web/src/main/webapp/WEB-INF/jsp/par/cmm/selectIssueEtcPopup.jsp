 ...
 <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        *************************************************************/
         ...
         * 팝업 옵션
         */
         var options             = parent.issueEtcPopupWindow.options.content.data,
             optionId            = parent.issueEtcPopupWindow.options.windowId,
             toDt                ="${toDt}",
             sevenDtBf           ="${sevenDtBf}",
             unitCdObj           = {},
             strgeTpObj          = {},
        ...
        *************************************************************/
        ...
        console.log('optionId:', optionId,parent.issueEtcPopupWindow);
        if(optionId === 'IssueEtcRentalPopup'){
            urlInfo = "<c:url value='/par/cmm/selectIssueEtcRentalPopupByCondition.do' />";
        }else if(optionId === 'IssueEtcReturnPopup'){
            urlInfo = "<c:url value='/par/cmm/selectIssueEtcReturnPopupByCondition.do' />";
        }
