    ...
    <section id="windows" class="pop_wrap">
        <div class="header_area">
            <div class="btn_right">
                ...
                <button id="btnClose" class="btn_m btn_close" type="button"><spring:message code="global.btn.close" /><!-- 닫기 --></button>
            </div>
        </div>
        ...
        <div class="btn_right mt10">
            <button type="button" class="btn_s btn_add" id="btnAdd">新增</button><!-- 추가 -->
            <button type="button" class="btn_s" id="itemPop">导入配件</button><!-- 부품가져오기 -->
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn_s" id="fileDelete">浏览</button>
                        </td>
                    </tr>
                    <tr>
