...
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><%-- <spring:message code="par.title.partReserveStatusSub" /> --%><!-- partReserveStatusSub --></h1>
            <div class="btn_right">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th scope="row"><spring:message code="par.lbl.reserveStatNm" /><!-- reserveStatNm --></th>
                    <td>
                        <input id="sResvStatTp" class="form_comboBox" />
                    </td>
                </tr>
                <tr>
...
$(document).on("click", ".linkRoNo", function(e){
    ...
    $(document).ready(function() {
        ...
        // sResvStatTp dropdownlist
        $("#sResvStatTp").kendoExtDropDownList({
            dataTextField:"cmmCdNm"
            ,dataValueField:"cmmCd"
            ,dataSource:[{cmmCd:"01", cmmCdNm:"申请"},{cmmCd:"02", cmmCdNm:"预约"},{cmmCd:"03", cmmCdNm:"预留"}]
            ,optionLabel:" "
            ,autoBind:false
            ,index:0
        });
        ...
        $("#targetResvHeaderGrid").kendoExtGrid({
            ...
            ,columns :
                ...
                ,{field:"regDt", title:"<spring:message code='par.lbl.resvDt'/>", format:"{0:<dms:configValue code='dateFormat' />}", width:80 }//regDt
                ...
                ,{field:"custNm", title:"<spring:message code='par.lbl.custNm'/>", width:80 }//custNm
                ,{field:"carNo", title:"<spring:message code='par.lbl.carNo'/>", width:100 }//carNo
                ,{field:"serPrsnId", title:"<spring:message code='par.lbl.saId'/>", width:80 }//serPrsnId
