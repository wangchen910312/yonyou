...
<script>
        ...
        storageList.push({cmmCd:"", cmmCdNm:" "});
        ...
        stockUnitList.push({cmmCd:"", cmmCdNm:" "});
    ...
    $(document).ready(function() {
        ...
        $("#btnItemAdd").kendoButton({
            click:function(e){
                ...
                for(var i=0; i<parData.length; i++){
                    ...
                    console.log("item data:"+kendo.stringify(data));
        ...
        $("#btnItemSend").kendoButton({
            click:function(e){
                ...
                console.log("data:"+kendo.stringify(multiItemsMasterSends));

                $.ajax({
                    url:"<c:url value='/par/pmm/itemMaster/multiItemMasterSends.do' />",
        ...
        $("#gridItem").kendoExtGrid({
            ...
            ,columns:[
                ...
                ,{field:"abcInd", title:"<spring:message code='par.lbl.abcInd' />",template:'#= changeAbcInd(abcInd)#',width:60 } //ABC CLASS
