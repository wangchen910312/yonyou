...
<script type="text/javascript" src="<c:url value='/resources/js/dms/dms.parts-1.0.js' />"></script>
    ...
    <section class="group">
        ...
        <div class="header_area">
            <div class="btn_right">
                <button class="btn_s btn_add"  id="btnBorrowAdd"><spring:message     code="par.btn.addBorrowDoc" /></button>
                <button class="btn_s btn_del"  id="btnBorrowDel"><spring:message     code="par.btn.delBorrowDoc" /></button>
            </div>
        </div>
        <!-- 그리드 기능 버튼 종료 -->
