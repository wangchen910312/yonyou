...
<div id="tabstrip" class="tab_area mt0">
    ...
    <div class="mt0">
        <div class="header_area">
            <div class="btn_right">
                <button id="btnAdd" name="btnAdd" class="btn_s" ><spring:message code="par.btn.add" /><!-- btnAdd --></button>
                <button id="btnTargetOff" name="btnTargetOff" class="btn_s" ><spring:message code="par.btn.targetOff" /><!-- btnTargetOff --></button>
            </div>
        </div>
    ...
    <div class="mt0">
        <div class="header_area">
            <div class="btn_right">
                <button id="btnTargetOn" name="btnTargetOn" class="btn_s" ><spring:message code="par.btn.targetOn" /><!-- btnTargetOn --></button>
            </div>
        </div>
        <div class="table_grid">
            <!-- targetOffGrid -->
...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <button id="btnPartsPriceSave" name="btnPartsPriceSave" class="btn_s" ><spring:message code="par.btn.save" /><!-- btnPartsPriceSave --></button>
            <button id="btnPartsPriceAdd" name="btnPartsPriceAdd" class="btn_s" ><spring:message code="par.btn.rowAdd" /><!-- btnPartsPriceAdd --></button>
            <button id="btnPartsPriceDel" name="btnPartsPriceDel" class="btn_s" ><spring:message code="par.btn.rowDel" /><!-- btnPartsPriceDel --></button>
            <button id="btnPartsSalPriceSave" name="btnPartsSalPriceSave" class="btn_s dis_none" ><spring:message code="par.btn.save" /><!-- btnPartsSalPriceSave --></button>
            <button id="btnPartsSalPriceAdd" name="btnPartsSalPriceAdd" class="btn_s dis_none" ><spring:message code="par.btn.rowAdd" /><!-- btnPartsSalPriceAdd --></button>
            <button id="btnPartsSalPriceDel" name="btnPartsSalPriceDel" class="btn_s dis_none" ><spring:message code="par.btn.rowDel" /><!-- btnPartsSalPriceDel --></button>
        </div>
    </div>
    <div class="table_grid">
