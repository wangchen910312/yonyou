    ...
    $(document).ready(function() {
        ...
        *************************************************************/
         ...
         */
         ...
         invcTpList.push({cmmCd:" ", cmmCdNm:" "});
         <c:forEach var="obj" items="${invcTpList}" varStatus="status">
             invcTpList.push({cmmCd:"${obj.cmmCd}", cmmCdNm:"${obj.cmmCdNm}"});
             invcTpObj["${obj.cmmCd}"] = "${obj.cmmCdNm}";
         </c:forEach>


         invcStatList.push({cmmCd:" ", cmmCdNm:" "});
         <c:forEach var="obj" items="${invcStatList}" varStatus="status">
             invcStatList.push({cmmCd:"${obj.cmmCd}", cmmCdNm:"${obj.cmmCdNm}"});
