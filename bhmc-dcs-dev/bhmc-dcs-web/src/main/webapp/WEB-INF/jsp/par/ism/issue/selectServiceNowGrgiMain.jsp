            ...
            <section class="group">
                ...
                <div class="header_area">
                    ...
                    <div class="btn_right">
                        ...
                        <button class="btn_s btn_add" id="btnAdd"><spring:message code="global.btn.rowAdd" /></button><!-- 행추가 添加行 -->
                        <button class="btn_s btn_del" id="btnDel"><spring:message code="global.btn.rowDel" /></button><!-- 행삭제?除行  -->
                    </div>
                </div>
