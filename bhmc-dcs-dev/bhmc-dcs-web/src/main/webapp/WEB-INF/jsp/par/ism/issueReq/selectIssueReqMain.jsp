...
<section class="group">
    ...
    <div class="header_area">
        <h2 class="title_basic"><spring:message code="par.title.issueReqInfo" /><!-- issueReqInfo --></h2>
            <div class="btn_right">
                <button id="btnOrderReq" class="btn_s btn_add"><spring:message code="par.btn.orderReq" /><!-- btnOrderReq --></button>
                <button id="btnResvReq" class="btn_s btn_delete"><spring:message code="par.btn.resvReq" /><!-- btnResvReq --></button>
                <button id="btnInvReq" class="btn_s btn_delete"><spring:message code="par.btn.invReq" /><!-- btnInvReq --></button>
            </div>
    </div>
