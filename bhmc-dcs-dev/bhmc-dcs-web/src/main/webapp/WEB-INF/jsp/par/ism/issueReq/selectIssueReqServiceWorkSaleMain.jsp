...
<section class="group">
    ...
    <div>
        <section class="group">
            <div class="header_area">
                <div class="btn_right">
                    <button id="btnPakage" class="btn_s"><spring:message code="ser.btn.pakage" /><!-- btnPakage --></button>
                    ...
                    <button id="btnOrderReq" class="btn_s"><spring:message code="par.btn.orderReq" /><!-- btnOrderReq --></button>
