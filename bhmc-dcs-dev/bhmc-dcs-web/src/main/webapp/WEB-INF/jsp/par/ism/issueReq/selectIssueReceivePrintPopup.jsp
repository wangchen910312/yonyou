    ...
    <section id="window" class="pop_wrap">
        <div class="header_area">
            ...
            <div class="btn_right">
                ...
                <button class="btn_m" id="btnClose"><spring:message code="global.btn.close" /></button>
            </div>
        </div>
    ...
    $("#targetReqDetailGrid").kendoExtGrid({
        ...
        ,columns :
            ...
            ,{field:"giStrgeCd", title:"<spring:message code='par.lbl.strge' />/<spring:message code='par.lbl.locId' />", width:120
                ,template:'#if(giStrgeCd !== "" && giStrgeCd !== null){# #= giStrgeCdMap[giStrgeCd]# / #= locCdMap[giLocCd]# #}#'
            }
