        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input id="sEndYn" name="sEndYn" class="form_comboBox" />
                    </td>
                </tr>
            </tbody>
        </table>
...
<section class="group">
    ...
    <div class="table_form">
        <table>
            ...
            <tbody>
                <tr>
                    <th scope="row"><span class="bu_required"><spring:message code="par.lbl.bpTp" /><!-- bpTp --></th>
                    <td>
                ...
                <tr>
                    ...
                    <th scope="row"><span class="bu_required"><spring:message code="par.lbl.bpNm" /><!-- bpNm --></th>
                    <td>
...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{ field:"endYn", title:"<spring:message code='par.lbl.venderEndYn' />"
                ,width:80
                ,attributes:{"class":"ac"}
                ,template:'#if(endYn != null){# #= useYnCdMap[endYn]# #}#'
            }//endYn
            ...
            ,{ field:"payTermCd", title:"<spring:message code='par.lbl.payTermCd' />", width:80
