...
<section class="group">
    ...
    <div>
        <section class="group">
            <div class="header_area">
                <div class="btn_right">
                    <button id="btnResvReq" class="btn_s"><spring:message code="par.btn.resvReq" /><!-- btnResvReq --></button>
                    <button id="btnCopyFromExcel" class="btn_s"><spring:message code="par.btn.copyFromTable" /><!-- btnCopyFromTable --></button>
                    <button id="btnPartsAdd" class="btn_s"><spring:message code="par.btn.addItemPop" /><!-- btnPartsAdd --></button>
                    ...
                    <button id="btnPakage" class="btn_s hidden"><spring:message code="par.btn.pakage" /><!-- btnPakage --></button>
