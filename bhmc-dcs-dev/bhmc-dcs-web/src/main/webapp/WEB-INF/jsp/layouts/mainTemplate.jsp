...
//                 if(!that.hasClass("k-last")){
//                     tabGroupWidth = tabGroupWidth - that.width();
...
//                                                 .bind("click", function(){
//                                                     var data = $(this).closest("li").data();
//                                                     _addTabMenu(data.title, data.url);
//                                                     hiddenTabMenu.remove();
//                                                 });
...
//         _tabMenu.select("li.k-last");
        ...
        $("#tabMenu ul").on("click", "li", function(e) {
            ...
            //활성화된 탭이면 iframe refresh
//             if($(this).hasClass("k-state-active")){
//                 $("#"+_iframeId).attr("src", _iframeUrl);
//             }
        });
        ...
        $("#portlet_list li").on("click", "a", function() {
            if(!$(this).hasClass("selected")){
                $.ajax({
                    ...
                    //_tabMenu.reload("li:first");
                    //location.href = "<c:url value='/selectMain.do' />";
                });
