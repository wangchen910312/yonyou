...
<section class="group">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-I-12237" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div id="tabstrip" class="tab_area">
        ...
        <div class="mt0">
            <div class="header_area">
                <div class="btn_right">
                    <dms:access viewId="VIEW-I-12230" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchScheduleSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
                    </dms:access>
                    <dms:access viewId="VIEW-I-12232" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchScheduleAdd"><spring:message code="global.btn.rowAdd" /><!-- 행추가 --></button>
                    </dms:access>
                    <dms:access viewId="VIEW-I-12231" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchScheduleDel"><spring:message code="global.btn.rowDel" /><!-- 행삭제 --></button>
                    </dms:access>
                    <dms:access viewId="VIEW-I-12229" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchScheduleCancel"><spring:message code="global.btn.cancel" /><!-- 취소 --></button>
                    </dms:access>
                    <dms:access viewId="VIEW-I-12228" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchScheduleExecute"><spring:message code="global.btn.batchExecute" /><!-- 배치실행 --></button>
                    </dms:access>
                </div>
            </div>
            <div class="table_grid">
        ...
        <div class="mt0">
            <div class="header_area">
                <div class="btn_right">
                    <dms:access viewId="VIEW-I-12225" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchResultSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
                    </dms:access>
                    <dms:access viewId="VIEW-I-12226" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchResultDel"><spring:message code="global.btn.rowDel" /><!-- 행삭제 --></button>
                    </dms:access>
                    <dms:access viewId="VIEW-I-12224" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchResultCancel"><spring:message code="global.btn.cancel" /><!-- 취소 --></button>
                    </dms:access>
                    <dms:access viewId="VIEW-I-12227" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s" id="btnBatchResultRefresh"><spring:message code="global.btn.refresh" /><!-- 새로고침 --></button>
                    </dms:access>
                </div>
            </div>
            <div class="table_grid">
