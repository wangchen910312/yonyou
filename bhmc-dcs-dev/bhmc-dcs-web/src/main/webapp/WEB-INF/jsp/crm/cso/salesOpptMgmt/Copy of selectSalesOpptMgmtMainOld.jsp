...
<%@taglib prefix="dms" uri="/WEB-INF/tlds/taglibs-dms"%>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input id="sStartRegDt" name="sStartRegDt" class="form_datepicker" style="width:40%" />
                                    ~
                                    <input id="sEndRegDt" name="sEndRegDt" class="form_datepicker" style="width:40%" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <section class="group">
                <div class="header_area">
                    <h1 class="title_basic"><spring:message code='global.title.salesOpptDetlInfo' /><!-- 판매기회 상세정보 --></h1>
                    <div class="btn_right">
                        ...
                        <tbody id="salesOpptMgmtInputForm" >
                            <tr>
                                ...
                                <td colspan="5" class="required_area">
                                    <input type="text" id="remark" name="remark" class="form_input" data-json-obj="true" style="width:93%" />
                                </td>
                            </tr>
                            <tr>
            ...
            <section class="group">
                <div class="header_area">
                    <h1 class="title_basic"><spring:message code='global.title.saleOpptFailDetl' /><!-- 판매기회 실패 상세정보 --></h1>
                </div>
                <div class="table_grid">
