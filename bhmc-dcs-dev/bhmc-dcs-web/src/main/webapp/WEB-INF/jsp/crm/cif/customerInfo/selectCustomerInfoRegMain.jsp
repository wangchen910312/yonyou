      ...
      <!-- 기본정보 -->
            <section class="group">
                <div class="header_area">
                    ...
                    <div class="btn_right">
					<dms:access viewId="VIEW-I-12504" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_m btn_save" id="btnCustSave"><spring:message code="global.btn.save" /></button> <!-- 저장 -->
					</dms:access>
					<dms:access viewId="VIEW-I-12503" hasPermission="${dms:getPermissionMask('READ')}">
...
<div id="personalDiv">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="required_area">
                                    <input id="custNm" name="custNm" type="text" value="" class="form_input getCustDupByKey"  maxlength="30" data-json-obj="true" />
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="required_area">
                                    <input id="hpNo" name="hpNo" type="text" value="" class="form_input numberic getCustDupByKey"  maxlength="20" data-type="mobile" pattern="\d" data-json-obj="true" />
                ...
                <div id="addInfo" class="table_form" style="display:none">
                    <div class="table_form form_width_100per mt5">
                        <table>
                            <colgroup>
                                <col style="width:10%;">
...
<div id="corporateDiv"  style="display:none"> <!-- corporateDiv Start -->
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="required_area">
                                    <input id="custNmC" name="custNmC" type="text" value="" class="form_input getCustDupByKey"  maxlength="30" data-json-obj="true" />
                                </td>
                                <th scope="row"><spring:message code="global.lbl.custNo" /></th> <!-- 고객번호 -->
                                <td>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th scope="row"><spring:message code="global.lbl.ssnCrnNo" /></th> <!-- 증거번호 -->
                                <td>
                                    <input id="ssnCrnNoC" name="ssnCrnNoC" type="text" value="" class="form_input numberandalpha getCustMathDocDupByKey"  pattern="[0-9A-Z]" maxlength="30" data-json-obj="true" />
                                </td>
                                <th scope="row"><spring:message code="global.lbl.bhmcyn" /></th> <!-- BHMC여부 -->
                                <td>
                                    <div class="form_float">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="required_area">
                                    <input id="officeTelNoC" name="officeTelNoC" type="text" value="" class="form_input numberic getCustDupByKey"  data-type="tel" maxlength="20" pattern="\d" data-json-obj="true" />
                                </td>
                                <th scope="row"><spring:message code="global.lbl.fax" /></th> <!-- FAX -->
                                <td>
    ...
    <div class="header_area">
		...
		<dms:access viewId="VIEW-I-12502" hasPermission="${dms:getPermissionMask('READ')}">
            <button class="btn_s btn_add" id="btnAddAddress" ><spring:message code="global.btn.rowAdd" /></button> <!-- 주소행추가 -->
		</dms:access>
		<dms:access viewId="VIEW-I-12501" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <!-- //주소정보 끝 -->
      ...
      <section class="group">
          <div class="header_area">
              ...
              <div class="btn_right">
				<dms:access viewId="VIEW-I-12500" hasPermission="${dms:getPermissionMask('READ')}">
                  <button class="btn_s btn_save" id="btnSaveRelCustGrid" ><spring:message code="global.btn.save" /></button> <!-- 연계인저장 -->
				</dms:access>
				<dms:access viewId="VIEW-I-12499" hasPermission="${dms:getPermissionMask('READ')}">
                  <button class="btn_s btn_add" id="btnAddRelCust" ><spring:message code="global.btn.rowAdd" /></button> <!-- 연계인행추가 -->
				</dms:access>
				<dms:access viewId="VIEW-I-12498" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        if (chkContinued) {
            ...
            $.ajax({
                ...
                success:function(result){
                    console.log("selectCustDupByKey !!! ");
                    console.log(result);
