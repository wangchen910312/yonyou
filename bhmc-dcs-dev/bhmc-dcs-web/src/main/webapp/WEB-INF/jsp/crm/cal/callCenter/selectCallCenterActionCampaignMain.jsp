        ...
        <div class="content_v1">
            <section class="group">
                <div class="header_area">
                    <h1 class="title_basic"><spring:message code="crm.menu.callCenterCampaign" /></h1><!-- 콜센터실행-캠페인 -->
                    <div class="btn_right">
            ...
            <section class="group">
                <div class="header_area">
                    <h2 class="title_basic"><spring:message code="crm.title.campaignInfo" /><!-- 캠페인정보 --></h2>
                </div>
                <div class="table_form">
                    <table>
                        <caption></caption>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="makNm" name="makNm" value="" readonly class="form_input form_readonly">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><spring:message code="global.lbl.activeCont" /><!-- 요약설명 --></th>
                                <td>
                                    <input type="text" id="activeCont" name="activeCont" value="" readonly class="form_input form_readonly">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><spring:message code="global.lbl.attachedFile" /><!-- 첨부파일 --></th>
                                <td>
                                    <div class="uploadFile_area">
                                        <ul class="k-button-group" id="fileList">
                                        </ul>
                                    </div>
                                </td>
                            </tr>
 ...
 ******************************************************-->
        ...
        <section class="slide_menu">
            <div id="slide-in-share" class="slide-in-share">
                <a id="slide-in-handle" class="slide-in-handle" href="#"><span class="txt_middle"><spring:message code="global.lbl.talkPlan" /><!-- 화술방안 --></span></a>
                    <div class="table_form">
                    <textarea id="talkPlan" name="talkPlan" rows="3" cols="" disabled class="form_textarea form_disabled"></textarea>
                        <%-- <table>
                            <caption></caption>
                            <colgroup>
                                <col style="width:10%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="7">
                                        <textarea rows="3" cols="" disabled class="form_textarea form_disabled"></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table> --%>
                  ...
                  ******************************************************/
                   ...
                   */
                   $(document).on("click", ".linkCust", function(e){
                        ...
                        console.log("dataItem.custNo:"+dataItem.custNo)
                ...
                $(document).ready(function() {
                    ...
                    $("#btnCallCenterSave").kendoButton({
                        click:function(e){
                            ...
                            if (validator.validate()) {
                                ...
                                $.ajax({
                                    url:"<c:url value='/crm/cal/callCenter/updateCallCenterActionCampaign.do' />",
                    ...
                    $("#grid01").kendoExtGrid({
                        dataSource:{
                             transport:{
                                read:{
                                    url:"<c:url value='/crm/cal/callCenter/selectCallCenterActionCampaigns.do' />"
                                }
                        ...
                        ,change:function(e){
                            ...
                            if ( dms.string.isNotEmpty(callSeq) ) {
                                var param = {"sCallSeq":callSeq};
                                $.ajax({
                                        url:"<c:url value='/crm/cal/callCenter/selectCallCenterActionCampaignByKey.do' />"
                                        ...
                                        $.ajax({
                                            ...
                                            if ( rows.length > 0 ) {
                                                $.each(rows, function(index, row) {
                                                    result += '<li><a onclick=\'dms.fileManager.download("'+row.fileDocNo+'","'+row.fileNo+'")\' href=\'javascript:;\'><span class="k-tool-icon k-insertFile"></span><span class="file_name">'+row.fileNm+'</span></a></li>';
                                                });
                     ...
                     ******************************************************/
                     ...
                     $("#haveCarGrid").kendoExtGrid({
                         dataSource:{
                             transport:{
                                 read:{
                                     url:"<c:url value='/crm/cal/callCenter/selectCampaignHaveCar.do' />"
                                 }
                                 ,parameterMap:function(options, operation) {
                                     if (operation === "read") {
                     ...
                     $("#lbrGrid").kendoExtGrid({
                         dataSource:{
                             transport:{
                                 read:{
                                     url:"<c:url value='/crm/cal/callCenter/selectCampaignRepairOrders.do' />"
                                     ,dataType:"json"
                                     ,type:"POST"
                                     ,contentType:"application/json"
                                 }
                    ...
                    $("#msgHistoryGrid").kendoExtGrid({
                        dataSource:{
                            transport:{
                                read:{
                                    url:"<c:url value='/crm/cal/callCenter/selectCampaignMsgHistorys.do' />"
                                },
                                parameterMap:function(options, operation) {
                                    if (operation === "read") {
                    ...
                    $("#salesOpptGrid").kendoExtGrid({
                        dataSource:{
                            transport:{
                                read:{
                                    url:"<c:url value='/crm/cal/callCenter/selectCampaignSalesOpptMgmts.do' />"
                                }
                                ,parameterMap:function(options, operation) {
                                    if (operation === "read") {
