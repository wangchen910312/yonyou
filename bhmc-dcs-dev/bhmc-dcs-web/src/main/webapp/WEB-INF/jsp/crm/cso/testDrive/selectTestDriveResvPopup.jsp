            ...
            <tbody id="tdrvInputForm">
                <tr>
                    ...
                    <td class="required_area">
                        <input id="hpNo" name="hpNo" class="form_input numberic" data-json-obj="true" maxlength="14" required data-name="<spring:message code="global.lbl.hpNo" />" data-bind="value:hpNo" />
                    </td>
                    <th scope="row"><span class="bu_required"><spring:message code="global.lbl.tdrvDt" /></span></th><!-- 시승일시 -->
                    <td class="required_area">
                        <input id="resvDt" name="start" class="form_datetimepicker" data-json-obj="true" required type="date" data-format="<dms:configValue code='dateFormat' /> HH:mm" data-name="<spring:message code="global.lbl.tdrvDt" />" data-bind="value:resvDt" />
                    </td>
                </tr>
                <tr>
                    <th scope="row"><span class="bu_required"><spring:message code="crm.lbl.tdrvHmCd" /></span></th><!-- 시승시간 -->
                    <td class="required_area">
                        <input id="tdrvHmCd" name="tdrvHmCd" class="form_comboBox" data-json-obj="true" required data-name="<spring:message code="crm.lbl.tdrvHmCd" />" data-bind="value:tdrvHmCd" />
                    </td>
                    ...
                    <td class="required_area">
                        ...
                        <input type="hidden" id="tdrvVinNo" name="tdrvVinNo" data-json-obj="true" required data-name="<spring:message code="crm.lbl.carId" />" data-bind="value:tdrvVinNo" />
                    </td>
                    <th scope="row"><span class="bu_required"><spring:message code="crm.lbl.tdrvClineCd" /></span></th><!-- 시승노선 -->
                    <td class="required_area">
                        <input id="tdrvClineCd" name="tdrvClineCd" class="form_comboBox" data-json-obj="true" style="width:60%" required data-name="<spring:message code="crm.lbl.tdrvClineCd" />" data-bind="value:tdrvClineCd" />
                ...
                <tr>
                    ...
                    <td class="readonly_area">
                        ...
                        <input type="hidden" id="scId" name="scId" data-json-obj="true" required data-name="<spring:message code="crm.lbl.scId" />" data-bind="value:scId" />
                    </td>
                    <th scope="row"></th>
                    <td></td>
                </tr>
