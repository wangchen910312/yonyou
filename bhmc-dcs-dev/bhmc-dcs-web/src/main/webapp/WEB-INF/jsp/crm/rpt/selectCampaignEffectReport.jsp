        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th scope="row"><spring:message code='global.lbl.campaignDt' /></th> <!-- 캠페인 일자 -->
                    <td>
...
function subTotalStatusCall(){
    ...
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=crm/report/selectCampaignEffectReport.cpt' />&op=view";
    var param = "";
