    ...
    $("#btnSave").kendoButton({
        ...
        , click:function(e){
            ...
            */
            ...
            console.log(JSON.stringify({"insertTargetVO":saveData}));
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
          /*  {title:"<spring:message code='global.lbl.no' />", width:60, sortable:false
           ...
           ,{field:"custNo", title:"<spring:message code='global.lbl.custNo' />"}// 고객번호
           ,{field:"custNm", title:"<spring:message code='global.lbl.custNm' />"}// 고객명
           ,{field:"telNo", hidden:true}// 전화번호
           ,{field:"hpNo", title:"<spring:message code='global.lbl.cellphone' />"}// 휴대폰
           ,{field:"emailNm", title:"<spring:message code='global.lbl.emailNm' />"}// 이메일
