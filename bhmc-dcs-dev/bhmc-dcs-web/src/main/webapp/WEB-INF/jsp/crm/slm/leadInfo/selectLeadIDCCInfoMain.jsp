...
<%@taglib prefix="dms" uri="/WEB-INF/tlds/taglibs-dms"%>
            ...
            <section class="group">
                <div class="header_area">
                    <h1 class="title_basic"><spring:message code='crm.menu.idccLeadMng' /></h1> <!-- 리드정보 -->
                    <div class="btn_right">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="row"><spring:message code="global.lbl.callPrsNm" /><!-- 콜업무담당자 --></th>
                                <td>
                                    <input id="sPrsnId" name="sPrsnId" class="form_comboBox"  data-json-obj="true" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form_float">
                                        <div class="date_left">
                                            <input id="sNextCallDtFrom" name="sNextCallDtFrom" class="form_datepicker" data-json-obj="true" />
                                            <span class="txt_from">~</span>
                                        </div>
                                        <div class="date_right">
                                            <input id="sNextCallDtTo" name="sNextCallDtTo" class="form_datepicker" data-json-obj="true" />
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="hpNo" name="hpNo" type="tel" class="form_input numberic" data-type="mobile" maxlength="20" data-json-obj="true" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="telNo" name="telNo" type="text" class="form_input numberic" data-type="tel" maxlength="20" data-json-obj="true" />
                                </td>
                            ...
                            <tr>
                                <th scope="row"><spring:message code='global.lbl.callPrsNm' /></th> <!-- 담당자 -->
                                <td>
                                    <input id="prsnId" name="prsnId" type="hidden" value="" data-json-obj="true" />
                                    <div class="form_search" >
                                        <input id="prsnNm" name="prsnNm" class="form_input form_readonly" readonly />
 ...
 ******************************************************-->
                    ...
                    <!-- 판매기회
                    <div id="saleOptyTabDiv">
                        <section class="group">
                          <div class="header_area">
                              <h2 class="title_basic"><spring:message code="global.lbl.saleOpty" /></h2>
                              <div class="btn_right">
                                  <button class="btn_xs" id="btnSearchSalesOppt" ><spring:message code="global.btn.search" /></button>
                              </div>
                          </div>
                          <div class="table_grid">
...
*************************************************************/
    ...
    // 통화상태(검색).   callStatCdList
    $("#sCallStatCd").kendoExtDropDownList({
        dataTextField:"cmmCdNm"
        , dataValueField:"cmmCd"
        , optionLabel:" "
        , dataSource:callStatCdList
    ...
    $("#sNextCallDtFrom").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        //,value:"${sysDate}"
        ,dateValidMessage:"<spring:message code='global.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
    });

    $("#sNextCallDtTo").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        //,value:"${sysDate}"
        ,dateValidMessage:"<spring:message code='global.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
    });
    ...
    /*
    $("#nextCallDt").kendoExtMaskedDatePicker({
...
/*
    ...
    */
    ...
    var custInfoTabUrl = "<c:url value='/crm/cif/customerInfo/selectCustomerInfoMain.do?custNo=' />";
...
*************************************************************/
    ...
    //버튼 - 담당자
     ...
     $("#btnLeadDtlSearch").click(function(){
         ...
         param["sLeadTp"] = "IDCC";  // COMMON:일반리드, IDCC:IDCC리드
         ...
         $.ajax({
             ...
             if (result.total >= 1) {
                 ...
                 $("#opptNo").val(result.data[0].opptNo);
                 $("#remark").val(result.data[0].remark);
                 $("#prefCommNo").val(result.data[0].prefCommNo);
                 ...
                 if ($("#callCnt").val() >= 3) {
                     //$("#callHpNo").attr('readonly', true);
                     //$("#regUrl").attr('readonly', true);
                     //$("#callRemark").attr('readonly', true);

                     //$("#callHpNo").addClass('form_readonly');
                     //$("#regUrl").addClass('form_readonly');
                     //$("#callRemark").addClass('form_readonly');

                     //$("#callStatCd").data("kendoExtDropDownList").enable(false);
                     $("#nextCallDt").data("kendoDateTimePicker").enable(false);
                 } else {
                     $("#nextCallDt").data("kendoDateTimePicker").enable(true);
                 }
     ...
     $("#btnSearchReset").kendoButton({
         click:function(e) {
             ...
             $("#sNextCallDtFrom").data("kendoExtMaskedDatePicker").value("");
             $("#sNextCallDtTo").data("kendoExtMaskedDatePicker").value("");
         }
     });
    ...
    $("#btnVisitLink").kendoButton({
        click:function(e) {
            ...
            //window.parent._createOrReloadTabMenu("<spring:message code='crm.menu.visitCustomer' />","<c:url value='/crm/cfw/visitCustomer/selectVisitCustomerMain.do' />?custNo="+custNo+"&leadNo="+leadNoo, "VIEW-I-10235"); //내방예약
    ...
    $("#btnSomSave").kendoButton({
        click:function(e){
            ...
            if( dms.string.isNotEmpty($("#opptNo").val())) {
                // 판매기회가 이미 생성되어 있습니다.
     ...
     $("#btnLeadSave").kendoButton({
         click:function(e) {
             ...
             $.ajax({
                 url:"<c:url value='/crm/slm/leadInfo/multiIDCCLeads.do' />"
...
*************************************************************/
         ...
         transport:{
             ...
             ,parameterMap:function(options, operation) {
                 if (operation === "read") {
                     ...
                     var sNextCallDtFrom = $("#sNextCallDtFrom").data("kendoExtMaskedDatePicker").value();
                     var sNextCallDtTo = $("#sNextCallDtTo").data("kendoExtMaskedDatePicker").value();
                     ...
                     if ( (dms.string.isNotEmpty(sNextCallDtFrom) && dms.string.isEmpty(sNextCallDtTo)) ||
                             (dms.string.isEmpty(sNextCallDtFrom) && dms.string.isNotEmpty(sNextCallDtTo))
                     ){
                         dms.notification.warning("<spring:message code='crm.lbl.nextCallDt' var='returnMsg' /><spring:message code='global.info.chkSelectItemMsg' arguments='${returnMsg}' />");
                         return false;
                     }
                     ...
                     params["sNextCallDtFrom"] = sNextCallDtFrom;
                     params["sNextCallDtTo"] = sNextCallDtTo;
             ...
             errors:"error"
                 ...
                 ,model:{
                     ...
                     ,fields:{
                         ...
                         ,prefCommNo:{type:"string", editable:false}
     ...
     ,columns:[
                  ...
                  ,{field:"nextCallDt", title:"<spring:message code='crm.lbl.nextCallDt' />", width:150, attributes:{"class":"ac"}
                      , format:"{0:<dms:configValue code='dateFormat' /> HH:mm}"
                  }
                  ...
                  ,{field:"prsnNm", title:"<spring:message code='global.lbl.callPrsNm' />", width:100, attributes:{"class":"ac"}}
                  ...
                  ,{field:"callStatCd", title:"<spring:message code='global.lbl.callRlt' />", width:100, attributes:{"class":"ac"}
                      ,template:'#if (callStatCd !== "" && callStatCd !== null){# #= callStatCdMap[callStatCd]# #}#'
                  }
                  ,{title:""}
