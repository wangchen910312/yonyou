        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th scope="row"><spring:message code='sal.lbl.saleDt' /></th> <!-- 소매일자 -->
                    <td>
                        <div class="form_float">
                            <div class="date_left">
                                <input id="sSaleFromDt" name="sSaleFromDt" class="form_datepicker ac">
                                <span class="txt_from">~</span>
                            </div>
                            <div class="date_right">
                                <input id="sSaleToDt" name="sSaleToDt" class="form_datepicker ac">
                            </div>
                        </div>
                    </td>
...
$(document).ready(function() {
    ...
    $("#btnSearch").kendoButton({
        click:function(e){
            ...
            var sSaleFromDt = $("#sSaleFromDt").val();
            var sSaleToDt = $("#sSaleToDt").val();
            var sJoinFromDt = $("#sJoinFromDt").val();
            var sJoinToDt = $("#sJoinToDt").val();
            var sCarlineCd = $("#sCarlineCd").val();

            if(dms.string.isEmpty(sSaleFromDt) || dms.string.isEmpty(sSaleToDt)){
    ...
    //소매일자
    $("#sSaleFromDt").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        ,dateValidMessage:"<spring:message code='ser.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
        ,value:"${fromDt}"
    });

    $("#sSaleToDt").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        ,dateValidMessage:"<spring:message code='ser.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
        ,value:"${toDt}"
    });
    ...
    $("#sSaleFromDt").kendoMaskedTextBox({
        mask:"####-##-##"
    });
    $("#sSaleToDt").kendoMaskedTextBox({
        mask:"####-##-##"
    });
...
function subTotalStatusCall(){
    ...
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=crm/report/selectSalesJoinRateReport.cpt' />&op=view";
    var param = "";

    param += "&sSaleFromDt="+sSaleFromDt;
    param += "&sSaleToDt="+sSaleToDt;
