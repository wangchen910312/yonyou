...
<script type="text/javascript" charset="UTF-8">
    ...
    var crm601List = [{"cmmCd":"", "cmmCdNm":""}]; //VOC 불만의 원인
    var crm602List = [{"cmmCd":"", "cmmCdNm":""}]; //VOC 접수출처
    var crm603List = [{"cmmCd":"", "cmmCdNm":""}]; //VOC 심각성
    var crm604List = [{"cmmCd":"", "cmmCdNm":""}]; //VOC 유형
    var crm605List = [{"cmmCd":"", "cmmCdNm":""}]; //1급 SUB 유형
    var crm606List = [{"cmmCd":"", "cmmCdNm":""}]; //2급 Sub 유형
    var crm607List = [{"cmmCd":"", "cmmCdNm":""}]; //3급 Sub 유형
    var crm608List = [{"cmmCd":"", "cmmCdNm":""}]; //VOC 성향
    var crm615List = [{"cmmCd":"", "cmmCdNm":""}]; //활동 획득 경로 코드
    var crm616List = [{"cmmCd":"", "cmmCdNm":""}]; //처리시한 코드
    var crm617List = [{"cmmCd":"", "cmmCdNm":""}]; //긴급 전화 첫 연결 코드
    var crm618List = [{"cmmCd":"", "cmmCdNm":""}]; //원인 코드
    var crm619List = [{"cmmCd":"", "cmmCdNm":""}]; //긴급구조 만족도 코드
    var crm620List = [{"cmmCd":"", "cmmCdNm":""}]; //승급 원인 코드
    var crm621List = [{"cmmCd":"", "cmmCdNm":""}]; //불만 만족도 코드
    var crm622List = [{"cmmCd":"", "cmmCdNm":""}]; //자료배송상태
    var com020List = [{"cmmCd":"", "cmmCdNm":""}]; //여부
    var crm030List = [{"cmmCd":"", "cmmCdNm":""}]; //고객 및 연계인 관계

    var statList        = [{"cmmCd":"", "cmmCdNm":""}]; //활동상태
    var activeTpList    = [{"cmmCd":"", "cmmCdNm":""}]; //활동유형
    var activeSubTpList = [{"cmmCd":"", "cmmCdNm":""}]; //활동SUB유형
    var activeList      = [{"cmmCd":"", "cmmCdNm":""}]; //활동코드
    ...
    <c:forEach var="obj" items="${crm602List}">
        crm602List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm603List}">
        crm603List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>
    ...
    <c:forEach var="obj" items="${crm605List}">
        crm605List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm606List}">
        crm606List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm607List}">
        crm607List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm608List}">
        crm608List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm615List}">
        crm615List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm616List}">
        crm616List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm617List}">
        crm617List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm618List}">
        crm618List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm619List}">
        crm619List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm620List}">
        crm620List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm621List}">
        crm621List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm622List}">
        crm622List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${com020List}">
        com020List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>

    <c:forEach var="obj" items="${crm030List}">
        crm030List.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>
    ...
    <c:forEach var="obj" items="${activeTpList}">
        activeTpList.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>
    ...
    <c:forEach var="obj" items="${activeSubTpList}">
        activeSubTpList.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>
    ...
    <c:forEach var="obj" items="${activeList}">
        activeList.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}"});
    </c:forEach>
