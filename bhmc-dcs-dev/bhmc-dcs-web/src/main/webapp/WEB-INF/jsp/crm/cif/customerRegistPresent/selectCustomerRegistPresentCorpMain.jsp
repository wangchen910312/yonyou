...
<%@taglib prefix="dms" uri="/WEB-INF/tlds/taglibs-dms"%>
            ...
            <section class="group">
                <div class="header_area">
                    <h1 class="title_basic"><spring:message code="crm.menu.custRegReportCorp" /></h1><!-- 고객등록 현황 -->
                    <div class="btn_right">
			        <dms:access viewId="VIEW-I-12520" hasPermission="${dms:getPermissionMask('READ')}">
                ...
                <div class="table_form" role="search" data-btnid="btnCustSearch">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><spring:message code='crm.lbl.corpNm' /></th><!-- 법인명 -->
                                <td>
                                    <input type="text" id="sCustNm" name="sCustNm" class="form_input" data-json-obj="true">
                                </td>
                                <th scope="row"><spring:message code='global.lbl.telNo' /></th><!-- 대표 전화번호 -->
                                <td>
                                    <input type="text" id="sOfficeTelNo" name="sOfficeTelNo" value="" class="form_input numberic" data-json-obj="true">
                                </td>
                                <th scope="row"><spring:message code='global.lbl.emailNm' /></th><!-- 대표 이메일 -->
                                <td>
...
$(document).ready(function() {
    ...
    $("#customerGrid").kendoExtGrid({
            ...
            transport:{
                ...
                ,parameterMap:function(options, operation) {
                    if (operation === "read") {
                        ...
                        params["sOfficeTelNo"]          = $("#sOfficeTelNo").val();
        ...
        ,columns:[
                    ...
                    , {field:"custNm" , title:"<spring:message code='crm.lbl.corpNm' />",  width:100, attributes:{"class":"ac"}}
                    ...
                    , {field:"officeTelNo"   , title:"<spring:message code='global.lbl.telNo' />", width:120, attributes:{"class":"ac"}}
