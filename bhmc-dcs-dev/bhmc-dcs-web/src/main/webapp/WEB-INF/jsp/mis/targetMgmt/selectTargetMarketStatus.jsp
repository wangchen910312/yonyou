...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-I-12357" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-I-12356" hasPermission="${dms:getPermissionMask('READ')}">
            ...
            <dms:access viewId="VIEW-I-12355" hasPermission="${dms:getPermissionMask('READ')}">
            ...
            <dms:access viewId="VIEW-I-12354" hasPermission="${dms:getPermissionMask('READ')}">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#sMarketStatusYyMm").kendoExtMaskedDatePicker({
            value:"${sysdate}"
           ,start:"year"
           ,depth:"year"
           ,format:"yyyyMM"
        ...
        $("#sMarketStatusProvince").kendoExtDropDownList({
            ...
            ,index:0
            ,select:function(e){
                $("#sMarketStatusCity").data("kendoExtDropDownList").setDataSource([]);
                $("#sMarketStatusCity").data("kendoExtDropDownList").enable(true);

                var dataItem = this.dataItem(e.item);
                if(dataItem.provinceCd == ""){
                    $("#sMarketStatusCity").data("kendoExtDropDownList").enable(false);
                    return false;
                }
        ...
        $("#btnTargetDcptMgmtMarketStatusSearch").kendoButton({
            click:function(e) {
                if($("#sMarketStatusYyMm").data("kendoExtMaskedDatePicker").value() == ''){
                ...
                transport:{
                    ...
                    ,parameterMap:function(options, operation) {
                        if (operation === "read") {
                            ...
                            params["sMarketStatusProvince"] = $("#sMarketStatusProvince").data("kendoExtDropDownList").value();
                            params["sMarketStatusCity"] = $("#sMarketStatusCity").data("kendoExtDropDownList").value();
            ...
            ,columns:[
                ...
                ,{field:"localPossessionRate", title:"<spring:message code='mis.lbl.possessionrate' />", width:250, attributes:{"class":"ac"}
                  ,template:function(dataItem){
                      if(dataItem.localPossessionRate == null || dataItem.localPossessionRate == "" || Number(dataItem.localPossessionRate)==0 ){
                          return "-";
                      }else{
                ...
                ,{field:"localLastMonthContrast",
                    title:"<spring:message code='mis.lbl.lastmonthcontrast' />", width:250, attributes:{"class":"ac"}
                    ,template:function(dataItem){
                        if(dataItem.localLastMonthContrast == null || dataItem.localLastMonthContrast == ""  || Number(dataItem.localLastMonthContrast)==0 ){
                            return "-";
                        }else{
                ...
                ,{field:"localLastYearMonth",
                    title:"<spring:message code='mis.lbl.lastyearmonth' />", width:250, attributes:{"class":"ac"}
                    ,template:function(dataItem){
                        if(dataItem.localLastYearMonth == null || dataItem.localLastYearMonth == ""  || Number(dataItem.localLastYearMonth)==0 ){
                            return "-";
                        }else{
        ...
        $("#detailGrid").kendoExtGrid({
            ...
            ,columns:[
                ...
                ,{field:"marketSungNm", title:"<spring:message code='mis.lbl.provinceNm' />", width:150, attributes:{"class":"ac"}}
                ,{field:"marketCityCd", title:"<spring:message code='mis.lbl.cityCd' />", width:100, attributes:{"class":"ac"}}
                ,{field:"marketCityNm", title:"<spring:message code='mis.lbl.cityNm' />", width:150, attributes:{"class":"ac"}}
