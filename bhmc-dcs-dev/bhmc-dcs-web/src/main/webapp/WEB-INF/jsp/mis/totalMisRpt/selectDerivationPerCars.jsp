...
<%--
    JSP Name : selectDerivationPerCars.jsp
    Description : [DCS] 파생 제품 침투율(차종별)
    author chibeom.song
    since 2017. 1. 11.
    version 1.0
...
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="mis.menu.derivationpercars" /></h1>
        <div class="btn_right">
            <dms:access viewId="VIEW-I-12820" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="table_info table_info_v1">
        <iframe id="iframeDerivationPerCars" name="iframeDerivationPerCars" src="" frameborder="0" scrolling="no" width="100%" height="750"></iframe>
    </div>
</section>
...
function mainCall(){
    var derivationpercarsUrl = "<c:url value='/ReportServer?reportlet=/mis/selectDerivationPerCars.cpt' />";
    $("#iframeDerivationPerCars").attr("src", derivationpercarsUrl);
}
