...
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="mis.menu.kpireportstatus" /></h1>
        <div class="btn_right">
            <dms:access viewId="VIEW-I-12816" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="table_form">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><spring:message code="mis.lbl.custkpi" /></th>
                    <td><input type="text" id="sKpi" name="sKpi" style="width:215px;"></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="table_info table_info_v1">
        <iframe id="iframeKpireportstatus" name="iframeKpireportstatus" src="" frameborder="0" scrolling="no" width="100%" height="750"></iframe>
    </div>
</section>
...
function mainCall(){
    var kpireportstatusUrl = "<c:url value='/ReportServer?reportlet=/mis/selectKpiReportStatus.cpt' />";
    $("#iframeKpireportstatus").attr("src", kpireportstatusUrl);
}
