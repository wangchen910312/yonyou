...
//
//        // 권한 사용자
//        List<UserVO> roleUsers = viewMappingService.selectViewMappingUsersByViewId(Constants.SYS_CD_DLR, "", LoginUtil.getDlrCd(), "READ,UPDATE,SEARCHALL");
...
//
//        // 권한 사용자
//        List<UserVO> roleUsers = viewAuthoritiesService.selectAuthoritiesUsersByRoleId(Constants.SYS_CD_DLR, LoginUtil.getDlrCd(), "ROLE_SC");
//        model.addAttribute("roleUsers", roleUsers);
//
//        // 차종
//        CarInfoSearchVO carInfoSearchVO = new CarInfoSearchVO();
