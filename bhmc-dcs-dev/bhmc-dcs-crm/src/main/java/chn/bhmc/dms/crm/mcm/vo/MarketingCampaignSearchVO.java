...
public class MarketingCampaignSearchVO extends SearchVO {
    ...
    /**
     * @param sCustDlrCd the sCustDlrCd to set
     */
    public void setsCustDlrCd(String sCustDlrCd) {
        this.sCustDlrCd = sCustDlrCd;
    }
    /**
     * @return the sCustDlrCd
     */
    public String getsCustDlrCd() {
        return sCustDlrCd;
    }
    /**
