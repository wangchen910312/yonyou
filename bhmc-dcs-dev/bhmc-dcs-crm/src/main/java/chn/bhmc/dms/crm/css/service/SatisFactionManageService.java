...
public interface SatisFactionManageService {
     ...
     */
    public void multiSatisFactionManages(BaseSaveVO<SatisFactionManageVO> satisFactionManageVO) throws Exception;
     ...
     */
    //public SatisFactionManageVO selectSurveyCdByKey(String sDlrCd, int sSeq) throws Exception;
    public SatisFactionManageVO selectSurveyCdByKey(SatisFactionMobileSearchVO schMobileVO) throws Exception;

    /**
     * 조회 조건에 해당하는 만족도 조사 대상자 총 인원수를 조회한다.
     * @param searchVO - 조회 조건을 포함하는 SatisFactionManageSearchVO
     * @return
     */
    ...
    /**
     * 조회 조건에 해당하는 만족도 조사 대상자 총 정보를 조회한다.
     * @param searchVO - 조회 조건을 포함하는 SatisFactionManageSearchVO
     * @return 조회 목록
     */
    ...
    /**
     * 조회 조건에 해당하는 만족도 조사 현황 총 정보를 조회한다.
     * @param searchVO - 조회 조건을 포함하는 SatisFactionManageSearchVO
     * @return 조회 목록
     */
    public List<SatisFactionManageVO> selectSatisFactionPresentResultsByCondition(SatisFactionManageSearchVO searchVO) throws Exception;
