...
public interface MarketingCampaignDAO {
    ...
    /**
     * 마케팅 캠페인(대상 딜러) 정보를 등록한다.(엑셀 업로드를 통한 데이터 저장시에만 사용)
     * @param MarketingCampaignVO - 마케팅 캠페인
     * @return 등록된 목록수
     */
    public int insertDlr(MarketingCampaignVO activeVO) throws Exception;
     ...
     * @return 삭제 수량
     */
    public int deleteDlr(MarketingCampaignVO activeVO) throws Exception;
