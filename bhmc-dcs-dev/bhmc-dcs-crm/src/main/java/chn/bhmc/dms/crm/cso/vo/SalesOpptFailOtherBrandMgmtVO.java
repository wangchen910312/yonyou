...
/**
 * 판매기회 타브랜드 실패 차량 관리  VO
 *
 * @ClassName   : SalesOpptFailOtherBrandMgmtVO.java
 * @Description : SalesOpptFailOtherBrandMgmtVO
 * @author liu jing
 * @since 2016.12.12.
 * @version 1.0
 * @see
 ...
 *  ===========    =============    ===========================
 *  2016.12.12     liu jing      Created First
 * </pre>
 */
...
public class SalesOpptFailOtherBrandMgmtVO extends BaseVO {
    ...
    **/
    ...
    public String toString() {
        return "SalesOpptFailOtherBrandMgmtVO [seq=" + seq + ", intrCarlineCd=" + intrCarlineCd + ", intrCarlineNm="
                + intrCarlineNm + ", otherBrandCarlineNm=" + otherBrandCarlineNm + ", useYn=" + useYn + ", regUsrId="
