...
@Mapper("testDriveMgmtDAO")
public interface TestDriveMgmtDAO {
     ...
     * @return 조회 상세 정보
     */
    public TestDriveResvVO selectTestDriveMgmtByKey(TestDriveResvSearchVO searchVO);
     ...
     * @return 등록된 목록수
     */
    public int insertTestDriveResv(TestDriveResvVO testDriveResvVO) throws Exception;

    /**
     * 시승 예약 정보를 수정한다.
     * @param testDriveResvVO - 수정할 정보가 담긴 TestDriveResvVO
     * @return 수정된 목록수
     */
    public int updateTestDriveResv(TestDriveResvVO testDriveResvVO) throws Exception;

    /**
     * 시승 예약 정보를 삭제한다.
     * @param testDriveResvVO - 삭제할 정보가 담긴 TestDriveResvVO
     * @return 삭제된 목록수
     */
