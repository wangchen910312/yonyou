...
public class CustomerCareExtrTargetVO extends BaseVO {
    ...
    private  String            activeTpNm;      // 실행유형명
    ...
    /**
     * @return the activeTpNm
     */
    public String getActiveTpNm() {
        return activeTpNm;
    }

    /**
     * @param activeTpNm the activeTpNm to set
     */
    public void setActiveTpNm(String activeTpNm) {
        this.activeTpNm = activeTpNm;
    }
    ...
    public String toString() {
        return "CustomerCareExtrTargetVO [dlrCd=" + dlrCd + ", custCareSeq=" + custCareSeq + ", extrDgreCnt="
                + extrDgreCnt + ", custNo=" + custNo + ", custExtrTermNo=" + custExtrTermNo + ", telNo=" + telNo
                + ", hpNo=" + hpNo + ", wechatId=" + wechatId + ", emailNm=" + emailNm + ", sungNm=" + sungNm
                + ", cityNm=" + cityNm + ", distNm=" + distNm + ", zipCd=" + zipCd + ", extZipCd=" + extZipCd
                + ", addrNm=" + addrNm + ", addrDetlCont=" + addrDetlCont + ", smsSendDt=" + smsSendDt
                + ", smsSendRsltCont=" + smsSendRsltCont + ", callCenSendDt=" + callCenSendDt + ", callCenRsltCont="
                + callCenRsltCont + ", regUsrId=" + regUsrId + ", regDt=" + regDt + ", updtUsrId=" + updtUsrId
                + ", updtDt=" + updtDt + ", custNm=" + custNm + ", regUsrNm=" + regUsrNm + ", activeTpCd=" + activeTpCd
                + ", activeTpNm=" + activeTpNm + ", autoActiveYn=" + autoActiveYn + ", custExtrAutoYn="
                + custExtrAutoYn + ", extrSeq=" + extrSeq + ", smsTmplUserSeq=" + smsTmplUserSeq + "]";
    }
