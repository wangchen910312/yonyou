    ...
    public void multiTargExtractExs(CrmTargExtractSaveVO saveVO, String gsCustExtrTermNo, String gsDlrCd) throws Exception {
        ...
        for(CrmTargExtractVO crmTargExtractVO : obj){
            ...
            if(!"CRM7500102".equals(crmTargExtractVO.getDetlExtrTermCd()) && !"CRM7500105".equals(crmTargExtractVO.getDetlExtrTermCd()) && !"CRM7500106".equals(crmTargExtractVO.getDetlExtrTermCd()) &&
               ...
               !"CRM7500319".equals(crmTargExtractVO.getDetlExtrTermCd()) && !"CRM7500323".equals(crmTargExtractVO.getDetlExtrTermCd()) && !"CRM7500325".equals(crmTargExtractVO.getDetlExtrTermCd()) &&
               !"CRM7500425".equals(crmTargExtractVO.getDetlExtrTermCd()) &&
               ...
               !"CRM7500112".equals(crmTargExtractVO.getDetlExtrTermCd()) && !"CRM7500113".equals(crmTargExtractVO.getDetlExtrTermCd()) && !"CRM7500433".equals(crmTargExtractVO.getDetlExtrTermCd()) &&
               !"CRM7500434".equals(crmTargExtractVO.getDetlExtrTermCd()) ){
