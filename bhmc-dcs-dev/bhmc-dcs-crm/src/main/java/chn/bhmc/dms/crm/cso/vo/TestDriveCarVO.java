...
public class TestDriveCarVO extends BaseVO {
    ...
    public String toString() {
        return "TestDriveCarVO [dlrCd=" + dlrCd + ", pltCd=" + pltCd + ", tdrvVinNo=" + tdrvVinNo + ", useYn=" + useYn
                + ", tdrvCont=" + tdrvCont + ", runDistVal=" + runDistVal + ", regUsrId=" + regUsrId + ", regDt="
                + regDt + ", updtUsrId=" + updtUsrId + ", updtDt=" + updtDt + ", carlineCd=" + carlineCd
                + ", carlineNm=" + carlineNm + ", modelCd=" + modelCd + ", modelNm=" + modelNm + ", carRegNo="
                + carRegNo + ", extColorCd=" + extColorCd + "]";
    }
