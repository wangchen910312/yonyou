 ...
 * </pre>
 *
 * @ClassName   : MembershipPointApprovalCallbackHandler.java
 ...
 *  ===========    =============    ===========================
 *  2016. 7. 5.     Kang Seok Han     최초 생성
 * </pre>
 */

public class MembershipPointApprovalCallbackHandler implements ApprovalCallbackHandler {

    Logger log = LoggerFactory.getLogger(MembershipPointApprovalCallbackHandler.class);
