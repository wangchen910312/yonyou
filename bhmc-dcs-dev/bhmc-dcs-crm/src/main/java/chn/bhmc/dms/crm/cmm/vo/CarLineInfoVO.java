...
public class CarLineInfoVO extends BaseVO {
    ...
    public String toString() {
        return "CarLineInfoVO [seq=" + seq + ", dlrCd=" + dlrCd + ", pltCd=" + pltCd + ", refTableNm=" + refTableNm
                ...
                + modelCd + ", modelNm=" + modelNm + ", extColorCd=" + extColorCd + ", extColorNm=" + extColorNm
                + ", intColorCd=" + intColorCd + ", intColorNm=" + intColorNm + ", flagYn=" + flagYn + ", regUsrId="
