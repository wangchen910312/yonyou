...
public class MembershipPointHisMngController extends HController {
    ...
    /**
     * 포인트 소멸이력 조회및 진행 화면을 출력한다.
     * @return
     */
    @RequestMapping(value = "/crm/dmm/membershipPointHisMng/selectMembershipPointHisMngMain.do", method = RequestMethod.GET)
    public String selectMembershipPointHisMngMain(Model model) throws Exception {
        //로그인 정보 : 딜러코드
        model.addAttribute("dlrCd", LoginUtil.getDlrCd());

        return "/crm/dmm/membershipPointHisMng/selectMembershipPointHisMngMain";
    }
    ...
    public SearchResult selectMembershipPointHisMngs(@RequestBody MembershipPointHisMngSearchVO searchVO) throws Exception {
        ...
        if(searchVO.getsStartDt() != null || searchVO.getsEndDt() != null ){
            ...
            endCal.set(year, month, day+1, 23, 59, 59);
