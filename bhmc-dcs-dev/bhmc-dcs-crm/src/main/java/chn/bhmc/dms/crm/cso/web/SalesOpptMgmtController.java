...
public class SalesOpptMgmtController extends HController {
    ...
    public String selectSalesOpptMgmtMain(Model model
        ...
        // TODO 리드 - 내방에서 판매기회 올경우 관심차 등록 해줘야 하나?
   ...
   public boolean updateTrsfStat(@Validated(Modify.class)@RequestBody SalesOpptMgmtVO saveVO)throws Exception {
       ...
       saveVO.setUpdtUsrId(LoginUtil.getUserId());
       saveVO.setDlrCd(LoginUtil.getDlrCd());        // TODO[이인문] 딜러코드
    ...
    */
     ...
     * @return
     */
    @RequestMapping(value = "/selectSMSPopup.do", method = RequestMethod.GET)
    public String selectSMSPopup(Model model) throws Exception {

        return "/crm/cso/salesOpptMgmt/selectSMSPopup";
    }
