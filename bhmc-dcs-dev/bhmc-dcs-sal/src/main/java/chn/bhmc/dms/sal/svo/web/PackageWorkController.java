...
public class PackageWorkController extends HController {
    ...
    private PackageWorkService packageWorkService;
    ...
    /**
     * 집단판매업무 신청 팝업 상세 내용조회
     * @param searchVO
     * @return
     */
    @RequestMapping(value = "/selectPackageSalesWorkPopupDetail.do", method = RequestMethod.POST)
    @ResponseBody
    public PackageSalesWorkVO selectPackageSalesWorkPopupDetail(@RequestBody PackageSalesWorkSearchVO searchVO) throws Exception {


        return packageWorkService.selectPackageSalesWorkPopupContainsByKey(searchVO);
    }
