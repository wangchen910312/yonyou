...
public interface AskHelpCarDAO {
     ...
     * @throws Exception
     */
    public List<AskHelpCarVO> selectAskHelpCarJudgesExcelByCondition(AskHelpCarSearchVO searchVO) throws Exception;
    ...
    public int deleteConfirmPolicyPopup(AskHelpCarPopupCarVO saveVO) throws Exception;
