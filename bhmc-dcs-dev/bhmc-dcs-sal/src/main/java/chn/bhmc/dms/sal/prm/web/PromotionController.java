...
public class PromotionController extends HController {
    ...
    @ResponseBody
    public SearchResult selectPromotionModel(@RequestBody VehicleSearchVO vehicleSearchVO) throws Exception {

        SearchResult result = new SearchResult();

        result.setData(vehicleSpecModelService.selectVehicleModelListByCondition(vehicleSearchVO));
