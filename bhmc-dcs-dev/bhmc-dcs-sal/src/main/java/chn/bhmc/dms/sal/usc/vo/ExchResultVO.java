...
public class ExchResultVO extends AbstractExcelDataBinder {
    ...
    public void bind(int rowNo, int cellNo, Object value) throws ExcelDataBindingException {
        ...
        try{
            switch(cellNo){
                ...
                //case 12:this.setOcarRcptPublDtS(getDateValue(ExcelDataBinderUtil.toString(value).trim())); break;
                case 12:this.setOcarRcptPublDtS(getDateValue(value)); break;
                case 13:this.setOcarNo(ExcelDataBinderUtil.toString(value).trim()); break;
                case 14:this.setNcarOwnerNm(ExcelDataBinderUtil.toString(value).trim()); break;
                case 15:this.setSsnCrnNo(ExcelDataBinderUtil.toString(value).trim()); break;
                case 16:this.setNcarVinNo(ExcelDataBinderUtil.toString(value).trim()); break;
                case 17:this.setNcarCarlineCd(ExcelDataBinderUtil.toString(value).trim()); break;
                case 18:this.setNcarGradeCd(ExcelDataBinderUtil.toString(value).trim()); break;
                case 19:this.setTmrCd(ExcelDataBinderUtil.toString(value).trim()); break;
                case 20:this.setPayAmt(ExcelDataBinderUtil.toString(value).trim()); break;
                case 21:this.setMatYyMmDt(ExcelDataBinderUtil.toString(value).trim()); break;
                case 22:this.setPayYyMmDt(ExcelDataBinderUtil.toString(value).trim()); break;
            }
        }catch(Exception e){
    ...
    private String getDateValue(Object obj) throws Exception{
    	if(obj == null) {
    		return "";
        }
        if(obj instanceof java.lang.String){
            ...
            return date[0]+gubun+date[1]+gubun+date[2];
        }else{
            return StringUtils.trim(DateUtil.convertToString(obj, "yyyy-MM-dd"));
        }
    }
}
