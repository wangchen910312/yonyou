...
public class DeliveryVO extends BaseVO {
    ...
    private String strNo;                           //번호
    private String strStat;                         //심사상태
    private String dlrNm;                           //딜러이름
    private String sdptCd;                          //사업부코드
    private String sdptNm;                          //사업부명
    private String distOfficeCd;                    //판사처코드
    private String distOfficeNm;                    //판사처명
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date strConfirmDt;                      //심사일자
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date strAskDt;                         //신청일자
