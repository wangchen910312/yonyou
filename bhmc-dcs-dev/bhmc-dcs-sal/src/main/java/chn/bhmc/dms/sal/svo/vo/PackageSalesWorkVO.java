 ...
 */
@ValidDescriptor({
    @ValidField(field="dlrCd"          , mesgKey="gal.lbl.dlrCd")
...
public class PackageSalesWorkVO extends BaseVO{
    ...
    /**
     * @return the evalUsrGrde
     */
    public String getEvalUsrGrde() {
        return evalUsrGrde;
    }

    /**
     * @param evalUsrGrde the evalUsrGrde to set
     */
    public void setEvalUsrGrde(String evalUsrGrde) {
        this.evalUsrGrde = evalUsrGrde;
    }
