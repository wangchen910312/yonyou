...
public class OnLineDlrTransfApprSaveVO extends BaseSaveVO<OnLineDlrTransfApprSaveVO> {
    /**
     * Statements
     * (long)serialVersionUID
     */
    private static final long serialVersionUID = 3357032799116055408L;
    ...
    @Valid
    private ArrayList<OnLineDlrTransfApprVO> list = new ArrayList<OnLineDlrTransfApprVO>();
    ...
    /**
     * @param regDtStr the regDtStr to set
     */
     ...
     * @return the list
     */
    public ArrayList<OnLineDlrTransfApprVO> getList() {
        return list;
    }
    /**
     * @param list the list to set
     */
    public void setList(ArrayList<OnLineDlrTransfApprVO> list) {
        this.list = list;
    }
