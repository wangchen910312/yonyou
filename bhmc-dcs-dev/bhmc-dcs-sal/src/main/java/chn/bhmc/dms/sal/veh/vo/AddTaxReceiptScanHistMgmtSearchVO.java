 ...
 * </pre>
 *
 * @ClassName   : AddTaxReceiptScanHistMgmtSearchVO.java
 * @Description : 기준정보 > 부가세스캔이력관리
 * @author chibeom.song
 * @since 2017. 2. 26.
 * @version 1.0
 * @see
...
public class AddTaxReceiptScanHistMgmtSearchVO extends SearchVO{
    
    private static final long serialVersionUID = -6023274259297438078L;
    
    // 검색조건
    private String langCd;
    private String sUploadStDt;
    private String sUploadEdDt;
     ...
     */
    public String getsUploadStDt() {
        return sUploadStDt;
    }
    /**
     * @param sUploadStDt the sUploadStDt to set
     */
    public void setsUploadStDt(String sUploadStDt) {
        this.sUploadStDt = sUploadStDt;
    }
    /**
     * @return the sUploadEdDt
     */
    public String getsUploadEdDt() {
        return sUploadEdDt;
    }
    /**
     * @param sUploadEdDt the sUploadEdDt to set
     */
    public void setsUploadEdDt(String sUploadEdDt) {
