...
import chn.bhmc.dms.sal.lom.service.DistributorAbnormalInventoryService;
...
@Service("DistributorAbnormalInventoryService")
public class DistributorAbnormalInventoryImpl extends HService implements DistributorAbnormalInventoryService, JxlsSupport{
    ...
    public void initJxlsContext(Context context, HMap params) throws Exception {
        ...
        DistributorAbnormalInventorySearchVO searchVO = new DistributorAbnormalInventorySearchVO();
        ...
        if (StringUtils.isNotEmpty((String)params.get("sGrDtsFrDt"))) {
            searchVO.setsGrDtsFrDt(DateUtil.convertToDate((String)params.get("sGrDtsFrDt")));
        }
        if (StringUtils.isNotEmpty((String)params.get("sSrchToDt"))) {
            searchVO.setsGrDtsToDt(DateUtil.convertToDate((String)params.get("sSrchToDt")));
        }

        List<TpVehicleConditionVO> list = selectDistributorAbnormalInventory(searchVO);
