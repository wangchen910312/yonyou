...
public interface ConfirmWearingVehicleDAO {
    ...
    /**
      ...
      */
    public List<ConfirmWearingVehicleVO> selectConfirmWearingVehicleByCondition(ConfirmWearingVehicleSearchVO searchVO);

    /**
     *  조회 조건에 해당하는  총 갯수를 조회한다.
     */
    public int selectConfirmWearingVehicleByConditionCnt(ConfirmWearingVehicleSearchVO searchVO);
     ...
     * @return
     */
    public int updateConfirmWearingVehicle(ConfirmWearingVehicleVO LocalVO);
    /**
     * 완성차 입고확정 및 확정취소 한다.
     * @param ConfirmWearingVehicleVO
     * @return
     */
    public int updateConfirmWearingVehicle2(ConfirmWearingVehicleVO LocalVO);

    /**
     * 입고확정 팝업  정보를 조회한다.
     */
    public List<ConfirmWearingVehiclePopupVO> selectConfirmWearingVehiclePopup(ConfirmWearingVehicleSearchVO searchVO);
     ...
     * @return
     */
    public int insertConfirmWearingVehicle(ConfirmWearingVehiclePopupVO LocalVO);
    ...
    */
     ...
     */
    public List<ConfirmWearingVehicleVO> retVehicleInfo(ConfirmWearingVehicleSearchVO searchVO);
}
