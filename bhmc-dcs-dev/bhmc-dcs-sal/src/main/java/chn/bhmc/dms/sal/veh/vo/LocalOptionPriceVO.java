...
public class LocalOptionPriceVO extends SearchVO{
    ...
    private String purcPrc;         // 구매가격
    private String salePrc;         // 소매가격
     ...
     * @return the purcPrc
     */
    public String getPurcPrc() {
        return purcPrc;
    }
    /**
     * @param purcPrc the purcPrc to set
     */
    public void setPurcPrc(String purcPrc) {
