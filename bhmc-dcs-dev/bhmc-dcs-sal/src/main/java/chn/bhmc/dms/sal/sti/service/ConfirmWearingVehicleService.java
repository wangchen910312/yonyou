...
public interface ConfirmWearingVehicleService {
     ...
     * @return
     */
	public void updateConfirmWearingVehicle(ConfirmWearingVehicleSaveVO ConfirmWearingVehicleSaveVO) throws Exception;
     ...
     */
    public List<ConfirmWearingVehicleVO> retVehicleInfo(ConfirmWearingVehicleSaveVO saveVO) throws Exception;
