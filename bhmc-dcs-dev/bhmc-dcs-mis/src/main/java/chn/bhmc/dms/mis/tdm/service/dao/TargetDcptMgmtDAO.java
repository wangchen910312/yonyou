...
public interface TargetDcptMgmtDAO {
     ...
     * @return
     */
    public TargetDcptMgmtVO selectTargetDcptMgmtRegByKeyI(@Param("provinceCd") String provinceCd, @Param("cityCd") String cityCd, @Param("regYear") String regYear, @Param("regMonth") String regMonth);
