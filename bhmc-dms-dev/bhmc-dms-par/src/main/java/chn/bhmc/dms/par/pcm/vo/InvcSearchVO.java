 ...
 * </pre>
 *
 * @ClassName   : InvcSearchVO.java
 * @Description : InvcSearchVO.java
 * @author Ju Won Lee
 * @since 2016. 2. 3.
 * @version 1.0
 * @see
...
public class InvcSearchVO extends SearchVO {
    ...
    **/
    ...
    /**
     * @param sGrLocCd the sGrLocCd to set
     */
    ...
    /**
     * @return the sUpdtDtStr
     */
    public String getsUpdtDtStr() {
        return sUpdtDtStr;
    }

    /**
     * @param sUpdtDtStr the sUpdtDtStr to set
     */
    public void setsUpdtDtStr(String sUpdtDtStr) {
        this.sUpdtDtStr = sUpdtDtStr;
    }
