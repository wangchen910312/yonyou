 ...
 * </pre>
 *
 * @ClassName   : StockDDDocNoTableNameStrategy.java
...
public class StockDDDocNoTableNameStrategy implements TableNameStrategy {
    ...
    public String makeTableName(String originalTableName) {
        return originalTableName + LocalDate.now().toString("yyyyMM") + LoginUtil.getDlrCd();
    }
}
