...
@Mapper("safetyStockWeightDAO")
public interface SafetyStockWeightDAO {
     ...
     */
    public SaftyStockWeightVO selectSafetyStockWeightByKey(@Param("dlrCd") String dlrCd, @Param("pltCd") String pltCd) throws Exception;
