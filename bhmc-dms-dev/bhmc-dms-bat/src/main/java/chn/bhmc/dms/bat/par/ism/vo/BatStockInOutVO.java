...
public class BatStockInOutVO {

    /**
     * Statements
     * (long)serialVersionUID
     */
    private static final long serialVersionUID = 4368583548197005878L;
     ...
     * 구매 총 건수
     */
    private double purcTotCnt;

    /**
     * 구매 총 금액
     */
    private double purcTotAmt;

    /**
     * 판매 총 금액
     */
    private double saleTotAmt;

    /**
     * 재고 총 금액
     */
    private double stockTotAmt;
