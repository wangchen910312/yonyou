...
public interface BatInvcDAO {
     ...
     * @return 조회한 송장 헤더 정보
     */
    public BatInvcVO selectInvcByKey(@Param("dlrCd") String dlrCd, @Param("invcDocNo") String invcDocNo) throws Exception;

    /**
     * 조회조건에 해당하는 송장정보를 조회한다.
