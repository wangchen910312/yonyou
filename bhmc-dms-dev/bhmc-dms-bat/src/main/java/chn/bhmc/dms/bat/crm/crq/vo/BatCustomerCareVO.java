...
public class BatCustomerCareVO extends BaseVO {
    ...
    public String toString() {
        return "BatCustomerCareVO [dlrCd=" + dlrCd + ", custCareSeq=" + custCareSeq + ", custCareNm=" + custCareNm
                ...
                + activeTmplIdNm + ", smsResvHm=" + smsResvHm + "]";
    }
