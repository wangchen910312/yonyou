 ...
 * </pre>
 *
 * @ClassName   : ReservationInfoReqBatchJobBean.java
...
public class ReservationInfoReqBatchJobBean extends BaseJobBean {

	@Autowired
	ReservationInfoReqService reservationInfoReqService;
    ...
    protected void executeJob(JobExecutionContext context) throws JobExecutionException {
        ...
        try{
            reservationInfoReqService.insertReservationReq(day);
        }catch(Exception e){
