...
public class BatMvtDocItemVO extends BaseVO {
     ...
     */
    private static final long serialVersionUID = 3823422027828142084L;
	 ...
	 * 출고창고코드
	 **/
	private String frStrgeCd;

	/**
	 * 입고창고코드
	 **/
	private String toStrgeCd;
	 ...
	 * 취소수불문서라인번호
	 **/
	private int cancMvtDocLineNo = 0;
	 ...
	 * 표준단가
	 **/
	private Double stdPrc = 0.0;

	/**
	 * 표준금액
	 **/
	private Double stdAmt = 0.0;

	/**
	 * 판매단가
	 **/
	private Double salePrc = 0.0;
     ...
     * 판매단가(세금미포함)
     **/
    private Double saleTaxDdctPrc = 0.0;

    /**
     * 판매금액(세금미포함)
     **/
    private Double saleTaxDdctAmt = 0.0;
	 ...
	 * 구매단가(세금미포함)
	 **/
	private Double purcTaxDdctPrc = 0.0;

	/**
	 * 구매금액
	 **/

	private Double purcAmt = 0.0;

	/**
	 * 구매금액(세금미포함)
	 **/

	private Double purcTaxDdctAmt = 0.0;
    ...
    private Double mmGrItemCnt = 0.0;

    /**
     * 당월 입고 수량
     **/

    private Double mmGrItemSum = 0.0;

    /**
     * 당월 출고 건
     **/
    private Double mmGiItemCnt = 0.0;

    /**
     * 당월 출고 수량
     **/
    private Double mmGiItemSum = 0.0;

    /**
     * 3개월 입고 건
     **/

    private Double mm3GrItemCnt = 0.0;

    /**
     * 3개월 입고 수량
     **/
    private Double mm3GrItemSum = 0.0;

    /**
     * 3개월 출고 건
     **/
    private Double mm3GiItemCnt = 0.0;

    /**
     * 3개월 출고 수량
     **/
    private Double mm3GiItemSum = 0.0;

    /**
     * 6개월 입고 건
     **/
    private Double mm6GrItemCnt = 0.0;

    /**
     * 6개월 입고 수량
     **/
    private Double mm6GrItemSum = 0.0;

    /**
     * 6개월 출고 건
     **/
    private Double mm6GiItemCnt = 0.0;

    /**
     * 6개월 출고 수량
     **/
    private Double mm6GiItemSum = 0.0;
