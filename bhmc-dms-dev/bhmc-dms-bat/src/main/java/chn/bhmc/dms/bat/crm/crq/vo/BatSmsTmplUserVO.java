...
public class BatSmsTmplUserVO extends BaseVO {
     ...
     */
    public void setTargCustSeq(String targCustSeq) {
    ...
    public String toString() {
        return "BatSmsTmplUserVO [seq=" + seq + ", custNo=" + custNo + ", custNm=" + custNm + ", hpNo=" + hpNo
                + ", refKeyNm=" + refKeyNm + ", regUsrId=" + regUsrId + ", regDt=" + regDt + ", updtUsrId=" + updtUsrId
                + ", updtDt=" + updtDt + ", targCustSeq=" + targCustSeq + "]";
    }
