...
public class LaborCodeDetailVO extends AbstractExcelDataBinder {
    ...
    /**
     * @param dstinCdNm the dstinCdNm to set
     */
    public void setDstinCdNm(String dstinCdNm) {
        this.dstinCdNm = dstinCdNm;
    }

    /**
     * @return the dstinCdNm
     */
    public String getDstinCdNm() {
        return dstinCdNm;
    }
