...
public class CampaignSearchVO extends SearchVO{
    ...
    /**
     * 주최코드  (CRM)법인 : 01 , 딜러 : 02
     */
    private String sHostCd;
     ...
     * 录入人id
     */
    private String sRegUseId;
    
    
    
    
    public String getsRegUseId() {
		return sRegUseId;
	}

	public void setsRegUseId(String sRegUseId) {
		this.sRegUseId = sRegUseId;
	}
