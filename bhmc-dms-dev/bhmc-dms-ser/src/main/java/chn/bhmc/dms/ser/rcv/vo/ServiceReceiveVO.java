...
public class ServiceReceiveVO extends BaseVO {
    ...
    **/
    ...
    private String roRegUsrId;
    
    
    
    public String getRoRegUsrId() {
		return roRegUsrId;
	}

	public void setRoRegUsrId(String roRegUsrId) {
		this.roRegUsrId = roRegUsrId;
	}
    ...
    /**
     * @param dlrRoTp the dlrRoTp to set
     */
