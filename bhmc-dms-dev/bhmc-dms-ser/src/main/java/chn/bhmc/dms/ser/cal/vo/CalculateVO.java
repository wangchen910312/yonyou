...
public class CalculateVO extends BaseVO {
    ...
    **/
     ...
     * 卡券面额
     */
    private Double cardDeno;
    /**
     * 索赔金额
     */
    private Double claimAmo;
    /**
     * 调整项
     */
    ...
    /**
     * 卡券是否已核销 Y 代表已经核销 空代表未核销
     */
    private String couponWrite;
    /**
     * 卡券是否已反核销 Y 代表已反销售 空代表未反核销
     */
    private String couponVoid;
    
   //LAN_BIN_CARD_NO 卡券号 贾明 2020-6-3
    private String  lanBinCardNo;
    // LAN_BIN_CARD_EFFE_DT 卡券是有效期 贾明 2020-6-3
    @JsonDeserialize(using=JsonDateDeserializer.class)
	...
	public Double getCardDeno() {
		return cardDeno;
	}

	public void setCardDeno(Double cardDeno) {
		this.cardDeno = cardDeno;
	}

	public Double getClaimAmo() {
		return claimAmo;
	}

	public void setClaimAmo(Double claimAmo) {
		this.claimAmo = claimAmo;
	}
	...
	public String getCardUseNoti() {
		return cardUseNoti;
	}

	public void setCardUseNoti(String cardUseNoti) {
		this.cardUseNoti = cardUseNoti;
	}
