...
public interface FreeServicePartDAO {
     ...
     * 면비부품 인터페이스 등록
     *
     * @param sanbaoVO -면비부품 인터페이스 삭제 정보를 포함하는 sanbaoVO
     * @return bindingResult
     * @throws Exception
     */
    public int insertFreeServicePartIf(FreeServicePartVO freeServicePartVO) throws Exception;
     ...
     * @throws Exception
     */
    public int deleteFreeServicePartIf(FreeServicePartVO freeServicePartVO) throws Exception;
