...
public class ClaimReqVO extends BaseVO{
    ...
    **/
    ...
    /**
     * @return the claimOrgStatCd
     */
    public String getClaimOrgStatCd() {
        return claimOrgStatCd;
    }

    /**
     * @param claimOrgStatCd the claimOrgStatCd to set
     */
    public void setClaimOrgStatCd(String claimOrgStatCd) {
        this.claimOrgStatCd = claimOrgStatCd;
    }
    ...
    /**
     * @return the claimOrgReqDt
     */
    public Date getClaimOrgReqDt() {
        return claimOrgReqDt;
    }

    /**
     * @param claimOrgReqDt the claimOrgReqDt to set
     */
    public void setClaimOrgReqDt(Date claimOrgReqDt) {
        this.claimOrgReqDt = claimOrgReqDt;
    }
