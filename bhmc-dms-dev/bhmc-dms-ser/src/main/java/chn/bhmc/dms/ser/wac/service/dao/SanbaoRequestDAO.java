 ...
 * </pre>
 *
 * @ClassName   : SanbaoRequestDAO.java
 * @Description : 삼보 요청에 관한 데이터처리 매퍼 클래스
 * @author Kwon Ki Hyun
 * @since 2016. 3. 21.
 * @version 1.0
 * @see
 ...
 * </pre>
 */
@Mapper("sanbaoRequestDAO")
public interface SanbaoRequestDAO {
    ...
    */
     ...
     * @throws Exception
     */
    public int insertSanBaoRequestToIfRollBack(SanbaoVO sanbaoVO) throws Exception;
    ...
    * 삼보요청  헤더  I/F 정보 등록
    *
    * @param sanbaoVO - 삼보요청  헤더  I/F 정보 등록  sanbaoVO
    * @return bindingResult
    * @throws Exception
    */
   public int insertSanbaoRequestsIf(SanbaoVO sanbaoVO) throws Exception;

   /**
    *
    * 삼보요청  부품  I/F 정보 등록
    *
    * @param sanbaoVO - 삼보요청  부품  I/F 정보 등록
    * @return bindingResult
    * @throws Exception
    */
   public int insertSanbaoRequestPartsIf(SanbaoVO sanbaoVO) throws Exception;
     ...
     * 삼보요청  상태 정보
     *
     * @param sanbaoVO - 삼보요청  상태 정보
     * @return bindingResult
     * @throws Exception
     */
    public String selectSanbaoRequestStatCdByKey(SanbaoVO sanbaoVO) throws Exception;
