...
public class BayManageVO extends BaseSaveVO<Object> {
	...
	BaseSaveVO<BayMasterVO> bayMasterListVO;
    ...
    public BaseSaveVO<BayMasterVO> getBayMasterListVO() {
        return bayMasterListVO;
    }

    public void setBayMasterListVO(BaseSaveVO<BayMasterVO> bayMasterListVO) {
        this.bayMasterListVO = bayMasterListVO;
    }
