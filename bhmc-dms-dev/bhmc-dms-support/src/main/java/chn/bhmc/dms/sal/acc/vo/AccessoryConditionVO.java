 ...
 * </pre>
 *
 * @ClassName   : AccessoryConditionVO
 * @Description : 경품판매현황 VO
...
public class AccessoryConditionVO extends BaseVO{
    /**
     * Statements
     * (long)serialVersionUID
     */
    private static final long serialVersionUID = -3903436981637982438L;
    ...
    private  String           contractCustTpNm;
    ...
    /**
     * @return the goodsTpNm
     */
    public String getGoodsTpNm() {
        return goodsTpNm;
    }

    /**
     * @param goodsTpNm the goodsTpNm to set
     */
    public void setGoodsTpNm(String goodsTpNm) {
        this.goodsTpNm = goodsTpNm;
    }
    ...
    /**
     * @return the contractCustTpNm
     */
    public String getContractCustTpNm() {
        return contractCustTpNm;
    }

    /**
     * @param contractCustTpNm the contractCustTpNm to set
     */
    public void setContractCustTpNm(String contractCustTpNm) {
        this.contractCustTpNm = contractCustTpNm;
    }
    ...
    /**
     * @return the eqipPrsnNm
     */
    public String getEqipPrsnNm() {
        return eqipPrsnNm;
    }

    /**
     * @param eqipPrsnNm the eqipPrsnNm to set
     */
    public void setEqipPrsnNm(String eqipPrsnNm) {
        this.eqipPrsnNm = eqipPrsnNm;
    }
    ...
    /**
     * @return the prenSumAmt
     */
    public double getPrenSumAmt() {
        return prenSumAmt;
    }

    /**
     * @param prenSumAmt the prenSumAmt to set
     */
    public void setPrenSumAmt(double prenSumAmt) {
        this.prenSumAmt = prenSumAmt;
    }
