...
public interface BinLocationMasterService {
    ...
    /**
     * 조회 조건에 해당하는 로케이션 마스터 콤보 정보를 조회한다.
     * @param searchVO - 조회 조건을 포함하는 BinLocationMasterSearchVO
     * @return 조회 목록
     */
    public List<BinLocationMasterTreeListVO> selectBinLocationMasterComboListByCondition(BinLocationMasterSearchVO searchVO) throws Exception;
