 ...
 * </pre>
 *
 * @ClassName   : MembershipGradeMngSearchVO.java
 * @Description : 멤버십 등급정보 조회VO
 * @author Kim Hyun Ho
 * @since 2016. 4. 18.
 * @version 1.0
 * @see
...
public class MembershipGradeMngSearchVO extends SearchVO {

    /**
     * Statements
     * (long)serialVersionUID
     */
    private static final long serialVersionUID = 3360430297185498255L;
    ...
    **/
    ...
    private  int sStdPridMonth; //기준최근
    private  int sGradeOrderNo;//등급순서
    ...
    /**
     * @return the sStdPridMonth
     */
    public int getsStdPridMonth() {
        return sStdPridMonth;
    }

    /**
     * @param sStdPridMonth the sStdPridMonth to set
     */
    public void setsStdPridMonth(int sStdPridMonth) {
        this.sStdPridMonth = sStdPridMonth;
    }
    ...
    /**
     * @return the sGradeOrderNo
     */
    public int getsGradeOrderNo() {
        return sGradeOrderNo;
    }

    /**
     * @param sGradeOrderNo the sGradeOrderNo to set
     */
    public void setsGradeOrderNo(int sGradeOrderNo) {
        this.sGradeOrderNo = sGradeOrderNo;
    }
