...
public class EtcIssueVO extends BaseVO {
    ...
    /**
     * @return the etcAtcTpCd
     */
    public String getEtcAtcTpCd() {
        return etcAtcTpCd;
    }

    /**
     * @param etcAtcTpCd the etcAtcTpCd to set
     */
    public void setEtcAtcTpCd(String etcAtcTpCd) {
        this.etcAtcTpCd = etcAtcTpCd;
    }
