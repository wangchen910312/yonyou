...
public class LtsModelMappingServiceImpl extends HService implements LtsModelMappingService{
     ...
     */
    @Override
    public List<LtsModelMappingVO> selectLtsModelByKey() throws Exception {

        return ltsModelMappingDAO.selectLtsModelByKey();
    }
    ...
    public String selectLtsModelMapping(String vinNo) throws Exception {
        ...
        for(LtsModelMappingVO objVO : selectLtsModelByKey()){
   ...
   /**
    * LTS MODEL CD 존재여부를 파악한다
    * @param searchVO - lts model code
    * @return
    * @throws Exception
    */
   public boolean selectLtsModelExistYn(LtsModelSearchVO searchVO) throws Exception {

       int returnCnt = ltsModelMappingDAO.selectLtsModelExistYn(searchVO);
