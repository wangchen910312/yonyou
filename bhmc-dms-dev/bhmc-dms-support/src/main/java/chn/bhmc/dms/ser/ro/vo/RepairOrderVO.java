     ...
     **/
      ...
      **/
       ...
       **/
       ...
       //需求编号 327 交车确认时提醒客户要在APP端进行确认，服务结算时校验是否已收到APP的确认 JiaMing 2021-3-31 
       private String   custConfirmCd; //01APP确认 02系统确认 空未确认
       private String   custConfirmYn; //是否需要确认Y是 N否 
