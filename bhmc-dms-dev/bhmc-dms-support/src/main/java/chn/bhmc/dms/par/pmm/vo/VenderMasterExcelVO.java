...
public class VenderMasterExcelVO extends AbstractExcelDataBinder {
    ...
    public void bind(int rowNo, int cellNo, Object value) throws ExcelDataBindingException {
        try{
            switch(cellNo){
                case 0:this.setBpCd(ExcelDataBinderUtil.toString(value).trim()); break;
                case 1:this.setBpNm(ExcelDataBinderUtil.toString(value).trim()); break;
                case 2:this.setBpFullNm(ExcelDataBinderUtil.toString(value).trim()); break;
                case 3:this.setContractNo(ExcelDataBinderUtil.toString(value).trim()); break;
                case 4:this.setContractStartDt(ExcelDataBinderUtil.toString(value).trim()); break;
                case 5:this.setOwnRgstNm(ExcelDataBinderUtil.toString(value).trim());  break;
                case 6:this.setPrsnNm(ExcelDataBinderUtil.toString(value).trim());  break;
                case 7:this.setPrsnTelNo(ExcelDataBinderUtil.toString(value).trim()); break;
                case 8:this.setPrsnHpNo(ExcelDataBinderUtil.toString(value).trim()); break;
                case 9:this.setSungNm(ExcelDataBinderUtil.toString(value).trim()); break;
                case 10:this.setDistNm(ExcelDataBinderUtil.toString(value).trim()); break;
                case 11:this.setAddr(ExcelDataBinderUtil.toString(value).trim()); break;
                case 12:this.setZipCd(ExcelDataBinderUtil.toString(value).trim()); break;
