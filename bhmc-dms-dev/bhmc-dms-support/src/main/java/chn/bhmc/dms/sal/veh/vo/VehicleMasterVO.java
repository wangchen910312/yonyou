...
public class VehicleMasterVO extends BaseVO {
    ...
    private String saleAdvUsrNm;                              //  판매고문 유저 이름
    private String ordRegUsrId;      // 주문자
    ...
    private double damt;                                  // 공제금액
    private double damtRate;                              // 공제율
    ...
    private String temp4;                               // 变更类型 2021-04-01 宫荣枢
    ...
    // 绑定发票标识(01.未绑定、02.机动车发票、03.增值税发票)：2021-04-12 gongrs
    ...
    /**
     * @return the saleAdvUsrNm
     */
    public String getSaleAdvUsrNm() {
        return saleAdvUsrNm;
    }
    /**
     * @param saleAdvUsrNm the saleAdvUsrNm to set
     */
    public void setSaleAdvUsrNm(String saleAdvUsrNm) {
        this.saleAdvUsrNm = saleAdvUsrNm;
    }
    /**
    ...
    /**
     * @return the newEngineNo
     */
    public String getNewEngineNo() {
        return newEngineNo;
    }
    /**
     * @param newEngineNo the newEngineNo to set
     */
     ...
     * @return the damtRate
     */
    public double getDamtRate() {
        return damtRate;
    }
    /**
     * @param damtRate the damtRate to set
     */
    public void setDamtRate(double damtRate) {
    ...
    /**
     * @return the oldEngineNo
     */
    public String getOldEngineNo() {
        return oldEngineNo;
    }
    /**
     * @param oldEngineNo the oldEngineNo to set
     */
    public void setOldEngineNo(String oldEngineNo) {
        this.oldEngineNo = oldEngineNo;
    }
