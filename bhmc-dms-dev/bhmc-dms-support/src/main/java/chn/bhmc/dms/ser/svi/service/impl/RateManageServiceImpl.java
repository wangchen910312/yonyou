   ...
   TableIdGenService rateDocNoIdgenService;
    ...
    public void multiRateManages(RateManageSaveVO objVO) throws Exception {
        ...
        for( RateManageVO rateManageVO : objVO.getUpdateList()){
            ...
            //有效开始日期 有效结束日期 String 类型  CRS 75 索赔单价有效期问题调整方案 贾明 2020-4-17 start
            
            String applyStartDtStr = DateUtil.convertToDateString(rateManageVO.getApplyStartDt());
            if("1899-12-31".equals(applyStartDtStr)){
            	applyStartDtStr = "1900-01-01";
            }
            rateManageVO.setApplyStartDtStr(applyStartDtStr);
            String applyEndDtStr = DateUtil.convertToDateString(rateManageVO.getApplyEndDt());
            rateManageVO.setApplyEndDtStr(applyEndDtStr);
           //有效开始日期 有效结束日期 String 类型  CRS 75 索赔单价有效期问题调整方案 贾明 2020-4-17 end
            /** 중복 체크**/
            getDuplicationCheck(rateManageVO);
