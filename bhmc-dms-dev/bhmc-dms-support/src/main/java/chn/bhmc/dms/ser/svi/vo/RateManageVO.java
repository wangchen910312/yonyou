...
@ValidDescriptor({
    ...
    ,@ValidField(field="rpirTp", mesgKey="ser.lbl.lbrTp")
})
public class RateManageVO extends BaseVO {
    ...
    //有效开始日期 String 类型  CRS 75 索赔单价有效期问题调整方案 贾明 2020-4-17
    private String applyStartDtStr;
    
    //有效结束日期 String 类型  CRS 75 索赔单价有效期问题调整方案 贾明 2020-4-17
    private String applyEndDtStr;
	...
	public String getApplyStartDtStr() {
		return applyStartDtStr;
	}

	public void setApplyStartDtStr(String applyStartDtStr) {
		this.applyStartDtStr = applyStartDtStr;
	}

	public String getApplyEndDtStr() {
		return applyEndDtStr;
	}

	public void setApplyEndDtStr(String applyEndDtStr) {
		this.applyEndDtStr = applyEndDtStr;
	}
