...
public class BinLocationMasterServiceImpl extends HService implements BinLocationMasterService {
    ...
    public void multiBinLocationMasters(BaseSaveVO<BinLocationMasterVO> obj) throws Exception {
        ...
        for(BinLocationMasterVO binLocationMasterVO : obj.getDeleteList()){
            ...
            if(StringUtils.isEmpty(binLocationMasterVO.getLocId())){
                lblList[0] = messageSource.getMessage("par.lbl.locId", null, LocaleContextHolder.getLocale());  // 로케이션
                throw processException("par.info.issueCheckMsg", lblList);
            }

            if(StringUtils.isEmpty(binLocationMasterVO.getLocNm())){
            ...
            String sLocCd = "";
            if(StringUtils.isEmpty(binLocationMasterVO.getLocCd())){
                // LOC CD (상위위치ID+위치ID
        ...
        for(BinLocationMasterVO binLocationMasterVO : obj.getInsertList()){
            ...
            searchVO.setsLvlId(binLocationMasterVO.getLvlId());         //lvlId
            searchVO.setsStrgeCd(binLocationMasterVO.getStrgeCd());     //strgrCd
        ...
        for(BinLocationMasterVO binLocationMasterVO : obj.getUpdateList()){
            ...
            binLocationMasterVO.setLocCd(sLocCd);
            binLocationMasterVO.setLocId(sLocCd);
            binLocationMasterVO.setDlrCd(LoginUtil.getDlrCd());
            binLocationMasterVO.setPltCd(LoginUtil.getPltCd());
            binLocationMasterVO.setRegUsrId(LoginUtil.getUserId());
            binLocationMasterVO.setUpdtUsrId(LoginUtil.getUserId());
            ...
            // 로케이션 마스터 카운트 조회.
            if(binLocationMasterDAO.selectBinLocationMasterByConditionCnt(searchVO) == 0){
                if("N".equals(binLocationMasterVO.getDbYn())){
                    // 추가.
                    binLocationMasterDAO.insertBinLocationMaster(binLocationMasterVO);
                }else{
                    ...
                    for(BinLocationMasterVO childBinLocationMasterVO: childBinLocationMasterList){
                        ...
                        saveBinLocationMasterVO.setLvlId(childBinLocationMasterVO.getLvlId());
    ...
    /*
     * @see chn.bhmc.dms.par.pmm.service.BinLocationMasterService#callSpParLocationUpdate(java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, java.lang.String)
     */
    @Override
    public void callSpParLocationUpdate(String prDlrId, String prPltCd, String prStrgeCd, String prLocCd, String prLvlId, String prNewLocId, String prNewLocNm, String prCudType, String prUsrId, String prDebugModeYn) throws Exception {
        // TODO Auto-generated method stub
        binLocationMasterDAO.callSpParLocationUpdate(prDlrId, prPltCd, prStrgeCd, prLocCd, prLvlId, prNewLocId, prNewLocNm, prCudType, prUsrId, prDebugModeYn);
    }
    ...
    public void multiBinLocationMasterItems(BaseSaveVO<BinLocationMasterVO> obj) throws Exception {
        ...
        for(BinLocationMasterVO binLocationMasterVO : obj.getInsertList()){
            ...
            if(StringUtils.isEmpty(binLocationMasterVO.getItemCd())){
    ...
    public int selectBinLocationMasterByItemCdCnt(BinLocationMasterSearchVO searchVO) throws Exception {
        ...
        return binLocationMasterDAO.selectBinLocationMasterByItemCdCnt(searchVO);
    }
    ...
    /*
     * @see chn.bhmc.dms.par.pmm.service.BinLocationMasterService#selectBinLocationMasterComboListByCondition(chn.bhmc.dms.par.pmm.vo.BinLocationMasterSearchVO)
     */
    @Override
    public List<BinLocationMasterTreeListVO> selectBinLocationMasterComboListByCondition(
            BinLocationMasterSearchVO searchVO) throws Exception {
        return binLocationMasterDAO.selectBinLocationMasterComboListByCondition(searchVO);
    }
