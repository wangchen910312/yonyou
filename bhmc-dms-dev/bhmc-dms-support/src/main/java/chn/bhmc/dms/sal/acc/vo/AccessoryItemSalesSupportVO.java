...
/**
 * @ClassName   : AccessoryItemSalesSupportVO
 ...
 *  ===========    =============    ===========================
 *  2017. 5. 12.   LIU JING    최초 생성
 * </pre>
 */
@ValidDescriptor({
    @ValidField(field="dlrCd", mesgKey="sal.lbl.dlrCd")
})
public class AccessoryItemSalesSupportVO extends BaseVO{
    ...
    */
     ...
     * 용품품목 리스트
     */
    List<AccessoryItemSalesItemSupportVO> items = new ArrayList<AccessoryItemSalesItemSupportVO>();
     ...
     * @return the items
     */
    public List<AccessoryItemSalesItemSupportVO> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<AccessoryItemSalesItemSupportVO> items) {
        this.items = items;
    }
     ...
     */
    public void setCupnAmt(int cupnAmt) {
