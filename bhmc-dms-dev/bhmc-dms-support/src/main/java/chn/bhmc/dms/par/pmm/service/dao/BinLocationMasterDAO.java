...
public interface BinLocationMasterDAO {
     ...
     * @return 조회 목록
     */
    public List<BinLocationMasterTreeListVO> selectBinLocationMasterComboListByCondition(BinLocationMasterSearchVO searchVO);
     ...
     * @return 없음
     */
    public void callSpParLocationUpdate(String prDlrId,String prPltCd, String prStrgeCd, String prLocCd, String prLvlId, String prNewLocId, String prNewLocNm, String prCudType, String prUsrId, String prDebugModeYn);
