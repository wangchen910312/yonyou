...
/**
 * @ClassName   : AccessoryItemSalesSearchSupportVO
...
public class AccessoryItemSalesSearchSupportVO extends SearchVO{
    ...
    /**
     * @param sGoodsNm the sGoodsNm to set
     */
    public void setsGoodsNm(String sGoodsNm) {
        this.sGoodsNm = sGoodsNm;
    }

    /**
     * @return the sGoodsNm
     */
    public String getsGoodsNm() {
        return sGoodsNm;
    }
