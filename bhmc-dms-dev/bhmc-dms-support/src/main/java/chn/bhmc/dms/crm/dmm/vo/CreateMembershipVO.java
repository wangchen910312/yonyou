 ...
 * </pre>
 *
 * @ClassName   : CreateMembershipVO.java
 * @Description : 딜러 One Click 회원 가입( 딜러에서 차량을 구매하고 가입하는 경우, 보통 버튼Click 한번으로 가입이 되므로 One Click 회원가입이라 한다.)
 * @author Kim Hyun Ho
 * @since 2016. 7. 26.
 * @version 1.0
 * @see
...
public class CreateMembershipVO extends BaseVO {

    /**
     * Statements
     * (long)serialVersionUID
     */
    private static final long serialVersionUID = 917191899463173191L;
