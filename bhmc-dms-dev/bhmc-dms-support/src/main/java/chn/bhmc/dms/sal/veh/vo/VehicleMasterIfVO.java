...
public class VehicleMasterIfVO {
    ...
    @JsonProperty("OLD_ENGIN_NO")
    private String oldEnginNo;

    @JsonProperty("NEW_ENGIN_NO")
    private String newEnginNo;

    @JsonProperty("REG_DT_CHAR")
    ...
    /**
     * @return the oldEnginNo
     */
    public String getOldEnginNo() {
        return oldEnginNo;
    }

    /**
     * @param oldEnginNo the oldEnginNo to set
     */
    public void setOldEnginNo(String oldEnginNo) {
        this.oldEnginNo = oldEnginNo;
    }

    /**
     * @return the newEnginNo
     */
    public String getNewEnginNo() {
        return newEnginNo;
    }

    /**
     * @param newEnginNo the newEnginNo to set
     */
    public void setNewEnginNo(String newEnginNo) {
        this.newEnginNo = newEnginNo;
    }
    ...
    public static void setSerialVersionUID(long serialVersionUID) {
        VehicleMasterIfVO.serialVersionUID = serialVersionUID;
    }
