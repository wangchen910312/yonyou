...
public class BinLocationMasterController extends HController {
    ...
    public String selectBinLocationDefineMain(Model model) throws Exception{
        ...
        // 로케이션 타입 정보 조회.
        model.addAttribute("locationTpCdList", commonCodeService.selectCommonCodesByCmmGrpCd("PAR006", null, langCd));
        //사용여부
    ...
    /**
     * 로케이션 마스터 콤보 목록 데이터를 조회한다.
     * @param searchVO - 조회 조건을 포함하는 BinLocationMasterSearchVO
     * @return
     */
    @RequestMapping(value = "/par/pmm/binLocationMaster/selectBinLocationMasterComboLists.do", method = RequestMethod.POST)
    @ResponseBody
    public List<BinLocationMasterTreeListVO> selectBinLocationMasterComboLists(@RequestBody BinLocationMasterSearchVO searchVO) throws Exception{
        
        searchVO.setsDlrCd(LoginUtil.getDlrCd());
        searchVO.setsPltCd(LoginUtil.getPltCd());
        List<BinLocationMasterTreeListVO> list = new ArrayList<BinLocationMasterTreeListVO>();
        list = binLocationMasterService.selectBinLocationMasterComboListByCondition(searchVO);
     ...
     * @return
     */
    @RequestMapping(value = "/par/pmm/binLocationMaster/callSpParLocationUpdate.do", method = RequestMethod.POST)
    @ResponseBody
    //public boolean callSpParLocationUpdate(@Validated @RequestBody BaseSaveVO<BinLocationMasterVO> binLocationMasterSaveVO, BindingResult bindingResult) throws Exception
    public boolean callSpParLocationUpdate(@Validated @RequestBody BinLocationMasterVO binLocationMasterVO, BindingResult bindingResult) throws Exception
    {
        String prDlrId = null;
        String prPltCd = null; 
        String prStrgeCd = null; 
        String prLocCd = null;
        String prLvlId = null;
        String prNewLocId = null;
        String prNewLocNm = null;
        String prUsrId = null;
        String prCudType = null;
        String prDebugModeYn = "Y";
        
        prDlrId = LoginUtil.getDlrCd();
        prPltCd = LoginUtil.getPltCd();
        prUsrId = LoginUtil.getUserId();
        
        prLvlId = String.valueOf(binLocationMasterVO.getLvlId());
        prStrgeCd = binLocationMasterVO.getStrgeCd();
        prNewLocId = binLocationMasterVO.getLocId();
        prNewLocNm = binLocationMasterVO.getLocNm();
        prLocCd    = binLocationMasterVO.getDbLocCd();
        prCudType  = binLocationMasterVO.getCudType();
        
        binLocationMasterService.callSpParLocationUpdate(prDlrId,prPltCd, prStrgeCd, prLocCd, prLvlId, prNewLocId, prNewLocNm, prCudType, prUsrId, prDebugModeYn);
        return true;
    }
    ...
    public String selectBinLocationMasterMaintenanceMain(Model model) throws Exception{
        ...
        //창고유형
        List<CommonCodeVO> strgeTpList = commonCodeService.selectCommonCodesByCmmGrpCd("COM022", null, langCd);
    ...
    public SearchResult selectBinLocationMasterByItemCd(@RequestBody BinLocationMasterSearchVO searchVO) throws Exception {
        ...
        result.setTotal(binLocationMasterService.selectBinLocationMasterByItemCdCnt(searchVO));
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/par/pmm/binLocationMaster/selectBinLocationMasterItemCombineMain.do")
    public String selectBinLocationMasterItemCombineMain(Model model) throws Exception{
        ...
        return "/par/pmm/binLocationMaster/selectBinLocationMasterItemCombineMain";
    }
