...
public class VehOfCustInfoVO extends BaseVO {
    ...
    private Date expcChkDt;                            /*정비예정일자*/
    private int expcChkRunDistVal;                     /*정비예정주행거리*/
    private String carDispQty;                         /*차량배기량*/
    private String manufactYyMmDt;                     /*제작년월일자*/
    private String ncarDstinCd;                        /*신차구분코드*/
    ...
    private String driverSexCd;                        //운전자성별
    ...
    private String carOwnerSexCd;                      //소유자성별
    private String carOwnerSexNm;                      //소유자성별
    private String carOwnerPurcMngNm;                  //소유자연계인
    ...
    private String incTp;                              /*보험가입아이템 유형 */
    ...
    private int carOwnerSeq;                           /*운전자 고객 seq*/
    private int driverSeq;                             /*방문자 고객 seq*/
    ...
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date sanbaoEndDt;                          //삼보 만료일자

    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date carOwnerRegDt;                        //등록일

    private String carlineYn;
    
    private String pcYn;
    
    private String WarrantyYn;
    ...
    /**
     * @return the driverSexCd
     */
    public String getDriverSexCd() {
        return driverSexCd;
    }
    /**
     * @param driverSexCd the driverSexCd to set
     */
    public void setDriverSexCd(String driverSexCd) {
        this.driverSexCd = driverSexCd;
    }
    /**
     * @return the carOwnerSexCd
     */
    public String getCarOwnerSexCd() {
        return carOwnerSexCd;
    }
    /**
     * @param carOwnerSexCd the carOwnerSexCd to set
     */
    public void setCarOwnerSexCd(String carOwnerSexCd) {
        this.carOwnerSexCd = carOwnerSexCd;
    }


    public String getCarOwnerSexNm() {
        return carOwnerSexNm;
    }
    public void setCarOwnerSexNm(String carOwnerSexNm) {
        this.carOwnerSexNm = carOwnerSexNm;
    }


    public String getCarOwnerPurcMngNm() {
        return carOwnerPurcMngNm;
    }
    public void setCarOwnerPurcMngNm(String carOwnerPurcMngNm) {
        this.carOwnerPurcMngNm = carOwnerPurcMngNm;
    }
    /**
     * @return the cust_cd
     */
    ...
    public Date getCarOwnerRegDt() {
        return carOwnerRegDt;
    }
    public void setCarOwnerRegDt(Date carOwnerRegDt) {
        this.carOwnerRegDt = carOwnerRegDt;
    }
    public Date getSanbaoEndDt() {
        return sanbaoEndDt;
    }
    public void setSanbaoEndDt(Date sanbaoEndDt) {
        this.sanbaoEndDt = sanbaoEndDt;
    }
	public String getCarlineYn() {
		return carlineYn;
	}
	public void setCarlineYn(String carlineYn) {
		this.carlineYn = carlineYn;
	}
