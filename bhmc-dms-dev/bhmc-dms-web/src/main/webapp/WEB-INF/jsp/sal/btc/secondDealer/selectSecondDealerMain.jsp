...
<%@taglib prefix="dms" uri="/WEB-INF/tlds/taglibs-dms"%>
   ...
   <section class="group">
        <div class="header_area">
            ...
            <div class="btn_right">
                <dms:access viewId="VIEW-D-11306" hasPermission="${dms:getPermissionMask('READ')}">
                <button id="btnViewDetail" class="btn_m"><spring:message code='global.btn.detail' /></button>           <!-- 상세 -->
                </dms:access>
                <dms:access viewId="VIEW-D-11305" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <section id="callSecondDealerWindow" class="pop_wrap">
        ...
        <div class="header_area">
            ...
            <div class="btn_right">
                <dms:access viewId="VIEW-D-11304" hasPermission="${dms:getPermissionMask('READ')}">
