...
<div id="resizableContainer">
	<section class="group">
		<div class="header_area">
			...
			<div class="btn_right">
                <dms:access viewId="VIEW-D-11238" hasPermission="${dms:getPermissionMask('READ')}">
                    <button type="button" id="btnCreate" class="btn_m"><spring:message code='global.lbl.registration' /></button>         <!-- 등록 -->
                </dms:access>
                <dms:access viewId="VIEW-D-11237" hasPermission="${dms:getPermissionMask('READ')}">
...
/*
    ...
    $("#sCarlineCd").kendoExtDropDownList({
      ...
      ,select:function(e){
          ...
          $("#sModelCd").data("kendoExtDropDownList").dataSource.data([]);
 ...
 */
    ...
    $("#grid").kendoExtGrid({
       ...
       ,columns:[
           {field:"reqSalNo", title:"<spring:message code='global.lbl.applNumber'/>", width:120, attributes:{"class":"ac"}}       // 신청번호
          ,{field:"atcDstinCd",title:"<spring:message code='sal.lbl.itemTp'/>",width:180,attributes:{"class":"al"}
             ,template:"# if(atcDstinCdObj[atcDstinCd] != null) { # #= atcDstinCdObj[atcDstinCd]# # }#"
          }// 항목
          ...
          ,{field:"approveCd",title:"<spring:message code='global.lbl.statNm'/>" ,width:200
             ,attributes:{"class":"ac"}
          ...
          ,{field:"dlrCd",width:50,  hidden:true}       // 딜러코드
          ,{field:"usrId", hidden:true}       // 사용자ID
          ,{field:"reqSeq", hidden:true}       // 구신청번호
       ]
   });
...
/*
                ...
                ,"sUsrId":sUsrId                    // 사용자id
                ,"sUsrNm":sUsrNm                    // 사용자id
                ,"sReqSeq":sReqSeq                  // 일련번호-구
                ,"sReqSalNo":sReqSalNo              // 일련번호-신 */
                ,"sData":data
