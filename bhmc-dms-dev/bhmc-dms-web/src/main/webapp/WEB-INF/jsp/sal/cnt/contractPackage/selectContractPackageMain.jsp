...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-D-10767" hasPermission="${dms:getPermissionMask('READ')}">
                <button id="btnViewDetail" class="btn_m"><spring:message code='global.btn.detail' /><!-- 상세 --></button>
            </dms:access>
            <dms:access viewId="VIEW-D-10766" hasPermission="${dms:getPermissionMask('READ')}">
                <button id="btnRefresh" class="btn_m btn_new"><spring:message code='global.btn.new' /></button>         <!-- 신규 -->
            </dms:access>
            <dms:access viewId="VIEW-D-10765" hasPermission="${dms:getPermissionMask('READ')}">
...
<form id="contForm" name="contForm" method="POST">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <th scope="row"><span class="bu_required"><spring:message code='global.lbl.contractDt' /></span></th>        <!-- 계약일자 -->
                        <td>
    ...
    <section class="group">
        <div class="header_area">
            ...
            <div class="btn_right">
                <dms:access viewId="VIEW-D-12831" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnCarAdd" class="btn_s"><spring:message code='global.btn.rowAdd' /></button>     <!-- 행추가 -->
                </dms:access>
                <dms:access viewId="VIEW-D-12830" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnCarDel" class="btn_s"><spring:message code='global.btn.rowDel' /></button>     <!-- 행삭제 -->
                </dms:access>
                <dms:access viewId="VIEW-D-12829" hasPermission="${dms:getPermissionMask('READ')}">
...
<span style="display:none">
   ...
   <input id="dlrCd" />
    ...
    <!-- 판매기회번호 -->
    <input id="saleOpptSeq" name="saleOpptSeq" data-json-obj="true" />
...
$(document).ready(function() {
   ...
   */
   ...
   $("#contGrid").kendoExtGrid({
      ...
      ,columns:[
         ...
         ,{field:"grpContractNo", title:"<spring:message code='sal.lbl.grpContractNo' />", width:120}      //그룹번호
         ,{field:"contractDt", title:"<spring:message code='global.lbl.contractDt' />", attributes:{"class":"ac"}, width:100, format:"{0:"+vDtyyyyMMdd+"}"}      //계약일
         ,{field:"contractTp", title:"<spring:message code='global.lbl.contractType' />", attributes:{"class":"ac"}, width:100, template:"#= dms.string.strNvl(contractTpObj[contractTp])#" }    //계약유형
         ,{field:"contractStatCd", title:"<spring:message code='global.lbl.contractStat' />", attributes:{"class":"ac"}, width:100, template:"#= dms.string.strNvl(contractStatCdObj[contractStatCd]) #" }    //계약상태
         ,{field:"contractCustNo", title:"<spring:message code='global.lbl.contractCustNo' />", width:170}             //계약고객번호
         ,{field:"custNm", title:"<spring:message code='global.lbl.custNm' />", attributes:{"class":"al"}, width:120}                    //고객명
         ,{field:"saleEmpNm", title:"<spring:message code='global.lbl.saleEmpNo' />", hidden:true, width:100}    //판매사원번호
         ,{field:"carlineCnt", title:"<spring:message code='sal.lbl.carlineCnt' />", attributes:{"class":"ar"}, width:100, format:"{0:n0}"}    //차종수량
         ,{field:"carCnt", title:"<spring:message code='sal.lbl.carCnt' />", attributes:{"class":"ar"}, width:100, format:"{0:n0}"}            //차량수량
         ,{field:"totSaleAmt", title:"<spring:message code='sal.lbl.payTotAmt' />", attributes:{"class":"ar"}, width:120,format:"{0:n2}"}      //총판매금액
      ]
  });
  ...
  fn_contGridDBclick = function(selectedItem){
      if( selectedItem != null && selectedItem != 'undefined'){
          ...
          if(Number(dms.string.strNvl(selectedItem.saleOpptSeq)) > 0){
