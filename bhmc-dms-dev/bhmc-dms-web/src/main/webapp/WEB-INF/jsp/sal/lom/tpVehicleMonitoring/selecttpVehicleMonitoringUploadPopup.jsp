...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                ...
                ,data:JSON.stringify({"insertList":saveData})
                ,type:'POST'
                ,dataType:'json'
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{field:"vinNo", title:"<spring:message code='global.lbl.vinNum' />",  width:100}            //vin no
            ...
            ,{
                field:"driverTelNo"
               ,title:"<spring:message code='global.lbl.telNo' />"
               ,attributes:{"class":"al"}
               ,width:100
            } //전화번호
            ,{
            ...
            ,{
                field:"dstbCmpDlDt"
               ,title:"<spring:message code='sal.lbl.dstbCmpDlDt' />"
               ,attributes:{"class":"al"}
               ,width:100
