...
<div class="header_area">
    <div class="btn_right">
        <dms:access viewId="VIEW-D-11189" hasPermission="${dms:getPermissionMask('READ')}">
...
<div class="table_info table_info_v1">
    <form id="frmTotalStatus" method="post">
        <iframe id="iframeSubTotalStatus" src="" frameborder="0" scrolling="auto" width="100%" height="610"></iframe>
    </form>
</div>
