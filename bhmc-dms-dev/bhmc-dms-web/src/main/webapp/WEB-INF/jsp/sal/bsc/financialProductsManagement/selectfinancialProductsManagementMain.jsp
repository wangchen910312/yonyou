            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="custTp" id="custTp" type="text" value="" class="form_input" maxlength="10">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="contractAmt" id="contractAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                        <th scope="row"><spring:message code="global.lbl.contractAmtRt" /></th> <!-- 계약금율 -->
                        <td>
                            <input name="contractAmtRate" id="contractAmtRate" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="3">
                        </td>
                        <th scope="row"><spring:message code="global.lbl.advanceReceived" /></th> <!-- 선수금 -->
                        <td>
                            <input name="prepayDlAmt" id="prepayDlAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                        <th scope="row"><spring:message code="global.lbl.advanceReceivedRt" /></th> <!-- 선수율 -->
                        <td>
                            <input name="prepayRate" id="prepayRate" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="3">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><spring:message code="sal.lbl.latepayDlAmt" /></th> <!-- 후불인도금액 -->
                        <td>
                            <input name="latepayDlAmt" id="latepayDlAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                        <th scope="row"><spring:message code="sal.lbl.mmPayAmtRate" /></th> <!-- 월불입금율 -->
                        <td>
                            <input name="mmPayAmtRate" id="mmPayAmtRate" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="3">
                        </td>
                        <th scope="row"><span class="bu_required"><spring:message code="global.lbl.instIntrRate" /></span></th> <!-- 할부이자율 -->
                        <td>
                            <input name="instIntrRate" id="instIntrRate" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="3">
                        </td>
                        <th scope="row"><spring:message code="sal.lbl.remIntrRate" /></th> <!-- 잔가이자율 -->
                        <td>
                            <input name="remIntrRate" id="remIntrRate" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="3">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><spring:message code="global.lbl.hdlgFeeRate" /></th> <!-- 취급수수료율 -->
                        <td>
                            <input name="hdlgFeeRate" id="hdlgFeeRate" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="3">
                        </td>
                        <th scope="row"><span class="bu_required"><spring:message code="global.lbl.hdlgFeeAmt" /></span></th> <!-- 취급수수료금액 -->
                        <td>
                            <input name="hdlgFeeAmt" id="hdlgFeeAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                        <th scope="row"><spring:message code="global.lbl.grteIncaRate" /></th> <!-- 보증보험료율 -->
                        <td>
                            <input name="grteIncaRate" id="grteIncaRate" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="3">
                        </td>
                        <th scope="row"><span class="bu_required"><spring:message code="global.lbl.grteIncaAmt" /></span></th> <!-- 보증보험료금액 -->
                        <td>
                            <input name="grteIncAmt" id="grteIncAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><spring:message code="global.lbl.stampAmt" /></th> <!-- 인지대 -->
                        <td>
                            <input name="stampAmt" id="stampAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                        <th scope="row"><spring:message code="global.lbl.authAmt" /></th> <!-- 공증료 -->
                        <td>
                            <input name="authAmt" id="authAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                        <th scope="row"><spring:message code="global.lbl.cashPrc" /></th> <!-- 현금금액 -->
                        <td>
                            <input name="cashPrc" id="cashPrc" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                        <th scope="row"><spring:message code="sal.lbl.instSbodtAmt" /></th> <!-- 할부부대비용계 -->
                        <td>
                            <input name="instSbodtAmt" id="instSbodtAmt" onfocus="fnOnfocus(this.id);" class="form_numeric ar" maxlength="12">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><spring:message code="global.lbl.account" /></th> <!-- 거래처 -->
                        <td>
                            <input name="bpCd" id="bpCd" type="text" value="" class="form_input" maxlength="20">
                        </td>
...
validator = function() {
    ...
    if( $("#instIntrRate").data("kendoExtNumericTextBox").value() <= 0){
        dms.notification.info("<spring:message code='global.lbl.instIntrRate' var='globalLblInstIntrRate' /><spring:message code='global.info.chkSelectItemMsg' arguments='${globalLblInstIntrRate},' />"); // 할부이자율
        $("#instIntrRate").focus();
        return false;
    }

    if( $("#hdlgFeeAmt").data("kendoExtNumericTextBox").value() <= 0){
        dms.notification.info("<spring:message code='global.lbl.hdlgFeeAmt' var='globalLblHdlgFeeAmt' /><spring:message code='global.info.chkSelectItemMsg' arguments='${globalLblHdlgFeeAmt},' />"); // 취급수수료
        $("#hdlgFeeAmt").focus();
        return false;
    }

    if( $("#grteIncAmt").data("kendoExtNumericTextBox").value() <= 0){
        dms.notification.info("<spring:message code='global.lbl.grteIncaAmt' var='globalLblGrteIncaAmt' /><spring:message code='global.info.chkSelectItemMsg' arguments='${globalLblGrteIncaAmt},' />"); // 보증보험료금액
        $("#grteIncAmt").focus();
        return false;
    }
