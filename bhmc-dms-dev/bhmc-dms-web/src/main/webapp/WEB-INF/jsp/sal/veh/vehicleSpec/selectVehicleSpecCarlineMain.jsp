...
<section class="group">
    ...
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.menu.vehicleSpecCarline" /></h1><!-- VehicleSpec - 차종 -->
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11276" hasPermission="${dms:getPermissionMask('READ')}">
...
$(document).ready(function() {
    ...
    */
    ...
    $("#grid").kendoExtGrid({
        ...
        ,sortable:false
        ,columns:[
            {field:"carlineCd",    title:"<spring:message code='global.lbl.carlineCd' />",    width:50, attributes:{"class":"ac"}} //차종
