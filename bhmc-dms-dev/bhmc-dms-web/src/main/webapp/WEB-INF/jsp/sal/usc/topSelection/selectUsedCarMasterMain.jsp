                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="factory" class="form_comboBox" >
                            </td>
                            <th scope="row"><spring:message code="global.lbl.carNm" /></th><!-- 차량명 -->
                            <td>
                            ...
                            <th scope="row"><spring:message code="global.lbl.vinSts" /></th><!-- 차량상태 -->
                            <td>
                                <input type="text" id="carStatCd" disabled class="form_comboBox form_disabled" data-bind="value:carStatCd">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><spring:message code="global.lbl.vinNum" /></th><!-- VIN NO -->
...
$(document).ready(function() {
    ...
    //상세 - 제조사
    $("#factory").kendoExtDropDownList({
        //dataTextField:"cmmCdNm",
        //dataValueField:"cmmCd",
        dataSource:["", "BMW", "HUYNDAI"]
    });
    ...
    $("#btnSave").kendoButton({
        click:function(e) {
            ...
            $.ajax({
                url:"<c:url value='/sal/usc/carMaster/updateUsedCar.do' />"
    ...
    $("#btnOwnerAdd").kendoButton({
        click:function(e) {
            ...
            if(grid.select().index() == -1){
                ...
                if(chk){
                    dms.notification.info("<spring:message code='global.lbl.add' var='globalLblAdd' /><spring:message code='global.lbl.infoData' var='globalLblInfoData' /><spring:message code='global.info.stInfo' arguments='${globalLblAdd}, ${globalLblInfoData}' />"
                            + "<br />"
        ...
        click:function(e) {
            ...
            if(grid.select().index() == -1){
                ...
                if (grid.gridValidation()){
                    $.ajax({
                        url:"<c:url value='/sal/usc/carMaster/saveUsedCarOwner.do' />"
    ...
    $("#btnDriverSave").kendoButton({
        click:function(e) {
            ...
            if(grid.select().index() == -1){
                ...
                if (grid.gridValidation()){
                    $.ajax({
                        url:"<c:url value='/sal/usc/carMaster/saveUsedCarDriver.do' />"
                        ,data:JSON.stringify(saveData)
                        ,type:'POST'
                        ,dataType:'json'
                        ,contentType:'application/json'
    ...
    $("#grid").kendoExtGrid({
        ...
        ,change:function(e) {
            ...
            if(this.select().length != 0){
                ...
                $.ajax({
                    ...
                    data:JSON.stringify({sCarId:carId}),
                    type:"POST",
                    dataType:"json",
                    contentType:"application/json",
                    error:function(jqXHR,status,error){
        ...
        ,columns:[ {field:"carId"          ,title:"<spring:message code = 'sal.lbl.carId'/>"      ,width:120 ,attributes:{"class":"ac"}}          //CAR ID
                    ...
                    ,{field:"carBrandCd"     ,title:"<spring:message code = 'global.lbl.brand'/>"   ,width:100 ,attributes:{"class":"ac"}}          //브랜드
                    ,{field:"carNm"          ,title:"<spring:message code = 'global.lbl.carNm'/>"   ,width:100 ,attributes:{"class":"al"}}          //차량명
                    ,{field:"carStatCd"      ,title:"<spring:message code = 'global.lbl.vinSts'/>"  ,width:100 ,attributes:{"class":"al"}
                    ...
                    ,{field:"corpCarDstinCd" ,title:"<spring:message code = 'sal.lbl.corpCarYn'/>"  ,width:100 ,attributes:{"class":"al"}
