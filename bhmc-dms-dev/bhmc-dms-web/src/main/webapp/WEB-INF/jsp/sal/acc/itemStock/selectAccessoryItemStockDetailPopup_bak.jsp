...
<section class="pop_wrap">
    ...
    <div class="table_form mt10">
        <table>
            ...
            <tbody>
                <tr>
                    <th scope="row"><spring:message code="sal.lbl.retlAddTaxRate" /><!-- 판매가세금비율 --></th>
                    <td>
                ...
                <tr>
                    ...
                    <th scope="row"><spring:message code="sal.lbl.taxDdctRetlPrc" /><!-- 판매가(세금불포함) --></th>
                    <td>
...
var viewModel = new kendo.observable({
    ...
    ,"pltCd":"${itemStock.pltCd}"                   //플랜트코드
    ,"spyrCd":"${itemStock.spyrCd}"                 //공급상구분
    ,"itemCd":"${itemStock.itemCd}"                 //용품코드
    ,"itemNm":"${itemStock.itemNm}"                 //용품명
