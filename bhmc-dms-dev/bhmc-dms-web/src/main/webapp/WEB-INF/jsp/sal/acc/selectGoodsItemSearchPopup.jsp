...
$(document).ready(function() {
    ...
    if(dms.string.isNotEmpty(options.sPkgItemCd)){
        $("#sPkgItemCd").val(dms.string.strNvl(options.sPkgItemCd));
        $("#tabstrip").data("kendoExtTabStrip").select(1);

    }else if(dms.string.isNotEmpty(options.sGoodsCd)){
        $("#sItemCd").val(dms.string.strNvl(options.sGoodsCd));
        $("#tabstrip").data("kendoExtTabStrip").select(0);
    }
