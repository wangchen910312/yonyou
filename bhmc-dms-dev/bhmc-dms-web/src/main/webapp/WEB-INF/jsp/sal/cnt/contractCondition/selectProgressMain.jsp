                        ...
                        <div class="form_float">
                            <div class="form_left">
                                <div class="form_search">
                                    <input id="vsContractCustNm" class="form_input" />
    ...
    <div id="tabstrip" class="tab_area">
        ...
        <div>
            <div class="table_grid">
                <div id="gridAll" class="resizable_grid"></div>
            </div>
        </div>
        <!--전체 탭 영역 -->
        ...
        <div>
            <div class="table_grid">
                <div id="grid10" class="resizable_grid"></div>
            </div>
        </div>
        <!--계약등록 탭 영역 -->
        ...
        <div>
            <div class="table_grid">
                <div id="grid20" class="resizable_grid"></div>
            </div>
        </div>
        <!--계약생성 탭 영역 -->
        ...
        <div>
            <div class="table_grid">
                <div id="grid50" class="resizable_grid"></div>
            </div>
        </div>
        <!--고객인도 탭 영역 -->
        ...
        <div>
            <div class="table_grid">
                <div id="grid91" class="resizable_grid"></div>
            </div>
        </div>
        <!--계약삭제 탭 영역 -->
        ...
        <div>
            <div class="table_grid">
                <div id="grid92" class="resizable_grid"></div>
            </div>
        </div>
        <!--계약해지 탭 영역 -->
    </div>
...
//고객명 enter
$("#vsContractCustNm").blur(function(e){
    cleanCustCheck();
});

// 고객명 enter
$("#vsContractCustNm").keyup(function(e){
...
function cleanCustCheck(){
    if(dms.string.strNvl($("#vsContractCustNm").val()) != dms.string.strNvl($("#sContractCustNm").val()) ){
        $("#sContractCustNo").val('');
        $("#sContractCustNm").val('');
    }
}
