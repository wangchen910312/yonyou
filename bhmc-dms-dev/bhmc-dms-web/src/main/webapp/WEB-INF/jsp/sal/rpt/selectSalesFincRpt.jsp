...
<%--
    JSP Name : selectSalesFincRpt.jsp
    Description : 금융 보고서
    author chibeom.song
    since 2017. 1. 23.
    version 1.0
...
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.rpt.salesfincrpt" /></h1>
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11198" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="table_info table_info_v1">
        <iframe id="iframeSalesFincRpt" name="iframeSalesFincRpt" src="" frameborder="0" scrolling="auto" width="100%" height="650" class='report'></iframe>
    </div>
</section>
...
function mainCall(){
    var salesFincRptUrl = "<c:url value='/ReportServer?reportlet=/sale/selectSalesFincRpt.cpt' />";
    var param = "";
    ...
    $("#iframeSalesFincRpt").attr("src", salesFincRptUrl + param);
}
