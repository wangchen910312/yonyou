...
<section class="group" style="height:500%" >
    ...
    <div id="tabstrip" class="tab_area tab_iframe">
        ...
        <!-- 가격 상담 능력 분석 -->
        <div class="mt0">
            <iframe id="iframeStatus01" frameborder="0" src="" scrolling="no" width="100%" height="700"></iframe>
        </div>
        <!-- //가격 상담 능력 분석 -->

        <!-- 판매 실적 통계 보고서 -->
        <div class="mt0">
            <iframe id="iframeStatus02" frameborder="0" src="" scrolling="no" width="100%" height="700"></iframe>
        </div>
        <!-- //판매 실적 통계 보고서 -->

        <!-- 영업사원 판매목표 진도보고서 -->
        <div class="mt0">
            <iframe id="iframeStatus03" frameborder="0" src="" scrolling="no" width="100%" height="700"></iframe>
        </div>
        <!-- //영업사원 판매목표 진도보고서 -->

        <!-- 판매 일 보고서 -->
        <div class="mt0">
            <iframe id="iframeStatus04" frameborder="0" src="" scrolling="no" width="100%" height="700"></iframe>
        </div>
        <!-- //판매 일 보고서 -->

        <!-- 판매 주간 보고서 -->
        <div class="mt0">
            <iframe id="iframeStatus05" frameborder="0" src="" scrolling="no" width="100%" height="700"></iframe>
        </div>
        <!-- //판매 주간 보고서 -->

        <!-- 차량판매 업무리포트 -->
        <div class="mt0">
            <iframe id="iframeStatus06" frameborder="0" src="" scrolling="no" width="100%" height="700"></iframe>
        </div>
        <!-- //차량판매 업무리포트 -->
    </div>
    <!-- //탭메뉴 전체 영역 -->
