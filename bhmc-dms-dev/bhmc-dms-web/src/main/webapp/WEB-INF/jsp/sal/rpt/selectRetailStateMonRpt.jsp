...
<%--
    JSP Name : selectRetailStateMonRpt.jsp
    Description : 월간소매 명세서
...
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.rpt.salesretailstatemon" /></h1>
        <div class="btn_right">
    ...
    <div class="table_info table_info_v1">
        <iframe id="iframeRetailStateMonRpt" name="iframeRetailStateMonRpt" src="" frameborder="0" scrolling="auto" width="100%" height="650" class='report'></iframe>
    </div>
</section>
...
function mainCall(){
    var retailMissionMonRptUrl = "<c:url value='/ReportServer?reportlet=/sale/selectRetailStateMonRpt.cpt' />&op=view";
    var param = "";
    ...
    $("#iframeRetailStateMonRpt").attr("src", retailMissionMonRptUrl + param);
}
var now = new Date();
