...
<%--
    JSP Name : selectSalesVehicleStatsRpt.jsp
    Description : 완성차판매리포트 보고서
    author chibeom.song
    since 2017. 1. 23.
    version 1.0
...
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.rpt.salesvehiclestatsrpt" /></h1>
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11227" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="table_info table_info_v1">
        <iframe id="iframeSalesVehicleStatsRpt" name="iframeSalesVehicleStatsRpt" src="" frameborder="0" scrolling="auto" width="100%" height="650" class='report'></iframe>
    </div>
</section>
...
function mainCall(){
    ...
    var salesvehiclestatsrptUrl = "<c:url value='/ReportServer?reportlet=/sale/selectSalesVehicleStatsRpt.cpt' />";
    var param = "";
    ...
    $("#iframeSalesVehicleStatsRpt").attr("src", salesvehiclestatsrptUrl + param);
