...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11234" hasPermission="${dms:getPermissionMask('READ')}">
                <button id="btnCreate" class="btn_m"><spring:message code='global.lbl.registration' /></button>   <!-- 등록 -->
            </dms:access>
            <dms:access viewId="VIEW-D-11233" hasPermission="${dms:getPermissionMask('READ')}">
...
function selectAskHelpCarPopupWindow(data){
    ...
    popupWindow = dms.window.popup({
        ...
        ,width :900  //Q21012900012 DMS代步车申请界面放大 ①政策说明弹窗放大，目前太小显示下维护的内容 jiaMing 2021-2-7
        ,height:600  //sHeight Q21012900012 DMS代步车申请界面放大 ①政策说明弹窗放大，目前太小显示下维护的内容 jiaMing 2021-2-7
        ,resizable:false
        //,modal:true
        ,content:{
...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
       ...
       ,columns:[
          ...
          ,{  //판매담당자명(오더 발행자)
              field:"salePrsnNm"
             ,title:"<spring:message code='sal.lbl.prsNm' />"
             ,width:130
             ,attributes:{"class":"ac"}
          }
          ,{  //연락처
              field:"salePrsnTelNo"
             ,title:"<spring:message code='sal.lbl.telNumber' />"
             ,width:150
             ,attributes:{"class":"ac"}
          }
          ,{  //신청구분
