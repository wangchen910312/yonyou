...
<section class="group">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11020" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_m" id="btnViewDetail" ><spring:message code='global.btn.update' /><!-- 수정 --></button>
            </dms:access>
            <dms:access viewId="VIEW-D-11019" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_m" id="btnConfirm"><spring:message code="sal.btn.evalConfirm" /></button><!-- 심사확정 -->
            </dms:access>
            <dms:access viewId="VIEW-D-11018" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_m" id="btnRequest"><spring:message code="sal.btn.evalRequest" /></button><!-- 심사신청 -->
            </dms:access>
            <dms:access viewId="VIEW-D-11017" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_m btn_new" id="btnReset"><spring:message code="global.btn.new" /></button><!-- 신규 -->
            </dms:access>
            <dms:access viewId="VIEW-D-11016" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_m btn_search" id="btnSearch"><spring:message code="global.btn.search" /></button><!-- 조회 -->
            </dms:access>
            <dms:access viewId="VIEW-D-11015" hasPermission="${dms:getPermissionMask('READ')}">
...
<section id="vehicleDlrExcWindow" class="pop_wrap">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11014" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input id="telNo" name="telNo" class="form_input numberic"  />
                    </td>
                    <th scope="row"><spring:message code="global.lbl.regDt" /></th><!-- 등록일 -->
                    <td>
    ...
    $("#btnSave").kendoButton({
        click:function(e) {
            ...
            if ( dms.string.isEmpty($("#telNo").val())){
                dms.notification.warning("<spring:message code='sal.lbl.telNumer' var='returnMsg' /><spring:message code='global.info.required.field' arguments='${returnMsg}' />");
                $("#telNo").focus();
                return false;
            }
