...
$(document).ready(function() {
    ...
    $("#mainGrid").kendoExtGrid({
       ...
       ,columns:[
          ...
          , {field:"usrNm", title:"<spring:message code='global.lbl.name' />", width:120, attributes:{"class":"ar"}}         // 이름
          , {field:"deptCd", title:"<spring:message code='sal.lbl.deptCd' />", width:100, attributes:{"class":"ar"}}         // 담당업무
          , {field:"pstnCd", title:"<spring:message code='global.lbl.deptNm' />", width:150, attributes:{"class":"ar"}}      // 부서
       ]
   });
