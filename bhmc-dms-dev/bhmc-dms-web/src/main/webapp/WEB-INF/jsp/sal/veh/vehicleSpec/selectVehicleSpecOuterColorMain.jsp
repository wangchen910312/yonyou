...
<section class="group">
    ...
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.menu.vehicleSpecExtClr" /></h1><!-- VehicleSpec - 외장색 -->
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11279" hasPermission="${dms:getPermissionMask('READ')}">
...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            {field:"extColorCd",    title:"<spring:message code='global.lbl.colorCode' />",    width:100,  attributes:{"class":"al"}} //컬러코드
            ,{field:"extColorNm",   title:"<spring:message code='global.lbl.extColorNm' />",   width:180, attributes:{"class":"al"}} //외장색명
            ,{field:"extColorEnNm", title:"<spring:message code='global.lbl.extColorEnNm' />", width:180, attributes:{"class":"al"}} //외장색영문명
            ,{field:"colorTp",      title:"<spring:message code='sal.lbl.colorTp' />",         width:100,  attributes:{"class":"al"}
              ,template:"# if(colorTpMap[colorTp] != null){# #= colorTpMap[colorTp].cmmCdNm# #}#"
             } //색상유형
            ,{field:"twoToneYn",    title:"<spring:message code='sal.lbl.twoToneYn' />",       width:100,  attributes:{"class":"ac"}} //투톤여부
