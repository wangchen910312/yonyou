        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <!-- 20200924 update by tjx 物流评价信息限制在90字内 -->
                        <textarea id="otherCont" name="otherCont" maxlength="90" rows="5" cols="" class="form_textarea"></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        *************************************************************/
        ...
        if(!dms.string.isEmpty(options.strCarStatCd) && dms.string.strNvl(options.strCarStatCd) === "70" ){
            $("#btnConfirm").hide();
        }else{
            $("#btnConfirm").show();
        }
