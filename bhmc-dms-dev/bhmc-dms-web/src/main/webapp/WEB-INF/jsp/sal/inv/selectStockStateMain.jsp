...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-D-10927" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" id="salMng" class="form_check" checked />
                    </td>
    ...
    <div class="header_area">
        <div class="btn_right">
            <dms:access viewId="VIEW-D-10926" hasPermission="${dms:getPermissionMask('READ')}">
                <button id="btnSave" class="btn_s"><spring:message code='global.btn.save' /></button>       <!-- 저장 -->
            </dms:access>
            <dms:access viewId="VIEW-D-10925" hasPermission="${dms:getPermissionMask('READ')}">
...
$(document).ready(function() {
   ...
   $("#subGrid").kendoExtGrid({
      ...
      ,columns:[
         ...
         ,{field:"ownStatCd",     title:"<spring:message code='sal.lbl.ownStatsCd' />", width:100, attributes:{"class":"al"}, template:"#= dms.string.strNvl(ownStatCdObj[ownStatCd]) #"}      // 보유상태
         ...
         ,{field:"contractNo", title:"<spring:message code='global.lbl.contractNo' />", attributes:{"class":"al"}, width:150, hidden:true}       // 계약번호
