...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                ...
                ,data:JSON.stringify({"exchRegistList":saveData})
                ,type:'POST'
                ,dataType:'json'
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{field:"officCd",   title:"办事处",    width:80,  attributes:{"class":"ac"}} //사무소
            ...
            ,{field:"ncarVinNo",   title:"新车VIN码",    width:80,  attributes:{"class":"ac"}} //VIN NO
            ...
            ,{field:"mayYyMmDt",   title:"材料月份",    width:80,  attributes:{"class":"ac"}} //자재년월
