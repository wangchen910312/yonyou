...
$(document).ready( function(){
    ...
    $("#grid").kendoExtGrid({
            ...
            ,schema:{
                model:{
                    ...
                    ,fields:{
                        ...
                        ,contractNo:{type:"string", editable:false } //crs 37 发票上传扫描信息显示的画面，在“证件号码”后面增加“手机号码”，取合同上的客户手机号，允许修改，校验手机号为11位数字。提交给发票系统，发票初审不通过时可修 贾明 2019-12-11
                    }
                }
            }
        }
        ...
        ,columns:[
            ...
            ,{field:"contractNo", title:"<spring:message code='sal.lbl.salesNo' />", width:200, attributes:{"class":"ac"},hidden:true}       /* crs 37 发票上传扫描信息显示的画面，在“证件号码”后面增加“手机号码”，取合同上的客户手机号，允许修改，校验手机号为11位数字。提交给发票系统，发票初审不通过时可修 贾明 2019-12-11 */
        ]
    });
