...
<div class="fsearch_area">
    <div class="header_area">
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11142" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th scope="row"><spring:message code='sal.lbl.idNo' /></th> <!-- ID번호(유형) -->
                    <td>
                        <input id="sSsnCrnNo" type="text" class="form_input"  style="width:40%"/>
                        <input id="sMathDocTp" type="text" class="form_comboBox" style="width:50%"/>
                    </td>
                ...
                <tr>
                    <th scope="row"><spring:message code='global.lbl.vinNo' /></th>    <!-- VIN NO번호 -->
                    <td>
...
<div class="table_info table_info_v1">
    <form id="frmTotalStatus" method="post">
        <iframe id="iframeSubTotalStatus" src="" frameborder="0" scrolling="no" width="100%" height="530"></iframe>
    </form>
</div>
...
function subTotalStatusCall(){
    ...
    param += "&sCarRegStartDt="+$("#sStartDt").val();
    param += "&sCarRegStartDt="+$("#sEndDt").val();
