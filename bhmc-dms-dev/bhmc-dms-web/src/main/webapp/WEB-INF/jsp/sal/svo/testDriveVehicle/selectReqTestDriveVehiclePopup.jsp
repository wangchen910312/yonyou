...
<form id="askForm" name="askForm" method="POST">
        ...
        <table>
            ...
            <tbody>
               <%--  <tr>
                    ...
                    <th scope="row" style="display:none;"><spring:message code='global.lbl.contactUserNm' /></th>  <!-- 연계인:사용자 -->
                    <td class="bor_color"  style="display:none;">
                        <div class="form_float">
                            <div class="form_left" style="width:35.5%">
                ...
                <tr>
                    <th scope="row"><spring:message code='sal.lbl.salePrsnNm' /></th>    <!-- 판매담당자 -->
                    <td colspan="3">
                ...
                <tr>
                  <!--Q21012900011 DMS试驾车申请 新增界面 申请类型 新建店申请 改成  “首次申请” 弹框调整 2021-3-10 jiaMing  -->
    ...
    <div class="table_form form_width_100per mt10">
        <table>
            ...
            <tbody>
                <tr>
                    <th scope="row"><spring:message code='sal.lbl.askCarImgFile' /></th>      <!-- 차량등록 관련서류:(인수차량 이미지-명칭변경) -->
                    <td>
                        <div id="fileUpN">
                    ...
                    <td>
                        ...
                        <button type="button" class="btn_s" id="btnFileUpSave" style="display:none;"><spring:message code="sal.btn.offer" /></button><!-- 저장 -->
    ...
    <span style="display:none">
        <input type="text" id="reqNo" name="reqNo" data-json-obj="true" />
        ...
        <input type="text" id="usrId" name="usrId" readonly class="form_input form_readonly" data-json-obj="true">
        <input type="text" id="usrNm" readonly class="form_input form_readonly">
    </span>
...
$(document).ready(function() {
    ...
    $("#carGrid").kendoExtGrid({
       ...
       ,height:100 //Q21012900011 DMS试驾车申请 新增界面 申请类型 新建店申请 改成  “首次申请” 弹框调整 2021-3-10 jiaMing 
       ,editable:{
            mode:"incell"
           ,confirmation:false
       }
       ...
       ,edit:function(e){
           ...
           if(fieldName == "carlineCd"){
               if(fn_isNoCarGridReadOnly()){
                   this.closeCell();
               }
           }
           if(fieldName == "fscCd"){
               if(fn_isNoCarGridReadOnly() ||
                  selectedItem.carlineCd == "" || fscCdDSList == null || fscCdDSList.length == 0){
                   this.closeCell();
               }
           }
           if(fieldName == "ocnCd"){
               if(fn_isNoCarGridReadOnly() ||
                  selectedItem.fscCd == "" || ocnCdDSList == null || ocnCdDSList.length == 0){
                   this.closeCell();
               }
           }
           if(fieldName == "extColorCd"){
               if(fn_isNoCarGridReadOnly() ||
                  selectedItem.ocnCd == "" || extColorCdDSList == null || extColorCdDSList.length == 0){
                   this.closeCell();
               }
           }
           if(fieldName == "intColorCd"){
               if(fn_isNoCarGridReadOnly() ||
                  selectedItem.extColorCd == "" || intColorCdDSList == null || intColorCdDSList.length == 0){
                   this.closeCell();
               }
           }
          ...
          ,{field:"fscCd", title:"<spring:message code='global.lbl.model' />" , width:150                 // 차관
              ...
              ,editor:function (container, options){
                  ...
                  .kendoExtDropDownList({
                      ...
                      ,valuePrimitive:true
                      ,autoWidth:true
                      ,template:"#=bf_selectFscNm(fscCd, fscNm)#"
   ...
   fn_selectLoadData = function(){
       ...
       if(typeof(dtSet.uploadSeq) != "undefined" && dtSet.uploadSeq != null && dtSet.uploadSeq != ""){
           ...
           if(dtSet.approveCd == "" || dtSet.approveCd == "A") {
               ...
               if(dtSet.approveCd == "C"
                   && ( dms.string.isEmpty(dtSet.fsmdAgrDt) || dms.string.strNvl(dtSet.fsdmAgrYn) != "Y")
                ){
       ...
       if($("#reqNo").val() != 0){                      //신규가아닐때만
        //Q21012900011 DMS试驾车申请 去掉换行符 jiaMing 2021-3-12 start
           $("#policyCont").val(dtSet.policyCont.replace(/\n/g,''));      //조회한정책
         //Q21012900011 DMS试驾车申请 去掉换行符 jiaMing 2021-3-12 
       }
 ...
 * 차종 그리드변경 가능 상태 체크
 */
function fn_isNoCarGridReadOnly(){
    return (dms.string.strNvl(v_approveCd) == "" || dms.string.strNvl(v_approveCd) == "A") ? false : true;
}
...
function selectPolicyCont(tpCd){
   ...
   //Q21012900011 DMS试驾车申请 去掉换行符 jiaMing 2021-3-12 end
}
