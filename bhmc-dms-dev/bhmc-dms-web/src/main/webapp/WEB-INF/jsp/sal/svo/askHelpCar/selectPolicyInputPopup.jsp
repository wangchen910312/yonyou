...
<section id="window" class="pop_wrap">
    <div class="header_area">
        ...
        <div class="btn_right">
            <button id="btnConfirm" class="btn_m"><spring:message code='sal.btn.requestEval' /></button>           <!-- 확정 -->
...
$(document).ready(function() {
    ...
    $("#tpCd").data("kendoExtDropDownList").select(0);
    ...
    $("#btnConfirm").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/sal/svo/askHelpCar/confirmPolicyInputPopup.do' />",
    ...
    $("#btnHistory").kendoButton({
        click:function(e){
            var tpCd = $("#tpCd").data("kendoExtDropDownList").value();
