...
<section class="group">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
            <dms:access viewId="VIEW-D-10924" hasPermission="${dms:getPermissionMask('READ')}">
...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
                    ...
                    ,{field:"reqStatCd",title:"<spring:message code = 'global.lbl.reqStat'/>" ,width:80  ,attributes:{"class":"al"}  //요청상태
                    ...
                    ,{field:"custNm"       ,title:"<spring:message code = 'global.lbl.custNm'/>"      ,width:80  ,attributes:{"class":"al"}} //고객명
                    ,{field:"contractNo"       ,title:"<spring:message code = 'global.lbl.contractNo'/>"      ,width:100  ,attributes:{"class":"ac"}} //계약번호
                    ,{field:"carlineCd",     title:"<spring:message code='global.lbl.carlineCd' />",      width:80, attributes:{"class":"al"}} //차종code
                    ...
                    ,{field:"ocnCd",         title:"<spring:message code='global.lbl.ocnCode' />",        width:80, attributes:{"class":"al"}}  //OCNcode
                    ...
                    ,{field:"vinNo1"       ,title:"VIN_NO"      ,width:140  ,attributes:{"class":"al"}} //VIN1
                    /*
