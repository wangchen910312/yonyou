...
<section class="group">
    ...
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="sal.menu.vehicleSpecIntClr" /></h1><!-- VehicleSpec - 내장색 -->
        <div class="btn_right">
            <dms:access viewId="VIEW-D-11280" hasPermission="${dms:getPermissionMask('READ')}">
...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{field:"intColorNm",  title:"<spring:message code='sal.lbl.intColorNm' />",    width:180,attributes:{"class":"al"}}  //내장컬러명
            ,{field:"intColorEnNm",title:"<spring:message code='sal.lbl.intColorEnNm' />",  width:180,attributes:{"class":"al"}}  //내장컬러영문명
