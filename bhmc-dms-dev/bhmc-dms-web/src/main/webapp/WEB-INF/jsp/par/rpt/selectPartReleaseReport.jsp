...
<div class="fsearch_area">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="par.title.partReleaseReport" /></h1>
        <div class="btn_right">
...
var toDt            = "${toDt}"
   ...
   <c:forEach var="obj" items="${storageList}" varStatus="status">
    ...
    function subTotalStatusCall(){
        ...
        var toDate = kendo.parseDate(sInvcGrDtTo);
        toDate.setDate(toDate.getDate() + 1);//To Data add day(+1)
        var toDateYyyyMmdd = kendo.toString(toDate,"${dateFormat}");

        var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=par/selectPartReleaseReport.cpt' />"
          , param = "";
