 ...
 <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        *************************************************************/
         ...
         * 팝업 옵션
         */
         var options = parent.searchItemMasterPopupWindow.options.content.data,
             itemDstinCdList     = [],
             itemDstinCdObj      = {},
             itemGrpCdObj        = {},
             abcIndList          = [],
            ...
            click:function(e){
                ...
                if(rows !== null)
                {
                    ...
                    $.each(rows, function(idx, row){
                      ...
                      //종료된 부품인 경우
                        /* if(grid.dataItem(row).endChk === 'N'){
                            var itemInfo = grid.dataItem(row).itemCd + '[' + grid.dataItem(row).itemNm + '] ' + "<spring:message code='par.lbl.useYn'/>";
                    ...
                    if(options.autoClose){
                        parent.searchItemMasterPopupWindow.close();
                    }
                }
            }
        });
        ...
        *************************************************************/
        $("#grid").kendoExtGrid({
            gridId:"G-PAR-0519-185401"
            ,dataSource:{
                transport:{
                    read:{
                        url:"<c:url value='/par/pmm/itemMaster/selectPopItemMasters.do' />"
                        ,dataType:"json"
                        ,type:"POST"
            ...
            ,columns:[
                ...
                ,{field:"avlbStockQty" ,title:"<spring:message code='par.lbl.avlbStockQty' />" ,width:80 ,attributes:{ "class":"ar"} ,format:"{0:n2}" ,decimal:2}//가용수량
