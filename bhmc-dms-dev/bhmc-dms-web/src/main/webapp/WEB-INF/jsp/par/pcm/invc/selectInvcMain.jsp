...
<div id="resizableContainer">
    ...
    <section class="group">
        <div class="header_area">
            ...
            <div class="btn_right">
                <button class="btn_s btn_s_min5 btn_del"   id="btnDelItem"><spring:message      code="par.btn.deleteItem" /></button>
                <button class="btn_s btn_s_min5 btn_save"  id="btnSave"><spring:message         code="par.btn.invcSave" /></button>
            </div>
        </div>
        ...
        <div class="table_grid mt10">
            <div id="gridInvc" class="resizable_grid"></div>
        </div>
    </section>
</div>
    <!-- //송장정보 -->
