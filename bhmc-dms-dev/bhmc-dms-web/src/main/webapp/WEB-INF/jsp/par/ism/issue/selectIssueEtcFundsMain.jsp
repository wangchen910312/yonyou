             ...
             */
             changeAmtEditor = function(container, options) {
                 ...
                 input.blur(function(){
                     ...
                     options.model.set("taxAmt",     (Math.round(Number(options.model.prc) * Number(options.model.qty) * 100)/100) - (Math.round(Number(lTaxDdctPrc) *  Number(options.model.qty) * 100)/100));
                     options.model.set("taxDdctAmt",  Math.round(lTaxDdctPrc *  options.model.qty * 100)/100);
