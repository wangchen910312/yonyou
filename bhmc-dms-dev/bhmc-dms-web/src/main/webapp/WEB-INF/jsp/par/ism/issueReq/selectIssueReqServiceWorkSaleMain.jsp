...
<section class="group">
    ...
    <div>
        <section class="group">
            <div class="header_area">
                <div class="btn_right">
                    <button id="btnPakage" class="btn_s btn_s_min5"><spring:message code="ser.btn.pakage" /><!-- btnPakage --></button>
                    <button id="btnSubPartsSelect" class="btn_s btn_s_min5"><spring:message code="par.btn.subPartsSelect" /><!-- btnSubPartsSelect --></button>
                    <button id="btnInPartsHistory" class="btn_s btn_s_min5"><spring:message code="par.btn.inPartsHistory" /><!-- btnInPartsHistory --></button>
                    <button id="btnOrderReq" class="btn_s btn_s_min5"><spring:message code="par.btn.orderReq" /><!-- btnOrderReq --></button>
                    <button id="btnPartsAdd" class="btn_s btn_s_min5"><spring:message code="par.btn.addItem" /><!-- btnPartsAdd --></button>
                    <button id="btnResvReq" class="btn_s btn_s_min5 hidden"><spring:message code="par.btn.resvReq" /><!-- btnResvReq --></button>
        ...
        */
        ...
        $("#targetReqHeaderGrid").kendoExtGrid({
           ...
           ,dataSource:{
                transport:{
                    ...
                    ,parameterMap:function(options, operation) {
                        if (operation === "read") {
                            ...
                            params["sParGiTp"] = $("#sParGiTp").val();                  //sParGiTp
            ...
            ,columns :
                ...
                ,{ field:"parReqDocNo", title:"<spring:message code='par.lbl.parReqDocNo'/>", width:110
                } //parReqDocNo
        ...
        $("#targetLbrGrid").kendoExtGrid({
           ...
           ,dataSource:{
            ...
            ,editable:false
            ,columns:[
                {field:"rnum", title:"<spring:message code='par.lbl.noName' />", width:30, attributes:{"class":"ac"} }
                ,{field:"roTp", title:"<spring:message code='ser.lbl.roTp' />", width:70, template:"#=roTpCdGrid(roTp)#" }
                ,{field:"lbrCd", title:"<spring:message code='ser.lbl.lbrCd' />", width:100}
                ,{field:"lbrNm", title:"<spring:message code='ser.lbl.lbrNm' />", width:300}
                ,{field:"lbrTp", title:"<spring:message code='ser.lbl.lbrTp' />", width:100}
                ,{field:"lbrPrc", title:"<spring:message code='par.lbl.lbrPrc' />", width:100, attributes:{"class":"ar"}, format:"{0:n0}", hidden:true}
                ,{field:"lbrHm", title:"<spring:message code='ser.lbl.lbrHm' />", width:70, attributes:{"class":"ar"} }
                ,{field:"dstbHm", title:"<spring:message code='ser.lbl.dstbHm' />", width:70, attributes:{"class":"ar"} , hidden:true}
                ,{field:"dcAmt", title:"<spring:message code='par.lbl.dcAmt' />", width:100, attributes:{"class":"ar"} , hidden:true}
                ,{field:"expcLbrAmt", title:"<spring:message code='ser.lbl.preLbrAmt' />", width:100, attributes:{"class":"ar"}, hidden:true
                ...
                ,{field:"payCmpNm", title:"<spring:message code='ser.lbl.payTp' />", width:100, hidden:true}
                ,{field:"remark", title:"<spring:message code='par.lbl.remark' />", width:200}
                ,{field:"lineNo", hidden:true}
            ]
        });
        // targetReqDetailGrid.
        $("#targetReqDetailGrid").kendoExtGrid({
            gridId:"G-PAR-0808-153602"
           ,dataSource:{
                transport:{
                    read:{
            ...
            */
            ,columns :
                ...
                ,{field:"resvQty", title:"<spring:message code='par.lbl.qty'/>", attributes:{"class":"ar"}, width:90
                    ,editor:function(container, options){
        ...
        $("#targetPartsInnerGrid").kendoExtGrid({
           ...
           ,dataSource:{
            ...
            ,columns :
                ...
                ,{field:"taxDdctAmt", title:"<spring:message code='par.lbl.amt' />", attributes:{"class":"ar"}, format:"{0:n2}", width:100 }
                ,{field:"taxAmt", title:"<spring:message code='par.lbl.taxAmt' />", attributes:{"class":"ar"}, width:80 }
                ,{field:"borrowStatus", title:"<spring:message code='par.lbl.borrowStatus' />", attributes:{"class":"ar"}, width:80 }
                ,{field:"receiveId", title:"<spring:message code='par.lbl.receiveId' />", width:80 }
            ]
        });
        //targetPartsReserveGrid
        $("#targetPartsReserveGrid").kendoExtGrid({
            gridId:"G-PAR-0808-153702"
           ,dataSource:{
                transport:{
                    read:{
                        url:"<c:url value='/par/ism/issueReq/selectIssueReqDetailes.do' />"
            ...
            ,columns :
                [{field:"resvDt", title:"<spring:message code='par.lbl.resvDt'/>", width:80 }
                ,{field:"resvStatus", title:"<spring:message code='par.lbl.resvStatus'/>", width:50 }
                ,{field:"resvTp", title:"<spring:message code='par.lbl.resvTp'/>", width:50 }
