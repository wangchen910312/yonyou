...
<div class="fsearch_area">
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="par.title.receiveListReport" /></h1>
        <div class="btn_right">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th scope="row"><spring:message code="par.lbl.grGiDt" /><!-- 입출고기간 --></th>
                    <td>
...
var toDt            = "${toDt}"
   ...
   <c:forEach var="obj" items="${storageList}" varStatus="status">
    ...
    function subTotalStatusCall(){
        ...
        toDate = kendo.parseDate($("#sInvcGrDtTo").data("kendoExtMaskedDatePicker").value());
        toDate.setDate(toDate.getDate() + 1);//To Data add day(+1)

        var toDateYyyyMmdd = kendo.toString(toDate,"${dateFormat}");
        toDate.setDate(toDate.getDate() - 1);//To data init

        var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=par/selectReceiveListReport.cpt' />"
          , param = "";
        ...
        param +="&sInvcGrDtTo="+toDateYyyyMmdd;
