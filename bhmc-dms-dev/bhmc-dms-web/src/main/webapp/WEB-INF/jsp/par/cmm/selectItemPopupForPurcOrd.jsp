            ...
            click:function(e){
                ...
                if(rows !== null){
                    ...
                    $.each(rows, function(idx, row){
                        ...
                        rowObj.sucCd          = frGrid.dataItem(row).sucCd;
                        rowObj.purcQty        = frGrid.dataItem(row).minPurcQty;
        ...
        *************************************************************/
        $("#searchGrid").kendoExtGrid({
            ...
            ,columns:[
                ...
                ,{field:"strgeCdList" ,title:"<spring:message code='par.lbl.strge' />" ,width:150}//입고창고
                ,{field:"sucCd" ,title:"<spring:message code='par.lbl.sucCd' />" ,width:100 }//SUC
        ...
        *************************************************************/
        $("#selectGrid").kendoExtGrid({
            ...
            ,edit:function(e){
                ...
                if(fieldName === "itemCd"||fieldName === "itemNm"||fieldName === "stockUnitCd"||fieldName === "purcPrc"
                    ||fieldName === "movingAvgPrc"||fieldName === "stockQty"||fieldName === "avlbStockQty"
                    ||fieldName === "resvStockQty"||fieldName === "rentQty"||fieldName === "borrowQty"||fieldName === "strgeCdList"){
                     this.closeCell();
                }
            }
            ,columns:[
                ...
                ,{field:"purcQty" ,title:"<spring:message code='par.lbl.purcQty' />" ,width:60 ,attributes:{ "class":"ar"},format:"{0:n0}" ,decimal:0
