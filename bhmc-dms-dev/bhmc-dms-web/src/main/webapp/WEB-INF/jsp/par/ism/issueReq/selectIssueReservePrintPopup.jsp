...
<%@taglib prefix="dms" uri="/WEB-INF/tlds/taglibs-dms"%>
    ...
    <section id="window" class="pop_wrap">
        <div class="header_area">
            <h1 class="title_center"><spring:message code="par.title.reserveDoc" /></h1>
            <div class="btn_right">
        ...
        <ul class="txt_input txt_input_v1">
            ...
            <li>
                <span class="span_txt"><spring:message code="par.lbl.reserveCustNm" />:<span id="lblReceiveId"></span> </span>
            </li>
            <li>
                <span class="span_txt"><spring:message code="par.lbl.reserveDt" />:<span id="lblReceiveTime"></span> </span>
            </li>
        </ul>
    </section>
    <!-- receiveDoc popup -->
...
$(document).ready(function() {
    ...
    * 팝업 옵션
    */
    var options = parent.issueReservePrintPopupButtonWindow.options.content.data;
    ...
    $("#sGiTp").kendoExtDropDownList({
        ...
        ,dataSource:[{cmmCd:"01",cmmCdNm:"预约" }] //TODO:[InBoShim] common code defined.
        ,autoBind:true
        ,index:0
    });
    ...
    $("#targetReqDetailGrid").kendoExtGrid({
       ...
       ,dataSource:{
        ...
        ,columns :
            ...
            ,{field:"itemCd", title:"<spring:message code='par.lbl.itemCd'/>",width:90 }
            ,{field:"itemNm", title:"<spring:message code='par.lbl.itemNm'/>", width:120 }
            ,{field:"giStrgeCd", title:"<spring:message code='par.lbl.strge' />/<spring:message code='par.lbl.locId' />", width:170
                ,template:'#if(giStrgeCdMap[giStrgeCd] !== undefined){# #= giStrgeCdMap[giStrgeCd]# #= locCdMap[giLocCd]# #}# / #if(locCdMap[giLocCd] !== undefined){# #= locCdMap[giLocCd]# #}#'
            }
