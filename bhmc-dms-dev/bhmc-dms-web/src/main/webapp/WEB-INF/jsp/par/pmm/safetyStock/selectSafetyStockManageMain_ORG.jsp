...
<!-- safetyStockManageMain -->
<!-- safetyStockCalculateMain -->
<section class="group">
    <div class="header_area">
        <h1 class="title_basic"><%-- <spring:message code="par.title.sftyStockCalcResult" /> --%><!-- sftyStockCalcResult --></h1>
        <div class="btn_right">
            <button id="btnSearch" class="btn_m btn_search"><spring:message code="par.btn.search" /><!-- btnSearch --></button>
            <button class="btn_m btn_save" id="btnReCalculate" type="button"><spring:message code="par.btn.sftyStockReCal" /></button><!--btnReCalculate  -->
            <button class="btn_m btn_save" id="btnSetSafyStock" type="button"><spring:message code="par.btn.setSftyStock" /></button><!--btnSetSafyStock  -->
        </div>
    </div>
</section>
<div class="mt10">
