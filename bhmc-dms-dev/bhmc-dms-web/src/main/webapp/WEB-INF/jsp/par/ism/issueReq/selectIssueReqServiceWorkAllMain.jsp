...
<section class="group">
    <div class="header_area">
        <%-- <h1 class="title_basic"><spring:message code="par.title.issueReqMng" /><!-- issueReqMng --></h1> --%>
            <div class="btn_left">
			<dms:access viewId="VIEW-D-11760" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnInit" name="btnInit" class="btn_m btn_reset"><spring:message code="par.btn.init" /></button><!--btnInit  -->
			</dms:access>
            </div>
            <div class="btn_right">
            <dms:access viewId="VIEW-D-11759" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnInvReqSave" class="btn_m btn_save btn_m_min"><spring:message code="par.btn.save" /><!-- btnInvReqSave --></button>
            </dms:access>
            <dms:access viewId="VIEW-D-11758" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnInvReq" class="btn_m btn_m_min"><spring:message code="par.btn.invConfirm" /><!-- btnInvReq --></button>
            </dms:access>
            <dms:access viewId="VIEW-D-11757" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnInvReturn" class="btn_m btn_m_min"><spring:message code="par.btn.invReturn" /><!-- btnInvReturn --></button>
            </dms:access>
            <dms:access viewId="VIEW-D-11756" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnPrint" class="btn_m btn_print btn_m_min"><spring:message code="par.btn.print" /></button><!--btnSearch  -->
            </dms:access>
            <dms:access viewId="VIEW-D-11755" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form_float">
                            <div class="date_left">
                                <input id="sReqStartDt" class="form_datepicker"  data-type="maskDate"/>
                                <span class="txt_from">~</span>
                            </div>
                            <div class="date_right">
                                <input id="sReqEndDt" class="form_datepicker"  data-type="maskDate"/>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <th scope="row"><spring:message code="par.lbl.issueCstNm" /><!-- 고객명칭 --></th>
                    <td>
                        <input id="sCustNm" name="sCustNm" class="form_input" />
                    </td>
                    <th scope="row"><spring:message code="par.lbl.serPrsnGroup" /></th>
                    <td>
                        <input id="sWkgrpNm" name="sWkgrpNm" class="form_input" />
                    </td>
                    <th scope="row"><spring:message code="par.lbl.tecNm" /></th>
                    <td>
                        <input id="sRealTecNm" name="sRealTecNm" class="form_input" />
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="hidden">
        ...
        <input type="hidden" id="parReqDocNo" name="sParReqDocNo" />
        ...
        <input type="hidden" id="borrowDocNo" name="resvDocNo" />
        <input type="hidden" id="parReqStatCd" name="parReqStatCd" />
        <input type="hidden" id="parReqStatNm" name="parReqStatNm" />
        <input type="hidden" id="reqStartDt" name="reqStartDt" />
        ...
        <input type="hidden" id="driverNm" name="driverNm" />
        <input type="hidden" id="carOwnerId" name="carOwnerId" />
        <input type="hidden" id="carOwnerNm" name="carOwnerNm" />
    </div>

    <!-- // tab start-->
    <div id="tabstrip" class="tab_area mt10">
    <ul>
        <li id ="tabPartOutStock" class="k-state-active"><spring:message code="par.title.partOutStock" /></li>
        <li id ="tabRoWorkInfo"><spring:message code="par.title.roWorkInfo" /></li>
        <li id ="tabPartsBorrowInfo"><spring:message code="par.title.partOutStockBorrow" /></li>
        <li id ="tabPartsReserve"><spring:message code="par.title.issueReqResvReadyAct" /></li>
    </ul>
    ...
    <div class="mt0">
        <section class="group">
            ...
            <dms:access viewId="VIEW-D-11754" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnPakage" class="btn_s btn_s_min5"><spring:message code="par.btn.pakage" /><!-- btnPakage --></button>
            </dms:access>
    ...
    <div class="mt0">
        <section class="group">
            ...
            <div class="btn_right_absolute">
            <dms:access viewId="VIEW-D-11751" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnIssueOutMove01" name="btnIssueOutMove01" class="btn_s btn_s_min5"><spring:message code="par.btn.issueOutMove" /></button><!--issueOutMove  -->
            </dms:access>
            </div>
            <div class="table_grid">
    ...
    <div class="mt0">
        <section class="group">
            ...
            <div class="btn_right_absolute">
            <dms:access viewId="VIEW-D-11750" hasPermission="${dms:getPermissionMask('READ')}">
                <button type="button" id="btnIssueOutMove02" name="btnIssueOutMove02" class="btn_s btn_s_min5" ><spring:message code="par.btn.issueOutMove" /></button><!--issueOutMove  -->
            </dms:access>
            </div>
            <div class="table_grid">
...
function pageInit(){
   var minDate = new Date("${sysStartDate}"),
    ...
    //button disable
    buttonEnableDisable(false, "00", "00", "00");
}
...
function updateIssuePartsReturnInves(gridObj, parReqStatCd){
    ...
    if(selectedRowDetailItem.parReqStatCd === undefined){
        ...
        for (i = length-1; i>=0; i--){
            ...
            if(item.parReqStatCd === "03" && item.itemCd ===selectedRowDetailItem.itemCd && item.reqStrgeCd === selectedRowDetailItem.reqStrgeCd && item.roLineNo === selectedRowDetailItem.roLineNo && item.parReqDocStockLineNo === selectedRowDetailItem.parReqDocStockLineNo){
                returnPartsMaxCnt++;
...
function setItemPriceInfo(item){
    ...
    item.itemAmt = kendo.parseFloat(kendo.toString(vItemAmt,'n2'));
    item.taxDdctAmt = kendo.parseFloat(kendo.toString(vTaxDdctAmt,'n2'));
    item.taxAmt = kendo.parseFloat(kendo.toString(vTaxAmt,'n2'));
...
function selectTargetReqHeaderChanged(selectedItem){
    ...
    //buttonEnableDisable Func  RO상태 : 위탁확인, 수리서비스, 정산대기 일대만 쓰기 작업 가능.
    var roStatCd = selectedItem.roStatCd;
    if(roStatCd === "01" || roStatCd === "02" || roStatCd === "03" ){
    ...
    $(document).ready(function() {
        ...
        $("#targetReqDetailGrid").kendoExtGrid({
            ...
            ,columns :
                ...
                ,{field:"receiveNm", title:"<spring:message code='par.lbl.receiveId' />", width:80}
                ,{field:"regUsrNm", title:"<spring:message code='par.lbl.handler' />", width:80}
