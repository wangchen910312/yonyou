...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/par/cpm/corpSalesAchievements/insertSalePlanExcelUploadFile.do"/>">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
 ...
 * 팝업 옵션
 */
 var options = parent.salePlanExcelUploadPopupWin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnFileUpload").kendoButton({
        ...
        ,click:function(e){
            if( dms.string.isEmpty($("#uploadFile").val())) {
                dms.notification.show("<spring:message code='par.lbl.file' var='fileMsg' /><spring:message code='global.info.chkSelectItemMsg' arguments='${fileMsg}' />", "popup");
                return;
            }
    ...
    $("#btnSave").kendoButton({
        ...
        ,click:function(e){
            ...
            if(options.autoClose){
                parent.salePlanExcelUploadPopupWin.close();
            }
    ...
    $("#progressSection").excelUpload({
        progressId :"UPLOAD_PARTS_SALE_PLAN"
    ...
    $("#grid").kendoExtGrid({
       ...
       ,dataSource:{
        ...
        ,columns:[
            ...
            ,{field:"saleItemQtyYearNow", title:"<spring:message code='par.lbl.saleItemQty'/>", width:70 }// 건수:件數
            ,{field:"saleQtyYearNow", title:"<spring:message code='par.lbl.saleQty'/>", width:70} // 수량:数量
