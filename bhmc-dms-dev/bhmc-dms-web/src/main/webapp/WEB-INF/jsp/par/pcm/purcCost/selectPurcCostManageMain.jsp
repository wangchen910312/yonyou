    ...
    <section class="group">
        ...
        <div id="tabstrip" class="tab_area">
            ...
            <div class="mt0">
                <div class="header_area">
                    <div class="btn_right">
                        <button class="btn_s btn_s_min5" id="btnTargetOff" type="button"><spring:message code="par.btn.targetOff" /></button><!--targetOff  -->
                    </div>
                </div>
            ...
            <div class="mt0">
                <div class="header_area">
                    <div class="btn_right">
                        <button class="btn_s btn_s_min5" id="btnTargetOn" type="button"><spring:message code="par.btn.targetOn" /></button><!--targetOn  -->
                    </div>
                </div>
