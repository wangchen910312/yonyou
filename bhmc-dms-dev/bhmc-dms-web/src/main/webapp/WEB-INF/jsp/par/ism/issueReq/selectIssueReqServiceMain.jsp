    ...
    <div id="tabstrip" class="tab_area">
        ...
        <div>
            <div class="btn_right_absolute">
                <button id="btnPartsAdd01" class="btn_s btn_add btn_s_min5">부품추가01</button>
                <button id="btnPartsDel01" class="btn_s btn_delete btn_s_min5">부품삭제01</button>
                <button id="btnPartsReq01" class="btn_s btn_delete btn_s_min5">부품요청01</button>
            </div>
        ...
        <div>
            <div class="btn_right_absolute">
                <button id="btnPartsAdd02" class="btn_s btn_add btn_s_min5">부품추가02</button>
                <button id="btnPartsDel02" class="btn_s btn_delete btn_s_min5">부품삭제02</button>
                <button id="btnPartsReq02" class="btn_s btn_delete btn_s_min5">부품요청02</button>
            </div>
            <div class="table_grid">
                <!-- 서비스RO 그리드 -->
        ...
        <div>
            <div class="btn_right_absolute">
                <button id="btnPartsAdd03" class="btn_s btn_add btn_s_min5">부품추가03</button>
                <button id="btnPartsDel03" class="btn_s btn_delete btn_s_min5">부품삭제03</button>
                <button id="btnPartsReq03" class="btn_s btn_delete btn_s_min5">부품요청03</button>
            </div>
            <div class="table_grid">
                <!-- 부품판매 그리드 -->
...
//위탁서 유형
var parGiTpList = [{"cmmCd":"", "cmmCdNm":"", "useYn":""}];
...
//부품출고유형상태(상태)
var partsParReqStatCdList = [{"cmmCd":"", "cmmCdNm":"", "useYn":""}];
