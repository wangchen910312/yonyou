...
<section class="group">
    <div class="header_area">
        <%-- <h1 class="title_basic"><spring:message code="par.title.itemGrpNm" /></h1> --%>
        <div class="btn_right">
    ...
    <div class="header_area">
        <div class="btn_right">
            <button class="btn_s btn_add btn_s_min5" id="btnAdd" type="button"><spring:message code="par.btn.rowAdd" /></button><!--btnAdd  -->
            <button class="btn_s btn_del btn_s_min5" id="btnDel" type="button"><spring:message code="par.btn.rowDel" /></button><!--btnDel  -->
        </div>
    </div>
    <!-- grid button list -->
