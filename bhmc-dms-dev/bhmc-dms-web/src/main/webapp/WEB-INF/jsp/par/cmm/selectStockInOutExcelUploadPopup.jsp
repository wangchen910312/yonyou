...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/par/stm/stockInOut/insertStockInOutExcelUploadFile.do"/>">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
...
var options = parent.stockInOutExcelUploadPopupWin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/par/stm/stockInOut/saveStockInOutExcelUpload.do' />"
                ,data:JSON.stringify({"stockInOutList":saveData})
                ,type:'POST'
                ,dataType:'json'
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{field:"itemCd", title:"<spring:message code='par.lbl.itemCd' />", width:80}                             //부품번호
            ,{field:"strgeCd", title:"<spring:message code='par.lbl.strge' />", width:80}                           //부품창고
            ,{field:"qty", title:"<spring:message code='par.lbl.avlbStock' />", width:80}                    //수량
