...
<section class="group">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
            <button id="btnInvConfirm" class="btn_s btn_s_min5"><spring:message code="par.btn.invConfirm" /><!-- invConfirm --></button>
            <button id="btnInvCancel" class="btn_s btn_s_min5"><spring:message code="par.btn.invCancel" /><!-- invCancel --></button>
        </div>
    </div>
