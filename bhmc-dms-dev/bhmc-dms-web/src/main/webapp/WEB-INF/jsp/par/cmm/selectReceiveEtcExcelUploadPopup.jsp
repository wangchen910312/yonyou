 ...
 * 팝업 옵션
 */
 var options       = parent.receiveEtcExcelUploadPopupWin.options.content.data,
     grStrgeTpObj  = {};
...
$(document).ready(function() {
    ...
    $("#btnFileDownload").kendoButton({
        click:function(e){
            location.href = "<c:url value='/cmm/sci/selectExcelTemplateDownload.do' />" + "?fileNm=ReceiveEtcItem_Tpl.xlsx";
        }
    });
    ...
    $("#progressSection").excelUpload({
        ...
        ,callback:function(obj){
            ...
            //$("#grid").data("kendoExtGrid").dataSource.data(obj.data);
    ...
    $("#grid").kendoExtGrid({
       ...
       ,dataSource:{
        ...
        ,columns:[
            ...
            ,{field:"excelQty", title:"<spring:message code='par.lbl.grQty' />", width:80
                ,attributes:{"class":"ar"}
            }
            ,{field:"excelPrc", title:"<spring:message code='par.lbl.grItemPrice' />", width:80
                ,attributes:{"class":"ar"}
            }
            ,{field:"excelTaxDdctPrc", title:"<spring:message code='par.lbl.grItemPriceTax' />", width:80
                ,attributes:{"class":"ar"}
            }
            ,{field:"excelStrgeCd", title:"<spring:message code='par.lbl.grStrgeCd' />", width:120
