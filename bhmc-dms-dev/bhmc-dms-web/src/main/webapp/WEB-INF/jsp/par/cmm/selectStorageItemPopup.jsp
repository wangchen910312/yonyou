 ...
 <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        *************************************************************/
        ...
        //grid
        $("#grid").kendoExtGrid({
            gridId:"G-PAR-0803-163502"
           ,dataSource:{
                transport:{
                    read:{
                        url:"<c:url value='/par/pmm/binLocationMaster/selectBinLocationItems.do' />"
                    }
            ...
            ,columns:[
                { field:"lvlId", title:"<spring:message code='par.lbl.lvlId'/>", width:50 }
                ,{ field:"locCd", title:"<spring:message code='par.lbl.locId'/>",  width:60, hidden:true }
                ,{ field:"upperLocId", title:"<spring:message code='par.lbl.locId'/>", width:60, headerAttributes:{ "colspan":"2" }}
                ,{ field:"locId", title:"", headerAttributes:{ "style":"display:none" } }
                ,{ field:"locNm", title:"<spring:message code='par.lbl.locNm'/>", width:120 }
                ...
                ,{ field:"baseAvlbStockQty", title:"<spring:message code='par.lbl.avlbStockQty'/>", width:100, attributes:{"class":"ar"}}
            ]
        });
