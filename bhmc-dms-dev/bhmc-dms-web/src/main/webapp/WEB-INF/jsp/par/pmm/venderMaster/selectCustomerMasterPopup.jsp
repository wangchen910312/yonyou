...
$.each(bpTpList, function(idx, obj){
    ...
    $(document).ready(function() {
        ...
        *************************************************************/
         ...
         * options
         */
        var options = parent.customerSearchPopupWin.options.content.data;
        ...
        *************************************************************/
        ...
        if(options.bpCd !== undefined && options.bpCd !== ""){
            $("#sBpCd").val(options.bpCd);
            $("#sBpCd").focus();
        }

        if(options.bpNm !== undefined && options.bpNm !== ""){
            $("#sBpNm").val(options.bpNm);
            $("#sBpNm").focus();
        }

        if(options.bpTp !== undefined && options.bpTp !== ""){
