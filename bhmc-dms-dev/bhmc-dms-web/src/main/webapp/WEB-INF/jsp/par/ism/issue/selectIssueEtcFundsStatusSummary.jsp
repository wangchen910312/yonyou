...
<div id="resizableContainer">
    <section class="group">
        <div class="header_area">
            <div class="btn_left">
			<dms:access viewId="VIEW-D-11959" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_m btn_reset btn_m_min" id="btnInit"><spring:message code="par.btn.init" /><!-- 초기화 --></button>
			</dms:access>
            </div>
            <div class="btn_right">
            <dms:access viewId="VIEW-D-12585" hasPermission="${dms:getPermissionMask('READ')}">
			...
			<dms:access viewId="VIEW-D-11958" hasPermission="${dms:getPermissionMask('READ')}">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <th scope="row"><spring:message code="par.lbl.obtGiDocNo" /><!-- 기타출고문서번호 --></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <th scope="row"><spring:message code="par.lbl.giStrgeCd" /><!-- 입고창고 --></th>
                        <td>
        ...
        <!-- 탭메뉴 전체 영역 -->
         <div id="tabstrip" class="tab_area">
            <!-- 탭메뉴 -->
            <ul>
                <li id="IEFH" class="k-state-active"><spring:message code="par.title.giFundsSumList" /><!-- 조달출고집계 --></li>
                <li id="IEFD"><spring:message code="par.title.giFundsSumListDetail" /><!-- 조달출고명세 --></li>
            </ul>
            <div>
                  <!-- 출고헤더정보  -->
...
$(document).ready(function() {
    ...
    $("#btnExcelExport").kendoButton({
        click:function(e){
            ...
            if(selectTabId == "IEFH"){
                ...
                templateFile = "PartIssueEtcFundsHeader_Tpl.xlsx";
                fileName = "PartIssueEtcFundsHeader.xlsx";
            } else {
                beanName = "issueEtcService";
                templateFile = "PartIssueEtcFundsDetail_Tpl.xlsx";
                fileName = "PartIssueEtcFundsDetail.xlsx";
            }
    ...
    $("#grid").kendoExtGrid({
       ...
       ,dataSource:{
        ...
        , columns:[
            ...
            ,{field:"etcGiDocNo" ,title:"<spring:message code='par.lbl.obtGiDocNo' />" ,width:120}//출고문서번호
            ...
            ,{field:"bpNm" ,title:"<spring:message code='par.lbl.dlrNm' />" ,width:140 }//업체
    ...
    $("#gridDetail").kendoExtGrid({
        gridId:"G-PAR-0905-143402"
       ,dataSource:{
            transport:{
                read:{
                    url:"<c:url value='/par/ism/issue/selectIssueEtcDetailListByCondition.do' />"
                }
                , parameterMap:function(options, operation) {
                    if (operation === "read") {
            ...
            ,schema:{
                ...
                ,model:{
                  ...
                  ,fields:{
                      ...
                      , giDt           :{ type:"date",   editable:false } //입고일자
                      ...
                      , giReasonCd     :{ type:"string", editable:false }
                    }
                }
                ,parse:function(d) {
                    if(d.data){
        ...
        , columns:[
            ...
            ,{field:"etcGiDocNo" ,title:"<spring:message code='par.lbl.etcGiDocNo' />" ,width:120}//입고문서번호
            ,{field:"giDt" ,title:"<spring:message code='par.lbl.giDt' />"
                ,format:"{0:<dms:configValue code='dateFormat' />}"
                ,width:90
                ,attributes:{"class":"ac tooltip-disabled"}
