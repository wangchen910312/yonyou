...
<div id="resizableContainer">
    <section id="windows" class="pop_wrap">
        ...
        <div class="table_form" role="search" data-btnid="btnSearch">
            <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/par/pmm/venderMaster/insertVenderCustomerMasterExcelUploadFile.do"/>">
            <table>
                <caption></caption>
                <colgroup>
                    <col style="width:70%;">
 ...
 * 팝업 옵션
 */
 var options = parent.venderCustomerMasterExcelUploadPopupWin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnFileDownload").kendoButton({
        click:function(e){
            location.href = "<c:url value='/cmm/sci/selectExcelTemplateDownload.do' />" + "?fileNm=PartCustomerInfoTarget_Tpl.xlsx";
        }
    });
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/par/pmm/venderMaster/multiVenderMasterCustomerExcelData.do' />"
    ...
    $("#progressSection").excelUpload({
        progressId :"UPLOAD_VENDER_CUSTOMER_MASTERS"
    ...
    $("#grid").kendoExtGrid({
                ...
                model:{
                    id:"bpCd"
                        ,fields:{
                            ...
                            ,bpTp:{ type:"string" , validation:{required:true} }
        ...
        ,columns:[
            ...
            ,{field:"bpTp", title:"<spring:message code='par.lbl.bpTp' />", width:70
