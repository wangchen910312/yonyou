                ...
                <div class="table_form form_width_70per">
                    <table>
                        ...
                        <tr>
                            ...
                            <th scope="row"><spring:message code="par.lbl.investigationPrsId" /><!-- 담당자 --></th>
                            <td>
                                <input type="hidden" id="prsnId" readonly class="form_input form_readonly">
                                <input type="text" id="prsnNm" readonly class="form_input form_readonly">
                            </td>
                    ...
                    //spanObj = "<a href ='<c:url value='/par/stm/investigation/selectInvestigationManageMain.do?pStockDdDocNo="+dataItem.stockDdDocNo+"'/>'><spring:message code='par.menu.stockResultInvest' /></a>";
                     ...
                     if(pType === "REQ"){ //승인요청
                         parent._createOrReloadTabMenu('<spring:message code="par.menu.stockMoveInvest" />'
                                 ,"<c:url value='/par/stm/investigation/selectInvestigationApproveMain.do?pStockDdDocNo="+pStockDdDocNo+"'/>", "VIEW-D-10232");
                     }else if(pType === "RGST"){
                         parent._createOrReloadTabMenu('<spring:message code="par.menu.stockResultInvest" />'
                                 ,"<c:url value='/par/stm/investigation/selectInvestigationManageMain.do?pStockDdDocNo="+pStockDdDocNo+"'/>", "VIEW-D-10548");
                     }
              ...
              */
              ...
              $("#grid").kendoExtGrid({
                 ...
                 ,change:function(e) {
                         ...
                         $("#prsnNm").val(selectedVal.prsnNm);                                                //재고실사문서
