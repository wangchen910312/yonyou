...
<script>
    ...
    $(document).ready(function() {
        ...
        * 팝업 옵션
        */
        var options = parent.stockGrItemPopupButtonWindow.options.content.data;
        ...
        *************************************************************/
        ...
        $("#grid").kendoExtGrid({
           ...
           ,dataSource:{
            ...
            ,columns :
                [{field:"regDt", title:"<spring:message code='par.lbl.grDt'/>",width:80 }
                ...
                ,{field:"endQty", title:"<spring:message code='par.lbl.qty' />", attributes:{"class":"ar"}, format:"{0:n0}", width:100 }
            ]
        });
