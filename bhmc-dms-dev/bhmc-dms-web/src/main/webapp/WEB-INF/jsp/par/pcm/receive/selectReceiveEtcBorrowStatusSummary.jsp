...
<div id="resizableContainer">
    <section class="group">
        <div class="header_area">
            <div class="btn_left">
			<dms:access viewId="VIEW-D-11938" hasPermission="${dms:getPermissionMask('READ')}">
                <button class="btn_m btn_reset btn_m_min" id="btnInit"><spring:message code="par.btn.init" /><!-- 초기화 --></button>
			</dms:access>
            </div>
            <div class="btn_right">
            <dms:access viewId="VIEW-D-12575" hasPermission="${dms:getPermissionMask('READ')}">
			...
			<dms:access viewId="VIEW-D-11937" hasPermission="${dms:getPermissionMask('READ')}">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <th scope="row"><spring:message code="par.lbl.receiveEtcBorrowNo" /><!-- 기타입고문서번호 --></th>
                        <td>
        ...
        <!-- 탭메뉴 전체 영역 -->
         <div id="tabstrip" class="tab_area">
            <!-- 탭메뉴 -->
            <ul>
                <li id="REBH" class="k-state-active"><spring:message code="par.title.grBorrowSumList" /><!-- 차입입고집계 --></li>
                <li id="REBD"><spring:message code="par.title.grBorrowSumListDetail" /><!-- 차입입고명세 --></li>
            </ul>
            <div>
                  <!-- 입고헤더정보  -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#btnExcelExport").kendoButton({
            click:function(e){
                ...
                if(selectTabId == "REBH"){
                    ...
                    templateFile = "PartReceiveEtcBorrowHeader_Tpl.xlsx";
                    fileName = "PartReceiveEtcBorrowHeader.xlsx";
                } else {
                    beanName = "receiveEtcService"
                    templateFile = "PartReceiveEtcBorrowDetail_Tpl.xlsx";
                    fileName = "PartReceiveEtcBorrowDetail.xlsx";
                }
        ...
        $("#grid").kendoExtGrid({
           ...
           ,dataSource:{
            ...
            , columns:[
                ...
                ,{field:"etcGrDocNo" ,title:"<spring:message code='par.lbl.receiveEtcBorrowNo' />" ,width:130}//입고문서번호
                ...
                ,{field:"bpNm" ,title:"<spring:message code='par.lbl.bpTp' />" ,width:180 }//업체
                ...
                ,{field:"returnItemCnt"
                    ...
                    ,format:"{0:n0}"
                    ,aggregates:["sum"]
                    ,footerTemplate:"<div class='ar'>#=kendo.toString(Math.round(sum * 100)/100,'n0')#</div>"}                //차출반환건수
               ,{field:"returnItemQty"
                    ...
                    ,format:"{0:n0}"
                    ,aggregates:["sum"]
                    ,footerTemplate:"<div class='ar'>#=kendo.toString(Math.round(sum * 100)/100,'n0')#</div>"}                //차출반환수량
               ,{field:"returnTotAmt"
                    ...
                    ,format:"{0:n2}"
                    ,aggregates:["sum"]
                    ,footerTemplate:"<div class='ar'>#= setSumData(sum)#</div>"}                //차출반환금액(세금제외)
        ...
        $("#gridDetail").kendoExtGrid({
            gridId:"G-PAR-0906-151202"
           ,dataSource:{
                transport:{
                    read:{
                        url:"<c:url value='/par/pcm/receive/selectReceiveEtcBorrowDetailListByCondition.do' />"
                    }
                    , parameterMap:function(options, operation) {
                        if (operation === "read") {
            ...
            , columns:[
                ...
                ,{field:"etcGrDocNo" ,title:"<spring:message code='par.lbl.receiveEtcBorrowNo' />" ,width:130}//입고문서번호
                ,{field:"returnDocNo" ,title:"<spring:message code='par.lbl.borrowReturnNo' />" ,width:130}//반환번호
                ,{field:"grDt" ,title:"<spring:message code='par.lbl.grDt' />"
                    ,format:"{0:<dms:configValue code='dateFormat' />}"
                    ,width:100
                    ,attributes:{"class":"ac tooltip-disabled"}
