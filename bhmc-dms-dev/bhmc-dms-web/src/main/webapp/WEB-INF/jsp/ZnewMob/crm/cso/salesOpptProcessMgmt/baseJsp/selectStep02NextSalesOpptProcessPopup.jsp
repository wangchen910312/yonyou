                        ...
                        <table class="flist01">
                            ...
                            <tbody  >
                                <tr>
                                    ...
                                    <td>
                                        <div class="f_item01">
                                            <input type="datetime-local" id="vsitResvDt" name="vsitResvDt" style="background-color:#ffffff;" data-json-obj="true"  />
                                        </div>
                                    </td>
                                </tr>
                                <tr id="trCustNmC">
            ...
            click:function(e){
               ...
               if ($("#localCarRegNoYn").prop("checked")){ salesOpptProcParam["localCarRegNoYn"] = "Y" } else { salesOpptProcParam["localCarRegNoYn"] = "N" };
                ...
                if(dms.string.isEmpty(sVsitResvDt)){
                    ...
                    salesOpptProcParam["vsitResvDt"] = chgDateTimeStamphhMM($("#vsitResvDt").val());
                }
