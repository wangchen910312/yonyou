...
<section id="content">
                ...
                <colgroup>
                 ...
                 <tbody>
                        ...
                        <tr>
                            ...
                            <td class="f_term">
                                <div class="f_item01 " style = "width:82%">
                                    <input type="date" id="sRegDtFrom" style="width:150px; background-color:#ffffff;" data-json-obj="true"  />
                                </div>
                                <span class="termtext"> ∼</span>
                                <div class="f_item01 " style = "width:82%">
                                    <input type="date" id="sRegDtTo" style="width:150px; background-color:#ffffff;" data-json-obj="true"  />
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id = "sNewDtRow">
                            ...
                            <td class="f_term">
                                <div class="f_item01 " style = "width:82%">
                                    <input type="date" id="sNewDtFrom" style="width:150px; background-color:#ffffff;" data-json-obj="true"  />
                                </div>
                                <span class="termtext"> ∼</span>
                                <div class="f_item01 " style = "width:82%">
                                    <input type="date" id="sNewDtTo" style="width:150px; background-color:#ffffff;" data-json-obj="true"  />
                                </div>
                            </td>
                        </tr>
                    </tbody>
    ...
    <section id="content_list">
        ...
        <c:import url="/WEB-INF/jsp/ZnewMob/crm/cso/salesOpptProcessMgmt/listJsp/selectSalesOpptProcessMgmtList.jsp"></c:import>
        <c:import url="/WEB-INF/jsp/ZnewMob/crm/cso/salesOpptProcessMgmt/listJsp/selectSalesOpptShowRoomList.jsp"></c:import>
...
<!--
//시스템 날짜 정보 가져오기.
var dateTimeFormat = '<dms:configValue code='dateFormat' />';
     ...
     /*********************************************************************************************************************************************/
        ...
        $("#btnOpenAssign").kendoButton({
             click:function(e){
                ...
                userList      = [];
                listCnt = 0;
                $("#listView").contents().find("input[name='isSaveName']").each(function(cnt){
                    if($("#listView").contents().find("input[name='isSaveName']")[cnt].checked == true){
                        var gridData = {
                                seq             :$("#listView").contents().find("input[name='seq']")[cnt].value,
                                custNo          :$("#listView").contents().find("input[name='custNo']")[cnt].value,
                                leadStatCd      :"02"
                        };
...
function contentList() {
  ...
  $("#header_title span").attr("class","search_open");
   ...
   if($("#salesOpptProgGrid").is(":visible")){
       initList();
       listData.read();
   }else{
       initList2();
