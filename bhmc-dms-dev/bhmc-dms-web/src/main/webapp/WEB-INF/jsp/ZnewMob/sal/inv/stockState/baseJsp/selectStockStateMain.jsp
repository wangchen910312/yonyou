...
$(document).ready(function() {
 ...
 // 재고
    ...
    $("#listView").height($(window).outerHeight()-($("#header").outerHeight()+$(".content_title").outerHeight()+$(".listhead").outerHeight()+$(".btnfixed").outerHeight()));
...
<section id="content">
<c:import url="/WEB-INF/jsp/ZnewMob/sal/inv/stockState/listJsp/selectStockStateList.jsp" />
<c:import url="/WEB-INF/jsp/ZnewMob/sal/inv/stockState/listJsp/selectStockStateDetailList.jsp" />
<!-- content_search -->
