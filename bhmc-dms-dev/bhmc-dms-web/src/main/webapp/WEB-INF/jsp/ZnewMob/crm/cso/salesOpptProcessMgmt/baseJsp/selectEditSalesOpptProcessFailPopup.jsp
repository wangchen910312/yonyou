...
<section id="content">
    ...
    <div class="content_right" id="salesOpptProcForm">
        <section id="content_detail" class="content_detail">
            ...
            <!-- 추적기록 -->
            <c:import url="/WEB-INF/jsp/ZnewMob/crm/cso/salesOpptProcessMgmt/listJsp/selectSalesOpptTraceMgmtList.jsp"></c:import>
            <!-- //추적기록 -->

            <!-- 회전기록 -->
            <c:import url="/WEB-INF/jsp/ZnewMob/crm/cso/salesOpptProcessMgmt/listJsp/selectSalesOpptProcessMgmtHistList.jsp"></c:import>
            <!-- //회전기록 -->
...
<!-- script -->
 ...
 var zipCodeSearchPopupWin; //zipcod popup
