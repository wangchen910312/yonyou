    ...
    <div class="content_right" id="salesOpptProcForm">
        <section id="content_detail" class="content_detail">
            ...
            <div class="con_btnarea btncount2">
                ...
                <div><span class="btnd1" id="btnPrevStepBefore"><spring:message code="crm.lbl.activeAppointmentSend" /><!-- 추출|예약으로 전달 --></span></div>
       ...
       $("#leadStatCd").data("kendoExtDropDownList").value(options.leadStatCd);
        ...
        $("#btnPrevStepBefore").kendoButton({
            click:function(e) {
                ...
                var officeTelNoC = $("#intrCarlineCd").data("kendoExtDropDownList").value();
                ...
                if (dms.string.isEmpty(officeTelNoC)) {
                    mob.notification.info("<spring:message code='global.lbl.officeTelNo' var='returnMsg' /><spring:message code='global.info.chkSelectItemMsg' arguments='${returnMsg}' />");
                    return false;
                }
