...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/crm/cif/customerCoupon/insertUploadFilePkgVin.do"/>">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
 ...
 * 팝업 옵션
 */
 var options = parent.custCouponMainUploadPopupPkgVin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            parent.custCouponMainUploadPopupPkgVin.close();
       }
    });

    $("#progressSection").excelUpload({
        progressId :"UPLOAD_FILE_PACKAGEVIN"
