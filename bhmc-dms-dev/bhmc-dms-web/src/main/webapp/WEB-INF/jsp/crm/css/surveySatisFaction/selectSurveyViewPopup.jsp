                ...
                <div class="survey">
                    ...
                    <div class="survey_content">
                        <ul>
                            ...
                            <c:set value="${status.index +1}" var="statusIndex"/>
                                <li>
                                    <h3><c:out value="${statusIndex}"/>. <c:out value="${qlist.qestCont}"/> <c:if test="${qlist.qestTpCd eq '02' && qlist.answSelCnt > 0 }">(<spring:message code="crm.lbl.selected" arguments="${qlist.answSelCnt}"/>)</c:if></h3>
                            ...
                            <c:if test="${questinList.size() ne 0}">
                                <li>
                                    <h3><spring:message code='crm.lbl.stsfIvstYn'/></h3> <!-- 만족여부 -->
                                    <div class="answer_area">
                                ...
                                <li>
                                    <h3>* <spring:message code='crm.lbl.cmplReasonCont'/></h3> <!-- 총결 -->
