        ...
        <div> <!-- 탭메뉴 시작-->
            <div class="header_area">
                <span class="btn_right">
                        <button type="button" id="btnPrevStepBefore" class="btn_m"><spring:message code="crm.lbl.failCustomer" /><!-- 전패(잠재고객 DB로 제출) --></button>
            ...
            <div id="custInfoTabDiv"> <!-- custInfoTabDiv Start -->
                ...
                <div class="table_form form_width_100per mt5"> <!-- 기본정보 시작-->
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"><spring:message code="crm.lbl.failedReason" /></th> <!-- //  전패원인  -->
                                <td colspan="3">
