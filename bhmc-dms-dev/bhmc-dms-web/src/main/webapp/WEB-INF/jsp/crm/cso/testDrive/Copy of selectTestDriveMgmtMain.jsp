            ...
            ***************************************************************************-->
            ...
            <section class="group">
                <div class="header_area">
                    ...
                    <div class="btn_right">
                        <button type="button" class="btn_s btn_save" id="tdrvMgmtSave" ><spring:message code="global.btn.save" /><!-- 저장 --></button>
                    </div>
                </div>
                <div class="table_form">
                ...
                $(document).ready(function() {
                    ...
                    $("#btnMan").kendoButton({
                        click:function(e){
                            ...
                            window.parent._createOrReloadTabMenu("<spring:message code='crm.menu.satisfactionMng' />", "<c:url value='/crm/css/satisFactionManage/selectSatisFactionManageMain.do' />", "VIEW-D-10275"); //만족도조사 관리
