...
<script type="text/javascript">
    ...
    function reportCall(){
        ...
        //console.log("re",reportParam);
        $("#iframeReport").attr("src", "<c:url value='/ReportServer?reportlet=crm/exhiHallReport/selectAgainStoreRate.cpt' />&op=view"+reportParam);
    }
