...
<script type="text/javascript">
    ...
    function custInfoReportCall(){
        ...
        $("#iframeCustInfoReport").attr("src", "<c:url value='/ReportServer?reportlet=crm/customerInfoReport/selectResponseTimeStsfRateReport.cpt' />&op=view"+custInfoReportParam);
    }
