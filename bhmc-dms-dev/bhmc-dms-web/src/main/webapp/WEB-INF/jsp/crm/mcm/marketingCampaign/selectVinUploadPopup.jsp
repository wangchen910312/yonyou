...
<section id="windows" class="pop_wrap">
    ...
    <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/crm/mcm/marketingCampaign/insertVinUploadFile.do"/>">
 ...
 * 팝업 옵션
 */
var parentData = parent.vinUploadPopupWin.options.content.data;

$(document).ready(function() {
    var uploadProgressId = "VIN";
    ...
    $("#btnFileDownload").kendoButton({
        click:function(e){
            location.href = "<c:url value='/cmm/sci/selectExcelTemplateDownload.do' />" + "?fileNm=MarketingCampaignVin_Tpl_zh.xlsx";
        }
    });
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/crm/mcm/marketingCampaign/insertVinExcelData.do' />"
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
           ...
           ,{field:"vinNo", title:"<spring:message code='crm.lbl.vinNo' />", width:100, attributes:{"class":"ac"}}// VIN 번호,hidden: gridVinYn
