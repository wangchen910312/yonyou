            ...
            <script type="text/javascript">
                            ...
                            , data:{
                                ...
                                , "callbackFunc":function(data){
                                    if(data.length >= 1) {
                                        ...
                                        var sCustNo = data[0].custNo;

                                        $.ajax({
                                            url:"<c:url value='/crm/cso/testDrive/selectTestDriveLastTimeDrivByKey.do' />",
                                            ...
                                            success:function(result) {
                                                $("#sTdrvDt").data("kendoExtMaskedDatePicker").value(result.resvDt);
                                                $("#sSaleOpptStepCd").data("kendoExtDropDownList").value(result.saleFcstCd);
                                            }
                                        });
                                        popupWindow.close();
                                    }
                ...
                $(document).ready(function() {
                    ...
                    tooltip.bind("show", function() {
                        ...
                        var selIdx
                            , resourceData = $("#scheduler").data('kendoScheduler').resources[1].dataSource.data()
                            , tdrvVinNo
                            , carlineCd
                            , carlineNm
                            , modelCd
                    ...
                    var startTime = kendo.toString(sysDate, "<dms:configValue code='dateFormat' />") + " 08:00";
                    var endTime = kendo.toString(sysDate, "<dms:configValue code='dateFormat' />") + " 18:00";
