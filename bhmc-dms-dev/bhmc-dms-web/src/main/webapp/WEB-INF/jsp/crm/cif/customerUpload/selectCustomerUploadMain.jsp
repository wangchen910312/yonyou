 ...
 *************************************************************/
 ...
 var custHoldTpList          = [{"cmmCd":"", "cmmCdNm":"", "useYn":""}];
...
$(document).ready(function() {
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
           ...
           ,{field:"prefCommMthCd", title:"<spring:message code='crm.lbl.prefCommMthCd' />",  width:130, attributes:{"class":"ac"}
               ,editor:function(container, options){
                   $('<input data-bind="value:' + options.field + '"  />')
                   .appendTo(container)
                   .kendoExtDropDownList({
           ...
           ,{field:"prefCommNo", title:"<spring:message code='crm.lbl.prefCommNo' />",  width:130, attributes:{"class":"ac"}}               // 선호연락처
           ,{field:"prefContactMthCd", title:"<spring:message code='crm.lbl.prefContactMthCd' />",  width:130, attributes:{"class":"ac"}
               ,editor:function(container, options){
                   $('<input data-bind="value:' + options.field + '"  />')
                   .appendTo(container)
                   .kendoExtDropDownList({
           ...
           ,{field:"prefContactTimeCd", title:"<spring:message code='crm.lbl.prefContactTime' />",  width:130, attributes:{"class":"ac"}
               ,editor:function(container, options){
                   $('<input data-bind="value:' + options.field + '"  />')
                   .appendTo(container)
                   .kendoExtDropDownList({
