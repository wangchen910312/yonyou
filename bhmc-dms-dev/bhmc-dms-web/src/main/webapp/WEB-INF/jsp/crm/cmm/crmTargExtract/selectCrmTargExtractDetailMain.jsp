                    ...
                    <ul>
                        ...
                        <li><a href="javascript:;"><spring:message code="crm.lbl.perCustInfo" /></a><!-- 개인고객정보 -->
                            <ul>
                                ...
                                <li><a href="javascript:f_addInput('CRM7500153');"><spring:message code="crm.lbl.mLevel" /></a></li><!-- 회원등급 -->
                                <li><a href="javascript:f_addInput('CRM7500154');"><spring:message code="crm.lbl.bmMembGrade" /></a></li><!-- BM 회원등급 -->
                            </ul>
                        </li>
...
<%--                                 <li><a href="javascript:f_addInput('CRM7500214');"><spring:message code="crm.lbl.expectPureTime" /></a></li><!-- 예상구매시기 --> --%>
                        ...
                        <li><a href="javascript:;"><spring:message code="crm.lbl.pureInfo" /></a><!-- 구매정보 -->
                            <ul>
                                ...
                                <li><a href="javascript:f_addInput('CRM7500456');"><spring:message code="global.lbl.insurance" /></a></li><!-- 보험 -->
                                <li><a href="javascript:f_addInput('CRM7500457');"><spring:message code="crm.lbl.fincRate" /></a></li><!-- 금융 -->
                                <li><a href="javascript:f_addInput('CRM7500458');"><spring:message code="ser.lbl.incStartDt" /></a></li><!-- 보험 시작일 -->
                                <li><a href="javascript:f_addInput('CRM7500460');"><spring:message code="ser.lbl.incEndDt" /></a></li><!-- 보험만료일자 -->
                            </ul>
                        </li>
                        <li><a href="javascript:;"><spring:message code="crm.lbl.lbrInfo" /></a><!-- 정비정보 -->
                            <ul>
                                <li><a href="javascript:f_addInput('CRM7500318');"><spring:message code="ser.lbl.calcEndDt" /></a></li><!-- 정비 일자 -->
                                ...
                                <li><a href="javascript:f_addInput('CRM7500355');"><spring:message code="ser.lbl.lbrTp" /></a></li><!-- 수리유형 -->
                                <li><a href="javascript:f_addInput('CRM7500351');"><spring:message code="crm.lbl.LastRoDt" /></a></li><!-- 最后1次维修时间 마지막번수리시간 -->
                                <li><a href="javascript:f_addInput('CRM7500352');"><spring:message code="crm.lbl.nextRoDt" /></a></li><!-- 下次保养时间 다음번 보양시간 -->
                                <li><a href="javascript:f_addInput('CRM7500359');"><spring:message code="ser.lbl.calcEndDt" />+<spring:message code="par.lbl.invResvWorkType" />+<spring:message code="ser.lbl.dlrRoTp" /></a></li><!-- //[정산완료시간+정비위탁유형+자체RO유형] -->
                            </ul>
                        </li>
                ...
                <section class="group">
                    ...
                    <div class="target_setting">
                        <ul>
                            ...
                            <li id="CRM7500153">
                                <div class="target_btn"><button id="CRM7500153_del" class="btn_s btn_target_delete">delete</button></div>
                                <div class="target_title"><spring:message code="crm.lbl.mLevel" /></div><!-- 회원등급 -->
                                <div class="target_content">
                                    <input id="CRM7500153_fleg" name="CRM7500153_fleg" type="hidden" value="N">
                                    <select id="CRM7500153-01" name="CRM7500153-01" multiple="multiple" data-bind="value:values" class="form_comboBox"></select>
                                </div>
                                <div class="target_empty"></div>
                            </li>
                            <li id="CRM7500154">
                                <div class="target_btn"><button id="CRM7500154_del" class="btn_s btn_target_delete">delete</button></div>
                                <div class="target_title"><spring:message code="crm.lbl.bmMembGrade" /></div><!-- BM 회원등급 -->
                                <div class="target_content">
                                    <input id="CRM7500154_fleg" name="CRM7500154_fleg" type="hidden" value="N">
                                    <select id="CRM7500154-01" name="CRM7500154-01" multiple="multiple" data-bind="value:values" class="form_comboBox"></select>
                                </div>
                                <div class="target_empty"></div>
                            </li>
                            <li id="CRM7500212">
                            ...
                            <li id="CRM7500456">
                                <div class="target_btn"><button id="CRM7500456_del" class="btn_s btn_target_delete">delete</button></div>
                                <div class="target_title"><spring:message code="global.lbl.insurance" /></div><!-- 보험유무 -->
                                <div class="target_content">
                                    <input id="CRM7500456_fleg" name="CRM7500456_fleg" type="hidden" value="N">
                                    <label for="CRM7500456-01-01" class="label_check">
                                        <input id="CRM7500456-01-01" name="CRM7500456-01" type="radio" value="Y" class="form_check" />
                                        <spring:message code="global.lbl.yes" /><!-- 예 -->
                                    </label>
                                    <label for="CRM7500456-01-02" class="label_check">
                                        <input id="CRM7500456-01-02" name="CRM7500456-01" type="radio" value="N" class="form_check" />
                                        <spring:message code="global.lbl.n" /><!-- 아니오 -->
                                    </label>
                                </div>
                                <div class="target_empty"></div>
                            ...
                            <li id="CRM7500457">
                                <div class="target_btn"><button id="CRM7500457_del" class="btn_s btn_target_delete">delete</button></div>
                                <div class="target_title"><spring:message code="crm.lbl.fincRate" /></div><!-- 금융유무 -->
                                <div class="target_content">
                                    <input id="CRM7500457_fleg" name="CRM7500457_fleg" type="hidden" value="N">
                                    <label for="CRM7500457-01-01" class="label_check">
                                        <input id="CRM7500457-01-01" name="CRM7500457-01" type="radio" value="Y" class="form_check" />
                                        <spring:message code="global.lbl.yes" /><!-- 예 -->
                                    </label>
                                    <label for="CRM7500457-01-02" class="label_check">
                                        <input id="CRM7500457-01-02" name="CRM7500457-01" type="radio" value="N" class="form_check" />
                                        <spring:message code="global.lbl.n" /><!-- 아니오 -->
                                    </label>
                                </div>
                                <div class="target_empty"></div>
                            ...
                            <li id="CRM7500458">
                                <div class="target_btn"><button id="CRM7500458_del" class="btn_s btn_target_delete">delete</button></div>
                                <div class="target_title"><spring:message code="ser.lbl.incStartDt" /></div><!-- 보험 시작일 -->
                                <div class="target_content">
                                    <input id="CRM7500458_fleg" name="CRM7500458_fleg" type="hidden" value="N">
                                    <div class="form_float">
                                        <div class="date_left">
                                            <input id="CRM7500458-01" name="CRM7500458-01" class="form_datepicker ac">
                                            <span class="txt_from">~</span>
                                        </div>
                                        <div class="date_right">
                                            <input id="CRM7500458-02" name="CRM7500458-02" class="form_datepicker ac">
                                        </div>
                                    </div>
                                </div>
                                <div class="target_empty"></div>
                            ...
                            <li id="CRM7500460">
                                <div class="target_btn"><button id="CRM7500460_del" class="btn_s btn_target_delete">delete</button></div>
                                <div class="target_title"><spring:message code="ser.lbl.incEndDt" /></div><!-- 보험만료일자 -->
                                <div class="target_content">
                                    <input id="CRM7500460_fleg" name="CRM7500460_fleg" type="hidden" value="N">
                                    <div class="form_float">
                                        <div class="date_left">
                                            <input id="CRM7500460-01" name="CRM7500460-01" class="form_datepicker ac">
                                            <span class="txt_from">~</span>
                                        </div>
                                        <div class="date_right">
                                            <input id="CRM7500460-02" name="CRM7500460-02" class="form_datepicker ac">
                                        </div>
                                    </div>
                                </div>
                                <div class="target_empty"></div>
                            ...
                            <li id="CRM7500318">
                                ...
                                <div class="target_title"><spring:message code="ser.lbl.calcEndDt" /></div><!-- 정산완료일 -->
                                <div class="target_content">
                            ...
                            <li id="CRM7500351">
                                ...
                                <div class="target_title"><spring:message code="crm.lbl.LastRoDt" /></div><!-- 最后1次维修时间 마지막번수리시간 -->
                                <div class="target_content">
                            ...
                            <li id="CRM7500352">
                                ...
                                <div class="target_title"><spring:message code="crm.lbl.nextRoDt" />(<spring:message code="global.lbl.bef" />)</div><!-- 下次保养时间 다음번 보양시간 -->
                                <div class="target_content">
                            ...
                            <li id="CRM7500359">
                                ...
                                <div class="target_title"><spring:message code="ser.lbl.calcEndDt" /><br/>+<spring:message code="par.lbl.invResvWorkType" /><br>+<spring:message code='ser.lbl.dlrRoTp' /></div><!-- 정비일자+정비위탁유형+자체RO유형 -->
                                <div class="target_content">
                                            <input id="CRM7500359_fleg" name="CRM7500359_fleg" type="hidden" value="N">
                                            <spring:message code="crm.lbl.RoCalcEndAfter" /><!-- 정산 완료일 후 00 일 -->
                                            <input id="CRM7500359-01" name="CRM7500359-01" type="nember" value="" class="form_numeric ar" style="width:22%">
                                            <spring:message code="global.lbl.day"/><!-- 일 -->
                                            <br/>
                                        <div class="form_float">
                                            <spring:message code="par.lbl.invResvWorkType" /><!-- 정비위탁유형 -->
                                            <div>
                                                <select id="CRM7500359-02" name="CRM7500359-02" multiple="multiple" data-bind="value:values" class="form_comboBox ar" ></select>
                                            </div>
                                        </div>
                                            <br/>
                                        <div class="form_float">
                                            <spring:message code="ser.lbl.dlrRoTp" /><!-- 자체RO유형 -->
                                            <div>
                                                <select id="CRM7500359-03" name="CRM7500359-03" multiple="multiple" data-bind="value:values" class="form_comboBox ar" ></select>
                                            </div>
                                        </div>
                                </div>
                                <div class="target_empty"></div>
...
function resetDefualtForm(){
    ...
    //[자체회원등급]
    $("#CRM7500153_fleg").val("N");
    $("#CRM7500153-01").data("kendoMultiSelect").value("");
    $("#CRM7500153").hide();

    //[BM 회원등급]
    $("#CRM7500154_fleg").val("N");
    $("#CRM7500154-01").data("kendoMultiSelect").value("");
    $("#CRM7500154").hide();
    ...
    $("#CRM7500359-01").data("kendoExtNumericTextBox").value(0);
    $("#CRM7500359-02").data("kendoMultiSelect").value("");
    ...
    //[보험]
    $("#CRM7500456_fleg").val("N");
    $("#CRM7500456-01-01").prop("checked", false);
    $("#CRM7500456-01-02").prop("checked", false);
    $("#CRM7500456").hide();

    //[금융]
    $("#CRM7500457_fleg").val("N");
    $("#CRM7500457-01-01").prop("checked", false);
    $("#CRM7500457-01-02").prop("checked", false);
    $("#CRM7500457").hide();

    //[보험 시작일]
    $("#CRM7500458_fleg").val("N");
    $("#CRM7500458-01").val("");
    $("#CRM7500458-02").val("");
    $("#CRM7500458").hide();

    //[보험만료일자]
    $("#CRM7500460_fleg").val("N");
    $("#CRM7500460-01").val("");
    $("#CRM7500460-02").val("");
    $("#CRM7500460").hide();
...
function f_showHideInput(){
    ...
    //[회원등급]
    if($("#CRM7500153-01").val() == "" || $("#CRM7500153-01").val() == null){
        $("#CRM7500153_fleg").val("N");
        $("#CRM7500153-01").data("kendoMultiSelect").value("");
        $("#CRM7500153").hide();
    }else{
        $("#CRM7500153").show();
        $("#CRM7500153_fleg").val("Y");
    }

    //[BM 회원등급]
    if($("#CRM7500154-01").val() == "" || $("#CRM7500154-01").val() == null){
        $("#CRM7500154_fleg").val("N");
        $("#CRM7500154-01").data("kendoMultiSelect").value("");
        $("#CRM7500154").hide();
    }else{
        $("#CRM7500154").show();
        $("#CRM7500154_fleg").val("Y");
    }
  ...
  //[정비일자+정비위탁유형]
    if($("#CRM7500359-01").data("kendoExtNumericTextBox").value() == null || $("#CRM7500359-01").data("kendoExtNumericTextBox").value() == 0 || $("#CRM7500359-01").val() == "" || $("#CRM7500359-01").val() == null ){
        $("#CRM7500359_fleg").val("N");
        $("#CRM7500359-01").data("kendoExtNumericTextBox").value(0);
        $("#CRM7500359-02").data("kendoMultiSelect").value("");
        $("#CRM7500359-03").data("kendoMultiSelect").value("");
    ...
    //[보험]
    if($("#CRM7500456-01-01").is(":checked") == false && $("#CRM7500456-01-02").is(":checked") == false){
        $("#CRM7500456_fleg").val("N");
        $("#CRM7500456-01-01").prop("checked", false);
        $("#CRM7500456-01-02").prop("checked", false);
        $("#CRM7500456").hide();
        ...
        $("#CRM7500456").show();
        $("#CRM7500456_fleg").val("Y");
    }

    //[금융]
    if($("#CRM7500457-01-01").is(":checked") == false && $("#CRM7500457-01-02").is(":checked") == false){
        $("#CRM7500457_fleg").val("N");
        $("#CRM7500457-01-01").prop("checked", false);
        $("#CRM7500457-01-02").prop("checked", false);
        $("#CRM7500457").hide();
        ...
        $("#CRM7500457").show();
        $("#CRM7500457_fleg").val("Y");
    }

    //[보험 시작일]
    if($("#CRM7500458-01").val() == "" || $("#CRM7500458-01").val() == null){
        $("#CRM7500458_fleg").val("N");
        $("#CRM7500458-01").val("");
        $("#CRM7500458-02").val("");
        $("#CRM7500458").hide();
        ...
        $("#CRM7500458").show();
        $("#CRM7500458_fleg").val("Y");
    }

    //[보험만료일자]
    if($("#CRM7500460-01").val() == "" || $("#CRM7500460-01").val() == null){
        $("#CRM7500460_fleg").val("N");
        $("#CRM7500460-01").val("");
        $("#CRM7500460-02").val("");
        $("#CRM7500460").hide();
...
function f_addInput(value){
    ...
    if(value == 'CRM7500101'){
        ...
        $("#CRM7500150").show();
        $("#CRM7500150_fleg").val("Y");
        $("#CRM7500150-01-01").click();
    }else if(value == 'CRM7500153'){
        $("#CRM7500153").show();
        $("#CRM7500153_fleg").val("Y");
    }else if(value == 'CRM7500154'){
        $("#CRM7500154").show();
        $("#CRM7500154_fleg").val("Y");
    ...
    //구매정보
        ...
        $("#CRM7500432").show();
        $("#CRM7500432_fleg").val("Y");
    }else if(value == 'CRM7500456'){
        $("#CRM7500456").show();
        $("#CRM7500456_fleg").val("Y");
        $("#CRM7500456-01-01").click();
    }else if(value == 'CRM7500457'){
        $("#CRM7500457").show();
        $("#CRM7500457_fleg").val("Y");
        $("#CRM7500457-01-01").click();
    }else if(value == 'CRM7500458'){
        $("#CRM7500458").show();
        $("#CRM7500458_fleg").val("Y");
    }else if(value == 'CRM7500460'){
        $("#CRM7500460").show();
        $("#CRM7500460_fleg").val("Y");
...
//                        $("#CRM7500150-01-02").focus();
                ...
                //회원등급
                if($("#CRM7500153_fleg").val() == "Y"){
                    // 화면 필수 체크
                    if ( dms.string.isEmpty($("#CRM7500153-01").val())){
                ...
                //BM 회원등급
                if($("#CRM7500154_fleg").val() == "Y"){
                    // 화면 필수 체크
                    if ( dms.string.isEmpty($("#CRM7500154-01").val())){
              ...
              //[정비일자+정비위탁유형]
                if($("#CRM7500359_fleg").val() == "Y"){
                    // 화면 필수 체크
                    if($("#CRM7500359-01").data("kendoExtNumericTextBox").value() == null || $("#CRM7500359-01").data("kendoExtNumericTextBox").value() == 0){
                        dms.notification.warning("<spring:message code='ser.lbl.calcEndDt' var='returnMsg' /><spring:message code='global.info.required.field' arguments='${returnMsg}' />");
                        $("#CRM7500359-01").data("kendoExtNumericTextBox").focus();
                        return false;
                    }

                    if ( dms.string.isEmpty($("#CRM7500359-02").val())){
                        dms.notification.warning("<spring:message code='par.lbl.invResvWorkType' var='returnMsg' /><spring:message code='global.info.required.field' arguments='${returnMsg}' />");
                        $("#CRM7500359-02").focus();
                        return false;
                    }
                ...
                //구매정보-보험 시작일
                if ($("#CRM7500458_fleg").val() == "Y"){
                    // 화면 필수 체크
                    if ( dms.string.isEmpty($("#CRM7500458-01").val())){
                    ...
                    // 화면 필수 체크
                    if ( dms.string.isEmpty($("#CRM7500458-02").val())){
                        dms.notification.warning("<spring:message code='ser.lbl.incStartDt' var='returnMsg' /><spring:message code='global.info.required.field' arguments='${returnMsg}' />");
                        $("#CRM7500458-02").focus();
                        return false;
                    }
                ...
                //구매정보-보험만료일자
                if ($("#CRM7500460_fleg").val() == "Y"){
                    // 화면 필수 체크
                    if ( dms.string.isEmpty($("#CRM7500460-01").val())){
                        dms.notification.warning("<spring:message code='ser.lbl.incEndDt' var='returnMsg' /><spring:message code='global.info.required.field' arguments='${returnMsg}' />");
                        $("#CRM7500460-01").focus();
                        return false;
                    }
                    // 화면 필수 체크
                    if ( dms.string.isEmpty($("#CRM7500460-02").val())){
                        dms.notification.warning("<spring:message code='ser.lbl.incEndDt' var='returnMsg' /><spring:message code='global.info.required.field' arguments='${returnMsg}' />");
                        $("#CRM7500460-02").focus();
                        return false;
                    }
                ...
                if($("#CRM7500101_fleg").val() == "N" && $("#CRM7500102_fleg").val() == "N" && $("#CRM7500103_fleg").val() == "N" && $("#CRM7500104_fleg").val() == "N" && $("#CRM7500105_fleg").val() == "N" &&
                   ...
                   $("#CRM7500321_fleg").val() == "N" && $("#CRM7500322_fleg").val() == "N" && $("#CRM7500323_fleg").val() == "N" && $("#CRM7500324_fleg").val() == "N" && $("#CRM7500355_fleg").val() == "N" &&
                   $("#CRM7500351_fleg").val() == "N" && $("#CRM7500352_fleg").val() == "N" && $("#CRM7500359_fleg").val() == "N" &&
                   $("#CRM7500425_fleg").val() == "N" &&
                   ...
                   $("#CRM7500153_fleg").val() == "N" && $("#CRM7500154_fleg").val() == "N" && $("#CRM7500456_fleg").val() == "N" && $("#CRM7500457_fleg").val() == "N" && $("#CRM7500458_fleg").val() == "N" &&
                   $("#CRM7500460_fleg").val() == "N" ){
                ...
                //회원등급
                json["CRM7500153"] = $("#CRM7500153-01").data("kendoMultiSelect").value() != "" && $("#CRM7500153-01").data("kendoMultiSelect").value() != null ?$("#CRM7500153-01").data("kendoMultiSelect").value():"";

                //BM 회원등급
                json["CRM7500154"] = $("#CRM7500154-01").data("kendoMultiSelect").value() != "" && $("#CRM7500154-01").data("kendoMultiSelect").value() != null ?$("#CRM7500154-01").data("kendoMultiSelect").value():"";
                ...
                //[정비일자+정비위탁유형]
                json["CRM7500359"] = $("#CRM7500359-01").data("kendoExtNumericTextBox").value() != null && $("#CRM7500359-01").data("kendoExtNumericTextBox").value() != 0 && $("#CRM7500359-02").data("kendoMultiSelect").value() != "" && $("#CRM7500359-02").data("kendoMultiSelect").value() != null && $("#CRM7500359-03").data("kendoMultiSelect").value() != "" && $("#CRM7500359-03").data("kendoMultiSelect").value() != null ? $("#CRM7500359-01").data("kendoExtNumericTextBox").value() + "|" + $("#CRM7500359-02").data("kendoMultiSelect").value() + "|" + $("#CRM7500359-03").data("kendoMultiSelect").value():"";
                ...
                //보험
                json["CRM7500456"] = $("#CRM7500456-01-01").is(":checked") == true || $("#CRM7500456-01-02").is(":checked") == true ? $("#CRM7500456-01-01").is(":checked") == true ? "Y":"N":"";

                //금융
                json["CRM7500457"] = $("#CRM7500457-01-01").is(":checked") == true || $("#CRM7500457-01-02").is(":checked") == true ? $("#CRM7500457-01-01").is(":checked") == true ? "Y":"N":"";

                //보험 시작일
                json["CRM7500458"] = $("#CRM7500458-01").val() != "" && $("#CRM7500458-01").val() != null ? $("#CRM7500458-01").val() + "|" + $("#CRM7500458-02").val():"";

                //보험만료일자
                json["CRM7500460"] = $("#CRM7500460-01").val() != "" && $("#CRM7500460-01").val() != null ? $("#CRM7500460-01").val() + "|" + $("#CRM7500460-02").val():"";
...
//     });
  ...
  //[참여 캠페인] 조건 입력부 비활성화
    ...
    ***********************************************************/
    ...
    //회원등급
    $("#CRM7500153-01").kendoMultiSelect({
    ...
    if(targExtractValMap["CRM7500153-01"] != "" && targExtractValMap["CRM7500153-01"] != null){
        $("#CRM7500153-01").data("kendoMultiSelect").value(targExtractValMap["CRM7500153-01"].split(","));
    }

    //BM 회원등급
    $("#CRM7500154-01").kendoMultiSelect({
    ...
    if(targExtractValMap["CRM7500154-01"] != "" && targExtractValMap["CRM7500154-01"] != null){
        $("#CRM7500154-01").data("kendoMultiSelect").value(targExtractValMap["CRM7500154-01"].split(","));
    }
  ...
  //[정비일자+정비위탁유형]
    $("#CRM7500359-01").kendoExtNumericTextBox({
        format:"n0"
        ,decimals:0                // 소숫점
        ,min:0
        ,value:0
    ...
    $("#CRM7500359-01").data("kendoExtNumericTextBox").value(targExtractValMap["CRM7500359-01"]);

    // 정비위탁유형
    $("#CRM7500359-02").kendoMultiSelect({
        dataSource:dms.data.cmmCdFilter(lbrTps),
        valuePrimitive:true,
        placeholder:"",
        dataTextField:"cmmCdNm",
    ...
    if(targExtractValMap["CRM7500359-02"] != "" && targExtractValMap["CRM7500359-02"] != null){
        $("#CRM7500359-02").data("kendoMultiSelect").value(targExtractValMap["CRM7500359-02"].split(","));
    }
    ...
    if(targExtractValMap["CRM7500359-03"] != "" && targExtractValMap["CRM7500359-03"] != null){
        $("#CRM7500359-03").data("kendoMultiSelect").value(targExtractValMap["CRM7500359-03"].split(","));
    }
    ...
    // 보험
    if(targExtractValMap["CRM7500456-01"] != "" && targExtractValMap["CRM7500456-01"] != null){
        if(targExtractValMap["CRM7500456-01"] == "Y"){
            $("#CRM7500456-01-01").prop("checked", true);
        }else{
            $("#CRM7500456-01-02").prop("checked", true);
        }
    }

    // 금융
    if(targExtractValMap["CRM7500457-01"] != "" && targExtractValMap["CRM7500457-01"] != null){
        if(targExtractValMap["CRM7500457-01"] == "Y"){
            $("#CRM7500457-01-01").prop("checked", true);
        }else{
            $("#CRM7500457-01-02").prop("checked", true);
        }
    }

    // 보험 시작일 FROM
    $("#CRM7500458-01").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        ,dateValidMessage:"<spring:message code='global.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
    });

    // 보험 시작일 TO
    $("#CRM7500458-02").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        ,dateValidMessage:"<spring:message code='global.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
    });

    $("#CRM7500458-01").data("kendoExtMaskedDatePicker").value(targExtractValMap["CRM7500458-01"]);
    $("#CRM7500458-02").data("kendoExtMaskedDatePicker").value(targExtractValMap["CRM7500458-02"]);

    // 보험만료일자 FROM
    $("#CRM7500460-01").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        ,dateValidMessage:"<spring:message code='global.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
    });

    // 보험만료일자 TO
    $("#CRM7500460-02").kendoExtMaskedDatePicker({
        format:"<dms:configValue code='dateFormat' />"
        ,dateValidMessage:"<spring:message code='global.lbl.date' var='dateMsg' /><spring:message code='global.err.invalid' arguments='${dateMsg}' />"
    });

    $("#CRM7500460-01").data("kendoExtMaskedDatePicker").value(targExtractValMap["CRM7500460-01"]);
    $("#CRM7500460-02").data("kendoExtMaskedDatePicker").value(targExtractValMap["CRM7500460-02"]);
