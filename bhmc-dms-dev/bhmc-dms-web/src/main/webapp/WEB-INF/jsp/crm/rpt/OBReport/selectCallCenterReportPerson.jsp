        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="sCallPrsnNm" class="form_input" />
                    </td>
                    <th></th>
                    <td></td>
                    <th></th>
...
<c:forEach var="obj" items="${callRsltCdList}">
    ...
    function reportCall(){
        ...
        reportParam += "&sCallPrsnNm="+$("#sCallPrsnNm").val();
        reportParam += "&sCallRsltCd="+$("#sCallRsltCd").val();
        reportParam += "&sStartRegDt="+$("#sStartRegDt").val();
        reportParam += "&sEndRegDt="+$("#sEndRegDt").val();

        $("#iframeReport").attr("src", "<c:url value='/ReportServer?reportlet=crm/OBReport/callCenterReportPerson.cpt' />&op=view"+reportParam);
    };
