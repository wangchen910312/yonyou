...
<script type="text/javascript">
    function reportCall(){
        ...
        $("#iframeReport").attr("src", "<c:url value='/ReportServer?reportlet=crm/satisfactionReport/satisfactionTotalReport.cpt' />&op=view"+reportParam);
    };
    ...
    <c:forEach var="obj" items="${users}">
        userDS.push({"usrId":"${obj.usrId}", "usrNm":"${obj.usrNm}"});
    </c:forEach>
