        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th scope="row"><spring:message code='global.lbl.newRegDt' /></th><!-- 신규일 -->
                    <td>
...
holdTpList.push({"cmmCd":"${obj.cmmCd}", "cmmCdNm":"${obj.cmmCdNm}", "useYn":"${obj.useYn}"});
    ...
    function reportCall(){
        ...
        $("#iframeReport").attr("src", "<c:url value='/ReportServer?reportlet=crm/opptReport/selectManagerReport.cpt' />&op=view"+reportParam);
    };
