        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input id="sIntrCarlineCd" name="sIntrCarlineCd" type="text" value="" class="form_comboBox"  data-json-obj="true" />
                    </td>
                    <th></th>
                    <td></td>
                    <th></th>
...
<script type="text/javascript">
    ...
    function custInfoReportCall(){
        ...
        custInfoReportParam += "&sIntrCarlineCdParam="+$("#sIntrCarlineCd").data("kendoExtDropDownList").value();
        $("#iframeCustInfoReport").attr("src", "<c:url value='/ReportServer?reportlet=crm/customerInfoReport/selectPrsnIntentionCarlineReport.cpt' />&op=view"+custInfoReportParam);
    }
