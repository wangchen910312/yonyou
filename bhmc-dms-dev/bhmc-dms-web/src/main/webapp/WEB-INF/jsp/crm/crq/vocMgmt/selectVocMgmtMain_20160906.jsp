                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope="row" id="pconCustInfoTxt" ><spring:message code="global.lbl.pconCustInfo" /><!-- 문의자 / 불만요청자 --></th>
                            <td>
...
<script type="text/javascript" charset="UTF-8">
    ...
    ************************************************************************************/
    ...
    function changeComboList(value) {
        ...
        console.log("유형에 따른 입력부 컨트롤 ( 유형 - 불만에 따라서 show / hide )")
        ...
        if(value === "02"){
            ...
            $("#pconCustInfoTxt").text("<spring:message code='crm.lbl.cmplDlEmpId' />")      //불만만족도
            $("#pconStsfIvstTxt").text("<spring:message code='crm.lbl.cmplStsfIvst' />")     //불만요청자
