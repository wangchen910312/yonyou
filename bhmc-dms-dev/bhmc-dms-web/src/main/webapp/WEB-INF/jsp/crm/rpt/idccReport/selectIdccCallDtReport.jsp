...
<script type="text/javascript">
    function idccReportCall(){
        ...
        idccReportParam += "&sLeadStatCd=02";
        idccReportParam += "&sValidGradeCd=02";
        $("#iframeIdccReport").attr("src", "<c:url value='/ReportServer?reportlet=crm/idccReport/selectIdccCallDtReport.cpt' />&op=view"+idccReportParam);
    }
