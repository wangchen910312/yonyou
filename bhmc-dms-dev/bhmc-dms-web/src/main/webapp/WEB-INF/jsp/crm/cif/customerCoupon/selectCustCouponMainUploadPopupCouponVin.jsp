...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/crm/cif/customerCoupon/insertUploadFileCouponVin.do"/>">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
 ...
 * 팝업 옵션
 */
 var options = parent.custCouponMainUploadPopupCouponVin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnFileDownload").kendoButton({
        click:function(e){
            location.href = "<c:url value='/cmm/sci/selectExcelTemplateDownload.do' />" + "?fileNm=CouponVin_Tpl.xlsx";
        }
    });
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            parent.custCouponMainUploadPopupCouponVin.close();
       }
    });

    $("#progressSection").excelUpload({
        progressId :"UPLOAD_FILE_CLUPONVIN"
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{field:"vinNo", title:"<spring:message code='crm.lbl.vinNo' />", width :150 , attributes:{"class":"ac"}}  // 고객번호
