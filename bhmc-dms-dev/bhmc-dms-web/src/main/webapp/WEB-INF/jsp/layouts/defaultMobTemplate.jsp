...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/kendo/old/kendo.common.min.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/kendo/old/kendo.rtl.min.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/kendo/old/kendo.default.min.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/kendo/old/kendo.dataviz.min.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/kendo/old/kendo.dataviz.default.min.css"/>">
...
<script type="text/javascript" src="<c:url value="/resources/js/kendo/old/kendo.all.min.js"/>"></script>
...
<div id="mwrap">
    ...
    <!-- container -->
    <div id="container">
        <div class="blind" style="width: 100%; height: 100%; background-color: black; position: absolute; left: 0; top: 0; opacity:0.4; display: none; z-index: 1000;" onclick="layerClose2('#layerPopup')"></div>
...
// 타이틀 클릭 조회기능 여부 전역변수(검색 타이틀 아이콘 처리용도) "Y":조회기능 유, "N":조회기능 무
var searchMode = "Y";
var searchModePopup = "N";  //팝업 조회기능 유무 추가
...
var includeList = "Y";
 ...
 $(document).ready(function() {
    ...
    if(includeList == "Y"){
     ...
     $("#docu_prev").bind("touchend", function()
         {
             if ($("#content_list").css("display") == "block") { mob.loading.show(); goMain(); }
         }
     );
    ...
    if(searchModePopup == "Y"){
        var  obj = $("#content_pop_search");
        if(obj.html() != null && obj.html() != "undefined"){
            $("#header_title").html("<span class='search_open'>"+$("#header_title").html()+"</span>");
            $("#header_title, #docu_prev").bind("click", function(){
                if(obj.css("display") == "block"){
