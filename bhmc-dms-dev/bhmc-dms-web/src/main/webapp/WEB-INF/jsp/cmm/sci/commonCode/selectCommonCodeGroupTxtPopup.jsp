...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        *************************************************************/
         ...
         * 팝업 옵션
         */
         var options = parent.cmmGrpTextPopupWin.options.content.data;
        ...
        *************************************************************/
        ...
        $("#btnAdd").kendoButton({
            click:function(e) {
                $('#grid').data('kendoExtGrid').dataSource.insert(0, {"cmmGrpCd":sCmmGrpCd, "langCd":"", "cmmGrpCdTxt":"", "remarkTitleNm":""});
            }
        });
        ...
        $("#btnSave").kendoButton({
            click:function(e) {
                ...
                if (grid.gridValidation()) {
                    $.ajax({
                        url:"<c:url value='/cmm/sci/commonCode/multiCommonCodeGroupTxts.do' />",
        ...
        *************************************************************/
        ...
        $("#grid").kendoExtGrid({
            dataSource:{
                 transport:{
                    read:{
                        url:"<c:url value='/cmm/sci/commonCode/selectCommonCodeGroupTxts.do' />"
                    }
                ...
                ,schema:{
                    model:{
                        ...
                        ,fields:{
                            ...
                            ,cmmGrpCdTxt:{type:"string", validation:{required:true}, editable:true}
            ...
            ,editableOnlyNewExcludeColumns:["langCd","cmmGrpCdTxt","remarkTitleNm"]
            ,autoBind:true
            ,pageable:false
            ,height:449
            ,columns:[
                {field:"cmmGrpCd", title:"<spring:message code='global.lbl.cmmGrpCd' />", width:100 ,attributes:{"class":"ac"}}
                ...
                ,{field:"cmmGrpCdTxt", title:"<spring:message code='global.lbl.cmmGrpCdTxt' />", width:200}
                ,{field:"remarkTitleNm", title:"<spring:message code='cmm.lbl.remarkTitleNm' />", width:250}
                ,{title:""}
            ]
