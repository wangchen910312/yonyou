...
<section class="group">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
          	<dms:access viewId="VIEW-D-10872" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="header_area">
        ...
        <div class="btn_right">
        	<dms:access viewId="VIEW-D-10873" hasPermission="${dms:getPermissionMask('READ')}">
            	<button type="button" class="btn_s" id="btnGroupSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
          	</dms:access>
          	<dms:access viewId="VIEW-D-10875" hasPermission="${dms:getPermissionMask('READ')}">
            	<button type="button" class="btn_s" id="btnGroupAdd"><spring:message code="global.btn.rowAdd" /><!-- 행추가 --></button>
          	</dms:access>
          	<dms:access viewId="VIEW-D-10876" hasPermission="${dms:getPermissionMask('READ')}">
            	<button type="button" class="btn_s" id="btnGroupDel"><spring:message code="global.btn.rowDel" /><!-- 행삭제 --></button>
          	</dms:access>
          	<dms:access viewId="VIEW-D-10874" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div id="tabstrip" class="tab_area">
        <ul>
            ...
            <li id="targetTaskTab"><spring:message code="global.lbl.targetTask" /><!-- 수신대상[직무] 탭 --></li>
        ...
        <div class="mt0">
            <div class="header_area">
                <div class="btn_right">
                  	<dms:access viewId="VIEW-D-10883" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnTemplateSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
                  	</dms:access>
                  	<dms:access viewId="VIEW-D-10881" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnTemplateAdd"><spring:message code="global.btn.add" /><!-- 추가 --></button>
                  	</dms:access>
                  	<dms:access viewId="VIEW-D-10882" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <div class="mt0">
            <div class="header_area">
                <div class="btn_right">
                  	<dms:access viewId="VIEW-D-10886" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnTargetTaskSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
                  	</dms:access>
                  	<dms:access viewId="VIEW-D-10884" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnTargetTaskAdd"><spring:message code="global.btn.add" /><!-- 추가 --></button>
                  	</dms:access>
                  	<dms:access viewId="VIEW-D-10885" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <div class="mt0">
            <div class="header_area">
                <div class="btn_right">
                  	<dms:access viewId="VIEW-D-10889" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnTargetUserSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
                  	</dms:access>
                  	<dms:access viewId="VIEW-D-10887" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnTargetUserAdd"><spring:message code="global.btn.add" /><!-- 추가 --></button>
                  	</dms:access>
                  	<dms:access viewId="VIEW-D-10888" hasPermission="${dms:getPermissionMask('READ')}">
        ...
        <div class="mt0">
            <div class="header_area">
                <div class="btn_right">
                  	<dms:access viewId="VIEW-D-10892" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnExcludeTargetUserSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
                 	</dms:access>
                  	<dms:access viewId="VIEW-D-10890" hasPermission="${dms:getPermissionMask('READ')}">
                    	<button type="button" class="btn_xs" id="btnExcludeTargetUserAdd"><spring:message code="global.btn.add" /><!-- 추가 --></button>
                  	</dms:access>
                  	<dms:access viewId="VIEW-D-10891" hasPermission="${dms:getPermissionMask('READ')}">
...
//수신대상[직무]/수신대상[사용자] 메세지템플릿 체크박스 이벤트 처리
...
$(document).ready(function() {
            ...
            if (grid.gridValidation()) {
                $.ajax({
                    ...
                    success:function(jqXHR, textStatus) {
                        ...
                        //메세지템플릿 변경에따라 수신대상[직무]/수신대상[사용자] 데이터소스를 갱신한다.
                ...
                ,content:{
                    ...
                    , data:{
                        ...
                        ,"callbackFunc":function(data){
                            ...
                            for(var i=0; i<data.length; i++) {
                                //알림정책 수신대상[직무]에 이미 등록된 목록은 제외 한다.
                                if(selectedAlrtPolicyId != "" && !targetTaskGrid.exists(function(obj){
    ...
    $("#policyGroupGrid").kendoExtGrid({
        ...
        ,editableOnlyNewExcludeColumns:["alrtPolicyGrpNm","actionUrlWeb","actionUrlMob","useYn"]
        ...
        ,columns:[
            ...
            ,{field:"alrtPolicyGrpNm", title:"<spring:message code='global.lbl.alrtPolicyGrpNm' />", width:400}
        ...
        ,columns:[
            ...
            ,{field:"mesgTmplTpList", title:"<spring:message code='global.lbl.mesgTmpl' />", width:300, filterable:false
                ,template:function (dataItem){
                    ...
                    var html = "<div class='mesgTmplTpListTemplate' data-uid='" + dataItem.uid + "' data-grid='targetTaskGrid'>"
