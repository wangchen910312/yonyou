...
<section class="group">
    <div class="header_area">
        ...
        <div class="btn_right">
	        <dms:access viewId="VIEW-D-10849" hasPermission="${dms:getPermissionMask('READ')}">
	            <button type="button" class="btn_m btn_save" id="btnSave"><spring:message code="global.btn.save" /><!-- 저장 --></button>
	        </dms:access>
	        <dms:access viewId="VIEW-D-13032" hasPermission="${dms:getPermissionMask('READ')}">
...
$(document).ready(function() {
    ...
    $("#custInfoUpdtValidPrid").data("kendoExtNumericTextBox").enable(false);
});
</script>