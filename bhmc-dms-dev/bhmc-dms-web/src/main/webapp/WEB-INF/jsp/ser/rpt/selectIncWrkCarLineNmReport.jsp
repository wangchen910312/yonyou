        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th scope="row"><spring:message code='ser.lbl.incWrkManNm' /></th> <!-- 보험업무담당 -->
                    <td>
                        <input id="" class="form_comboBox" />
                    </td>
                </tr>
...
function subTotalStatusCall(){
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectIncWrkCarLineNmReport.cpt' />"
      , param = "";
