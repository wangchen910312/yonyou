    ...
    <div class="content">
        <section class="group">
            <div class="header_area">
                <div class="btn_left">
                    <dms:access viewId="VIEW-D-13196" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" id="btnInit" class="btn_m btn_reset"><spring:message code="global.btn.init" /></button>
                    </dms:access>
                </div>
                <div class="btn_right">
                    <dms:access viewId="VIEW-D-13194" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_m" id="btnExcelExport"><spring:message code="ser.btn.excelDownload" /></button>
                    </dms:access>
                    <dms:access viewId="VIEW-D-13195" hasPermission="${dms:getPermissionMask('READ')}">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="row"><spring:message code="ser.lbl.custReqCd" /></th><!-- 의견코드 -->
                                <td>
                                    <input type="text" id="sCustReqCd" class="form_input"/>
                                </td>
...
$(document).ready(function(){
    ...
    $("#btnExcelExport").kendoButton({
        ...
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/ser/ro/repairOrder/selectServiceCustDemandHistoryCnt.do' />"
                ...
                ,success:function(result){
                    if(result.total <= 10000){
                        dms.ajax.excelExport({
                            ...
                            ,"templateFile"         :"RepairOrderCustDmndHistList_Tpl.xlsx"
                            ,"fileName"             :"<spring:message code='ser.menu.roCustDnmdHist' />.xlsx"
                            ,"sVinNo"               :$("#sVinNo").val()
                            ,"sDriverNm"            :$("#sDriverNm").val()
                            ,"sRoDocNo"             :$("#sRoDocNo").val()
    ...
    $("#grid").kendoExtGrid({
        gridId:"G-SER-0717-000001"
        ,dataSource:{
            transport:{
                read:{
                    url:"<c:url value='/ser/ro/repairOrder/selectRepairOrdersCustDemandHistory.do' />"
                    ,dataType:"json"
                    ,type:"POST"
                    ,contentType:"application/json"
                }
                ,parameterMap:function(options, operation) {
                    if (operation === "read") {
                        ...
                        params["sCustReqCd"] = $("#sCustReqCd").val();
            ...
            ,schema:{
                model:{
                    ...
                    ,fields:{
                        ...
                        ,custReqCd:{type:"string"}
                        ,custReqCont:{type:"string"}
        ...
        ,columns:[
            ...
            ,{field:"custReqCd", title:"<spring:message code='ser.lbl.custReqCd' />", width:100, attributes:{"class":"ac"}} // 의견코드
            ,{field:"custReqCont", title:"<spring:message code='ser.lbl.reqCont' />", width:150}               // 의견내용
        ]
    });
