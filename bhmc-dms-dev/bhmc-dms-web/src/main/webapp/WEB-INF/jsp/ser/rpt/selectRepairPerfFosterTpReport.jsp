...
<div class="fsearch_area">
    ...
    <div class="header_area">
        <div class="btn_right">
            <%-- <dms:access viewId="VIEW-D-12892" hasPermission="${dms:getPermissionMask('READ')}"> --%>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input id="sTecNm" class="form_input" />
                    </td> --%>
                </tr>
            </tbody>
        </table>
...
function subTotalStatusCall(){
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectRepairPerfFosterTpReport.cpt' />"
      , param = "";
