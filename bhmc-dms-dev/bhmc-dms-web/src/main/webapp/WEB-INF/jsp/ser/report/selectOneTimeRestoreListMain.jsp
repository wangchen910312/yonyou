...
<!-- 서비스경영 통계  -->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div id="I04" style="background-image:url('${springPath}/resources/img/ico_prei03.png') ;width:30px;height:40px;background-size:auto auto">xx</div>
                    </td>
                    <th scope="row"><spring:message code="ser.lbl.driver" /></th><!--운전자  -->
                    <td>
                        <input type="text" value="22" class="form_input" id="sDriverNm">
                    </td>
                    <th scope="row"></th>
                    <td></td>
                </tr>
    ...
    <div class="table_info table_info_v1 mt10">
        ...
        <iframe id="iframeReport" name="iframeReport" src="" frameborder="0" scrolling="no" width="100%" height="800"></iframe>
    </div>
...
function reportCall(){
    ...
    reportUrl = "<c:url value='/ReportServer?reportlet=ser/selectPreCheckPrintMain.cpt'/>&locale=zh&sDiagDocNo=PC201609-0018&sDlrCd=A07AA";
