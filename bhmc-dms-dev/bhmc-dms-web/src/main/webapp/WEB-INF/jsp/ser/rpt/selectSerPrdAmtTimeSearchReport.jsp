...
<div class="fsearch_area">
    ...
    <div class="header_area">
        <div class="btn_right">
            <%-- <dms:access viewId="VIEW-D-12882" hasPermission="${dms:getPermissionMask('READ')}"> --%>
...
function subTotalStatusCall(){
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerPrdAmtTimeSearchReport.cpt' />"
      , param = "";
    ...
    param += "&sDlrRoTp="+$("#sSelfDefineTp").val();
