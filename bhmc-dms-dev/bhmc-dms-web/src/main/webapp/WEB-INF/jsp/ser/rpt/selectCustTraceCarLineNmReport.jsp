        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th scope="row"><spring:message code='ser.lbl.rpirTp' /></th> <!-- 수리유형(수리예약유형) -->
                    <td>
...
function subTotalStatusCall(){
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectCustTraceCarLineNmReport.cpt' />"
      , param = "";
