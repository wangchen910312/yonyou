...
<%--
    ...
    <input type="hidden" id="sItemCd" name="sItemCd" />
    <input type="hidden" id="sRoDocNo" name="sRoDocNo" />
    <input type="hidden" id="sRoDt" name="sRoDt" />
         ...
         transport:{
            ...
            ,parameterMap:function(options, operation) {
                if (operation === "read") {
                    ...
                    params["sRoDt"] =  kendo.parseDate( $("#sRoDt").val());
