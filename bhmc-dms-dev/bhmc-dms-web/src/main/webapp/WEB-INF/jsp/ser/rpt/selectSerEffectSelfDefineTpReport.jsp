...
<div class="fsearch_area">
    ...
    <div class="header_area">
        <div class="btn_right">
            <%-- <dms:access viewId="VIEW-D-12884" hasPermission="${dms:getPermissionMask('READ')}"> --%>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input id="" class="form_comboBox" disabled />
                    </td>
                </tr>
            </tbody>
        </table>
...
function subTotalStatusCall(){
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerEffectSelfDefineTpReport.cpt' />"
      , param = "";
