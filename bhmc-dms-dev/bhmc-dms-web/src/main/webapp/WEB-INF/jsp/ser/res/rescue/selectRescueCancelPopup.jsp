...
<section id="windows" class="pop_wrap">
    ...
    <div class="header_area">
        <h1 class="title_basic"><spring:message code="ser.lbl.resvCancel" /><!-- 예약취소 --></h1>
        <div class="btn_right">
    ...
    <input type="hidden" id="rescStatCd" name="rescStatCd" value="C">
...
$(document).ready(function() {
    ...
    $("#rescDocNo").val(options.rescDocNo);
    ...
    $("#btnCreate").kendoButton({
        click:function(e) {
            ...
            $.ajax({
                url:"<c:url value='/ser/res/rescue/updateRescue.do' />"
