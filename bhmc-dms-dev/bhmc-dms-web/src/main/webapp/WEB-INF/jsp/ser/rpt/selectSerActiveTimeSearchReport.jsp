        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <th scope="row"><spring:message code='ser.lbl.carlineNm' /></th> <!-- 활동코드 -->
                    <td>
                        <input id="" class="form_comboBox" />
                    </td>
                    <th scope="row"><spring:message code='ser.lbl.rpirTp' /></th> <!-- 활동명칭 -->
                    <td>
                        <input id="" class="form_comboBox" />
                    </td>
                </tr>
...
function subTotalStatusCall(){
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectSerActiveTimeSearchReport.cpt' />"
      , param = "";
