        ...
        <section class="group">
            <div class="header_area">
                <div class="btn_right" style="display:none">
                    <dms:access viewId="VIEW-D-12083" hasPermission="${dms:getPermissionMask('READ')}">
                        <button class="btn_m btn_search" id="btnSearch"><spring:message code="global.btn.search" /></button>
                    </dms:access>
                    <dms:access viewId="VIEW-D-12082" hasPermission="${dms:getPermissionMask('READ')}">
