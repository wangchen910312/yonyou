    ...
    <div class="content">
        <section class="group">
            ...
            <h1 class="title_basic"><spring:message code="ser.title.incMng" /></h1>
                <div class="btn_right">
                    <dms:access viewId="VIEW-D-12090" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_m btn_search" id="btnSearch"><spring:message code="global.btn.search" /></button>
                    </dms:access>
                    <dms:access viewId="VIEW-D-12089" hasPermission="${dms:getPermissionMask('READ')}">
            ...
            <div class="header_area">
                <div class="btn_right">
                    <dms:access viewId="VIEW-D-12088" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s btn_add btn_s_min5" id="btnAdd"><spring:message code="global.btn.rowAdd" /></button>
                    </dms:access>
                    <dms:access viewId="VIEW-D-12087" hasPermission="${dms:getPermissionMask('READ')}">
                        <button type="button" class="btn_s btn_del btn_s_min5" id="btnDel"><spring:message code="global.btn.rowDel" /></button>
                    </dms:access>
                    <dms:access viewId="VIEW-D-12086" hasPermission="${dms:getPermissionMask('READ')}">
