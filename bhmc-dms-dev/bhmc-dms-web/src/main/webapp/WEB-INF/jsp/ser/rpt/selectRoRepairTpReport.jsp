...
<div class="fsearch_area">
    ...
    <div class="header_area">
        <div class="btn_right">
            <%-- <dms:access viewId="VIEW-D-12867" hasPermission="${dms:getPermissionMask('READ')}"> --%>
...
function subTotalStatusCall(){
    var subTotalStatusUrl = "<c:url value='/ReportServer?reportlet=ser/selectRoRepairTpReport.cpt' />"
      , param = "";
