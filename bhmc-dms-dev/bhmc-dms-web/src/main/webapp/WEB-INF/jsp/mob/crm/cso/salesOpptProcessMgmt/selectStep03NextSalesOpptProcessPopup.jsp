                        ...
                        <tr>
                            ...
                            <td>
                                <div class="f_item01">
                                    ...
                                    <span class="date" onclick="calpickerWithTime('vsitDt','vsitTime')">날짜선택</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="f_item01">
                                    <input type="search" class="ar" id="vsitTime" data-json-obj="true" /> <!-- name="vsitTime"  -->
                                    <span class="time" onclick="timepicker2('vsitTime')">시간선택</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="f_item01">
                                    ...
                                    <span class="date" onclick="calpickerWithTime('vsitEndDt','vsitEndTime')">날짜선택</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
        ...
        $("#btnNextStep").kendoButton({
            click:function(e){
                ...
                if(dms.string.isEmpty(sVsitDt)){
                    ...
                    salesOpptProcParam["vsitDt"] =  chgDateTimeStamphhMM($("#vsitDt").val() + " " + $("#vsitTime").val());
                }
