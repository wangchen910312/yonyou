            ...
            <table class="flist01">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="f_term">
                            <div class="f_item01" style = "width:82%">
                                ...
                                <span class="date" onclick="calpicker('sRoFromDt');"><spring:message code='global.lbl.date' /></span>
                            </div><span class="termtext"> ∼</span>
                            <div class="f_item01" style = "width:82%">
                                <input type="search" id="sRoToDt" style="width:140px" class="" />
                                <span class="date" onclick="calpicker('sRoToDt');"><spring:message code='global.lbl.date' /></span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="f_term">
                            <div class="f_item01" style = "width:82%">
                                <input type="search" id="sCalcFromDt" style="width:140px" class="" />
                                <span class="date" onclick="calpicker('sCalcFromDt');"><spring:message code='global.lbl.date' /></span>
                            </div><span class="termtext"> ∼</span>
                            <div class="f_item01" style = "width:82%">
                                <input type="search" id="sCalcToDt" style="width:140px" class="" />
                                <span class="date" onclick="calpicker('sCalcToDt');"><spring:message code='global.lbl.date' /></span>
                            </div>
                        </td>
                    </tr>
                </tbody>
...
/*
    $("#lbrCalcAmt,#lbrDcRate,#lbrDcAmt,#lbrWhDcAmt,#lbrBmPointUseAmt,#lbrPointUseAmt,#lbrEtcDcAmt,#lbrCalcSumAmt,#parCalcAmt,#parDcRate,#parDcAmt,#parWhDcAmt,#parBmPointUseAmt").kendoExtNumericTextBox({
        format:"n2"                // n0:###,###, n2:###,###.##
       ,decimals:2                // 소숫점
       //,min:0.00
       ,value:0.00
