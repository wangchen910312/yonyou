...
<div class="deleteitem">
    ...
    <span class="clboth" style="width:30%">#:chgDate2Str(expcSaleDt) #</span>
...
var listData = new kendo.data.DataSource({
  ...
  ,schema:{
      ...
      ,model:{
          ...
          ,fields:{
              ...
              ,modelNm:{type:"string"}
              ,expcSaleDt:{type:"date" ,format:"{0:<dms:configValue code='dateFormat' />}"}
  ...
  change:function(e) {
      ...
      if(rTotal > 0){
          ...
          parent.setSubListHeightNew("salesOpptList",3,rTotal);
      }else{
          //parent.setSubListHeight2("salesOpptList", 0, "Y");
          parent.setSubListHeightNew("salesOpptList",3,0);
      }
      }, 200);

      checklistCnt("salesOpptList_noData",this.total(),noDatamsg);
