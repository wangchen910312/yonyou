              ...
              if(result.data!=null && result.data != ""){
                  ...
                  $.each(result.data , function(i , row){
                      ...
                      data.push({
                          ...
                          statCd:row.statCd,
                          ddlnDt:chgDate2DateTimeStr(row.ddlnDt),
                          opptChgDt:chgDate2DateTimeStr(row.opptChgDt),
                          regDt:chgDate2DateTimeStr(row.regDt),
                          allocDt:chgDate2DateTimeStr(row.allocDt),
                          delayYn:row.delayYn,
                          remark:row.remark
                       });
                  });
