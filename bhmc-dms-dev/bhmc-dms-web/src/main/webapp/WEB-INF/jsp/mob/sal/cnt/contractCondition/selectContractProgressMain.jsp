                        ...
                        <tr>
                            ...
                            <td class="f_term">
                                <div class="f_item01" style="width:80%">
                                    <input type="search" id="sCtrStartDt"  />
                                    <span class="date" onclick="calpicker('sCtrStartDt')"><spring:message code='global.lbl.date' /></span>
                                </div>
                                <span class="termtext"> ∼</span>
                                <div class="f_item01" style="width:80%">
                                    <input type="search" id="sCtrEndDt"  />
                                    <span class="date" onclick="calpicker('sCtrEndDt')"><spring:message code='global.lbl.date' /></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table  class="flist01">
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <!--
                            <tr>
                                <th scope="row"><spring:message code="sal.lbl.recPrice" /></th>
                                <td>
                                    <div class="f_text f_disabled">
                                    <input id="recPrice" type="text" class="f_text" placeholder="" disabled="disabled"/>
                                    </div>
                                </td>
                            </tr> <!-- 영수증발행가격
                            -->
...
$(document).ready(function() {
    ...
    // 목록 조회
    $("#mainList").attr("src", "<c:url value='/mob/sal/cnt/contractCondition/selectContractProgressList.do' />");
