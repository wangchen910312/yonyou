...
var listData = new kendo.data.DataSource({
  ...
  change:function(e) {
      ...
      if(rTotal > 0){
          ...
          //parent.setSubListHeightNew("dlrMbrShipList",2,rTotal);
      }else{
          //parent.setSubListHeight2("dlrMbrShipList", 0, "Y");
          //parent.setSubListHeightNew("dlrMbrShipList",2,0);
      }
      }, 200);

      checklistCnt("dlrMbrShipList_noData",this.total(),noDatamsg);
