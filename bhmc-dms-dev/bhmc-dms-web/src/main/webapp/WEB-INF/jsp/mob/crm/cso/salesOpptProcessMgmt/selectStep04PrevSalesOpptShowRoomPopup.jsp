...
<section id="content">
        ...
        <section id="content_detail" class="content_detail">
            ...
            <div class="formarea" id="formarea" >
                <table class="flist01">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row"><spring:message code="crm.lbl.failedReason" /><!-- 전패원인 --></th>
                            <td>
            ...
            <div class="co_group">
                <div class="content_title">
                    ...
                    <div class="title_btn">
                        <span class="tbtn01" id="btnAddAddress" ><spring:message code="global.btn.add" /><!-- 추가 --></span>
    ...
    <div class="con_btnarea btncount3">
        ...
        <div><span class="btnd1" id="btnPrevStepBefore"><spring:message code="crm.lbl.failCustomer" /><!-- 전패(잠재고객 DB로 제출) --></span></div>
