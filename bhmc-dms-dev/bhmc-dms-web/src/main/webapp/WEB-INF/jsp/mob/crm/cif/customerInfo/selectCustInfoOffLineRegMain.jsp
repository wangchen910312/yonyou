    ...
    <section id="content">
        ...
        <section id="content_list">
            <div class="content_title conttitlePrev">
                <h2><spring:message code="global.lbl.regCustList" /><!-- 등록고객 목록  --></h2>
            </div>
            <div class="listarea">
...
custSourceList({"cmmCd":"${obj.cmmCd}", "cmmCdNm":"${obj.cmmCdNm}", "useYn":"${obj.useYn}"});
...
function selectItemList(){
    ...
    try{
        ...
        {
            document.location='bhmccp://SELECT?TABLE_NM=Cust_info&return_func=setItemList';
        }else /* if (userAgent.search("android") > -1) */
        {
            //alert("1");
            window.bhmccp.SELECT('Cust_info', '', 'setItemList');
        }
    }catch(e){
        /* var resultList = "{\"data\":[{\"SUBCAMPAIN_CD\":\"\", \"CUST_NM\":\"사진\", \"CUST_HP\":\"1111111111\", \"CAMPAIN_CD\":\"11\",\"CREATE_DATE\":\"2015-01-01\"},{\"SUBCAMPAIN_CD\":\"\", \"CUST_NM\":\"사진2\", \"CUST_HP\":\"2111111111\",\"CAMPAIN_CD\":\"11\",\"CREATE_DATE\":\"2015-01-01\"}]}";
