...
<!--                                 </div> -->
                                <div class="numdetail">
                                    ...
                                    <p class="right_cont"><span class="txt"><spring:message code='mob.lbl.crm.reservedLeadCount' />/<spring:message code='mob.lbl.crm.visitReserviceLeadCount' /></span><span class="txt_num" id="____"><fmt:formatNumber value="${reservedLeadCount}" type="number" />/<fmt:formatNumber value="${visitReserviceLeadCount}" type="number" /></span></span></p><!-- 예약방문/내방  -->
