        ...
        <section id="content_detail" class="content_detail">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="f_item01">
                                    ...
                                    <%-- <span class="date" onclick="calpicker('vsitDt')"><spring:message code='global.lbl.date' /></span> --%>
                                    <span class="date" onclick="calpickerWithTime('vsitDt','vsitTime')"><spring:message code='global.lbl.date' /></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="f_item01">
                                    <input type="search" class="ar" id="vsitTime" name="vsitTime" />
                                    <span class="time" onclick="timepicker2('vsitTime')"><spring:message code='ser.lbl.dt' /></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="f_item01">
                                    ...
                                    <span class="date" onclick="calpickerWithTime('vsitEndDt','vsitEndTime')"><spring:message code='global.lbl.date' /></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="f_item01">
                                    <input type="search" class="ar" id="vsitEndTime" name="vsitEndTime"/>
                                    <span class="time" onclick="timepicker2('vsitEndTime')"><spring:message code='ser.lbl.dt' /></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="co_group">
                <div class="content_title ">
                    ...
                    <%-- <div class="title_btn" style="position:relative;top:-1px;">
                        <span class="btnd1" id="infoCheck"><spring:message code='global.lbl.infoData' /><spring:message code='global.btn.confirm' /></span>
                    </div> --%>
                </div>
                <div class="co_view">
                    <div class="formarea" id="formarea" >
                        <table class="flist01">
                            ...
                            <tbody  >
                                ...
                                <%-- <tr class="fromScanID fromScanDirver fromNameCard" style="display:none;">
                                    <th scope="row"><spring:message code="crm.lbl.addrNm" /><!--주소 --></th>
                                    <td>
                                        <div class="f_text"><input type="text" id="addrFull" name="addrFull" maxlength="40" data-json-obj="true" /></div>
                                    </td>
                                </tr> --%>
                                ...
                                <%-- <tr class="fromScanNamecard" style="display:none;">
                                    <th scope="row"><spring:message code="global.btn.zipCd" /><!--우편번호 --></th>
                                    <td>
                                        <div class="f_text"><input type="text" id="CCCCCCCCCCC3" name="CCCCCCCCCCC3" maxlength="40" data-json-obj="true" /></div>
                                    </td>
                                </tr> --%>
                                <!--
                                <tr class="fromScanNamecard" style="display:none;">
                                    <th scope="row"><spring:message code="global.lbl.officeTelNo" /></th>
                                    <td>
                                        <div class="f_text"><input type="number" class="numberic" id="telNo" name="telNo" maxlength="40" data-json-obj="true" /></div>
                                    </td>
                                </tr><!--유선전화 -->
                            </tbody>
                        </table>
        ...
        $("#btnNextStepBefore").kendoButton({
            click:function(e) {
              ...
              //방문인원수
                ...
                vsitDt = chgDateTimeStamphhMM($("#vsitDt").val() + " " + $("#vsitTime").val());
        ...
        $("#btnSave").kendoButton({
            click:function(e){
                ...
                */
                ...
                var sVsitEndDt = chgDateTimeStamphhMM($("#vsitEndDt").val() + " " + $("#vsitEndTime").val());
                ...
                $.ajax({
                    ...
                    ,contentType:'application/json'
                    ,error:function(jqXHR,status,error){
                        console.log(jqXHR.responseJSON.errors[0].errorMessage);
                        ...
                        if(jqXHR.responseJSON.errors.length>0){
                            ...
                            }else if(jqXHR.responseJSON.errors[0].errorMessage.search("전화번호가 규칙에 맞지 않습니다.")>-1){
