...
var userNm = "${userNm}";   // 사용자
    ...
    fnSearchTtext = function() {
        ...
        if (sRegStartDt.val() != "" && sRegEndDt.val() != "") {
            $("#search1Area span[name='searchStr']").html(sRegStartDt.val() + "~<br/>" + sRegEndDt.val());
        }
        else {
            if(sRegStartDt.val() != "") {
                $("#search1Area span[name='searchStr']").html(sRegStartDt.val() + "~");
            }
            else if (sRegEndDt.val() != "") {
                $("#search1Area span[name='searchStr']").html("~" + sRegEndDt.val());
            }
        }
