...
<section id="content">
    ...
    <div class="content_right" id="salesOpptProcForm">
        <section id="content_detail" class="content_detail">
            <div class="content_title conttitlePrev">
                <h2><spring:message code='global.lbl.failReason' /><!-- 실패사유 --></h2>
            </div>
            <div class="formarea" id="formarea" >
                <table class="flist01">
                    <caption><spring:message code="global.lbl.failReason" /></caption>
                    <colgroup>
                        <col style="width:30%;">
                        <col style="">
                    </colgroup>
                    <tbody>
                        <tr>
                            <th scope="row" class="required"><spring:message code="crm.lbl.failedReason" /><!-- 전패원인 --></th>
                            <td>
                                <div class="f_text"><input type="text" id="failCauCd" name="failCauCd" data-json-obj="true"  /></div>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><spring:message code="crm.lbl.otherBrand" /><!-- 타사브랜드 --></th>
                            <td>
                                <div class="f_text"><input type="text" id="otherBrandCd" name="otherBrandCd" data-json-obj="true"  /></div>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><spring:message code="crm.lbl.failReasonAly" /><!-- 원인분석 --></th>
                            <td>
                                <textarea rows="2" cols="" class="f_textarea"  id="failCauReasonCont" name="failCauReasonCont" data-json-obj="true" ></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="co_group">
                <div class="content_title ">
                    <h1><spring:message code='global.title.basicInfo' /><!-- <spring:message code='global.lbl.basicInfo' /> --></h1>
                </div>
                <div class="co_view">
                    <div class="formarea" id="formarea" >
                        <table class="flist01">
                            <caption><spring:message code='global.title.basicInfo' /></caption>
                            <colgroup>
                                <col style="width:30%;">
                                <col style="">
                            </colgroup>
    ...
    <div class="con_btnarea btncount2">
        <div style="width:20%"><span class="btnd1t2" id="btnCancel"><spring:message code="global.btn.cancel" /><!-- 취소 --></span></div>
        <div style="width:80%"><span class="btnd1" id="btnPrevStepBefore"><spring:message code="crm.lbl.failCustomer"/><!-- 전패(잠재고객 DB로 제출) --></span></div>
...
<div id="docu_top" style="display:none">TOP</div>
 ...
 <c:forEach var="obj" items="${bizcondCdList}">
    bizcondCdList.push({"cmmCd":"${obj.cmmCd}", "cmmCdNm":"${obj.cmmCdNm}", "useYn":"${obj.useYn}"});
     ...
     <c:forEach var="obj" items="${failCauCdList}">
         failCauCdList.push({"cmmCd":"${obj.cmmCd}" , "cmmCdNm":"${obj.cmmCdNm}", "useYn":"${obj.useYn}"});
     </c:forEach>
...
// 고객확보유형2      holdDetlTpSeq   (CRM***)
        ...
        $("#failCauCd").kendoExtDropDownList({
            ...
            , dataValueField:"cmmCd"
            , optionLabel:"<spring:message code='global.lbl.check'/>"
            , dataSource:dms.data.cmmCdFilter(failCauCdList)
            , index:0
            , change:function(e){
     ...
     // 이메일   /^[A-Za-z0-9+]*$/  /[a-zA-Z0-9]/g;
       ...
       $("#btnCustSearch").click(function(){
           ...
           $.ajax({
               ...
               otherBrandCd = result.data[0].otherBrandCd;
               //$("#addrGrid").data("kendoExtGrid").dataSource.read();
               onSelectSearchFailOtherBrand();

               //$("#otherBrandCd").data("kendoExtDropDownList").text(otherBrandCd);
            ...
            click:function(e) {
             ...
             // 의향차종
                ...
                if ( dms.string.isEmpty(failCauCd) ) {
                    mob.notification.info("<spring:message code='crm.lbl.failedReason' var='returnMsg' /><spring:message code='global.info.chkSelectItemMsg' arguments='${returnMsg}' />");
                    return false;
                };
           ...
           if(responseJson.data!=null){
               if(responseJson.data.length == 0) {
                   ...
                   for(var i=0; i<responseJson.data.length; i++){
                       var otherBrandCdObj = {};
                       otherBrandCdObj.cmmCd=responseJson.data[i].intrCarlineCd;
                       otherBrandCdObj.cmmCdNm=responseJson.data[i].otherBrandCarlineNm;
                       otherBrandCdList.push(otherBrandCdObj);
                   }
                   $("#otherBrandCd").data("kendoExtDropDownList").setDataSource(otherBrandCdList);
               }
           }
