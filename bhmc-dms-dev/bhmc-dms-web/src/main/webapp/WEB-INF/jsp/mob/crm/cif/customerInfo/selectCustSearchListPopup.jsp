...
<div class="dlistitem" id="listContentRow">
    <span style="width:45%">#:custNm #<%--(#:changeCustTp(custTp)#)--%></span>
  ...
  transport:{
    read:function(options) {
      ...
      if(parentUrl.indexOf("/mob/crm/cif/customerInfo/selectCustomerInfoMain.do") > -1){
          ...
          params["sMngScId"] = parent.$("#psMngScId").data("kendoExtDropDownList").value();
          params["sCustCd"]  = parent.$("#psCustCd").data("kendoExtDropDownList").value();
          params["sHpNo"]    = parent.$("#psHpNo").val();
          /* params["sEmailNm"]  = parent.$("#psEmailNm").val(); */
          params["sSaleDtFrom"]= chgDate(parent.$("#psSaleDtFrom").val());
          params["sSaleDtTo"]= chgDate(parent.$("#psSaleDtTo").val());
          ...
          /* console.log("1 : ", parent.$("#custNm").val());
          console.log("2 : ", parent.$("#custTp").data("kendoExtDropDownList").value());   없음
          console.log("3 : ", parent.$("#hpNo").val());     없음
          console.log("4 : ", parent.$("#telNo").val());    undefined
          console.log("5 : ", parent.$("#custNo").val()); undefined */
      }
