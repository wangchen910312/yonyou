                ...
                <colgroup>
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td class="f_term">
                            <div class="f_item01">
                                <input type="search" id="sAllocDtFrom" style="width:140px" class="" />
                                <span class="date" onclick="calpicker('sAllocDtFrom');">날짜선택</span>
                            </div><span class="termtext"> ∼</span>
                            <div class="f_item01">
                                <input type="search" id="sAllocDtTo" style="width:140px" class="" />
                ...
                <table  class="flist01">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="f_text f_disabled"><input id="hpNo" type="number" class="numberic" placeholder="" disabled="disabled" data-json-obj="true"/></div>
                            </td>
                        </tr>
                        <tr>
...
roleUsersList.push({"cmmCd":"${obj.usrId}" , "cmmCdNm":"${obj.usrNm}"});
</c:forEach>

leadSrcList.push({"cmmCd":"", "cmmCdNm":" ", "useYn":""});
...
statList.push({"cmmCd":"", "cmmCdNm":" ", "useYn":""});
            ...
            if (saveData.insertList.length > 0) {
             ...
             $.ajax({
                 ...
                 success:function(result){
                     mob.notification.success("<spring:message code='global.lbl.save' var='saveSuccessMsg' /><spring:message code='global.info.successMsg' arguments='${saveSuccessMsg}'/>");
...
function contentDetail(dataItem) {
    ...
    if(dataItem != null){
        ...
        (dataItem.bhmcYn == "Y") ? $("#bhmcYn").attr("checked",true):$("#bhmcYn").attr("checked",false);
