...
var listData = new kendo.data.DataSource({
    transport:{
        read:function(options) {
          ...
          var data = [];
          rowTotal = parent.sungCdDs.length;
          $.each(parent.sungCdDs , function(i , row){
              rowIndex++;
              data.push({
                  sungNm:parent.sungCdDs[i].sungNm,
                  sungCd:parent.sungCdDs[i].sungCd
                });
          });
...
function listViewClick(e)
{
    ...
    parent.contentCommonDetail(1,e.dataItem);
    parent.$("#comonPopupList2").attr("src", "<c:url value='/mob/cmm/sci/commonPopup/selectZipCodeListPopup2.do?sungCd="+dataItem.sungCd+"' />");
    parent.$("#comonPopupList3").attr("src", "");
