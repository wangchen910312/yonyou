        ...
        <div class="formarea form2">
            <table class="flist01">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="f_term">
                            <div class="f_item01" style = "width:82%">
                                <input type="search" id="sRcvCpltFromDt" style="width:140px" class="" value="${oneMonthDtBf}"/>
                                <span class="date" onclick="calpicker('sRcvCpltFromDt');">날짜선택</span>
                            </div><span class="termtext"> ∼</span>
                            <div class="f_item01" style = "width:82%">
                                <input type="search" id="sRcvCpltToDt" style="width:140px" class="" value="${toDt}"/>
                                <span class="date" onclick="calpicker('sRcvCpltToDt');">날짜선택</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <%-- <tr>
                        <th scope="row"><spring:message code="ser.lbl.rcvDocNo" /><!-- 정산번호 --></th>
                        <td>
                            <div class="f_text"><input type="text" id="sRcvDocNo" /></div>
                        </td>
                    </tr> --%>
                </tbody>
            </table>
                ...
                <div class="co_view" style="display:none;">
                    <div class="listarea01">
                        <div class="listhead dlistitem">
                            ...
                            <%-- <span style="width:50%"><spring:message code="ser.lbl.invoiceNo" /><!-- 소각여부 --></span>
                            <span style="width:50%"><spring:message code="ser.lbl.invoiceNo" /><!-- 소각시간 --></span> --%>
                        </div>
                        <iframe id="subList1" name="subList1" border="1" frameborder="0" width="100%" height="170px"></iframe>
...
$(document).ready(function() {
    ...
    $("#subList1Btn").bind("click", function()
    {
        if(!$(this).hasClass("co_close")){
            $("#subList1").attr("src", "<c:url value='/mob/ser/rcv/serviceReceive/selectServiceReceiveDetailsHistList.do' />");
        }
    });
...
function contentDetail(dataItem) {
    ...
    if( dataItem != null && dataItem != 'undefined'){
        ...
        //$("#paymPridCd").val(dataItem.paymPridCd);
