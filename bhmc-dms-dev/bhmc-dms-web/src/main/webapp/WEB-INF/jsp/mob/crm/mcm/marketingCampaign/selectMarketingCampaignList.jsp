...
<script type="text/javascript">
    ...
    var listData = new kendo.data.DataSource({
        transport:{
            read:function(options) {
                ...
                params["sMakCd"]      = parent.$("#sMakCd2").val();
                ...
                $.ajax({
                    ...
                    ,success:function(result) {
                        checklistCnt("mainList_noData", result.total, noDatamsg);
                        if(result.data != null && result.data != "") {
                            ...
                            //  sSignDocNo, sSignDocNo 추적중.. 오후 1시 38분
    ...
    listViewClick = function(e) {
        parent.fnContentDetail(e.dataItem.makCd, e.dataItem.signDocId, e.dataItem.apprDocNo);
    }
