      ...
      $.ajax({
          ...
          ,success:function(result) {
              if(result.data!=null){
                  ...
                  //parent.setSubListHeight2("activeList",rowTotal,"N");
                  parent.setSubListHeightNew("activeList",5,rowTotal);
                  //mob.notification.success("<spring:message code='global.info.success'/>");
              }else{
                  app.hideLoading();
                  //parent.setSubListHeight2("activeList",0,"N");
                  parent.setSubListHeightNew("activeList",5,0);
              }

              checklistCnt("activeList_noData",result.total,noDatamsg);
          }
      });
    }
  },
