...
<section id="content">
    ...
    <section id="content_search" class="content_search" style="display:none;">
                    ...
                    <tr>
                        ...
                        <td class="f_term">
                            <div class="f_item01" style = "width:82%">
                                <input type="search" id="sSubmitDtFrom" style="width:150px" data-json-obj="true" readOnly />
                                <span class="date" onclick="calpicker('sSubmitDtFrom');"><spring:message code='global.lbl.date' /></span>
                            </div><span class="termtext"> ∼</span>
                            <div class="f_item01" style = "width:82%">
                                <input type="search" id="sSubmitDtTo" style="width:150px" data-json-obj="true" readOnly />
                                <span class="date" onclick="calpicker('sSubmitDtTo');"><spring:message code='global.lbl.date' /></span>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <div class="con_btnarea">
            ...
            <span id="btnCtlSearch" class="btnd1"><span class="search"><spring:message code='global.btn.search' /><!-- 조회 --></span></span>
            </dms:access>
        </div>
                                ...
                                <tr id="trLeadStat">
                                    ...
                                    <td>
                                       <%--  <div class="tabarea2 tabarea2_v2">
                                            <ul class="tridetype">
                                            <!-- <ul class="tabmenu"> -->
                                                <li><span id="btnCtlGotoStep01"><spring:message code='crm.lbl.uploadAdd'/></span></li><!-- 업로드 집객-->
                                                <li><span id="btnCtlGotoStep02"><spring:message code='crm.lbl.activeAppointment'/></span></li><!-- 추출예약 -->
                                                <li><span id="btnCtlGotoStep04Before"><spring:message code='crm.lbl.activeProcessing'/></span></li><!-- 추적추진 -->
                                                <li><span id="potenCustFail" class="on"><spring:message code='crm.lbl.potenCustFail'/></span></li><!-- 잠재고객(실패) -->
...
/*     $("#sSubmitDtFrom").kendoExtMaskedDatePicker({
    ...
    //$("#header_title").html("<span class='search_open'>"+$("#header_title").html()+"</span>");
     ...
     if(fromTodoCustNo.length > 0){
         ...
         $("#mainList").attr("src", "<c:url value='/mob/crm/cso/salesOpptProcessMgmt/selectSalesOpptProcessMgmtFailList.do' />");
     }
...
function onSelectBtnStepClick(selStep){
     ...
     if (selStep == "btnStep08") {
         ...
         //$("[id^='btnStep08']").attr("class", "child3 on");
         //$("[id^='btnStep09']").attr("class", "child2");
         ...
         //$("[id^='btnStep09']").attr("class", "child3 on");
         //$("[id^='btnStep08']").attr("class", "child2");
     ...
     /*
     $("#btnStep09 > a").html("<span align="center" style="background-color:#b4b6bc;"><spring:message code='global.btn.failed' /><!-- 실패 --></span>");
     <li id="btnStep09"><a href="javascript:;" onclick="javascript:onSelectBtnStepClick('btnStep09');" ><span align="center" style="background-color:#b4b6bc;"><spring:message code='global.btn.failed' /><!-- 실패 --></span></a></li>
...
function contentDetailFromTodo(_fromTodoCustNo, _fromTodoLeadStatCd) {
     ...
     //params["sLeadStatCd"] = _fromTodoLeadStatCd;
     ...
     $.ajax({
         ...
         ,success:function(result) {
             if(result.data!=null){
                 ...
                 //$("#rvsitYn").val(chgBuyYnMap[dataItem.rvsitYn]);
