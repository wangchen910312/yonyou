    ...
    <section id="content_list">
        <div class="content_title conttitlePrev">
            <h2 id="content_list_title"><spring:message code="sal.lbl.comVehicleDrvHisList" /><!-- 회사차 운행내역 목록 --></h2>
             <div class="title_btn">
                <dms:access viewId="VIEW-D-12651" hasPermission="${dms:getPermissionMask('READ')}">
                    ...
                    <colgroup>
                     ...
                     <tbody>
                        <tr id="search1Area">
                            ...
                            <dms:access viewId="VIEW-D-12650" hasPermission="${dms:getPermissionMask('READ')}">
                        ...
                        <tr id="search2Area">
                            ...
                            <dms:access viewId="VIEW-D-12649" hasPermission="${dms:getPermissionMask('READ')}">
                                <td><span name="searchStr"></span> <span class="btn_delete"><spring:message code="global.lbl.del" /><!-- 삭제 --></span></td>
                            </dms:access>
                        </tr>
                        <tr id="search3Area">
                            <th scope="row"><span><spring:message code="global.lbl.useTime" /><!-- 사용일시 --></span></th>
                            <dms:access viewId="VIEW-D-12648" hasPermission="${dms:getPermissionMask('READ')}">
                                <td><span name="searchStr"></span> <span class="btn_delete"><spring:message code="global.lbl.del" /><!-- 삭제 --></span></td>
                            </dms:access>
                        </tr>
                        <tr id="search4Area">
                            <th scope="row"><span><spring:message code="global.lbl.cmpCarDstinCd" /><!-- 회사차유형 --></span></th>
                            <dms:access viewId="VIEW-D-12647" hasPermission="${dms:getPermissionMask('READ')}">
                                <td><span name="searchStr"></span> <span class="btn_delete"><spring:message code="global.lbl.del" /><!-- 삭제 --></span></td>
                            </dms:access>
                        </tr>
                    </tbody>
        ...
        <div class="listarea">
            <div class="dlistitem listhead">
                ...
                <span style="width:60%" class="clboth"><spring:message code="global.lbl.cmpCarDstinCd" /><!-- 회사차구분 --></span>
    ...
    <section id="content_search" class="content_search" style="display:none;">
       ...
       <div class="formarea">
                ...
                <colgroup>
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="f_text"><input type="text" id="sCmpCarDstinCd"  class="form_comboBox" style="width:100%"></div>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="con_btnarea">
            <dms:access viewId="VIEW-D-12646" hasPermission="${dms:getPermissionMask('READ')}">
    ...
    <div class="content_right" id="itemForm">
        <section id="content_detail" class="content_detail" style="display:none">
                ...
                <table  class="flist01">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 <div class="f_item01 f_disabled">
                                    <input type="search" id="useStartDt" name="useStartDt" value="" data-json-obj="true" disabled="disabled"/>
                        ...
                        <tr>
                            ...
                            <td>
                                 <div class="f_item01 f_disabled">
                                    <input type="search" id="useEndDt" name="useEndDt" value="" data-json-obj="true" disabled="disabled"/>
            ...
            <div class="con_btnarea btncount3">
                <dms:access viewId="VIEW-D-12645" hasPermission="${dms:getPermissionMask('READ')}">
                    <div><span class="btnd1t2" id="btnReset"><spring:message code='global.btn.init' /></span></div><!-- 초기화 -->
                </dms:access>
                <dms:access viewId="VIEW-D-12644" hasPermission="${dms:getPermissionMask('READ')}">
                    <div><span class="btnd1" id="btnSave"><spring:message code='global.btn.save' /></span></div><!-- 저장 -->
                </dms:access>
                <dms:access viewId="VIEW-D-12643" hasPermission="${dms:getPermissionMask('READ')}">
...
function setSearchBox(){
    ...
    if(sVinNo == "" && sCarRegNo == "" && sUseStartDt == "" && sUseEndDt == "" && sCmpCarDstinCd == ""){
        $(".skeyarea").hide();
    }else{
        // 20170206 수정
        //$(".skeyarea").show();
        ...
        if(sCmpCarDstinCd == "") $("#search4Area").hide();
...
$(document).ready(function() {
    ...
    $("#btnSearch").kendoButton({
        click:function(e) {
            ...
            if(sCmpCarDstinCd != "") $("#search4Area span[name='searchStr']").text($("#sCmpCarDstinCd").data("kendoExtDropDownList").text());
...
function contentDetail(dataItem) {
    ...
    $("#carRegNoOut").val(dataItem.carRegNo);
    ...
    $("#useStartKmVal").val(comma(dataItem.useStartKmVal));
    $("#useEndKmVal").val(comma(dataItem.useEndKmVal));
    $("#remark").val(dataItem.remark);
    $("#regDt").val(dataItem.regDt);
    $("#regUsrId").val(dataItem.regUsrId);
...
/*
  ...
  //고객 팝업 열기 함수.
    ...
    function fnOnblur(id){
        var startVal = Number(uncomma($("#useStartKmVal").val()));
        var endVal = Number(uncomma($("#useEndKmVal").val()));
        ...
        $("#useStartKmVal").val(comma(startVal));
        $("#useEndKmVal").val(comma(endVal));
    }
