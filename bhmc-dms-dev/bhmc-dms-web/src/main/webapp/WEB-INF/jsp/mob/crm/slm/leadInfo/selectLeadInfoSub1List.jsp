...
var sub1ListData = new kendo.data.DataSource({
  ...
  change:function(e) {
    ...
    if(rTotal > 0){
        ...
        parent.setSubListHeightNew("subList1",2,rTotal);
    }else{
        //parent.setSubListHeight2("subList1", 0, showYn);
        parent.setSubListHeightNew("subList1",2,0);
    }
    }, 200);

    checklistCnt("listarea_noData_sub1",rTotal,noDatamsg);
...
function removeItem(obj){
    ...
    sub1ListData.remove(sub1ListData.data()[idx]);
    showYn = "Y";
    listView.refresh();
}
