      ...
      $.ajax({
          ...
          ,success:function(result) {
              if(result.data!=null){
                  ...
                  app.hideLoading();
                  //parent.setSubListHeight2("contactList",rowTotal, "N");
                  parent.setSubListHeightNew("contactList",2,rowTotal);
                  //mob.notification.success("<spring:message code='global.info.success'/>");

              }else{
                  app.hideLoading();
                  //parent.setSubListHeight2("contactList",0, "N");
                  parent.setSubListHeightNew("contactList",2,0);
              }
              checklistCnt("contactList_noData",result.total,noDatamsg);
          }
      });
    }
  },
