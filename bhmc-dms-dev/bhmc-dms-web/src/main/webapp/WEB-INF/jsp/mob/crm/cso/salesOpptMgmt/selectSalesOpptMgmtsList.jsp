  ...
  transport:{
    read:function(options) {
      ...
      params["sEndRegDt"] = new Date( parent.$("#sEndRegDt").val()); */
       ...
       if(parent.$("#sStartRegDt").val() == "" || parent.$("#search7Area span[name='searchStr']").text() == ""){
          params["sStartRegDt"] = null;
      }else{
          params["sStartRegDt"] = chgDate(parent.$("#sStartRegDt").val());
      }

      if(parent.$("#sEndRegDt").val() == "" || parent.$("#search7Area span[name='searchStr']").text() == ""){
          params["sEndRegDt"] = null;
      }else{
          params["sEndRegDt"] = chgDate(parent.$("#sEndRegDt").val());
      }
