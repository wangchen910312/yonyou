...
<script type="text/x-kendo-template" id="list-template">
        <div class="dlistitem bgNone">
            ...
            <!-- <span class="clboth" style="width:35%" id="pre_userdb">#:trimNull(rowData.giTp)  #</span> -->
            <span style="width:50%">#:trimNull(rowData.itemQty) #/#:trimNull(rowData.calcUnitCd)  #</span>
            <span style="width:50%">#:mob.format.currency(rowData.itemPrc, "{0:n0}") #/#:mob.format.currency(rowData.itemTotAmt, "{0:n0}") #</span>
        </div>
</script>
