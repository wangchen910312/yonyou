...
ordStatCdList.push({"cmmCd":"${obj.carlineCd}", "cmmCdNm":"${obj.carlineNm}", "useYn":"${obj.useYn}"});
...
$(document).ready(function() {
    ...
    $("#sOrdsTp").kendoExtDropDownList({
       ...
       /*
       ,dataBound:function(){
           var ordTp = this.value();
           this._savedOld = ordTp.slice(0);
       }
       */
    });
    $("#ordTpRadio input[type=radio][name=radio]").change(function (){
        if($(this).val()=="Y"){
            ...
            //$("#sOrdsTp").data("kendoExtDropDownList").setOptions({optionLabel:"<spring:message code='global.lbl.check' />",index:1});
    ...
    //var sOrdsTp     = $("#sOrdsTp").data("kendoExtMobileMultiSelectDropDownList").text();
 ...
 // 버튼 - 조회
    ...
    $("#docu_prev").bind("click", function()
    {
        ...
        else if ($("#content_search").css("display") == "block") { contentListNonRefresh(); /*contentList();*/ }
        else if ($("#content_detail").css("display") == "block") { contentListNonRefresh(); /*contentList();*/ }
