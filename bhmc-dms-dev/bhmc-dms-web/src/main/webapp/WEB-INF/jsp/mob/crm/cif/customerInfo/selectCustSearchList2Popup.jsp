...
<div class="dlistitem" id="listContentRow">
    ...
    <span style="width:40%" class="clboth">#:carOwnerNm #</span>
    <span style="width:30%">#:trimNull(carOwnerTelNo) #</span>
    <span style="width:30%">#:trimNull(carOwnerHpNo) #</span>
</div>
</script>
    ...
    read:function(options) {
      ...
      $.ajax({
          ...
          ,success:function(result) {
              ...
              checklistCnt("listarea_noData_pop2",result.total,noDatamsg);
          }
      });
    }
  },
