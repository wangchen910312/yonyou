...
<section id="content">
    ...
    <div class="content_right" id="salesOpptProcForm">
        <section id="content_detail" class="content_detail">
                ...
                <div class="co_view">
                    <div class="formarea" id="formarea" >
                        <table class="flist01">
                            ...
                            <tbody  >
                                <tr>
                                    <th scope="row" class="required"><spring:message code="crm.lbl.visitAppointDt" /><!-- 방문예약시간 --></th>
                                    <td>
                                        <div class="f_item01">
                                            <input type="search" class="ar" id="vsitResvDt" name="vsitResvDt" data-json-obj="true" />
                                            <span class="date" onclick="calpickerWithTime('vsitResvDt','vsitResvTime')">날짜선택</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="f_item01">
                                            <input type="text" class="ar" id="vsitResvTime" name="vsitResvTime"  />
                                            <span class="time" onclick="timepicker2('vsitResvTime')">시간선택</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr id="trCustNmC">
            ...
            <div class="con_btnarea btncount2">
                ...
                <div style="width:70%"><span class="btnd1" id="btnNextStepBefore"><spring:message code="crm.btn.visitReservation" /><!-- 방문|면담으로 제출 --></span></div>
    ...
    <section class="lay_pop" id="checkPwDiv" >
        ...
        <div class="btnarea">
            ...
            <span class="btnd1" id="btnCheckPwd" ><spring:message code="crm.btn.visitReservation" /><!-- 방문|면담으로 제출 --></span>
        </div>
    </section>
</section>
...
/*
        $("#vsitResvDt").kendoDateTimePicker({
       ...
       $("#leadStatCd").data("kendoExtDropDownList").value(options.leadStatCd);
        ...
        $("#btnNextStepBefore").kendoButton({
            click:function(e) {
                ...
                var vsitResvDt = $("#vsitResvDt").val();
                var onDutyYn = $("onDutyYn").val();
                ...
                if ( dms.string.isEmpty(vsitResvDt)) {
                    mob.notification.info("<spring:message code='crm.lbl.visitAppointDt' var='returnMsg' /><spring:message code='global.info.chkSelectItemMsg' arguments='${returnMsg}' /> ");
                    return false;
                };
        ...
        $("#btnNextStep").kendoButton({
            click:function(e){
                ...
                //salesOpptProcParam["vsitResvDt"] = chgDateTimeStamphhMM($("#vsitResvDt").val() + " " + $("#vsitResvTime").val()); //$("#vsitResvDt").val();
               ...
               if ($("#localCarRegNoYn").prop("checked")){ salesOpptProcParam["localCarRegNoYn"] = "Y" } else { salesOpptProcParam["localCarRegNoYn"] = "N" };
                ...
                var sVsitResvDt = $("#vsitResvDt").val();
                if(dms.string.isEmpty(sVsitResvDt)){
                    salesOpptProcParam["vsitResvDt"] = null;
                }else{
                    salesOpptProcParam["vsitResvDt"] = chgDateTimeStamphhMM($("#vsitResvDt").val() + " " + $("#vsitResvTime").val());
                }
                ...
                var loadingTop=(screen.height/2-48);
                $(".k-loading-image").css("top",loadingTop+"px");
