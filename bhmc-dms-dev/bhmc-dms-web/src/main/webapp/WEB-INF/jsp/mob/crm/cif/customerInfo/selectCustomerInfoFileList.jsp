...
var listData = new kendo.data.DataSource({
  transport:{
      ...
      ,parameterMap:function(options, operation) {
          if (operation === "read") {
              ...
              params["sFileDocNo"] = parent.$("#docId").val();
  ...
  change:function(e) {
      ...
      setTimeout(function(){
      if(rTotal > 0){
          //parent.setSubListHeight2("fileList", rTotal, "Y");
          parent.setSubListHeightNew("fileList",1,rTotal);
      }else{
          //parent.setSubListHeight2("fileList", 0, "Y");
          parent.setSubListHeightNew("fileList",1,0);
      }
      }, 200);

      checklistCnt("fileList_noData",this.total(),noDatamsg);
