...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/mis/tmp/insertSalesmanDcptRegUploadFile.do"/>">
        <input type="hidden" id="sDealerSaleManDcptYyMm" name="sDealerSaleManDcptYyMm" value="${sDealerSaleManDcptYyMm}">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/mis/tmp/selectSalesmanDcptRegExcel.do?sDealerSaleManDcptYyMm=' />"+$("#sDealerSaleManDcptYyMm").val()
