...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value='/mis/tmp/insertTargetYearRegUploadFile.do'/>">
        <input type="hidden" id="goalYy" name="goalYy" value="${targetYearRegSearchVO.goalYy}">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
 ...
 * 팝업 옵션
 */
 var options = parent.targetYearAllRegUploadPopupWin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/mis/tmp/insertTargetAllYearRegUploadSave.do?goalYy=' />"+$("#goalYy").val()
                ,data:JSON.stringify({"targetAllYearRegUploadList":saveData})
                ,type:'POST'
                ,dataType:'json'
                ...
                ,success:function(jqXHR, textStatus) {
                    ...
                    parent.targetYearAllRegUploadPopupWin.close();
                }
            });
       }
    });
    ...
    $("#progressSection").excelUpload({
        progressId :"UPLOAD_TARGETYEAR_ALL_SOURCE"
