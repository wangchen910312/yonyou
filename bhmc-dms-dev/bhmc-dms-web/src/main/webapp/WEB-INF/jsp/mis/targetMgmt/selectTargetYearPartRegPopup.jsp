...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/mis/tmp/insertTargetYearRegUploadFile2.do"/>">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
 ...
 * 팝업 옵션
 */
 var options = parent.targetYearPartRegUploadPopupWin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/mis/tmp/insertTargetPartYearRegUploadSave.do' />"
                ,data:JSON.stringify({"targetPartYearRegUploadList":saveData})
                ,type:'POST'
                ,dataType:'json'
                ...
                ,success:function(jqXHR, textStatus) {
                    ...
                    parent.targetYearPartRegUploadPopupWin.close();
                }
            });
       }
    });
    ...
    $("#progressSection").excelUpload({
        progressId :"UPLOAD_TARGETYEAR_PART_SOURCE"
