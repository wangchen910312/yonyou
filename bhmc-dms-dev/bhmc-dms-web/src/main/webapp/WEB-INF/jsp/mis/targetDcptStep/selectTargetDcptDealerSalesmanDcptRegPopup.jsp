...
<section id="windows" class="pop_wrap">
    ...
    <div class="table_form" role="search" data-btnid="btnSearch">
        <form id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data" action="<c:url value="/mis/tds/insertSalesmanTargetDcptRegUploadFile.do"/>">
        <input type="text" id="sMonitorSaleDate" name="sMonitorSaleDate" value="${targetDcptStepSearchVO.getsMonitorSaleDate()}">
        <table>
            <caption></caption>
            <colgroup>
                <col style="width:70%;">
 ...
 * 팝업 옵션
 */
 var options = parent.targetSalesmanDcptRegUploadPopupWin.options.content.data;
...
$(document).ready(function() {
    ...
    $("#btnSave").kendoButton({
        click:function(e){
            ...
            $.ajax({
                url:"<c:url value='/mis/tds/selectSalesmanTargetDcptRegExcel.do?sMonitorSaleDate=' />"+$("#sMonitorSaleDate").val()
                ,data:JSON.stringify({"targetSalesmanRegUploadList":saveData})
                ,type:'POST'
                ,dataType:'json'
                ...
                ,success:function(jqXHR, textStatus) {
                    ...
                    parent.targetSalesmanDcptRegUploadPopupWin.close();
                }
            });
       }
    });
    ...
    $("#progressSection").excelUpload({
        progressId :"UPLOAD_SALESMAN_DCPT_SOURCE"
    ...
    $("#grid").kendoExtGrid({
        ...
        ,columns:[
            ...
            ,{field:"carlineCd", title:"<spring:message code='global.lbl.carLine' />", width:150,attributes:{"class":"ac"}}
            ,{field:"goalPrefVal", title:"<spring:message code='mis.lbl.targetvalue' />", width:150,attributes:{"class":"ac"}}
        ]
