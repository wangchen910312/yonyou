...
<Query>
<![CDATA[SELECT '张三' AS DAYS, '61' AS d1Val FROM DUAL
    UNION ALL
    SELECT '李四' AS DAYS, '78' AS d1Val FROM DUAL
    UNION ALL
    SELECT '李三' AS DAYS, '55' AS d1Val FROM DUAL
    UNION ALL
    SELECT '崔**' AS DAYS, '100' AS d1Val FROM DUAL
    UNION ALL
    SELECT '李一' AS DAYS, '100' AS d1Val FROM DUAL
    UNION ALL
    SELECT '张一' AS DAYS, '97' AS d1Val FROM DUAL
    UNION ALL
    SELECT '张四' AS DAYS, '97' AS d1Val FROM DUAL
    UNION ALL
    SELECT '崔一' AS DAYS, '96.57' AS d1Val FROM DUAL
    UNION ALL
    SELECT '王四' AS DAYS, '92.88' AS d1Val FROM DUAL
    UNION ALL
    SELECT '安三' AS DAYS, '91' AS d1Val FROM DUAL
    ]]></Query>
</TableData>
</TableDataMap>
...
<TextAttr>
<Attr alignText="0">
<FRFont name="Microsoft YaHei" style="1" size="128" foreground="-13421773"/>
</Attr>
</TextAttr>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="DAYS" valueName="D1VAL" function="com.fr.data.util.function.NoneFunction">
...
<BoundsAttr x="0" y="0" width="478" height="771"/>
</Widget>
...
<BoundsAttr x="0" y="771" width="478" height="26"/>
</Widget>
<Sorted sorted="false"/>
<WidgetZoomAttr compState="0"/>
<AppRelayout appRelayout="true"/>
<Size width="478" height="797"/>
<MobileWidgetList/>
</Center>
</Layout>
