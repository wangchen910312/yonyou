...
/**
 * <pre>
 * [제조사] 년간 목표 등록 전체 엑셀 업로드 데이터
 * </pre>
 *
 * @ClassName   : TargetYearAllRegVO.java
 * @Description : [제조사] 년간 목표 등록 전체 엑셀 업로드 데이터
 * @author chibeom.song
 * @since 2016. 7. 22.
 * @version 1.0
 * @see
...
public class TargetYearAllRegVO extends AbstractExcelDataBinder {
