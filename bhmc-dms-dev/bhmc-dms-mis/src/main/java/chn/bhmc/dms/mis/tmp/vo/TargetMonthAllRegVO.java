...
public class TargetMonthAllRegVO extends AbstractExcelDataBinder {
     ...
     * @return the goalYyMm
     */
    public String getGoalYyMm() {
        return goalYyMm;
    }

    /**
     * @param goalYyMm the goalYyMm to set
     */
    public void setGoalYyMm(String goalYyMm) {
        this.goalYyMm = goalYyMm;
    }
    ...
    public void bind(int rowNo, int cellNo, Object value) throws ExcelDataBindingException {
        try{
            switch(cellNo){
                case 0:this.setDlrCd(ExcelDataBinderUtil.toString(value).trim()); break;            // 딜러 코드
                case 1:this.setCarLineCd(ExcelDataBinderUtil.toString(value).trim()); break;        // 차종 코드
                case 2:this.setGoalPrefVal(ExcelDataBinderUtil.toString(value).trim()); break;      // 목표설정값
                default :
            }
        }catch(Exception e){
