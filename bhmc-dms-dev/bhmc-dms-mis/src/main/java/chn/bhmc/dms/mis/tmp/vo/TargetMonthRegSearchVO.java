 ...
 * </pre>
 *
 * @ClassName   : TargetMonthRegSearchVO.java
...
public class TargetMonthRegSearchVO extends SearchVO {
    ...
    private String goalDstinCd;     // 목표구분
    ...
    /**
     * @return the goalDstinCd
     */
    public String getGoalDstinCd() {
        return goalDstinCd;
    }
    /**
     * @param goalDstinCd the goalDstinCd to set
     */
    public void setGoalDstinCd(String goalDstinCd) {
        this.goalDstinCd = goalDstinCd;
    }
    /**
     * @return the delYn
     */
