...
public class DealerVO extends BaseVO {
     ...
     * 완성차계약수납
     */
    private String allowContractSaleYn;

    /**
     * 판매계약서 추가 문구
     */
    private String saleContractText;

    /**
     * 보험계약서 추가 문구
     */
    private String saleInsuranceText;
    ...
    /**
     * 是否使用聚合支付
     * add 20190802 wushibin by
     **/
    @NotEmpty
    @Pattern(regexp="[Y|N]")
    private String aggregatePaymentUseYn;
    
    public String getAggregatePaymentUseYn() {
		return aggregatePaymentUseYn;
	}

	public void setAggregatePaymentUseYn(String aggregatePaymentUseYn) {
		this.aggregatePaymentUseYn = aggregatePaymentUseYn;
	}
    ...
    /**
     * @return the allowContractSaleYn
     */
    public String getAllowContractSaleYn() {
        return allowContractSaleYn;
    }

    /**
     * @param allowContractSaleYn the allowContractSaleYn to set
     */
    public void setAllowContractSaleYn(String allowContractSaleYn) {
        this.allowContractSaleYn = allowContractSaleYn;
    }


    public String getSaleContractText() {
        return saleContractText;
    }

    public void setSaleContractText(String saleContractText) {
        this.saleContractText = saleContractText;
    }

    public String getSaleInsuranceText() {
        return saleInsuranceText;
    }

    public void setSaleInsuranceText(String saleInsuranceText) {
        this.saleInsuranceText = saleInsuranceText;
    }

    /**
     * @return the preSaleText
     */
    ...
    /**
     * @param preSaleText the preSaleText to set
     */
    ...
    /**
     * @param usedCarText the usedCarText to set
     */
    public void setUsedCarText(String usedCarText) {
        this.usedCarText = usedCarText;
    }
     ...
     */
    public String getSmsRemainAmount() {
     ...
     */
    public void setSmsRemainAmount(String smsRemainAmount) {
     ...
     */
    public void setSmsRemainCnt(String smsRemainCnt) {
