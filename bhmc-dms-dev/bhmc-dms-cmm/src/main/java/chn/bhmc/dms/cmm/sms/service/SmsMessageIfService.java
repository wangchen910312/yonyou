...
public interface SmsMessageIfService {
     ...
     * @param smsMessageIfVO
     */
    String mergeSmsMessageIF(SmsMessageIfVO smsMessageIfVOs) throws Exception;

    /**
     * SMS 예약 취소를 위한 인터페이스
     * @param smsMessageIfVO
     */
    int updateSmsMessageCancIF(List<SmsMessageIfVO> smsMessageIfVOs) throws Exception;
