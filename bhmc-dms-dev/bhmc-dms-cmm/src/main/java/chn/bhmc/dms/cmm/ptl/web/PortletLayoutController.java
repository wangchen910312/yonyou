...
public class PortletLayoutController extends HController {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/cmm/ptl/portletLayout/selectDistributorArrearsInfo.do", method = RequestMethod.POST)
    @ResponseBody
    public SearchResult selectDistributorArrearsInfo() throws Exception {
    	  SearchResult result = new SearchResult();
          result.setData(portletLayoutService.selectDistributorArrearsByCondition());
        return result;
    }
