...
public interface NotificationTargetDAO {
     ...
     * @return
     */
    public List<NotificationTargetUserVO> selectNotificationTargetAllUsers(@Param("dlrCd") String dlrCd, @Param("alrtPolicyGrpId") String alrtPolicyGrpId, @Param("alrtPolicyId") String alrtPolicyId);
}
