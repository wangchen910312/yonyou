...
//        model.addAttribute("portletLayoutList", portletLayoutList);
        ...
        return "/home"; //문제 생기면 이거 주석 풀고 khskhs
    ...
    public String selectMain(Model model,HttpServletRequest request) throws Exception {
      ...
      //20191219 update by sunzq3 去掉安卓判断操作系统逻辑,将手机平板判断合起来 end
            ...
            // 포틀릿 메인 화면은 layout3x2로 고정
            portletLayout = portletLayoutService.selectPortletLayoutByKey("TPL-003");
