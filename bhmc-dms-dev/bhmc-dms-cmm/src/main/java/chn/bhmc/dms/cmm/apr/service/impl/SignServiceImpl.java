...
public class SignServiceImpl extends HService implements SignService {
    ...
    public int insertSign(SignVO signVO) throws Exception {
        ...
        for(SignLineVO signLineVO : signVO.getSignLines()){
            ...
            if(signDocLineNo == 1) {
                ...
                sendSignRequestAlarm(signVO.getSignDocId(), signLineVO.getSignUsrId(), signLineVO.getSignUsrNm(), signVO.getRefDocParams());
            }
     ...
     * @throws Exception
     */
    private void sendSignRequestAlarm(String signDocNo, String signUsrId, String signUsrNm, String refDocParams) throws Exception {
    	...
    	if("Y".equals(docVO.getSignAlrtYn())){
    	     ...
    	     context.setActionParams(refDocParams);
