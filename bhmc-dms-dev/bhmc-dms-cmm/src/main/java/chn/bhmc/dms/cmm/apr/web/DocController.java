...
public class DocController extends HController {
    ...
    /**
     * 결재양식 정보를 일괄적용한다.
     * @param saveVO - 결재양식정보 등록/수정/삭제 목록을 포함하는 DocSaveVO
     * @param bindingResult
     * @return
     */
    ...
    /**
     * 결재양식 결재라인 목록 데이터를 조회한다.
     * @param searchVO - 조회 조건을 포함하는 DocLineSearchVO
     * @return
     */
    ...
    public boolean deleteAndInsertDocLines(@Validated @RequestBody DocVO docVO) throws Exception {
        docService.deleteAndInsertDocLines(LoginUtil.getDlrCd(), docVO.getSignDocId(), docVO.getDocLineList());
        return true;
    }
}
