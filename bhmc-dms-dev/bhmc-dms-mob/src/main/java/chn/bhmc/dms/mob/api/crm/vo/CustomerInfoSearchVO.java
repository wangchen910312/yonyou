...
public class CustomerInfoSearchVO extends SearchVO {
     ...
     */
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date sRoDtFrom;

    /*
     * RO 끝
     */
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date sRoDtTo;
    ...
    private String sMembershipNo; // 멤버십 번호
     ...
     **/
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date sSaleStartDt;
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date sSaleEndDt;
    ...
    /**
     * @return the sCustCollSrcCd
     */
    public String getsCustCollSrcCd() {
        return sCustCollSrcCd;
    }

    /**
     * @param sCustCollSrcCd the sCustCollSrcCd to set
     */
    public void setsCustCollSrcCd(String sCustCollSrcCd) {
        this.sCustCollSrcCd = sCustCollSrcCd;
    }
    ...
    /**
     * @return the sSaleStartDt
     */
    public Date getsSaleStartDt() {
        return sSaleStartDt;
    }

    /**
     * @param sSaleStartDt the sSaleStartDt to set
     */
    public void setsSaleStartDt(Date sSaleStartDt) {
        this.sSaleStartDt = sSaleStartDt;
    }

    /**
     * @return the sSaleEndDt
     */
    public Date getsSaleEndDt() {
        return sSaleEndDt;
    }

    /**
     * @param sSaleEndDt the sSaleEndDt to set
     */
    public void setsSaleEndDt(Date sSaleEndDt) {
        this.sSaleEndDt = sSaleEndDt;
    }

    /**
     * @return the sRoDtFrom
     */
    public Date getsRoDtFrom() {
        return sRoDtFrom;
    }

    /**
     * @param sRoDtFrom the sRoDtFrom to set
     */
    public void setsRoDtFrom(Date sRoDtFrom) {
        this.sRoDtFrom = sRoDtFrom;
    }

    /**
     * @return the sRoDtTo
     */
    public Date getsRoDtTo() {
        return sRoDtTo;
    }

    /**
     * @param sRoDtTo the sRoDtTo to set
     */
    public void setsRoDtTo(Date sRoDtTo) {
        this.sRoDtTo = sRoDtTo;
    }
