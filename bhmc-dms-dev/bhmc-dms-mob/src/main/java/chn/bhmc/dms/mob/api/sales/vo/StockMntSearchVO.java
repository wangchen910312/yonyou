...
public class StockMntSearchVO extends BaseSearchVO{
    ...
    private String sStartPrice;
    private String sEndPrice;
    private String sStockDate;
	@JsonDeserialize(using=JsonDateDeserializer.class)
    private Date sStartGrDt;
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date sEndGrDt;
    public String getsStartPrice() {
		return sStartPrice;
	}
	public void setsStartPrice(String sStartPrice) {
     ...
     * @return the sBlockYn
     */
    public String getsStockDate() {
        return sStockDate;
    }
    /**
     * @param sBlockYn the sBlockYn to set
     */
    public void setsStockDate(String sStockDate) {
        this.sStockDate = sStockDate;
    }
}
