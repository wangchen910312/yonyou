 ...
 */
@Controller
public class MobPartReservationCopyController extends HController {
     ...
     * @return
     */
    @RequestMapping(value="/mob/par/pcm/partReservation/selectPartReservationMain.do", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value="/mob/par/pcm/partReservation/selectPartReservations.do",  method = RequestMethod.POST)
