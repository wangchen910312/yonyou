...
public class SmsTmplUserController extends HController{
     ...
     * @return
     */
    @RequestMapping(value = "/crm/cmm/customerInfo/deleteSmsTmplUsers.do", method = RequestMethod.POST)
    @ResponseBody
    public int deleteSmsTmplUsers(@RequestBody List<SmsTmplUserVO> saveVO) throws Exception {

        return smsTmplUserService.deleteSmsTmplUsers(saveVO);
