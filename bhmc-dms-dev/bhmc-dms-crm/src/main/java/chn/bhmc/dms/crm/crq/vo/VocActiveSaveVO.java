...
public class VocActiveSaveVO extends BaseSaveVO<VocActiveVO> {
    ...
    /**
     * @return the vocMgmtVO
     */
    public VocMgmtVO getVocMgmtVO() {
        return vocMgmtVO;
    }

    /**
     * @param vocMgmtVO the vocMgmtVO to set
     */
    public void setVocMgmtVO(VocMgmtVO vocMgmtVO) {
        this.vocMgmtVO = vocMgmtVO;
    }
