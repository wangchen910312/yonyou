...
public class SatisFactionManageVO extends BaseVO {
    ...
    private static final long serialVersionUID = -4387832869625063520L;
        ...
        **/
        ...
        private String regUsrNm;//고객명
        private String delYn;//만족도설문지 사용가능여부

        private String stsfIvstY;//만족여부 Y
        private String stsfIvstN;//만족여부 N
        ...
        /**
         * @return the stsfIvstY
         */
        public String getStsfIvstY() {
            return stsfIvstY;
        }

        /**
         * @param stsfIvstY the stsfIvstY to set
         */
        public void setStsfIvstY(String stsfIvstY) {
            this.stsfIvstY = stsfIvstY;
        }

        /**
         * @return the stsfIvstN
         */
        public String getStsfIvstN() {
            return stsfIvstN;
        }

        /**
         * @param stsfIvstN the stsfIvstN to set
         */
        public void setStsfIvstN(String stsfIvstN) {
            this.stsfIvstN = stsfIvstN;
        }
        ...
        /**
         * @return the rcpeExtrSeqChkCnt
         */
        public int getRcpeExtrSeqChkCnt() {
            return rcpeExtrSeqChkCnt;
        }

        /**
         * @param rcpeExtrSeqChkCnt the rcpeExtrSeqChkCnt to set
         */
        public void setRcpeExtrSeqChkCnt(int rcpeExtrSeqChkCnt) {
            this.rcpeExtrSeqChkCnt = rcpeExtrSeqChkCnt;
        }
}