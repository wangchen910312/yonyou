...
public class SmsMessageVO extends BaseVO {
    ...
    //고객번호 필수 여부 ( N인경우 고객번호 없어도됨 )
    private  String        custNoRequired;
    ...
    /**
     * @return the custNoRequired
     */
    public String getCustNoRequired() {
        return custNoRequired;
    }

    /**
     * @param custNoRequired the custNoRequired to set
     */
    public void setCustNoRequired(String custNoRequired) {
        this.custNoRequired = custNoRequired;
    }
    ...
    public String toString() {
        return "SmsMessageVO [smsTp=" + smsTp + ", smsTmplMsg=" + smsTmplMsg + ", resvDt=" + resvDt
                ...
                + contactBizCd + ", refTableNm=" + refTableNm + ", refKeyNm=" + refKeyNm + ", custNoRequired="
                + custNoRequired + ", insertSms=" + insertSms + "]";
    }
