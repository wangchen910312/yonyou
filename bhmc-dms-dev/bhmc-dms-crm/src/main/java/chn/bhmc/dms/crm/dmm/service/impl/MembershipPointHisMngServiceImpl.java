...
public class MembershipPointHisMngServiceImpl extends HService implements MembershipPointHisMngService, JxlsSupport{
    ...
    public void initJxlsContext(Context context, HMap params) throws Exception {
        ...
        if ( !"null".equals((String)params.get("sPointExtcDt")) && params.get("sPointExtcDt") != null  ) {
            searchVO.setsPointExtcDt(DateUtil.convertToDate((String)params.get("sPointExtcDt")));
        }
