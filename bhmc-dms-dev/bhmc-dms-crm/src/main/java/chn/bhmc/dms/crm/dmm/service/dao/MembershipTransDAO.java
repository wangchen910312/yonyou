...
public interface MembershipTransDAO {
    ...
    /**
     * 멤버쉽 양도/양수 정보를 Detail에 등록한다.
     * @param membershipTransVO - 등록할 정보가 담긴 MembershipTransVO
     * @return 등록된 목록수
     */
    public int insertMembershipTransTemp(MembershipTransVO memberahipTransVO) throws Exception;
     ...
     * @return 조회 목록
     */
    public List<MembershipTransVO> selectMembershipTransApproveCondition(MembershipTransSearchVO searchVO) throws Exception;


    /**
     * 멤버쉽 양도/양수 실패정보를 Master에 수정한다.
     * @param membershipTransVO - 수정할 정보가 담긴 MembershipTransVO
     * @return 수정된 목록수
     */
    public int updateMembershipTransErr(MembershipTransVO memberahipTransVO) throws Exception;
}
