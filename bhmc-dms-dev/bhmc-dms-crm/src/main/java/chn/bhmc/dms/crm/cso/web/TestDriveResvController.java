...
public class TestDriveResvController extends HController {
    ...
    public String selectTestDriveResvMain(Model model) throws Exception {
        ...
        model.addAttribute("saleOpptStepCdList", commonCodeService.selectCommonCodesByCmmGrpCd("CRM363", null, langCd));      // 판매기회단계
    ...
    @ResponseBody
    public TestDriveResvVO selectTestDriveLastTimeDrivByKey(@RequestBody TestDriveResvSearchVO searchVO)throws Exception {

        TestDriveResvVO testDriveResvVO = new TestDriveResvVO();
        testDriveResvVO = testDriveMgmtService.selectTestDriveLastTimeDrivByKey(searchVO);
