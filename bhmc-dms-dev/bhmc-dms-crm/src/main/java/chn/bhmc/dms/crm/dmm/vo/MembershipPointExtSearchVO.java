...
public class MembershipPointExtSearchVO extends SearchVO {
    ...
    **/
    ...
    private  Date              sStartPointExtcExpcDt;
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private  Date              sEndPointExtcExpcDt;
    ...
    **/
    ...
    /**
     * @return the sStartPointExtcExpcDt
     */
    public Date getsStartPointExtcExpcDt() {
        return sStartPointExtcExpcDt;
    }

    /**
     * @param sStartPointExtcExpcDt the sStartPointExtcExpcDt to set
     */
    public void setsStartPointExtcExpcDt(Date sStartPointExtcExpcDt) {
        this.sStartPointExtcExpcDt = sStartPointExtcExpcDt;
    }

    /**
     * @return the sEndPointExtcExpcDt
     */
    public Date getsEndPointExtcExpcDt() {
        return sEndPointExtcExpcDt;
    }

    /**
     * @param sEndPointExtcExpcDt the sEndPointExtcExpcDt to set
     */
    public void setsEndPointExtcExpcDt(Date sEndPointExtcExpcDt) {
        this.sEndPointExtcExpcDt = sEndPointExtcExpcDt;
    }
