...
public class MembershipGradeChgVO extends BaseVO {
    ...
    private static final long serialVersionUID = 4235921367719768470L;
        ...
        **/
        ...
        private int serCnt; //정비건수
        private int serAmt; //정비금액
        @NotEmpty
        ...
        private int salePridCarPurcCnt;//판매기간차량구매수
        private String applyGradeCd;//적용등급코드
        ...
        /**
         * @return the salePridCarPurcCnt
         */
        public int getSalePridCarPurcCnt() {
            return salePridCarPurcCnt;
        }



        /**
         * @param salePridCarPurcCnt the salePridCarPurcCnt to set
         */
        public void setSalePridCarPurcCnt(int salePridCarPurcCnt) {
            this.salePridCarPurcCnt = salePridCarPurcCnt;
        }



        /**
         * @return the applyGradeCd
         */
        public String getApplyGradeCd() {
            return applyGradeCd;
        }
        ...
        /**
         * @param applyGradeCd the applyGradeCd to set
         */
        public void setApplyGradeCd(String applyGradeCd) {
            this.applyGradeCd = applyGradeCd;
        }
        ...
        /**
         * @param serAmt the serAmt to set
         */
