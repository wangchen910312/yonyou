...
@ValidDescriptor({
    ...
    ,@ValidField(field="cupnTp"     , mesgKey="crm.lbl.cupnTp")
    ,@ValidField(field="dcRate"     , mesgKey="crm.lbl.dcRate")
    ,@ValidField(field="dcAmt"      , mesgKey="crm.lbl.dcAmt")
    ,@ValidField(field="prenGoods"  , mesgKey="crm.lbl.prenGoods")
    ,@ValidField(field="prenCnt"    , mesgKey="crm.lbl.prenCnt")
