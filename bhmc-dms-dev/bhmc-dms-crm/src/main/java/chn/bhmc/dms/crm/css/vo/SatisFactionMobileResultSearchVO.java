...
public class SatisFactionMobileResultSearchVO extends SearchVO {
    ...
    **/
    ...
    private  String sCustNm;//고객명,HP_NO
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private  Date sStartDt;//시작기간
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private  Date sEndDt;//종료기간
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private  Date sStartVocRegDt;//낮은점수 처리요청 시작기간
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private  Date sEndVocRegDt;//낮은점수 처리요청 종료기간

    private  String sSatisFactionPresentResult;     // 만족도 조사 결과만 조회 여부

    private  String sStsfIvstYn;//만족여부

    private  String sQestTp;      // M : 단답형, 다답형 / C : 주관식
    private  String sExportTp;      // 엑셀 export 타입

    private  String sMngUsrNm;      // 담당자 ( 서비스고문 or 판매고문 )
    ...
    /**
     * @return the sStartVocRegDt
     */
    public Date getsStartVocRegDt() {
        return sStartVocRegDt;
    }


    /**
     * @param sStartVocRegDt the sStartVocRegDt to set
     */
    public void setsStartVocRegDt(Date sStartVocRegDt) {
        this.sStartVocRegDt = sStartVocRegDt;
    }


    /**
     * @return the sEndVocRegDt
     */
    public Date getsEndVocRegDt() {
        return sEndVocRegDt;
    }


    /**
     * @param sEndVocRegDt the sEndVocRegDt to set
     */
    public void setsEndVocRegDt(Date sEndVocRegDt) {
        this.sEndVocRegDt = sEndVocRegDt;
    }
    ...
    /**
     * @return the sSatisFactionPresentResult
     */
    public String getsSatisFactionPresentResult() {
        return sSatisFactionPresentResult;
    }


    /**
     * @param sSatisFactionPresentResult the sSatisFactionPresentResult to set
     */
    public void setsSatisFactionPresentResult(String sSatisFactionPresentResult) {
        this.sSatisFactionPresentResult = sSatisFactionPresentResult;
    }
    ...
    /**
     * @return the sStsfIvstYn
     */
    public String getsStsfIvstYn() {
        return sStsfIvstYn;
    }


    /**
     * @param sStsfIvstYn the sStsfIvstYn to set
     */
    public void setsStsfIvstYn(String sStsfIvstYn) {
        this.sStsfIvstYn = sStsfIvstYn;
    }
    ...
    /**
     * @return the sExportTp
     */
    public String getsExportTp() {
        return sExportTp;
    }


    /**
     * @param sExportTp the sExportTp to set
     */
    public void setsExportTp(String sExportTp) {
        this.sExportTp = sExportTp;
    }
    ...
    /**
     * @return the sMngUsrNm
     */
    public String getsMngUsrNm() {
        return sMngUsrNm;
    }


    /**
     * @param sMngUsrNm the sMngUsrNm to set
     */
    public void setsMngUsrNm(String sMngUsrNm) {
        this.sMngUsrNm = sMngUsrNm;
    }
