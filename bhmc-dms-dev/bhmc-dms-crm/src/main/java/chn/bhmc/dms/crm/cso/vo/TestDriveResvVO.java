...
public class TestDriveResvVO extends BaseVO {
    ...
    /**
     * @param tdrvHmCdNm the tdrvHmCdNm to set
     */
    ...
    /**
     * @param custStsfCdNm the custStsfCdNm to set
     */
    ...
    public String toString() {
        return "TestDriveResvVO [dlrCd=" + dlrCd + ", pltCd=" + pltCd + ", tdrvSeq=" + tdrvSeq + ", callNo=" + callNo
                ...
                + modelNm + ", carRegId=" + carRegId + ", tdrvHmCdNm=" + tdrvHmCdNm + ", custStsfCdNm=" + custStsfCdNm
                + ", custCdNm=" + custCdNm + "]";
    }
    /**
    ...
    /**
     * @param custStsfStatCd the custStsfStatCd to set
     */
    public void setCustStsfStatCd(String custStsfStatCd) {
        this.custStsfStatCd = custStsfStatCd;
    }
    /**
     * @param tdrvLicenseNo the tdrvLicenseNo to set
     */
