 ...
 * 영업 스케쥴  VO
 *
 * @ClassName   : SalesOpptFailSaveVO.java
 * @Description : SalesOpptFailSaveVO.Class
 * @author in moon lee
 * @since 2016.03.07.
 * @version 1.0
 * @see
...
@ValidDescriptor({
    ...
    ,@ValidField(field="saleOpptStatCd"  , mesgKey="global.lbl.saleOpptStatCd")     // 판매기회상태
...
public class SalesOpptFailSaveVO extends BaseSaveVO<CarLineInfoVO> {
