...
public class SatisFactionMobileResultVO extends BaseVO {
    ...
    **/
    ...
    /**
         * @return the qestTpCdNm
         */
        public String getQestTpCdNm() {
            return qestTpCdNm;
        }


        /**
         * @param qestTpCdNm the qestTpCdNm to set
         */
        public void setQestTpCdNm(String qestTpCdNm) {
            this.qestTpCdNm = qestTpCdNm;
        }
