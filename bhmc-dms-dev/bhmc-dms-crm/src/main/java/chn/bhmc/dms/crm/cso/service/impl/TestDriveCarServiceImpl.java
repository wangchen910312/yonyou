...
public class TestDriveCarServiceImpl extends HService implements TestDriveCarService {
    ...
    /**
     *
     * 시승차 - 시승차량 관리 상태를 저장한다. / 세일즈에서 호출 : 시승차량 상태 변경시..
     * @param TestDriveCarSaveVO : dlrCd(딜러코드), pltCd(센터코드), tdrvVinNo(차대번호)
...
//        insertTdrvCar(aa);
    ...
    public int deleteTestDriveCar(TestDriveCarSearchVO searchVO) throws Exception {
        ...
        return testDriveCarDAO.deleteTestDriveCar(searchVO);
    }
