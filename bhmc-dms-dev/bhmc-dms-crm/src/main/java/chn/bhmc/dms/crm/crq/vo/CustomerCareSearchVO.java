...
public class CustomerCareSearchVO extends SearchVO {
    ...
    private  String              sCustExtrTermCd;       // 대상자추출조건코드[대상자추출]
    ...
    /**
     * @return the sCustExtrTermCd
     */
    public String getsCustExtrTermCd() {
        return sCustExtrTermCd;
    }
    /**
     * @param sCustExtrTermCd the sCustExtrTermCd to set
     */
    public void setsCustExtrTermCd(String sCustExtrTermCd) {
        this.sCustExtrTermCd = sCustExtrTermCd;
    }
    ...
    public String toString() {
        return "CustomerCareSearchVO [sDlrCd=" + sDlrCd + ", sCustCareNm=" + sCustCareNm + ", sActiveTpCd="
                + sActiveTpCd + ", sCustCareSeq=" + sCustCareSeq + ", sCustExtrTermCd=" + sCustExtrTermCd
