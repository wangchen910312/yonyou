 ...
 * 판매기회추적
 *
 * @ClassName   : SalesOpptTraceMgmtSearchVO
 * @Description : SalesOpptTraceMgmtSearchVO
 * @author kyo jin lee
 * @since 2016.03.07.
 * @version 1.0
 * @see
...
public class SalesOpptTraceMgmtSearchVO extends SearchVO {
    ...
    /**
     * @return the sCallDialNum
     */
    public String getsCallDialNum() {
        return sCallDialNum;
    }

    /**
     * @param sCallDialNum the sCallDialNum to set
     */
    public void setsCallDialNum(String sCallDialNum) {
        this.sCallDialNum = sCallDialNum;
    }
