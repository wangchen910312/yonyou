...
public class ContractReVO extends BaseVO{
     ...
     * 기타업무 상태점검
     */
    private String contractYn;      // 계약생성여부
    private String vinYn;           // 차량여부
    private String incYn;           // 보험완성여부
    private String goodsYn;         // 용품완성여부
    private String fincYn;          // 보험완성여부
    private String useYn;           // 중고차완성여부
    private String payYn;           // 수납완성여부
    ...
    /**
     * @return the saleEmpPw
     */
    public String getSaleEmpPw() {
        return saleEmpPw;
    }

    /**
     * @param saleEmpPw the saleEmpPw to set
     */
    public void setSaleEmpPw(String saleEmpPw) {
        this.saleEmpPw = saleEmpPw;
    }
    ...
    /**
     * @return the dcLvlCdNm
     */
    public String getDcLvlCdNm() {
        return dcLvlCdNm;
    }


    /**
     * @param dcLvlCdNm the dcLvlCdNm to set
     */
    public void setDcLvlCdNm(String dcLvlCdNm) {
        this.dcLvlCdNm = dcLvlCdNm;
    }
    ...
    /**
     * @return the incUpdtDtStr
     */
    public String getIncUpdtDtStr() {
        return incUpdtDtStr;
    }

    /**
     * @param incUpdtDtStr the incUpdtDtStr to set
     */
    public void setIncUpdtDtStr(String incUpdtDtStr) {
        this.incUpdtDtStr = incUpdtDtStr;
    }
     ...
     * @return the vinYn
     */
    public String getVinYn() {
        return vinYn;
    }
    /**
     * @param vinYn the vinYn to set
     */
    public void setVinYn(String vinYn) {
        this.vinYn = vinYn;
    }
    /**
     * @return the incYn
     ...
     * @return the goodsYn
     */
    public String getGoodsYn() {
        return goodsYn;
    }
    /**
     * @param goodsYn the goodsYn to set
     */
    public void setGoodsYn(String goodsYn) {
        this.goodsYn = goodsYn;
    }
    /**
     * @return the fincYn
     */
    ...
    /**
     * @return the lv2DlrYnNm
     */
    public String getLv2DlrYnNm() {
        return lv2DlrYnNm;
    }


    /**
     * @param lv2DlrYnNm the lv2DlrYnNm to set
     */
    public void setLv2DlrYnNm(String lv2DlrYnNm) {
        this.lv2DlrYnNm = lv2DlrYnNm;
    }


    /**
     * @return the dcApproveYnNm
     */
    public String getDcApproveYnNm() {
        return dcApproveYnNm;
    }


    /**
     * @param dcApproveYnNm the dcApproveYnNm to set
     */
    public void setDcApproveYnNm(String dcApproveYnNm) {
        this.dcApproveYnNm = dcApproveYnNm;
    }
