...
public interface GroupSalesApplicationDAO {
     ...
     * 집단판매심사정보 삭제
     */
    public boolean deleteGroupSalesApplicationDetJdg(GroupSalesApplicationVO vo);
    ...
    //집단판매신청정보수신1
    public int procFleetSaleFigureReq1RollBack(GroupSalesApplicationVO saveVO) throws Exception;
    ...
    public List<GroupSalesApplicationVO> selectGroupSalesApplicationMainByCondition(GroupSalesApplicationSearchVO searchVO) throws Exception;
