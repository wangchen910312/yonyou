...
public class PurcEvalImageVO extends BaseVO {
    ...
    private String modelCd;                  //차량모델명
    private String telNo;                       //전화번호
    private String carNo;                       //차량번호
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date giDt;                          //출고일자
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private Date purcRegDt;                     //매일등록일자
    @JsonDeserialize(using=JsonDateDeserializer.class)
    ...
    private Double evalAmtTo;                   //평가금액구간종료
    private String lastOwnerNm;                 //최종소유자명
     ...
     */
    public Double getEvalAmtTo() {
        return evalAmtTo;
    }
    /**
     * @param evalAmtTo the evalAmtTo to set
     */
    public void setEvalAmtTo(Double evalAmtTo) {
