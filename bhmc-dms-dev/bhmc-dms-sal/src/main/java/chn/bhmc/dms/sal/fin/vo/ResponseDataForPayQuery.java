 ...
 * @version
 */
public class ResponseDataForPayQuery implements Serializable {
	...
	public ResponseDataForPayQuery() {

	}

	public ResponseDataForPayQuery(Integer responseCode, String responseMessage) {
