...
public class GroupSalesApplicationSaveVO extends BaseSaveVO<GroupSalesApplicationVO> {
    ...
    List<GroupSalesApplicationVehVO> vehicleListVO;
     ...
     */
    public List<GroupSalesApplicationVehVO> getVehicleListVO() {
     ...
     */
    public void setVehicleListVO(List<GroupSalesApplicationVehVO> vehicleListVO) {
