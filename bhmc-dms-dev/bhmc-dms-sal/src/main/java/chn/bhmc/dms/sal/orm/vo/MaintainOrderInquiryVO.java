...
public class MaintainOrderInquiryVO implements Serializable {
    ...
    private String sysDt;               //시스템 일자(년월)
	private String dlrCd;             //딜러코드
	private String ptyOrdYyMmDt;      //위약오더 년월일자
     ...
     */
    public String getPtyOrdYyMmDt() {
        return ptyOrdYyMmDt;
    }
    /**
     * @param ptyOrdYyMmDt the ptyOrdYyMmDt to set
     */
    public void setPtyOrdYyMmDt(String ptyOrdYyMmDt) {
    ...
    /**
     * @return the sysDtDate
     */
    public Date getSysDtDate() {
        return sysDtDate;
    }
    /**
     * @param sysDtDate the sysDtDate to set
     */
    public void setSysDtDate(Date sysDtDate) {
        this.sysDtDate = sysDtDate;
    }
