...
public interface PackageWorkDAO {
     ...
     * 집단판매업무 신청 팝업 저장
     */
    public int insertPackageSalesWorkPopups (PackageSalesWorkVO packageSalesWorkVO) throws Exception;

    /**
     * 집단판매업무 신청 팝업 수정
     */
    public int updatePackageSalesWorkPopups (PackageSalesWorkVO packageSalesWorkVO) throws Exception;
     ...
     * 집단판매업무 신청 삭제
     */
    public int deletePackageSalesWorkPopupsVeh (PackageSalesWorkVO packageSalesWorkVO) throws Exception;
    ...
    * @throws Exception
    */
    public int procBigClientDcReq(PackageSalesWorkVO packageSalesWorkVO) throws Exception;

    /**
     *
     * 집단판매업무 신청 확정 ROLLBACK
     * @param PackageSalesWorkVO
     * @return bindingResult
     * @throws Exception
     */
    public int procBigClientDcReqRollBack(PackageSalesWorkVO packageSalesWorkVO) throws Exception;
     ...
     * 집단판매업무 심사 확정.
     */
    public int insertPackageSalesWorkJudge(PackageSalesWorkVO packageSalesWorkVO) throws Exception;

    /**
     * 집단판매업무 심사 승인/불승인 여부 저장
     */
    public int updatePackageSalesWorkJudgeHeader(PackageSalesWorkVO packageSalesWorkVO) throws Exception;

    // 집단판업무 결과 송신 프로시저
    public int procPackageReq(PackageSalesWorkVO packageSalesWorkVO) throws Exception;
     ...
     * @return 등록된 목록수
     */
    public int insertPackageSalesWorkVehicle(PackageSalesWorkVO packageSalesWorkVO) throws Exception;
     ...
     * @return 검색된 목록수
     */
    public PackageSalesWorkVO selectVehicleByKey(PackageSalesWorkVO packageSalesWorkVO) throws Exception;
     ...
     * @return 수정된 목록수
     */
    public int updatePackageSalesWorkVehicle(PackageSalesWorkVO packageSalesWorkVO) throws Exception;
     ...
     * @return 수정된 목록수
     */
    public int deletePackageSalesWorkVehicle(PackageSalesWorkVO packageSalesWorkVO) throws Exception;
