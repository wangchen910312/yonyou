...
/**
 * @ClassName   : AccessoryMngSearchVO
 * @Description : 경품판매관리 조회 VO
...
public class AccessoryMngSearchVO extends SearchVO{
    ...
    private String sContractStatCd;             // 상태
    @JsonDeserialize(using=JsonDateDeserializer.class)
    ...
    private double sPrenSumAmt;               // 용품 할인금액
