...
public class ContractReSaveVO {
    ...
    // 대행업무
    private BaseSaveVO<AapInfoVO> aapsVO;
     ...
     * @return the aapsVO
     */
    public BaseSaveVO<AapInfoVO> getAapsVO() {
        return aapsVO;
    }

    /**
     * @param aapsVO the aapsVO to set
     */
    public void setAapsVO(BaseSaveVO<AapInfoVO> aapsVO) {
        this.aapsVO = aapsVO;
    }
