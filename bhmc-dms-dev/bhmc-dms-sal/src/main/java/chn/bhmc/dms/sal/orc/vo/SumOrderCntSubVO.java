...
public class SumOrderCntSubVO extends BaseVO{
    ...
    /**
     * 주문유형 이름 값 (화면에 보여지는 값 )
     **/
    private  String ordTpNm;

    /**
     * 오더상태 이름 값 (화면에 보여지는 값 )
     **/
    private  String ordStatCdNm;

    /**
     * 하치장명 이름 값 (화면에 보여지는 값 )
     **/
    private  String vinmVlocNm;
    ...
    /**
     * @return the ordStatCdNm
     */
    public String getOrdStatCdNm() {
        return ordStatCdNm;
    }

    /**
     * @param ordStatCdNm the ordStatCdNm to set
     */
    public void setOrdStatCdNm(String ordStatCdNm) {
        this.ordStatCdNm = ordStatCdNm;
    }

    /**
     * @return the vinmVlocNm
     */
    public String getVinmVlocNm() {
        return vinmVlocNm;
    }

    /**
     * @param vinmVlocNm the vinmVlocNm to set
     */
    public void setVinmVlocNm(String vinmVlocNm) {
        this.vinmVlocNm = vinmVlocNm;
    }
