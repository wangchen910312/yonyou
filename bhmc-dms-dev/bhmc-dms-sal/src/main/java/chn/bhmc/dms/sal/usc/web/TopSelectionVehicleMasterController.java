...
/*        //연계인1,2
        ...
        TopSelectionCertifyImgInfoVO topSelectionCertifyImgInfoVO = topSelectionService.selectVehicleCertify(searchVO);
        ...
        model.addAttribute("topSelectionCertifyImgInfoVO", topSelectionCertifyImgInfoVO);
        model.addAttribute("carId", carId);
        model.addAttribute("id", id);
        
        model.addAttribute("vehicleImageList", vehicleSpecOptionService.selectVehicleImages(carId));
