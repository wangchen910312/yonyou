 ...
 * </pre>
 *
 * @ClassName   : TpVehicleConditionVO
...
public class TpVehicleConditionVO extends AbstractExcelDataBinder {
    ...
    public void bind(int rowNo, int cellNo, Object value) throws ExcelDataBindingException {
        ...
        try{
            switch(cellNo){
                ...
                case 10:this.setDstbCmpDlDt(ExcelDataBinderUtil.getDateValue(value, null)); break;
                default :
            }
        }catch(Exception e){
