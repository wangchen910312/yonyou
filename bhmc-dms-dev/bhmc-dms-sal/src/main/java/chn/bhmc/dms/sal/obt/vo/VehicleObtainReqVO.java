...
public class VehicleObtainReqVO extends BaseVO {
     ...
     * @return the obtNo
     */
    public String getObtNo() {
        return obtNo;
    }
    /**
     * @param obtNo the obtNo to set
     */
    public void setObtNo(String obtNo) {
        this.obtNo = obtNo;
    }
    /**
     * @return the dlrCd
