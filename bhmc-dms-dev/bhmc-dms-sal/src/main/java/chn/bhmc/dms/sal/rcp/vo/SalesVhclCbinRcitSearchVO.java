...
public class SalesVhclCbinRcitSearchVO extends SearchVO {
    ...
    // 宫荣枢 2021-04-22 新增加筛选条件“发票来源”、“发票状态”
    private String sReceiptResource;
    private String sReceiptStatus;
    
    /**
     * R19080700284 统一发票管理功能  贾明 2019-8-8 增加 初审、上传店代码 、次月复核、 出库店代码 查询条件
     */
   ...
   //crs 37 发票上传扫描信息显示的画面，在“证件号码”后面增加“手机号码”，取合同上的客户手机号，允许修改，校验手机号为11位数字。提交给发票系统，发票初审不通过时可修 贾明 2019-12-11 end
	...
	public String getsReceiptResource() {
		return sReceiptResource;
	}
	public void setsReceiptResource(String sReceiptResource) {
		this.sReceiptResource = sReceiptResource;
	}
