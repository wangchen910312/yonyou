...
public class AccessoryItemSalesVO extends BaseVO{
     ...
     * 용품수
     */
    /*liuxueying 11.4 update start*/
    private double goodsCnt;
    private double goodsTotCnt;
    /*liuxueying 11.4 update end*/
    /**
     * 용품수량
     */
    ...
    */
     ...
     */
    public void setGoodsTotCnt(double goodsTotCnt) {
