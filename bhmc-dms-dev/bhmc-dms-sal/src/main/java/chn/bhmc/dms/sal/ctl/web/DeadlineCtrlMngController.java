...
public class DeadlineCtrlMngController extends HController {
     ...
     * 원샷개폐체크
     */
    @RequestMapping(value = "/selectOneShotCheck.do", method = RequestMethod.POST)
    @ResponseBody
    public int selectOneShotCheck(@RequestBody DeadlineCtrlMngSearchVO searchVO) throws Exception {
