package chn.bhmc.dms.sal.sample.web;
...
@Controller
@RequestMapping(value = "/sal/sample")
public class SalesSampleController extends HController {
     ...
     * @return
     */
    @RequestMapping(value = "/combo/selectSampleComboMain.do", method = RequestMethod.GET)
    public String selectSampleMain(Model model) throws Exception {
        ...
        return "/sal/sample/combo/sampleComboMain";
    }
