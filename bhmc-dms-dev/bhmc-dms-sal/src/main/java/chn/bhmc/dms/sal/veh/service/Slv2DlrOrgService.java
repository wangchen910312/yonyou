 ...
 * </pre>
 *
 * @ClassName   : Slv2DlrOrgService.java
...
public interface Slv2DlrOrgService {
     ...
     * @return
     */
    int insertSaleSlv2DlrOrgMgmtSave(Slv2DlrOrgVO slv2DlrOrgVO) throws Exception;
     ...
     * @return
     */
    Slv2DlrOrgVO selectSaleSlv2DlrOrgMgmtDetail(Slv2DlrOrgSearchVO searchVO) throws Exception;
     ...
     * @return
     */
    int updateSaleSlv2DlrOrgMgmtSave(Slv2DlrOrgVO slv2DlrOrgVO) throws Exception;
