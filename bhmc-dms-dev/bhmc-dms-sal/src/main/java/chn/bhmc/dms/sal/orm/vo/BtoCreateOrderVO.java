...
public class BtoCreateOrderVO implements Serializable {
    ...
    private String ordYyMmPrid;

    /**
     * @return the ordYyMmPrid
     */
    public String getOrdYyMmPrid() {
        return ordYyMmPrid;
    }
    /**
     * @param ordYyMmPrid the ordYyMmPrid to set
     */
    public void setOrdYyMmPrid(String ordYyMmPrid) {
        this.ordYyMmPrid = ordYyMmPrid;
    }
     ...
     * 인터페이스 전송 결과 메세지
     */
    private String iffailmsgRtn;

    /**
     * @return the strOrdQty
     */
    public String getStrOrdQty() {
        return strOrdQty;
    }
    /**
     * @param strOrdQty the strOrdQty to set
     */
    public void setStrOrdQty(String strOrdQty) {
        this.strOrdQty = strOrdQty;
    }
    ...
    /**
     * @return the iffailmsgRtn
     */
    public String getIffailmsgRtn() {
        return iffailmsgRtn;
    }
    /**
     * @param iffailmsgRtn the iffailmsgRtn to set
     */
    public void setIffailmsgRtn(String iffailmsgRtn) {
        this.iffailmsgRtn = iffailmsgRtn;
    }
    /**
     * @return the remark
     */
