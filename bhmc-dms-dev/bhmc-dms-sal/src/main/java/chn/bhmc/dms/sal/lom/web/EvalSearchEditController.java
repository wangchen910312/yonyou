...
public class EvalSearchEditController extends HController {
     ...
     * @return
     */
    @RequestMapping(value = "/selectEvalHistoryPopup.do", method = RequestMethod.GET)
    public String selectSpecialCarPolicyMain(Model model,@RequestParam(value="sVinNo", required = false, defaultValue="") String sVinNo) throws Exception{
        ...
        return "/sal/lom/evalSearchEdit/selectEvalHistoryPopup";
    }
     ...
     * @return
     */
    @RequestMapping(value = "/selectEvalHistorySearch.do", method = RequestMethod.POST)
    @ResponseBody
